...
$ref = base64_encode('angervent_intensity_report.php');
if(!isLoggedIn())
{
...
if(chkUserPlanFeaturePermission($user_id,'11'))
{
	$angervent_intensity_report = 1;
}
else
{
...
elseif(isset($_POST['btnPdfReport']))	
{
	...
	if(!$error)
	{
		$start_date = date('Y-m-d',strtotime($start_date));
		$end_date = date('Y-m-d',strtotime($end_date));
		$output = getAngerVentIntensityReportHTML($user_id,$start_date,$end_date);	
		$filename ="angervent_intensity_report_".time().".xls";
		convert_to_excel($filename,$output);
		exit(0);
		list($uavb_return,$arr_uavb_date,$arr_intensity_scale_1,$arr_intensity_scale_1_image,$arr_intensity_scale_2,$arr_intensity_scale_2_image) = getAngerVentIntensityReport($user_id,$start_date,$end_date);
								...
								<td align="center" valign="top" bgcolor="#FFFFFF">
									<table width="940" border="0" cellspacing="0" cellpadding="0" id="my_tbl">
										<tr>
                                            ...
                                            <?php 
											if($angervent_intensity_report == 1 ) 
											{ ?>
												...
												<table width="920" border="0" cellpadding="0" cellspacing="1" bgcolor="#999999" >
													<tr>
														<td width="920" align="left" valign="top" bgcolor="#E1E1E1" class="report_header">&nbsp;&nbsp;Angervent Intensity Report</td>
													</tr>
												</table>
												<table width="920" border="0" cellspacing="0" cellpadding="0">
													<tr>
												...
												<table width="920" border="0" cellpadding="0" cellspacing="1" bgcolor="#999999" >
													...
													{ ?>
													<tr>													
														<td height="30" align="center" valign="left" bgcolor="#E1E1E1" class="report_header"><?php echo date("d M Y h:i:s",strtotime($arr_uavb_date[$i])). '<br/>( '.date("l",strtotime($arr_uavb_date[$i])).')';?></td>	
