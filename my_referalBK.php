...
$ref = base64_encode('my_referal.php');
if(!isLoggedIn())
{
...
$referral_data = get_all_refered($_SESSION['user_id']);
//echo '<pre>';
                        ...
                        <table width="580" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td width="100%" align="left" valign="top">
                            		<span class="Header_brown">List Referred Friends</span><br /><br />
									<?php 
									...
									{ ?>
                                        <table width="580" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC">
                                            <tr>
                                                ...
                                                <td width="30%" height="30" align="center" valign="middle" bgcolor="#FFFFFF"><strong>Email id</strong></td>
                                                <td width="30%" height="30" align="center" valign="middle" bgcolor="#FFFFFF"><strong>Name</strong></td>
                                        ...
                                        foreach($referral_data as $record) 
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td height="30" align="center" valign="middle" bgcolor="#FFFFFF"><?php echo $record['email_id']; ?></td>
                                                <td height="30" align="center" valign="middle" bgcolor="#FFFFFF"><?php echo $record['name']; ?></td>
                                                <td height="30" align="center" valign="middle" bgcolor="#FFFFFF"><?php echo date('d/m/Y h:i:s A',strtotime($record['add_date'])); ?></td>
                                                <td height="30" align="center" valign="middle" bgcolor="#FFFFFF"><?php echo getUserRegistrationDateByEmail($record['email_id']); ?></td>
