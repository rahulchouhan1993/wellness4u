                            ...
                            for($j=0;$j<$loop_count;$j++) {  
                                    ...
                                    {   
...

                                        {
                                            ...
                                            $data='<iframe width="275px" height="175px" src="'.$fileData["banner"].'" frameborder="0" allowfullscreen></iframe>';
...

                                        {
                                            ...
                                            $data='<embed src="'.SITE_URL.'/uploads/'.$fileData["banner"].'" autostart="true" loop="true" height="175px" width="275px"></embed>';
...

                                        {
                                            ...
                                            $data='<a href="uploads/'.$fileData['banner'].'" target="_blank"><img src="images/pdf-icon.png" style="width:300px; height: 175px;object-fit: contain;" class="img-responsive" alt="" /></a>';
                                        ...
                                        $title=$imgData['topic_subject'];

                                        $desc=$imgData['narration'];
...

                        {
                             ...
                             $img=$file=$data=$title=$desc=$credit=$credit_url="";
                                    ...
                                    {   
                                        ...
                                        $title=$fileData['topic_subject'];

                                        $desc=$fileData['narration'];

                                        $credit=$fileData['credit'];

                                        $credit_url=$fileData['credit_url'];
