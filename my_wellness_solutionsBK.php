                            ...
                            <tr>
                            	<td align="center" valign="top" id="bgimage" background="<?php  echo $image; ?>" bgcolor="#FFFFFF" style=" padding:10px;">
                                    <form id="frm_StressBusterBox1" name="frm_StressBusterBox1" method="post" action="#" enctype="multipart/form-data">
                                        ...
                                        <input type="hidden" name="hdnmid" id="hdnmid" value="<?php echo $mid;?>"  />
                                            ...
                                            <table width="570" border="0" cellspacing="0" cellpadding="0">
                                                    ...
                                                    <td height="50" colspan="2" align="left" valign="top">
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                ...
                                                                <td width="55%" height="35" align="right" valign="top">
                                                                    <select name="theam_id1" id="theam_id" onchange="ChangeTheamMWS()">
                                                ...
                                                <tr>
                                                    <td height="35" colspan="2" align="left" valign="top">
                                                        <span class="Header_brown">Make your Choice:</span>&nbsp;
                                                        <select name="sol_cat_id" id="sol_cat_id" onchange="getMWSBoxCode()">
                                                ...
                                                <tr id="tr_user_upload_form" style="display:<?php echo $tr_user_upload_form;?>;">
                                                    <td colspan="2" align="left" valign="top" >
                                                        <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <tr>
                                                                <td align="left" colspan="2" bgcolor="#FFF2C1" style="padding-left:15px; padding-right:15px;"><strong>Title: </strong>
                                                ...
                                                <tr>
                                                    <td colspan="2" height="30"  align="left" valign="bottom">
                                                        ...
                                                        <span id="btn_show_user_upload_form" style="display:<?php echo $btn_show_user_upload_form;?>">
                                                            <input name="btnShowUpload" type="button" class="button" id="btnShowUpload" value="Show User Upload Area" />
                                                        </span>
