		...
		<div class="col-sm-12">
			<div class="panel">
				<div class="panel-body">
					...
					<form role="form" class="form-horizontal" id="add_cat" name="add_cat" method="post">                                             
						<div class="form-group"><label class="col-lg-2 control-label">Main Profile<span style="color:red">*</span></label>
							<div class="col-lg-5">
								<input type="text" name="cat_name" id="cat_name" placeholder="Main Profile" class="form-control" required>
							</div>
						</div>
...
<script src="admin-js/add-category-validator.js" type="text/javascript"></script>
</body>
</html>