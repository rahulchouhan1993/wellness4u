		...
		<div class="col-sm-12">
			<div class="panel">
				<div class="panel-body">
					...
					<form role="form" class="form-horizontal" id="add_admin" name="add_admin" method="post">                                             
						<div class="form-group"><label class="col-lg-2 control-label">User Name<span style="color:red">*</span></label>
							<div class="col-lg-5">
								<input type="text" name="username" id="username" placeholder="Username" class="form-control" required>
							</div>
						</div>
						<div class="form-group"><label class="col-lg-2 control-label">Password<span style="color:red">*</span></label>
							<div class="col-lg-5">
						...
						<div class="form-group"><label class="col-lg-2 control-label">Contact Number<span style="color:red">*</span></label>
							<div class="col-lg-5">
								<input type="text" name="contact_no" id="contact_no" placeholder="Contact Number" class="form-control" required>
							</div>
						</div>
...
<script src="admin-js/add-admin-validator.js" type="text/javascript"></script>
</body>
</html>