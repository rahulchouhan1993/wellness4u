								...
								<td align="center" valign="middle" bgcolor="#FFFFFF" style="background-repeat:repeat-x; padding:10px;">
									<form action="#" name="frmregister" id="frmregister" method="post" enctype="multipart/form-data"> 
										...
										<table width="750" border="0" cellspacing="0" cellpadding="0"  id="tblrow">
                                            ...
                                            <tr>
                                                <td width="30%" height="30" align="left" valign="top">Name:</td>
                                                <td width="70%" height="30" align="left" valign="top"><input name="name" type="text" class="input" id="name" size="45"  value="<?php echo $name; ?>" /></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td height="30" align="left" valign="top"><input name="email" type="text" class="input" id="email" size="45" value="<?php echo $email; ?>" /></td>
                                            </tr>
                                            ...
                                            <tr>
												<td height="30" align="left" valign="top">DOB:</td>
                                            ...
                                            <tr>
                                                <td height="30" align="left" valign="top">Sex:</td>
                                                <td height="30" align="left" valign="top">
                                            ...
                                            <tr>
                                                ...
                                                <td height="30" align="left" valign="top"><input name="mobile" type="text" class="input" id="mobile" size="45" value="<?php echo $mobile; ?>" /></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td height="30" align="left" valign="top"><input name="reg_no" type="text" class="input" id="reg_no" size="45" value="<?php echo $reg_no ?>" /></td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td height="30" align="left" valign="top">Issued by:</td>
                                                <td height="30" align="left" valign="top"><input name="issued_by" type="text" class="input" id="issued_by" size="45" value="<?php echo $issued_by; ?>" /></td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td height="30" align="left" valign="top">Scan Copy:</td>
                                                <td height="30" align="left" valign="top"><input name="scan_image" type="file" id="scan_image" /></td>
                                            </tr>
                                        ...
                                        {  ?>
                                            <tr class="row_id_membership_<?php echo $i; ?>">
                                                <td height="30" align="left" valign="top">Memberships: &nbsp;</td>
                                                <td height="30" align="left" valign="top">
                                                	<input name="membership[]" type="text" class="input" id="membership_<?php echo $i; ?>" size="45" value="<?php echo $arr_membership[$i]; ?>" />
                                                </td>
                                            </tr>
                                            <tr class="row_id_membership_<?php echo $i; ?>">
                                                <td height="30" align="left" valign="top">Memberships No: &nbsp;</td>
                                                <td height="30" align="left" valign="top">
                                                	<input name="membership_no[]" type="text" class="input" id="membership_no_<?php echo $i; ?>" size="45" value="<?php echo $arr_membership_no[$i]; ?>" />
                                        ...
                                        <?php
                                            ...
                                            <tr>
                                                <td colspan="2" align="left" valign="top">
                                                	<table border="0" width="750" cellpadding="0" cellspacing="0" id="tblrow2">
                                                    	<tr>
                                                    ...
                                                    {  ?>
                                                        <tr class="row_id_service_<?php echo $i; ?>">
                                                            ...
                                                            <td height="30" align="left" valign="top">
                                                                <input name="service_clinic_name[]" type="text" class="input" id="service_clinic_name_<?php echo $i; ?>" size="25" value="<?php echo $arr_service_clinic_name[$i]; ?>" style="width:120px;" />
                                                            </td>
                                                            <td height="30" align="left" valign="top">
                                                                <input name="service_location[]" type="text" class="input" id="service_location_sl_<?php echo $i; ?>" size="25" value="<?php echo $arr_service_location[$i]; ?>" style="width:120px;" readonly="readonly" onfocus="showLocationPopup('sl_<?php echo $i; ?>')" />
                                                            ...
                                                            <td height="30" align="left" valign="top">
                                                                <input name="service_rendered[]" type="text" class="input" id="service_rendered_<?php echo $i; ?>" size="25" value="<?php echo $arr_service_rendered[$i]; ?>" style="width:120px;" />
                                                            </td>
                                                            <td height="30" align="left" valign="top">
                                                                <input name="service_notes[]" type="text" class="input" id="service_notes_<?php echo $i; ?>" size="25" value="<?php echo $arr_service_notes[$i]; ?>" style="width:120px;" />
                                                            </td>
                                                            <td height="30" align="left" valign="top">
                                                               <?php
																if($i > 0)
                                            ...
                                            <tr>
                                                <td colspan="2" height="30" align="left" valign="top"><strong>Referred by:  </strong>&nbsp;&nbsp;
                                            ...
                                            <tr>
												...
												<td height="30" align="left" valign="top">
													...
													<textarea readonly="readonly" name="tos" id="tos" rows="10" cols="32"><?php echo strip_tags(getPageContents('79'));?></textarea>
												</td>
											</tr>
											<tr>
												<td height="40" align="left" valign="middle">&nbsp;</td>
												<td height="40" align="left" valign="bottom"><input name="btnSubmit" type="submit" class="button" id="btnSubmit" value="Create my account as a Wellness Adviser on www.wellnessway4u.com" /></td>
											</tr>
                                        </table>
                                    </form>	
                                </td>
