...

{
	...
	if( ($food_report == '') && ($activity_report == '') && ($wae_report == '') && ($gs_report == '') && ($sleep_report == '') && ($mc_report == '') && ($mr_report == '') && ($mle_report == '') && ($adct_report == '') )
											...
											{ ?>
												...
												<table width="920" border="0" cellspacing="0" cellpadding="0">
													...
													<tr>
														...
														<td width="260" height="45" align="left" valign="middle"><input type="submit" name="btnSubmit" id="btnSubmit" value="View Diary" /></td>
