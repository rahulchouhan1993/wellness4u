...
if(!chkAdviserPlanFeaturePermission($pro_user_id,'16'))
{
...
if(isset($_POST['btnSubmit']))
{
	...
	if(!$error)
	{
		...
		if(updateTheme($theam_name,$color_code,$image,$credit,$credit_url,$status,$day,$theam_id,$pro_user_id,$country_id,$str_state_id,$str_city_id,$str_place_id,$str_user_id,$keywords))
		{
...
{
	$theam_id = $_GET['id'];
	list($theam_name,$color_code,$image,$credit,$credit_url,$status,$day,$country_id,$state_id,$city_id,$place_id,$user_id,$keywords) = getTheamDetailsFront($theam_id,$pro_user_id);
	if($theam_name == '')
	{
		header('location: themes.php');
		exit(0);
							...
							<tr>
								<td align="center" valign="middle" bgcolor="#FFFFFF" style="background-repeat:repeat-x; padding:10px;">
									<form action="#" name="frmedit_profile" id="frmedit_profile" method="post" enctype="multipart/form-data"> 
										...
										<input type="hidden" name="hdntheam_id" value="<?php echo $theam_id;?>" />
                                        ...
                                        <tbody>
                                        	...
                                        	<tr>
									<td width="20%" align="right"><strong>Theme Name</strong></td>
                                ...
                                <tr>
								 ...
								 <tr>
									<td align="right"></td>
									<td align="center"></td>
									<td align="left"><img border="0" src="<?php echo SITE_URL."/uploads/".$image ?>" width="100"  />    </td>
								</tr>
                                <tr>
