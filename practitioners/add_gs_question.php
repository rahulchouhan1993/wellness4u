...
$ref = base64_encode('practitioners/add_gs_question.php');
...
//echo "<script>window.location.href='practitioners/gs_questions.php'</script>";
...
if(!chkAdviserPlanFeaturePermission($pro_user_id,'18'))

{

//	header('location: gs_questions.php');
echo "<script>window.location.href='practitioners/gs_questions.php'</script>";
...
{  
...

	{
...

		{
			...
			echo $str_user_id = implode(',',$arr_user_id);

		}

		

		if(addGSQuestion($situation,$situation_font_family,$situation_font_size,$situation_font_color,$listing_date_type,$days_of_month,$single_date,$start_date,$end_date,$str_state_id,$str_city_id,$str_user_id,$pro_user_id,$keywords,$listing_order,$arr_min_rating,$arr_max_rating,$arr_interpretaion,$arr_treatment,$country_id,$str_place_id))

		{

			$msg = "Question Added Successfully!";

		//	header('location: gs_questions.php?msg='.urlencode($msg));
echo "<script>window.location.href='gs_questions.php'</script>";
                                        ...
                                        <tbody>
                                            ...
                                            <tr id="tr_date_range" style="display:<?php echo $tr_date_range;?>">
                                                ...
                                                <td align="left">
                                                    ...
                                                    <input name="start_date" id="start_date" type="text" value="<?php echo $start_date;?>" class="form-control" style="width:230px;display: inline;"  /> - <input name="end_date" id="end_date" type="text" value="<?php echo $end_date;?>"  class="form-control" style="width:230px;display: inline;"  />
                                        ...
                                        {  ?>
                                            ...
                                            <tr id="row_id_1_<?php echo $i;?>">
                                                ...
                                                <td align="left">
                                                    ...
                                                    <select name="min_rating[]" id="min_rating_<?php echo $i; ?>" class="form-control" style="width:100px; display:inline;">
                                                    ...
                                                    <select name="max_rating[]" id="max_rating_<?php echo $i; ?>" class="form-control" style="width:100px; display:inline;" ">
...
<!--        <script>
        ...
        $('#single_date').datepicker({format: 'yyyy-mm-dd'});
