                	...
                	<td height="45" align="center" valign="bottom">
                    	<table width="950" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td width="922" height="32" align="left" valign="middle">
                                    <table height="30px" bgcolor="#71706e" border="0" cellspacing="0" cellpadding="0" width="922">
                                        <tr>
            	...
            	<tr>
            		<td height="150" align="left" valign="top">
                    	<div class="imgtopbanner">
                        	<?php
							if($default_adviser_top_banner)
							{ ?>
                            <span id="header_top_banner"><a href="<?php echo SITE_URL.'/practitioners/add_banner.php';?>"><img border="0" src="<?php echo SITE_URL.'/uploads/'.$top_banner; ?>" width="960" height="150" alt="Click here to Upload your Consultation Forum Banner (960 X 150) .This Banner will appear in this position on pages accessed by your Consult for your Services" title="Click here to Upload your Consultation Forum Banner (960 X 150) .This Banner will appear in this position on pages accessed by your Consult for your Services" /></a></span>
                            <?php
							}
							else
							{ ?>
                            ...
                            <div class="imgtoplogo">
                                <a href="<?php echo SITE_URL.'/practitioners';?>"><img src="images/cwri_logo.png" width="127" height="105" border="0" /></a>                            </div>
                            <div class="imgtopstrip" style="left:925px; top:115px;">
                            	
                              <div style="width:30px; height:30px;"><a href="<?php echo SITE_URL.'/practitioners/banners.php';?>"><img alt="Change Banner" title="Change Banner" src="images/edit.png" width="30" border="0" /></a></div>
                            </div>    
                            <?php
							} ?>
