...
<div class="col-md-12">	 
						<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                    ...
                                    <tbody>
                                        <tr >
                                            <td colspan="8" align="right">
                                            	<input type="button" name="btnAddNew" id="btnAddNew" value="Add New Question" onclick="javascript:window.location='add_mle_question.php'" />
                                        ...
                                        <?php
                                        echo getAllMLEQuestionsList($pro_user_id);
                                        ?>
                                    </tbody>
                                    </table>
                                <?php 
                            ...
                            <tr >
                                            <td colspan="8" align="right">&nbsp;</td></tr>
						</table>
</div>
 </div>
 </div>
