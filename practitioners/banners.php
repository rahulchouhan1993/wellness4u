...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
							<tr>
                                ...
                                if($page_access)
                                { ?>	
                                    <table border="1" style="border-collapse:collapse;" width="100%" cellpadding="1" cellspacing="1" bgcolor="">
                                    <tbody>
                                        <?php
                                        ...
                                        <tr>
                                            <td colspan="4" align="right">
                                            	...
                                            	<input type="button" name="btnAddNew" id="btnAddNew" value="Add New" onclick="javascript:window.location='add_banner.php'" />
                                        ...
                                        <tr class="manage-header" bgcolor="#CCCCCC">
                                            ...
                                            <td width="65%" class="manage-header" align="center"><strong>Banner</strong></td>
                                            <td width="15%" class="manage-header" align="center"><strong>Status</strong></td>
                                           <td width="10%" class="manage-header" align="center"><strong>Edit</strong></td>
                                        </tr>
                                        <?php
                                        echo getAllAdviserBannersList($pro_user_id);
                                        ?>
                                    </tbody>
                                    </table>
                                <?php 
