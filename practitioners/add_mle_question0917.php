...
$ref = base64_encode('practitioners/add_mle_question.php');
...
if(isset($_POST['btnSubmit']))
{
	...
	if(!$error)
	{
		...
		if(addMLEQuestion($situation,$situation_font_family,$situation_font_size,$situation_font_color,$listing_date_type,$days_of_month,$single_date,$start_date,$end_date,$str_state_id,$str_city_id,$str_user_id,$pro_user_id,$keywords,$listing_order,$arr_min_rating,$arr_max_rating,$arr_interpretaion,$arr_treatment,$country_id,$str_place_id))
		{
