...
$ref = base64_encode('practitioners/mc_questions.php');
...
if(!chkAdviserPlanFeaturePermission($pro_user_id,'20'))
{
	header('location: mc_questions.php');
	exit(0);
}
...
if(isset($_POST['btnSubmit']))
{
	...
	if(!$error)
	{
		...
		if(updateMCQuestion($situation,$situation_font_family,$situation_font_size,$situation_font_color,$listing_date_type,$days_of_month,$single_date,$start_date,$end_date,$country_id,$str_state_id,$str_city_id,$str_place_id,$str_user_id,$pro_user_id,$keywords,$listing_order,$arr_min_rating,$arr_max_rating,$arr_interpretaion,$arr_treatment,$status,$mc_id))
		{
			$msg = "Question Updated Successfully!";
			header('location: mc_questions.php?msg='.urlencode($msg));
		}
		else
		{
			$error = true;
						...
						<table width="960" align="center" border="0" cellspacing="0" cellpadding="0">
							<tr>
	                            <td height="40" align="left" valign="top" class="breadcrumb">
                                    ...
                                    <a href="index.php" target="_self" class="breadcrumb_link">Home</a> &gt; <a href="#" target="_self" class="breadcrumb_link">Wellness Parameters Settings</a> &gt; Edit My Communication/Interaction Question
                                </td>
                            </tr>
                        </table> 
							...
							<tr>
								<td align="center" valign="middle" bgcolor="#FFFFFF" style="background-repeat:repeat-x; padding:10px;">
									<form action="#" name="frmedit_profile" id="frmedit_profile" method="post" enctype="multipart/form-data"> 
                                    	<input type="hidden" name="hdnmc_id" id="hdnmc_id" value="<?php echo $mc_id;?>" />
