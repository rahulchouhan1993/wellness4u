...
<div class="col-md-10">	
					...
					if($record['last_status_updated_by_adviser'] == '1')
                                        ...
                                        <table width="760" border="1" align="center" cellpadding="5" cellspacing="1" >
                                            <tr>
                                                <td width="5%" height="30" align="center" valign="middle" bgcolor="#CCCCCC"><strong>Sr.No.</strong></td>
                                                <td width="40%" height="30" align="center" valign="middle" bgcolor="#CCCCCC"><strong>Invitation/Activation/Deactivation Message</strong></td>
                                                <td width="20%" height="30" align="center" valign="middle" bgcolor="#CCCCCC"><strong>Invitation Sent Date</strong></td>
                                                <td width="20%" height="30" align="center" valign="middle" bgcolor="#CCCCCC"><strong>Status</strong></td>
                                                <td width="15%" height="30" align="center" valign="middle" bgcolor="#CCCCCC"><strong>Status Date</strong></td>
