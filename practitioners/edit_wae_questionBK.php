...
$ref = base64_encode('practitioners/wae_questions.php');
...
if(isset($_POST['btnSubmit']))
{
	...
	if(!$error)
	{
		...
		if(updateWAEQuestion($situation,$situation_font_family,$situation_font_size,$situation_font_color,$listing_date_type,$days_of_month,$single_date,$start_date,$end_date,$country_id,$str_state_id,$str_city_id,$str_place_id,$str_user_id,$pro_user_id,$keywords,$listing_order,$arr_min_rating,$arr_max_rating,$arr_interpretaion,$arr_treatment,$status,$wae_id))
		{
						...
						<table width="960" align="center" border="0" cellspacing="0" cellpadding="0">
							<tr>
	                            <td height="40" align="left" valign="top" class="breadcrumb">
                                    ...
                                    <a href="index.php" target="_self" class="breadcrumb_link">Home</a> &gt; <a href="#" target="_self" class="breadcrumb_link">Wellness Parameters Settings</a> &gt; Edit My Work Place Question
                                </td>
                            </tr>
                        </table> 
							...
							<tr>
								<td align="center" valign="middle" bgcolor="#FFFFFF" style="background-repeat:repeat-x; padding:10px;">
									<form action="#" name="frmedit_profile" id="frmedit_profile" method="post" enctype="multipart/form-data"> 
                                    	<input type="hidden" name="hdnwae_id" id="hdnwae_id" value="<?php echo $wae_id;?>" />
