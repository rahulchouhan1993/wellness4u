                                    ...
                                    <tbody>
                                        <tr>
                                            <td colspan="8" align="right">
                                            	<input type="button" name="btnAddNew" id="btnAddNew" value="Add New Question" onclick="javascript:window.location='add_gs_question.php'" />
                                        ...
                                        <?php
                                        echo getAllGSQuestionsList($pro_user_id);
                                        ?>
                                    </tbody>
                                    </table>
                                <?php 
