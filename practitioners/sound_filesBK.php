						...
						<table width="940" border="0" align="center" cellspacing="0" cellpadding="0">
							<tr>
								<td height="40" align="left" valign="top" class="breadcrumb">
                                    ...
                                    <a href="index.php" target="_self" class="breadcrumb_link">Home</a> &gt; <a href="#" target="_self" class="breadcrumb_link">Settings</a> &gt; Background Music Settings
								</td>
							</tr>
						</table>  
						<table width="940" border="0" align="center" cellpadding="0" cellspacing="0">
							<tr>
								<td align="left" valign="top">
									<span class="Header_brown">Background Music Settings<?php //echo getPageTitle($page_id);?></span><br /><br />
									
                                    <table border="1" style="border-collapse:collapse;" width="100%" cellpadding="1" cellspacing="1">
                                    <tbody>
                                        <tr>
                                            <td colspan="7" align="right">
                                            	<input type="button" name="btnAddNew" id="btnAddNew" value="Add New" onclick="javascript:window.location='add_sound_file.php'" />
                                                
                                            </td>
                                        </tr>
                                        <tr class="manage-header">
                                            <td width="5%" class="manage-header" align="center" >S.No.</td>
                                            <td width="30%" class="manage-header" align="center">Music File</td>
                                            <td width="20%" class="manage-header" align="center">Day</td>
                                            <td width="15%" class="manage-header" align="center">Status</td>
                                            <td width="5%" class="manage-header" align="center">Edit</td>
                                        </tr>
                                        <?php
                                        echo getAllSoundFilessList($pro_user_id);
                                        ?>
                                    </tbody>
                                    </table>
								</td>
