...
elseif($msg == '12')
{
	$message = '<span class="Header_brown">Your request sent successfully</span> <br /><br />';
}
elseif($msg == '13')
{
	$message = '<span class="Header_brown">Your Banner uploaded successfully.It will activated after admin approval.</span> <br /><br />';
}
else
{
