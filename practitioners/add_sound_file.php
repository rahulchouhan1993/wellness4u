...
<form action="#" name="frmedit_profile" id="frmedit_profile" method="post" enctype="multipart/form-data"> 
                                 ...
                                 <tr>
									...
									<td width="75%" align="left"><select id="day" name="day[]" multiple="multiple" class="form-control" >
                                    								<?php
                                                                        for($i=1;$i<=31;$i++)
                                                                        { ?>
                                ...
                                <tr>
									...
									<td width="75%" align="left"><input class="form-control" type="text"  id="credit" name="credit" value="<?php echo $credit; ?>"/>
                                     </td>
								</tr>
                                <tr>
									<td colspan="3" align="center">&nbsp;</td>
                                ...
                                <tr>
									...
									<td width="5%" align="center"><strong>:</strong></td>
									<td width="75%" align="left"><input class="form-control" type="text"  id="credit_url" name="credit_url" value="<?php echo $credit_url; ?>"/>&nbsp;(Please enter link like http://www.google.com)
                                     </td>
								</tr>
                                <tr>
									<td colspan="3" align="center">&nbsp;</td>
                                ...
                                <tr>
                                   <td ><strong>Upload Music</strong>
                                    ...
                                    <td><input name="music" type="file" id="music" class="form-control col-xs-4" />
                                     </td>
                                  </tr>
								<tr>
									<td colspan="3" align="center">&nbsp;</td>
