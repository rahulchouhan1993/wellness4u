                                    ...
                                    <tbody>
                                        <tr>
                                            <td colspan="7" align="right">
                                            	<input type="button" name="btnAddNew" id="btnAddNew" value="Add New" onclick="javascript:window.location='add_theme.php'" />
                                                
                                            </td>
                                        </tr>
                                        <tr class="manage-header">
                                            <td width="5%" class="manage-header" align="center" >S.No.</td>
                                            <td width="30%" class="manage-header" align="center">Theme Name</td>
                                            <td width="15%" class="manage-header" align="center">Color Code</td>
                                            <td width="15%" class="manage-header" align="center">Image</td>
                                            <td width="15%" class="manage-header" align="center">Day</td>
                                            <td width="15%" class="manage-header" align="center">Status</td>
                                           <td width="5%" class="manage-header" align="center">Edit</td>
                                        </tr>
                                        <?php
                                        echo getAllThemesList($pro_user_id);
                                        ?>
                                    </tbody>
                                    </table>
								<?php 
