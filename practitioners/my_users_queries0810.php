                        ...
                        <table width="940" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC">
                            ...
                            <tr>
                            	<td width="100%" align="left" valign="middle" bgcolor="#FFFFFF">
                                    ...
                                    <select name="user_id" id="user_id" style="width:120px;"  onchange="getUserQueryPageOptions('<?php echo $pro_user_id;?>','','user_id','pg_id');">
                            ...
                            <tr>
                                <td width="100%" align="left" valign="top">
									...
									?>
                                    	<table width="940" border="0" align="center" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td width="50%" align="left" valign="middle"><strong>User Name: <?php echo getUserFullNameById($arr_temp_user[$k]);?></strong></td>
                                                <td width="50%" align="left" valign="middle"><strong>Status: <?php echo $adviser_status;?></strong></td>
