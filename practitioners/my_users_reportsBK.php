                            	...
                            	<td width="100%" align="left" valign="middle" bgcolor="#FFFFFF">
                                    <form action="#" id="frmactivity" method="post" name="frmactivity">
                                        <table width="920" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td width="150" height="45" align="left" valign="middle" class="Header_brown">Date Selection Type:</td>
                                                ...
                                                <td width="520" height="45" align="left" valign="middle"></td>
                                            </tr>
                                        </table>
                                        <table width="920" border="0" cellspacing="0" cellpadding="0" id="tbldaterange" style="display:<?php echo $tbldaterange;?>">
                                            <tr>
                                                <td width="150" height="45" align="left" valign="middle" class="Header_brown">Start Date:</td>
                                                <td width="250" align="left" valign="middle">
                                                ...
                                                <td width="150" height="45" align="left" valign="middle" class="Header_brown">End Date:</td>
                                                <td width="250" align="left" valign="middle">
                                        ...
                                        <table width="920" border="0" cellspacing="0" cellpadding="0" id="tblsingledate" style="display:<?php echo $tblsingledate;?>">
                                            <tr>
                                                <td width="150" height="45" align="left" valign="middle" class="Header_brown">Date:</td>
                                                <td width="250" align="left" valign="middle">
                                        ...
                                        <table width="920" border="0" cellspacing="0" cellpadding="0" id="tblmonthdate" style="display:<?php echo $tblmonthdate;?>">
                                            <tr>
                                                <td width="150" height="45" align="left" valign="middle" class="Header_brown">Month:</td>
                                                <td width="250" align="left" valign="middle">
                                        ...
                                        <table width="920" border="0" cellspacing="0" cellpadding="0" >
                                            <tr>
                                                <td height="30" align="left" valign="middle" class="Header_brown">User:</td>
                                                <td align="left" valign="middle" >
                                                    <select name="user_id" id="user_id" style="width:200px;" onchange="getUserAcceptedReportsOptionsNew('<?php echo $pro_user_id;?>');getUserAcceptedReportsSetOptions('<?php echo $pro_user_id;?>');toggleScaleShow(); getModuleWiseKeywordsOptions(); getModuleWiseCriteriaOptions();resetReportForm();getUserTriggerCriteriaOptions();">
                                            ...
                                            <tr>
                                                <td width="150" height="45" align="left" valign="middle" class="Header_brown">Module:</td>
                                                <td width="250" align="left" valign="middle" id="idreporttype">
                                                    <select name="report_module" id="report_module" style="width:200px;" onchange="getUserAcceptedReportsSetOptions('<?php echo $pro_user_id;?>');toggleScaleShow(); getModuleWiseKeywordsOptions(); getModuleWiseCriteriaOptions(); resetReportForm();">
                                                        <option value="">Select Report</option>
                                                        <?php echo getUserAcceptedReportsOptionsNew($user_id,$pro_user_id,$report_module); ?>
                                                    </select>
                                                </td>
                                                <td width="150" height="45" align="left" valign="middle" class="Header_brown">Set:</td>
                                                <td width="250" align="left" valign="middle" id="iduserreportset">
                                                    <select name="user_set_id" id="user_set_id" style="width:200px;" onchange="getModuleWiseKeywordsOptions(); getModuleWiseCriteriaOptions(); ">
                                            ...
                                            <tr>
                                                <td height="30" align="left" valign="middle" class="Header_brown">Keyword:</td>
                                            ...
                                            <tr id="idscaleshow" style="display:<?php echo $idscaleshow;?>">
                                                <td height="45" align="left" valign="middle" class="Header_brown">Keyword Scale:</td>
                                                <td align="left" valign="middle">
                                                ...
                                                <td height="45" align="left" valign="middle" class="Header_brown">Scale value:</td>
                                                <td align="left" valign="middle">
                                            ...
                                            <tr>
                                                <td height="30" align="left" valign="middle" class="Header_brown">Criteria:</td>
                                            ...
                                            <tr id="idcriteriascaleshow" style="display:<?php echo $idcriteriascaleshow;?>">
                                                <td height="45" align="left" valign="middle" class="Header_brown">Criteria Scale:</td>
                                ...
                                { ?>
                                    <table width="920" border="0" cellpadding="0" cellspacing="0" class="report">
                                            ...
                                            { ?>
                                                ...
                                                <table width="920" border="0" cellpadding="0" cellspacing="1" bgcolor="#999999" >
                                                    <tr>
                                                        <td width="920" align="left" valign="top" bgcolor="#E1E1E1" class="report_header">&nbsp;Activity Analysis Chart</td>
                                                    </tr>
                                                </table>
                                                <table width="920" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                            ...
                                            { ?>
                                                ...
                                                <table width="920" border="0" cellpadding="0" cellspacing="1" bgcolor="#999999" >
                                                    <tr>
                                                        <td width="920" align="left" valign="top" bgcolor="#E1E1E1" class="report_header">&nbsp;Meal Time Chart</td>
                                                    </tr>
                                                </table>
                                                <table width="920" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                            ...
                                            { ?>
                                                ...
                                                <table width="920" border="0" cellpadding="0" cellspacing="1" bgcolor="#999999" >
                                                    <tr>
                                                        <td width="920" align="left" valign="top" bgcolor="#E1E1E1" class="report_header">&nbsp;Physical State Report</td>
                                                    </tr>
                                                </table>
                                                <table width="920" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                            ...
                                            { ?>
                                                ...
                                                <table width="920" border="0" cellpadding="0" cellspacing="1" bgcolor="#999999" >
                                                    <tr>
                                                        <td width="920" align="left" valign="top" bgcolor="#E1E1E1" class="report_header">&nbsp;Emotional State Report</td>
                                                    </tr>
                                                </table>
                                                <table width="920" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
