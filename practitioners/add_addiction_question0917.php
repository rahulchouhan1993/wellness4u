...
$ref = base64_encode('practitioners/add_addiction_question.php');
...
if(isset($_POST['btnSubmit']))
{
	...
	if(!$error)
	{
		...
		if(addAddictionQuestion($situation,$situation_font_family,$situation_font_size,$situation_font_color,$listing_date_type,$days_of_month,$single_date,$start_date,$end_date,$str_state_id,$str_city_id,$str_user_id,$pro_user_id,$keywords,$listing_order,$arr_min_rating,$arr_max_rating,$arr_interpretaion,$arr_treatment,$country_id,$str_place_id))
		{
									...
									<form action="#" name="frmedit_profile" id="frmedit_profile" method="post" enctype="multipart/form-data"> 
                                        ...
                                        <tbody>
                                            ...
                                            <tr id="tr_date_range" style="display:<?php echo $tr_date_range;?>">
                                                ...
                                                <td align="center" valign="top"><strong>:</strong></td>
                                                <td align="left">
                                                    <input name="start_date" id="start_date" type="text" value="<?php echo $start_date;?>" class="form-control" style="width:100px; display:inline;""  /> - <input name="end_date" id="end_date" type="text" value="<?php echo $end_date;?>"  class="form-control" style="width:100px; display:inline;""  />
