...
if(isset($_POST['btnSubmit']))
{
	...
	{
		$error = true;
		$err_msg = "Please Enter Theme Name.";
	}
	...
	if(!$error)
	{
		...
		if(addTheme($theam_name,$color_code,$image,$credit,$credit_url,$day,$pro_user_id,$country_id,$str_state_id,$str_city_id,$str_place_id,$str_user_id,$keywords))
		{
