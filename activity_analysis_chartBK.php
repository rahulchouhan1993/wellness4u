...
$ref = base64_encode('activity_analysis_chart.php');
if(!isLoggedIn())
{
...
if(chkUserPlanFeaturePermission($user_id,'27'))
{
	$activity_analysis_chart = 1;
}
else
{
...
elseif(isset($_POST['btnPdfReport']))	
{
	...
	if(!$error)
	{
		$start_date = date('Y-m-d',strtotime($start_date));
		$end_date = date('Y-m-d',strtotime($end_date));
		$output = getActivityChartHTML($user_id,$start_date,$end_date);	
						...
						<table width="940" border="0" cellpadding="0" cellspacing="1" bgcolor="#339900">
							<tr>
								<td align="center" valign="top" bgcolor="#FFFFFF">
									<table width="740" border="0" cellspacing="0" cellpadding="0" id="my_tbl">
										<tr>
											<td height="200" align="center" valign="top" class="mainnav">
											<?php
											if($activity_analysis_chart == 1)
											{ ?>	
												...
												<table width="920" border="0" cellpadding="2" cellspacing="1" bgcolor="#999999">
													<tr>
														<td height="30" align="left" valign="middle" bgcolor="#E1E1E1" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal; color:#0000FF;">Date : <?php echo date("d M Y",strtotime($arr_date[$i]));?>(<?php echo date("l",strtotime($arr_date[$i]));?>)</td>
													</tr>
                                                    <tr>
														<td height="30" align="left" valign="middle" bgcolor="#E1E1E1" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal; color:#0000FF;">Sleep Time : <?php echo getUserSleepTime($user_id,$arr_date[$i]);?></td>
                                                    </tr>
                                                    <tr>
														<td height="30" align="left" valign="middle" bgcolor="#E1E1E1" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal; color:#0000FF;">Wake-up Time : <?php echo getUserWakeUpTime($user_id,$arr_date[$i]);?></td>
													</tr>
												</table>
												<table width="920" border="0" cellpadding="0" cellspacing="0">
													<tr>
												...
												<table width="920" border="0" cellpadding="2" cellspacing="1" bgcolor="#999999">
													<tr>
														<td width="25" height="50" align="center" valign="middle" bgcolor="#E1E1E1" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal; color:#0000FF;">SNo</td>
														<td width="250" height="50" align="left" valign="middle" bgcolor="#E1E1E1" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal; color:#0000FF;">Activity</td>
														<td width="50" height="50" align="center" valign="middle" bgcolor="#E1E1E1" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal; color:#0000FF;">Time</td>
														<td height="50" align="center" valign="middle" bgcolor="#E1E1E1" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal; color:#0000FF;">Duration</td>
														<td height="50" align="center" valign="middle" bgcolor="#E1E1E1" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal; color:#0000FF;">Sedentary Activity(SA)</td>
														<td height="50" align="center" valign="middle" bgcolor="#E1E1E1" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal; color:#0000FF;">Light Activity(LA)</td>
														<td height="50" align="center" valign="middle" bgcolor="#E1E1E1" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal; color:#0000FF;">Moderate Activity(MA)</td>
														<td height="50" align="center" valign="middle" bgcolor="#E1E1E1" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal; color:#0000FF;">Vigorous Activity(VA)</td>
														<td height="50" align="center" valign="middle" bgcolor="#E1E1E1" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal; color:#0000FF;">Super Active(SUA)</td>
													</tr>	
														<?php
														$j=1;
														...
														{ ?>
													<tr>
														<td height="30" align="center" valign="middle" bgcolor="#E1E1E1" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal; color:#0000FF;"><?php echo $j;?></td>
														<td height="30" align="left" valign="middle" bgcolor="#E1E1E1" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal; color:#0000FF;"><?php echo getDailyActivityName($key);?></td>
														<td height="30" align="center" valign="middle" bgcolor="#FFFFFF" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal;"><?php echo $val['time'];?></td>
														<td height="30" align="center" valign="middle" bgcolor="#FFFFFF" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal;"><?php echo $val['duration'];?></td>
														<td height="30" align="center" valign="middle" bgcolor="#FFFFFF" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal;"><?php echo $val['sa_cal_burned'];?></td>
														<td height="30" align="center" valign="middle" bgcolor="#FFFFFF" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal;"><?php echo $val['la_cal_burned'];?></td>
														<td height="30" align="center" valign="middle" bgcolor="#FFFFFF" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal;"><?php echo $val['ma_cal_burned'];?></td>
														<td height="30" align="center" valign="middle" bgcolor="#FFFFFF" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal;"><?php echo $val['va_cal_burned'];?></td>
														<td height="30" align="center" valign="middle" bgcolor="#FFFFFF" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal;"><?php echo $val['sua_cal_burned'];?></td>
													</tr>   
														<?php
														 $j++;
														}?>
													<tr>
														<td height="30" align="center" valign="middle" bgcolor="#E1E1E1" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal; color:#0000FF;">&nbsp;</td>
														<td height="30" align="left" valign="middle" bgcolor="#E1E1E1" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal; color:#0000FF;">Total</td>
