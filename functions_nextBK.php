...
function getWelcomeUserBoxCode($name,$user_id,$col='2',$show_custid ='')
{
	...
	$output = '';
	$output .= '            <table width="'.$width.'" border="0" cellpadding="0" cellspacing="1" bgcolor="#666666">';
	$output .= '                <tr>';
	$output .= '                    <td align="left" valign="middle" bgcolor="#FFFFCC" class="breadcrumb">';
	$output .= '                        <table width="'.$width.'" border="0" cellspacing="0" cellpadding="0">';
	$output .= '                            <tr>';
	if($show_custid == '1')
        {
        $output .= '                                <td height="30" align="right" valign="middle" style="padding-left:10px;">Welcome '.$name.'</td>';    
        $output .= '                                <td height="30" align="right" valign="middle" style="padding-right:10px;">Cust Id: '.getUserUniqueId($user_id).'</td>';
	}
        else
        {
        $output .= '                                <td height="30" align="center" valign="middle" style="padding-left:10px;">Welcome '.$name.'</td>';    
        }
        $output .= '				</tr>';
	$output .= '                        </table>';
	$output .= '			</td>';
