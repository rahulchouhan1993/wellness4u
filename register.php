...
if(isset($_POST['btnSubmit']))	
{
	...
	if(!$error)
	{
               if($gestid != '')
                  {
		    $signUpUser = updatesSignUpUserVivek($gestid,$name,$middle_name,$last_name,$email,$dob,$height,$weight,$sex,$mobile,$state_id,$city_id,$place_id,$food_veg_nonveg,$beef,$pork,$password,$country_id);
		  }
               else
                  {
...
<form action="<?php echo SITE_URL.'/register.php'?>" name="frmregister" id="frmregister" method="post">
                                        ...
                                        <input type="hidden" name="ref" id="ref" value="<?php echo base64_decode($ref); ?>" />
...
<table width="100%" border="0" cellspacing="4" cellpadding="2">
											...
											<tr>
                                                <td></td>
												<td height="5" align="left" valign="top" class="err_msg">      
                                                    Email Content  
                                                </td>
										    </tr>
