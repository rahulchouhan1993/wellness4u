<?php
//if($page_id == '12' || $page_id == '13' || $page_id == '26' || $page_id == '30' || $page_id == '31' || $page_id == '32' || $page_id == '33' || $page_id == '34' || $page_id == '35')
if(chkIfScrollingWindowActivateForPage($page_id))
{ ?>

<?php  echo getScrollingWindowsCode($page_id);?>

<?php
}
else
{
	list($arr_banner_id,$arr_page_id,$arr_page,$arr_position_id,$arr_banner,$arr_url,$arr_banner_type,$arr_position,$arr_side,$arr_width,$arr_height) = getbanners($page_id,'Left');
