...
$ref = base64_encode('food_chart.php');
if(!isLoggedIn())
{
...
if(chkUserPlanFeaturePermission($user_id,'2'))
{
	$food_chart = 1;
}
else
...
elseif(isset($_POST['btnPdfReport']))	
{
	...
	if(!$error)
	{
		$start_date = date('Y-m-d',strtotime($start_date));
		$end_date = date('Y-m-d',strtotime($end_date));
		$output = getFoodChartHTML($user_id,$start_date,$end_date);	
                                                ...
                                                <tbody>	
												 ...
												 <table width="920" border="0" cellpadding="2" cellspacing="1" bgcolor="#999999">
                                                    <tr>
                                                        ...
                                                        <td height="50" align="left" valign="middle" bgcolor="#E1E1E1" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal; color:#0000FF;">Food Constituents</td>
                                                        <td height="50" align="left" valign="middle" bgcolor="#E1E1E1" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal; color:#0000FF;">Recommended Dietary Allowance Per Day</td>
                                                        <td height="50" align="left" valign="middle" bgcolor="#E1E1E1" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal; color:#0000FF;">Average Requirement Per Day</td>
                                                        <td height="50" align="left" valign="middle" bgcolor="#E1E1E1" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal; color:#0000FF;">Upper Limit Per Day</td>
                                                        <td height="50" align="left" valign="middle" bgcolor="#E1E1E1" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal; color:#0000FF;">Average Quantity consumed per day for the Period</td>
                                                        <td height="50" align="left" valign="middle" bgcolor="#E1E1E1" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal; color:#0000FF;">Deficiency / Excess of Constituents Consumed on Average basis</td>
                                                        <td height="50" align="left" valign="middle" bgcolor="#E1E1E1" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal; color:#0000FF;">Deficiency / Excess of Constituents Consumed on Recommended values</td>
                                                        <td height="50" align="left" valign="middle" bgcolor="#E1E1E1" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal; color:#0000FF;">Observations</td>
                                                        <td height="50" align="left" valign="middle" bgcolor="#E1E1E1" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal; color:#0000FF;">Recommend</td>
                                                        <td height="50" align="left" valign="middle" bgcolor="#E1E1E1" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal; color:#0000FF;">Guideline</td>
                                                        <td height="50" align="left" valign="middle" bgcolor="#E1E1E1" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal; color:#0000FF;">Benefits</td>
                                                    </tr>	
                                                    <?php
                                                    $j=1;
                                                    ...
                                                    { ?>
                                                    <tr>
                                                        <td height="30" align="left" valign="middle" bgcolor="#E1E1E1" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal; color:#0000FF;"><?php echo $j;?></td>
                                                        <td height="30" align="left" valign="middle" bgcolor="#E1E1E1" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal; color:#0000FF;"><?php echo $key;?></td>
                                                        <td height="30" align="center" valign="middle" bgcolor="#FFFFFF" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal;"><?php echo $val['nutrientstdreq'];?></td>
                                                        <td height="30" align="center" valign="middle" bgcolor="#FFFFFF" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal;"><?php echo $val['nutrientavgreq'];?></td>
                                                        <td height="30" align="center" valign="middle" bgcolor="#FFFFFF" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal;"><?php echo $val['nutrientupperlimit'];?></td>
                                                        <td height="30" align="center" valign="middle" bgcolor="#FFFFFF" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal;"><?php echo $val['avg_qty_consumed'];?></td>
                                                        <td height="30" align="center" valign="middle" bgcolor="#FFFFFF" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal;"><?php echo $val['def_exc_avg_consumed'];?></td>
                                                        <td height="30" align="center" valign="middle" bgcolor="#FFFFFF" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal;"><?php echo $val['def_exc_rec_consumed'];?></td>
                                                        <td height="30" align="left" valign="middle" bgcolor="#FFFFFF" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal;"><?php echo $val['observations'];?></td>
                                                        <td height="30" align="left" valign="middle" bgcolor="#FFFFFF" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal;"><?php echo $val['recommend'];?></td>
                                                        <td height="30" align="left" valign="middle" bgcolor="#FFFFFF" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal;"><?php echo $val['guideline'];?></td>
                                                        <td height="30" align="left" valign="middle" bgcolor="#FFFFFF" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal;"><?php echo $val['benefits'];?></td>
                                                    <?php
                                                        $j++;
                                                    }?>
                                                    </tr>
