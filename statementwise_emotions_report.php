...
$ref = base64_encode('statementwise_emotions_report.php');
...
if(chkUserPlanFeaturePermission($user_id,'10'))
{
	$statementwise_emotions_report = 1;
}
else
{
...

{
	...
	if(!$error)
	{
		...
		$output = getStatementwiseEmotionsReportHTML($user_id,$start_date,$end_date,$wae_report,$gs_report,$sleep_report,$mc_report,$mr_report,$mle_report,$adct_report,$temp_permission_type,$temp_pro_user_id);	
            ...
            <div class=" col-md-12">
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0" id="my_tbl">
										...
										<tr>
											...
											if($statementwise_emotions_report == 1 ) 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left">
                                                            ...
                                                            <form action="#" method="post" name="frmpdfreports" id="frmpdfreports">
                                                                ...
                                                                <input type="submit" name="btnPdfReport" id="btnPdfReport" value="Save to Pdf" class="btn btn-primary"/>
