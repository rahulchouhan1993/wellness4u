				...
				<tr>
					...
					<td width="260" height="240" align="center" valign="top" background="images/top_back.jpg" bgcolor="#FFFFFF" style="padding-left:10px; background-repeat:repeat-x;">
						...
						<table width="250" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="250" align="center" valign="middle">
									<span class="Header_brown">New Vender</span><br />
									<span class="mainnav"><a href="<?php echo SITE_URL.'/vender_register.php';?>" target="_self"><img src="images/register_now.jpg" width="99" height="24" border="0" /></a></span>
								</td>
							</tr>
							<tr>
						...
						<table width="250" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td width="120" height="35" align="left" valign="bottom">Vender Login ID:</td>
