    ...
    $output.= '<form id="frm_feedback_reply" name="frm_feedback_reply" method="post" action="#" enctype="multipart/form-data">
                ...
                <input type="hidden" name="parent_id" id="parent_id" value="'.$data["parent_feedback_id"].'" />                    
                             <table cellpadding="0" cellspacing="0" width="80%" align="center" border="0" style="margin-top:-75%;">                  
                                 <tr>                            
                                     <td width="40%" height="40" align="left" valign="top">Subject:</td>                            
                                     <td width="60%" height="40" align="left" valign="top"> '.$obj->getPageTitle($data["page_id"]).'</td>                        
                                </tr>   
                                <tr>                         
...
elseif ($action == 'feedback_update_save') {
    ...
    $feedback=$feedback_old.'<br>'.$current. ': '.$feedback_new;
                ...
                <div class="col-md-10">
                    <div class="form-group row">
                        <div class="col-md-6">
                          ...
                          <input name="activity[]" type="text" class="form-control" id="activity_'.$total_row.'"  list="capitals'.$total_row.'" autocomplete="off" onchange="activity_datalist('.$total_row.')" required />
                        ...
                        <div class="col-md-6 row">
                           <label class="label">Other Activity</label>
                           <input type="text" name="other_activity[]" class="form-control">
                        </div>
                    </div>
                     <div class="form-group row">
                        <div class="col-md-3">
                          <label class="label">Activity Time Start</label>
                        ...
                        <div class="col-md-3">
                           <label class="label">Activity Time End</label>
                    ...
                    <div class="form-group row">
                        <div class="col-md-4">
                            <label class="label">My View</label>
                            <select class="form-control" name="user_response[]">'.$obj->getCategoryOptions('46').'</select>
                        </div>
                        <div class="col-md-4">
                          <label class="label">Activity Location Type</label>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <label class="radio-inline"><input type="radio" name="proper_guidance_'.$total_row.'" value="1">Yes</label>
                            <label class="radio-inline"><input type="radio" name="proper_guidance_'.$total_row.'" value="0" checked>No</label>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="label">(Including any Precaution taken)</label>
...
elseif ($action == 'checkActivityData') {
    ...
    if(!empty($act_data))
    {
        ...
        $response = array('status' => true, 'message' => 'You already added activity of this date!','html'=>$html,'count'=>$row_count,'yesterday_sleep_time'=>$act_data[0]['yesterday_sleep_time'],'today_wakeup_time'=>$act_data[0]['today_wakeup_time'],'sleep_duration'=>$act_data[0]['sleep_duration']);
