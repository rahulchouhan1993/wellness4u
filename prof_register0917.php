...
if(isset($_POST['btnSubmit']))	
{
	...
	elseif(chkProEmailExists($email))
	{
		$error = true;
		$tr_err_email = '';
	...
	elseif(!is_numeric($mobile))
	{
		$error = true;
		$tr_err_mobile = '';
		$err_mobile = 'Please enter valid mobile no';
	}
	...
	if($country_id == '')
	{
		$error = true;
		$tr_err_country_id = '';
		$err_country_id = 'Please select your state';
	}
	...
	if(!$error)
	{
		for($i=0;$i<count($arr_membership);$i++)
		{
			if(isset($_FILES['membership_image']['tmp_name'][$i]) && $_FILES['membership_image']['tmp_name'][$i] != '')
			{
				...
				if(($file4 != '.jpg')and($file4 != '.JPG') and ($file4 !='jpeg') and ($file4 != 'JPEG') and ($file4 !='.gif') and ($file4 != '.GIF') and ($file4 !='.png') and ($file4 != '.PNG'))
				{
					...
					$arr_tr_err_membership[$i] = '';
					$arr_err_membership[$i] = 'Please Upload Only(jpg/gif/jpeg/png) files for membership scan image';
				}	 
		...
		if(!$error)
		{
			...
			$signUpProUser = signUpProUser($name,$email,$password,$dob,$sex,$mobile,$address,$country_id,$state_id,$city_id,$place_id,$reg_no,$issued_by,$scan_image,$membership,$membership_no,$membership_image,$service_clinic_name,$service_location,$service_location_country_id,$service_location_state_id,$service_location_city_id,$service_location_place_id,$service_rendered,$service_notes,$referred_by,$ref_name,$specify);
			if($signUpProUser > 0)
			{
				...
				$url = SITE_URL.'/validate_pro_user.php?sess='.base64_encode($email).'';
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			$('#addMoreMembershipRows').click(function() {
				...
				$('#tblrow tr:#add_before_this_row').before('<tr class="row_id_membership_'+row_cnt+'"><td height="30" align="left" valign="top">Memberships: &nbsp;</td><td height="30" align="left" valign="top"><input name="membership[]" type="text" class="form-control" id="membership_'+row_cnt+'" size="45" value="" /></td></tr><tr class="row_id_membership_'+row_cnt+'"><td height="30" align="left" valign="top">Memberships No: &nbsp;</td><td height="30" align="left" valign="top"><input name="membership_no[]" type="text" class="form-control" id="membership_no_'+row_cnt+'" size="45" value="" /></td></tr><tr class="row_id_membership_'+row_cnt+'"><td height="30" align="left" valign="top">Scan Copy: &nbsp;</td><td height="30" align="left" valign="top"><input name="membership_image[]" type="file" id="membership_image_'+row_cnt+'" />&nbsp;<input type="button" value="Remove Item" id="tr_row_'+row_cnt+'" name="tr_row_'+row_cnt+'" onclick="removeMultipleRows(\'row_id_membership_'+row_cnt+'\',\'hdnrow_totalRow\')" /></td></tr><tr class="row_id_membership_'+row_cnt+'" id="tr_err_membership_'+row_cnt+'" style="display:none;"><td align="right">&nbsp; </td><td valign="top" align="left" class="err_msg" id="err_membership_'+row_cnt+'"></td></tr><tr class="row_id_membership_'+row_cnt+'"><td height="30" align="left" valign="top">&nbsp;</td><td height="30" align="left" valign="top">&nbsp;</td></tr>');	
									...
									<form action="#" name="frmregister" id="frmregister" method="post" enctype="multipart/form-data"> 
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0"  id="tblrow">
                                            ...
                                            <tr>
                                                ...
                                                <td width="70%"  align="left" valign="top"><input name="name" type="text" class="form-control" id="name" size="45"  value="<?php echo $name; ?>" /></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td height="50" align="left" valign="top"><input name="email" type="text" class="form-control" id="email" size="45" value="<?php echo $email; ?>" /></td>
                                            </tr>
                                            <tr id="tr_err_email" style="display:<?php echo $tr_err_email;?>;">
                                                <td align="right">&nbsp; </td>
                                                <td valign="top" align="left" class="err_msg" id="err_email"><?php echo $err_email;?></td>
                                            </tr>
                                            <tr>
												<td height="50" align="left" valign="top">DOB:</td>
												<td height="50" align="left" valign="top">
													<input name="dob" id="dob" type="text" value="<?php echo $dob;?>" class="form-control" />
                                            ...
                                            <tr>
                                                <td height="30" align="left" valign="top">Adviser Registration Number:</td>
                                            ...
                                            <tr>
                                                ...
                                                <td height="50" align="left" valign="top"><input name="scan_image" type="file" class="form-control" id="scan_image" /></td>
                                            </tr>
                                        ...
                                        {  ?>
                                            ...
                                            <tr class="row_id_membership_<?php echo $i; ?>">
                                                ...
                                                <td height="50" align="left" valign="top">
													...
													if($i > 0)
													{ ?>
														&nbsp;&nbsp;<input type="button" value="Remove Item" id="tr_row_<?php echo $i; ?>" name="tr_row_<?php echo $i; ?>" onclick="removeMultipleRows('row_id_membership_<?php echo $i; ?>','hdnrow_totalRow')" class="btn btn-danger"/>
													<?php } ?>
                                                </td>
                                            </tr>
                                        ...
                                        <?php
                                        	...
                                        	<tr id="add_before_this_row">
                                                <td height="50" align="left" valign="top">&nbsp;</td>
                                                <td height="50" align="left" valign="top"><a href="javascript:void(0)" target="_self" class="btn btn-success" id="addMoreMembershipRows">Add More Membership</a></td>
                                            </tr> 
                                        	<tr>
                                                <td height="50" align="left" valign="top">&nbsp;</td>
                                                <td height="50" align="left" valign="top">&nbsp;</td>
                                            ...
                                            <tr>
                                                <td height="80" colspan="2" align="left" valign="top"><strong>Currently providing Services at:</strong></td>
                                            </tr>
                                            <tr>
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" id="tblrow2" >
                                                    	<tr>
                                                        	<td width="5%" height="50" align="left" valign="top"><strong>SrNo</strong></td>
                                                            ...
                                                            <td width="15%" height="50" align="left" valign="top"><strong></strong></td>
                                                		</tr>
													<?php
                                                    ...
                                                    {  ?>
                                                        <tr class="row_id_service_<?php echo $i; ?>">
                                                            ...
                                                            <td height="50" align="left" valign="top">
             <div class="col-xs-12">                                                <input name="service_clinic_name[]" type="text" class="form-control" id="service_clinic_name_<?php echo $i; ?>" size="25" value="<?php echo $arr_service_clinic_name[$i]; ?>" />
             </div>
                                                            </td>
                                                            <td height="50" align="left" valign="top">
      <div class="col-xs-12">                                                          <input name="service_location[]" type="text" class="form-control" id="service_location_sl_<?php echo $i; ?>" size="25" value="<?php echo $arr_service_location[$i]; ?>" readonly onfocus="showLocationPopup('sl_<?php echo $i; ?>')"  />
                                                            ...
                                                            <td height="50" align="left" valign="top">
             <div class="col-xs-12">                                                   <input name="service_rendered[]" type="text" class="form-control" id="service_rendered_<?php echo $i; ?>" size="25" value="<?php echo $arr_service_rendered[$i]; ?>"  /> </div>
                                                            </td>
                                                            <td height="50" align="left" valign="top">
        <div class="col-xs-12">                                                        <input name="service_notes[]" type="text" class="form-control" id="service_notes_<?php echo $i; ?>" size="25" value="<?php echo $arr_service_notes[$i]; ?>"  /></div>
                                                            </td>
                                                            <td height="50" align="left" valign="top">
      <div class="col-xs-12">                                                         <?php
																if($i > 0)
																{ ?>
														<input type="button" value="Remove" id="tr_row2_<?php echo $i; ?>" name="tr_row2_<?php echo $i; ?>" onclick="removeMultipleRows('row_id_service_<?php echo $i; ?>','hdnrow_totalRow2')" class="btn btn-danger" />
													<?php } ?>
       </div>                                                     </td>
                                                        </tr>
                                                    <?php
                                                        ...
                                                        <tr id="add_before_this_row2">
                                                            <td colspan="6" height="50" align="left" valign="top"><a href="javascript:void(0)" target="_self" class="btn btn-success" id="addMoreServiceRows">Add More Service</a></td>
                                                        </tr> 
                                                        <tr>
...
<strong>Referred by:  </strong>&nbsp;&nbsp;
                                                	<select class="form-control" name="referred_by" id="referred_by">
                                                        ...
                                                        <option value="practitioner" <?php if($referred_by == 'practitioner') {?> selected="selected" <?php } ?>>Adviser</option>
                                                        <option value="others" <?php if($referred_by == 'others') {?> selected="selected" <?php } ?>>Other Medium</option>
                                                    </select>
	</div>                                                
                                                    <div class="col-xs-4"><strong>Name:</strong><input type="text" id="ref_name" class="form-control" name="ref_name" value="<?php echo $ref_name; ?>"/></div>
                                                    <div class="col-xs-4">
                                                    &nbsp;&nbsp;<strong>Specify:</strong><input class="form-control" type="text" id="specify" name="specify" value="<?php echo $specify; ?>"/>
                                        </div></div>        </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td height="50" align="left" valign="top"><input name="password" class="form-control" type="password"  id="password"  /></td>
                                            </tr>
                                             <tr>
                                             <td></td>
                                            ...
                                            <tr>
												...
												<td height="50" align="left" valign="top">
													...
													<textarea readonly name="tos" id="tos" class="form-control" cols="32"><?php echo strip_tags(getPageContents('79'));?></textarea>
												</td>
											</tr>
											<tr>
												<td height="60" align="left" valign="middle">&nbsp;</td>
												<td height="60" align="left" valign="bottom"><input name="btnSubmit" type="submit" class="btn btn-primary" id="btnSubmit" value="Create my account as a Adviser" title="Create my account as a Wellness Adviser on www.wellnessway4u.com" /></td>
											</tr>
                                        </table>
                                        <br/>
                                    </form>	
