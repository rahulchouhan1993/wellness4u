...
$ref = base64_encode('addictions.php');
if(!isLoggedIn())
{
...
$adct_date = $today_year.'-'.$today_month.'-'.$today_day;
...
if(isset($_POST['btnSubmit']))	
{
	...
	$empty_selected_adct_id_arr = true;
	for($i=0;$i<$cnt;$i++)
	{
		$selected_adct_id = strip_tags(trim($_POST['selected_adct_id_'.$i]));
		if($selected_adct_id != '')
		{
			$empty_selected_adct_id_arr = false;
		...
		array_push($selected_adct_id_arr,$selected_adct_id);
	}
	...
	if( ($day == '') || ($month == '') || ($year == '') )
	{
		$error = true;
		$tr_err_adct_date = '';
		$err_adct_date = 'Please select date!';
	}
	elseif(!checkdate($month,$day,$year))
	{
		$error = true;
		$tr_err_adct_date = '';
		$err_adct_date = 'Please select valid date!';
	}
	elseif(mktime(0,0,0,$month,$day,$year) > $now)
	{
		$error = true;
		$tr_err_adct_date = '';
		$err_adct_date = 'Please select today or previous date!';
	}
	else
	{
	...
	//Validations for gs - START	
	if($empty_selected_adct_id_arr)
	{
		$error = true;
	...
	else
	{
		for($i=0;$i<count($selected_adct_id_arr);$i++)
		{
			...
			array_push($tr_err_adct , $temp_tr_err);
			array_push($err_adct , $temp_err);	
		}
	}
	//Validations for gs - END		

	if(!$error)
	{
		$addUsersAdctQuestion = addUsersAdctQuestion($user_id,$adct_date,$selected_adct_id_arr,$scale_arr,$remarks_arr,$my_target_arr,$adviser_target_arr,$pro_user_id);
		if($addUsersAdctQuestion)
		{
...
else
{
	...
	$adct_date = $year.'-'.$month.'-'.$day;
	list($scale_arr,$remarks_arr,$selected_adct_id_arr,$my_target_arr,$adviser_target_arr) = getUsersADCTQuestionDetails($user_id,$adct_date,$pro_user_id);
	for($i=0;$i<count($selected_adct_id_arr);$i++)
	{
		if(($selected_adct_id_arr[$i] == '') || ($selected_adct_id_arr[$i] == '0') )
		{
			$tr_response_img[$i] = '';
			$tr_response_slider[$i] = 'none';
		}
...
<head>
	...
	<script type="text/javascript"> 
		$(document).ready(function() {
			...
			for(var i=0; i < cnt; i++)
			{
				//alert("old: "+activity_prefill_arr[i]);
										...
										<tr>
												...
												<table width="550" border="0" cellspacing="0" cellpadding="0">
														...
														<td colspan="4" height="50" align="left" valign="top">
                                                        	<table width="550" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    ...
                                                                    <td height="50" align="left" valign="middle" class="Header_brown">Addictions</td>
                                                                </tr>
                                                             </table>       
                                                        </td>
													</tr>
                                                    <tr> 
                                                        ...
                                                        <td width="150" height="30" align="left" valign="middle">
															<select name="pro_user_id" id="pro_user_id" onchange="getUsersADCTQuestionDetails(); updateUserFormTheme();" style="width:120px;">
														...
														<td width="180" height="30" align="left" valign="middle">
															<select name="day" id="day" onchange="getUsersADCTQuestionDetails();" style="width:40px;">
															...
															<select name="month" id="month" onchange="getUsersADCTQuestionDetails();" style="width:60px;">
																<?php echo getMonthOptions($month,$yesterday_month,$today_month); ?>
															</select>
															<select name="year" id="year" onchange="getUsersADCTQuestionDetails();" style="width:60px;">
															<?php
                                                    ...
                                                    <tr id="tr_err_adct_date" style="display:<?php echo $tr_err_adct_date;?>;" valign="top">
														<td align="right" valign="top">&nbsp; </td>
														<td align="right" valign="top">&nbsp; </td>
														<td align="left" colspan="2" class="err_msg" valign="top"><?php echo $err_adct_date;?></td>
													</tr>
												</table>                          
												<div id="divadct">
												<table width="560" border="0" cellspacing="0" cellpadding="0" id="tbladct">
											<?php
											if(count($arr_adct_id) > 0)
											{
												...
												{ 
                                                                                                    ...
                                                                                                    ?>
													<tr style="display:<?php echo $tr_err_adct[$i];?>;" valign="top">
														<td align="left" colspan="2" class="err_msg" valign="top"><?php echo $err_adct[$i];?></td>
													</tr>
													<tr>
														<td align="left" colspan="2" valign="top">&nbsp;</td>
													</tr>
													<tr>
														<td width="130" height="35" align="left" valign="top">&nbsp;&bull; Situation:</td>
														<td width="430" height="35" align="left" valign="top">
															<input type="checkbox" name="selected_adct_id_<?php echo $i;?>" id="selected_adct_id_<?php echo $i;?>" value="<?php echo $arr_adct_id[$i];?>" <?php if($selected_adct_id_arr[$i] == $arr_adct_id[$i]) { ?> checked="checked" <?php } ?> onclick="toggleMyResponseScale('selected_adct_id_','<?php echo $i;?>')" />&nbsp;<strong><span style="font-family:<?php echo $arr_situation_font_family[$i];?>;font-size:<?php echo $arr_situation_font_size[$i];?>px;color:#<?php echo $arr_situation_font_color[$i];?>;"><?php echo $arr_situation[$i]; ?></span></strong>
														</td>
													</tr>
													<tr id="tr_response_img_<?php echo $i; ?>" style="display:<?php echo $tr_response_img[$i]?>">
														<td width="130" height="37" align="left" valign="top">&nbsp;&bull; My Response Scale:</td>
														<td width="430" height="37" align="left" valign="top">
															<img border="0" src="images/scale_slider.jpg" width="427"  />														</td>
													</tr>
													<tr id="tr_response_slider_<?php echo $i; ?>" style="display:<?php echo $tr_response_slider[$i]?>">
														<td width="130" height="37" align="left" valign="top">&nbsp;&bull; My Response Scale:</td>
														<td width="430" height="37" align="left" valign="top" background="images/blank_slider.jpg" style="background-repeat:no-repeat;">
															<select name="scale[]" id="scale_<?php echo $i;?>" style="display:none;">
													...
													<tr>
                                                                                                            <td width="130" align="left" valign="top">&nbsp;&bull; My Response Details:</td>
                                                                                                            <td width="430" align="left" valign="top">
                                                                                                                ...
                                                                                                                <div class="tr_response_img_<?php echo $i; ?>" style="display:<?php echo $tr_response_img[$i]?>">
                                                                                                                    <textarea name="remarks2[]" id="remarks2_<?php echo $i;?>" cols="25" rows="3" disabled>&nbsp;</textarea>
                                                                                                                </div>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td align="left" colspan="2" valign="top">
                                                                                                                <table width="560" border="0" cellspacing="0" cellpadding="0">
                                                                                                                    <tr>
                                                                                                                        <td width="130" align="left" valign="top">&nbsp;&bull; My Target:</td>
                                                                                                                        <td width="150" align="left" valign="top">
                                                                                                                            ...
                                                                                                                            </select><br><?php echo getUsersLastMyTargetADCTDateString($user_id,$pro_user_id,$arr_adct_id[$i]);?>
                                                                                                                            </div>
                                                                                                                            
                                                                                                                            <div class="tr_response_img_<?php echo $i; ?>" style="display:<?php echo $tr_response_img[$i]?>">
                                                                                                                                <select name="my_targets2[]" id="my_targets2_<?php echo $i;?>" disabled>
                                                                                                                                <option value="" <?php if($my_target_arr[$i] == "") {?> selected="selected" <?php } ?>>Select</option>
                                                                                                                            <?php
                                                                                                                            for($j=1;$j<=10;$j++)
                                                                                                                            { ?>
                                                                                                                        ...
                                                                                                                        <td width="150" align="left" valign="top">
                                                                                                                            <div class="tr_response_slider_<?php echo $i; ?>" style="display:<?php echo $tr_response_slider[$i]?>">
                                                                                                                            <select name="adviser_target[]" id="adviser_target_<?php echo $i;?>" <?php echo $field_disable;?>>
                                                                                                                            ...
                                                                                                                            </select><br><?php echo getUsersLastAdviserTargetADCTDateString($user_id,$pro_user_id,$arr_adct_id[$i]);?>
                                                                                                                            </div>
													...
													<tr>
														<td width="130" height="35" align="left" valign="top">&nbsp;</td>
														<td width="430" align="left" valign="top"><input type="submit" name="btnSubmit" id="btnSubmit" value="Submit" /></td>
													</tr>
											<?php
											} 		
											else
											{
											 ...
											 ?>
                                            		<tr>
														<td align="center" colspan="2" valign="top"><?php echo $err_msg2;?></td>
													</tr>
                                            <?php
											} ?>
											  </table>
