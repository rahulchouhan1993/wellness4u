				...
				<tr>
					...
					<td width="260" height="240" align="center" valign="top" background="images/top_back.jpg" bgcolor="#FFFFFF" style="padding-left:10px; background-repeat:repeat-x;">
						...
						<table width="250" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="250" align="center" valign="middle">
									<span class="Header_brown">New Users</span><br />
									<span class="mainnav"><a href="<?php echo SITE_URL.'/register.php';?>" target="_self"><img src="images/register_now.jpg" width="99" height="24" border="0" /></a></span>
								</td>
							</tr>
							<tr>
						...
						<table width="250" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td width="79" height="35" align="left" valign="bottom">User Name:</td>
								<td width="171" height="35" align="left" valign="bottom">
									<input name="username" type="text" class="input" id="username" value="<?php echo $username;?>" size="25" />
								</td>
							</tr>
							<tr>
								<td height="35" align="left" valign="bottom">Password:</td>
								<td height="35" align="left" valign="bottom">
									<input name="password" type="password" class="input" id="password" size="25" />
								</td>
							</tr>
							<tr>
