...
<!--<input type="text" name="signup_city" id="signup_city" placeholder="City" class="input-text-box input-half-width" autocomplete="false">-->
								...
								<div class="password-wrapper-reg">
								    <input type="password" name="signup_password" id="signup_password" placeholder="Password" class="input-text-box" autocomplete="off" required>
								    <span toggle="#signup_password" class="toggle-password-reg" onclick="togglePasswordReg()">👁️</span>
								</div>
