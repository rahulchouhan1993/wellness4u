...
<!-- google font -->
<link rel="stylesheet" href="http://localhost/testesofstates/css/bootstrap.min.css">
<link rel="stylesheet" href="http://localhost/testesofstates/css/font-awesome.min.css">
<link rel="stylesheet" href="http://localhost/testesofstates/css/animated.css" media="all">
<link rel="stylesheet" href="http://localhost/testesofstates/css/slick.css" media="all">
<link rel="stylesheet" href="http://localhost/testesofstates/css/jquery-ui.css" media="all">
<link rel="stylesheet" href="http://localhost/testesofstates/css/style.css?v=1508748975">
<link rel="stylesheet" href="http://localhost/testesofstates/css/responsive.css">
<link rel="stylesheet" href="http://localhost/testesofstates/css/tokenize2.css" />
</head>
<body>
<!--<header>
	<nav>
...
<!--                                                                        <div class="form-group">
								    ...
								    <div class="form-group">
                                                                        <a href="prof_register.php" class="btn-red" href="javascript:doVendorRegistrationProceed()">PROCEED</a>
                                                                        
                                                                        <!--<a href="prof_register.php"><input type="Submit"  name="btnSubmit" id="btnSubmit"  value="Procced" /></a>-->
...
<script src="http://localhost/testesofstates/js/jquery-1.12.4.min.js"></script>

<script src="http://localhost/testesofstates/js/jquery-ui.js"></script>

<script src="http://localhost/testesofstates/js/bootstrap.min.js"></script>

<script src="http://localhost/testesofstates/js/banner.js"></script>

<script src="http://localhost/testesofstates/js/slick.js"></script>

<script src="http://localhost/testesofstates/js/main.js"></script>

<script src="http://localhost/testesofstates/js/animatedModal.min.js"></script>

<script src="http://localhost/testesofstates/js/tokenize2.js"></script>

<script src="http://localhost/testesofstates/js/bootbox.min.js"></script>

<script src="http://localhost/testesofstates/js/commonfn.js?v=1508748975"></script>
