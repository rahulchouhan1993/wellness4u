...
class Admin
{
	...
	public function getMainProfileOption($cat_id,$type='1',$multiple='')
	{
		$DBH = new DatabaseHandler();
		$output = '';
	...
	public function getMainCategoryOption($parent_cat_id,$cat_id,$type='1',$multiple='')
	{
		...
		if($go_ahead)
		{
			try {
				...
				$sql = "SELECT cat_id,cat_name FROM `tblcategories` WHERE ".$sql_parent_cat_id_str." AND `cat_deleted` = '0' ORDER BY cat_name ASC";	
				$STH = $DBH->query($sql);
				if( $STH->rowCount() > 0 )
				{
					while($r= $STH->fetch(PDO::FETCH_ASSOC))
	...
	public function getVendorAccessFormCode($va_id,$vafm_id)
	{
		...
		if($va_id != '' && $va_id != '0')
		{
			...
			elseif($vafm_id == '2')
			{
				...
				$cgst_tax_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'cgst_tax');	
				$sgst_tax_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'sgst_tax');	
				$cess_tax_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'cess_tax');	
				$gst_tax_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'gst_tax');	
				...
				$output = '	<div style="border:1px solid #CCC;padding:5px;margin: 10px 0px;">
								...
								<div style="border:1px solid #CCC;padding:5px;margin: 10px 0px;">
									...
									<div class="form-group">
										<label class="col-lg-2 control-label">Show Vendor</label>
										<div class="col-lg-4">
											<select name="vendor_id_show" id="vendor_id_show" class="form-control">
												'.$this->getShowHideOption($vendor_id_show).'
											</select>
										</div>
									</div>
									<div class="form-group">
										<label class="col-lg-2 control-label">Show Vendor Details</label>
										<div class="col-lg-4">
											<select name="vendor_show_show" id="vendor_show_show" class="form-control">
								...
								<div style="border:1px solid #CCC;padding:5px;margin: 10px 0px;">
									...
									<div class="form-group">
										<label class="col-lg-2 control-label">Show Ordering Size in Frontend</label>
										<div class="col-lg-4">
											<select name="ordering_size_show_show" id="ordering_size_show_show" class="form-control">
									...
									<div class="form-group">
										<label class="col-lg-2 control-label">Show Current Stock in Frontend</label>
										<div class="col-lg-4">
											<select name="cusine_qty_show_show" id="cusine_qty_show_show" class="form-control">
												'.$this->getShowHideOption($cusine_qty_show_show).'
											</select>
										</div>
									</div>
									<div class="form-group">
										<label class="col-lg-2 control-label">Show Sold Quantity in Frontend</label>
										<div class="col-lg-4">
											<select name="sold_qty_show_show" id="sold_qty_show_show" class="form-control">
									...
									<div class="form-group">
										<label class="col-lg-2 control-label">Show Offer Item</label>
										<div class="col-lg-4">
											<select name="is_offer_show" id="is_offer_show" class="form-control">
												'.$this->getShowHideOption($is_offer_show).'
											</select>
										</div>
									</div>
									<div class="form-group">
										<label class="col-lg-2 control-label">Show Offer Price</label>
										<div class="col-lg-4">
											<select name="offer_price_show" id="offer_price_show" class="form-control">
												'.$this->getShowHideOption($offer_price_show).'
											</select>
										</div>
									</div>
									<div class="form-group">
										<label class="col-lg-2 control-label">Show Offer Date</label>
										<div class="col-lg-4">
											<select name="offer_date_type_show" id="offer_date_type_show" class="form-control">
								...
								<div style="border:1px solid #CCC;padding:5px;margin: 10px 0px;">
									...
									<div class="form-group">
										<label class="col-lg-2 control-label">Show Category in Frontend</label>
										<div class="col-lg-4">
											<select name="cucat_show_show" id="cucat_show_show" class="form-control">
								...
								<div style="border:1px solid #CCC;padding:5px;margin: 10px 0px;">
									<div class="form-group">
										<label class="col-lg-2 control-label">Show Quantity Type</label>
										<div class="col-lg-4">
											<select name="cw_qt_cat_id_show" id="cw_qt_cat_id_show" class="form-control">
												'.$this->getShowHideOption($cw_qt_cat_id_show).'
											</select>
										</div>
									</div>
									<div class="form-group">
										<label class="col-lg-2 control-label">Show Quantity Unit</label>
										<div class="col-lg-4">
											<select name="cw_qu_cat_id_show" id="cw_qu_cat_id_show" class="form-control">
												'.$this->getShowHideOption($cw_qu_cat_id_show).'
											</select>
										</div>
									</div>
									<div class="form-group">
										<label class="col-lg-2 control-label">Show Quantity</label>
										<div class="col-lg-4">
											<select name="cw_quantity_show" id="cw_quantity_show" class="form-control">
												'.$this->getShowHideOption($cw_quantity_show).'
											</select>
										</div>
									</div>
									<div class="form-group">
										<label class="col-lg-2 control-label">Show Quantity in Frontend</label>
										<div class="col-lg-4">
											<select name="cw_show_show" id="cw_show_show" class="form-control" >
								...
								<div style="border:1px solid #CCC;padding:5px;margin: 10px 0px;">
									<div class="form-group">
										...
										<div class="col-lg-4">
											<select name="publish_date_type_show" id="publish_date_type_show" class="form-control">
									...
									<div class="form-group">
										...
										<div class="col-lg-4">
											<select name="delivery_date_type_show" id="delivery_date_type_show" class="form-control">
												'.$this->getShowHideOption($delivery_date_type_show).'
											</select>
										</div>
									</div>
									<div class="form-group">
										<label class="col-lg-2 control-label">Show Delivery Date in Frontend</label>
										<div class="col-lg-4">
											<select name="delivery_date_show_show" id="delivery_date_show_show" class="form-control">
									...
									<div class="form-group">
										<label class="col-lg-2 control-label">Show Delivery Time in Frontend</label>
										<div class="col-lg-4">
											<select name="delivery_time_show_show" id="delivery_time_show_show" class="form-control">
												'.$this->getShowHideOption($delivery_time_show_show).'
											</select>
										</div>
									</div>
									<div class="form-group">
										<label class="col-lg-2 control-label">Show Cancellation Cut Off Time</label>
										<div class="col-lg-4">
									...
									<div class="form-group">
										<label class="col-lg-2 control-label">Show Cancellation Cut Off Time in Frontend</label>
										<div class="col-lg-4">
											<select name="cancel_cutoff_time_show_show" id="cancel_cutoff_time_show_show" class="form-control">
								...
								<div class="form-group left-label">
									<label class="col-lg-4 control-label"><strong>Tax Details(GST/CGST/SGST/CESS):</strong></label>
								</div>
								<div style="border:1px solid #CCC;padding:5px;margin: 10px 0px;">
									<div class="form-group">
										<label class="col-lg-2 control-label">Show SGST Tax</label>
										<div class="col-lg-4">
											<select name="sgst_tax_show" id="sgst_tax_show" class="form-control">
												'.$this->getShowHideOption($sgst_tax_show).'
											</select>
										</div>
									</div>
									<div class="form-group">
										<label class="col-lg-2 control-label">Show CGST Tax</label>
										<div class="col-lg-4">
											<select name="cgst_tax_show" id="cgst_tax_show" class="form-control">
												'.$this->getShowHideOption($cgst_tax_show).'
											</select>
										</div>
									</div>
									<div class="form-group">
										<label class="col-lg-2 control-label">Show CESS Tax</label>
										<div class="col-lg-4">
											<select name="cess_tax_show" id="cess_tax_show" class="form-control">
												'.$this->getShowHideOption($cess_tax_show).'
											</select>
										</div>
									</div>
									<div class="form-group">
										<label class="col-lg-2 control-label">Show GST Tax</label>
										<div class="col-lg-4">
											<select name="gst_tax_show" id="gst_tax_show" class="form-control">
												'.$this->getShowHideOption($gst_tax_show).'
											</select>
										</div>
									</div>
								</div>
								...
								<div style="border:1px solid #CCC;padding:5px;margin: 10px 0px;">
									<div class="form-group">
										<label class="col-lg-2 control-label">Show Cusine Description 1</label>
										<div class="col-lg-4">
											<select name="cusine_desc_1_show" id="cusine_desc_1_show" class="form-control">
												'.$this->getShowHideOption($cusine_desc_1_show).'
											</select>
										</div>
									</div>
									<div class="form-group">
										<label class="col-lg-2 control-label">Show Cusine Description 1 in Frontend</label>
										<div class="col-lg-4">
											<select name="cusine_desc_show_1_show" id="cusine_desc_show_1_show" class="form-control">
												'.$this->getShowHideOption($cusine_desc_show_1_show).'
											</select>
										</div>
									</div>
									<div class="form-group">
										<label class="col-lg-2 control-label">Show Cusine Description 2</label>
										<div class="col-lg-4">
											<select name="cusine_desc_2_show" id="cusine_desc_2_show" class="form-control">
												'.$this->getShowHideOption($cusine_desc_2_show).'
											</select>
										</div>
									</div>
									<div class="form-group">
										<label class="col-lg-2 control-label">Show Cusine Description 2 in Frontend</label>
										<div class="col-lg-4">
											<select name="cusine_desc_show_2_show" id="cusine_desc_show_2_show" class="form-control" >
