...
$ref = base64_encode('general_stressors.php');
if(!isLoggedIn())
{
...
$gs_date = $today_year.'-'.$today_month.'-'.$today_day;
...
if(isset($_POST['btnSubmit']))	
{
    ...
    //echo '<br><pre>';
    //print_r($my_target_arr);
    //echo '<br></pre>';
    
    $selected_gs_id_arr = array();
    $empty_selected_gs_id_arr = true;
    for($i=0;$i<$cnt;$i++)
    {
        $selected_gs_id = trim($_POST['selected_gs_id_'.$i]);
        if($selected_gs_id != '')
        {
            $empty_selected_gs_id_arr = false;
        ...
        array_push($selected_gs_id_arr,$selected_gs_id);
    }
    ...
    if( ($day == '') || ($month == '') || ($year == '') )
    {
        $error = true;
        $tr_err_gs_date = '';
        $err_gs_date = 'Please select date!';
    }
    elseif(!checkdate($month,$day,$year))
    {
        $error = true;
        $tr_err_gs_date = '';
        $err_gs_date = 'Please select valid date!';
    }
    elseif(mktime(0,0,0,$month,$day,$year) > $now)
    {
        $error = true;
        $tr_err_gs_date = '';
        $err_gs_date = 'Please select today or previous date!';
    }
    else
    {
    ...
    else
    {
        for($i=0;$i<count($selected_gs_id_arr);$i++)
        {
            ...
            array_push($tr_err_gs , $temp_tr_err);
            array_push($err_gs , $temp_err);	
        }
    }
    ...
    if(!$error)
    {
        $addUsersGSQuestion = addUsersGSQuestion($user_id,$gs_date,$selected_gs_id_arr,$scale_arr,$remarks_arr,$my_target_arr,$adviser_target_arr,$pro_user_id);
        if($addUsersGSQuestion)
        {
                        ...
                        <table width="570" align="center" border="0" id="color_code" cellpadding="0" cellspacing="1" bgcolor="<?php echo $bg_color_code; ?>">
                            <tr>
                                <td align="left" valign="top" id="bgimage" background="<?php echo $bg_image; ?>" bgcolor="#FFFFFF" style="background-repeat: repeat; padding:10px;">
                                    <form action="#" id="frmgs" method="post" name="frmgs">
                                                    ...
                                                    <table width="550" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                        	...
                                                        	<table width="550" border="0" cellspacing="0" cellpadding="0">
                                                                    <tr>
                                                                        ...
                                                                        <td height="50" align="left" valign="middle" class="Header_brown">General Stressors</td>
                                                                    </tr>
                                                                </table>       
                                                            </td>
                                                        </tr>
                                                        <tr> 
                                                            ...
                                                            <td width="150" height="30" align="left" valign="middle">
                                                                <select name="pro_user_id" id="pro_user_id" onchange="getUsersGSQuestionDetails(); updateUserFormTheme();" style="width:120px;">
                                                            ...
                                                            <td width="180" height="30" align="left" valign="middle">
                                                                <select name="day" id="day" onchange="getUsersGSQuestionDetails();" style="width:40px;">
                                                                ...
                                                                <select name="month" id="month" onchange="getUsersGSQuestionDetails();" style="width:60px;">
                                                                    <?php echo getMonthOptions($month,$yesterday_month,$today_month); ?>
                                                                </select>
                                                                <select name="year" id="year" onchange="getUsersGSQuestionDetails();" style="width:60px;">
                                                                <?php
                                                        ...
                                                        <tr id="tr_err_gs_date" style="display:<?php echo $tr_err_gs_date;?>;" valign="top">
                                                            <td align="right" valign="top">&nbsp; </td>
                                                            <td align="right" valign="top">&nbsp; </td>
                                                            <td align="left" colspan="2" class="err_msg" valign="top"><?php echo $err_gs_date;?></td>
                                                        </tr>
                                                    </table>  
                                                    <div id="divgs">                        
                                                        <table width="560" border="0" cellspacing="0" cellpadding="0" id="tblgs">
                                                        <?php
                                                        if(count($arr_gs_id) > 0)
                                                        {
                                                            for($i=0;$i<count($arr_gs_id);$i++)
                                                            { ?>
                                                            <tr style="display:<?php echo $tr_err_gs[$i];?>;" valign="top">
                                                                <td align="left" colspan="2" class="err_msg" valign="top"><?php echo $err_gs[$i];?></td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="430" height="35" align="left" valign="top">
                                                                        <input type="checkbox" name="selected_gs_id_<?php echo $i;?>" id="selected_gs_id_<?php echo $i;?>" value="<?php echo $arr_gs_id[$i];?>" <?php if($selected_gs_id_arr[$i] == $arr_gs_id[$i]) { ?> checked="checked" <?php } ?> onclick="toggleMyResponseScale('selected_gs_id_','<?php echo $i;?>')" />&nbsp;<strong><span style="font-family:<?php echo $arr_situation_font_family[$i];?>;font-size:<?php echo $arr_situation_font_size[$i];?>px;color:#<?php echo $arr_situation_font_color[$i];?>;"><?php echo $arr_situation[$i]; ?></span></strong>
                                                                </td>
                                                            </tr>
                                                                    ...
                                                                    <table width="560" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            ...
                                                                            <td width="150" align="left" valign="top">
                                                                                ...
                                                                                </select><br><?php echo getUsersLastMyTargetGSDateString($user_id,$pro_user_id,$arr_gs_id[$i]);?>
                                                                                </div>
                                                                            ...
                                                                            <td width="150" align="left" valign="top">
                                                                                ...
                                                                                </select><br><?php echo getUsersLastAdviserTargetGSDateString($user_id,$pro_user_id,$arr_gs_id[$i]);?>
                                                                                </div>
