		...
		<input type="hidden" name="ref_url" id="ref_url" value="<?php echo $ref_url;?>" />
            ...
            <tr id="tr_err_msg" style="display:<?php echo $tr_err_msg;?>;">
                ...
                <p align="center">
                    ...
                    <a href="<?php echo SITE_URL.'/register.php?gestid='.$gestid.'&ref='.$ref;?>" target="_self">
					<!--<img src="images/register_now.jpg" width="99" height="24" border="0" />-->
					<span class="btn btn-success" >Register Now</span>
					</a>
