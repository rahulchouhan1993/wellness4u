...
//header("Location: message.php?msg=14&gotopage=".$page_id); 
            header("Location: my_wellness_solutions.php?mid=".$page_id."&date=".$gs_date); 
            exit(0);
*/
        }
        else
                                        ...
                                        <table width="570" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td height="50" align="left" valign="top">
                                                    ...
                                                    <div id="divgs"> 
                                                        <?php echo getUsersGSQuestionDetailsCode($day,$month,$year,$pro_user_id,$user_id,$scale_arr,$remarks_arr,$selected_gs_id_arr,$my_target_arr,$adviser_target_arr);?>                   
                                                    </div>
                                                </td>
                                            </tr>
                                        </table>
