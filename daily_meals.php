...
//	header("Location: index.php?mode=login");
    echo "<script>window.location.href='login.php?mode=login'</script>";
	exit(0);
}
...
//	  	header("Location: index.php?mode=invalid");
    echo "<script>window.location.href='index.php?mode=invalid'</script>";
		exit(0);
	}
							...
							<div id="pagination_contents" align="center"> 
								...
								<tbody>
									...
									<tr class="manage-header">
										...
										<td width="18%" class="manage-header" align="center"><strong>Meals</strong></td>
										<td width="5%" class="manage-header" align="center"><strong>Measures</strong></td>
										...
										<td width="5%" class="manage-header" align="center"><strong>Veg / Egg/ Non. Veg</strong></td>
										<td width="5%" class="manage-header" align="center"><strong>Daily Code</strong></td>
