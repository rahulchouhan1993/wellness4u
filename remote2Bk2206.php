                             ...
                             <table cellpadding="0" cellspacing="0" width="75%" align="center" border="0" style="margin-top:-75%;">                        
                                 <tr>                            
                                     ...
                                     <td width="40%" height="40" align="left" valign="top">                                
                                         <select id="temp_page_id1" name="temp_page_id1">                                    
                                 ...
                                 $output .='<tr> 
                                     ...
                                     <td width="40%" height="40" align="left" valign="top">                                
                                         <input type="text" id="name1" name="name1" '.$readonly.' value="'.$name.'"/>                            
                                     </td>                        
                                 </tr>                        
                                 <tr>                            
                                     <td width="60%" height="40" align="left" valign="top">Email:</td>                            
                                     <td width="40%" height="40" align="left" valign="top">                                
                                         <input type="text" id="email1" name="email1" '.$readonly.' value="'.$email.'"/>                                                                         
                                     </td>                        
                                 </tr>                        
                                 <tr>                            
                                     <td width="60%" height="110" align="left" valign="top">Feedback and Suggestions:</td>                            
                                     <td width="40%" height="110" align="left" valign="top">                                    
                                         <textarea  cols="30" rows="5" type="text" id="feedback1" name="feedback1">'.$textarea.'</textarea>                                                                         
                                     </td>                        
                                 </tr>                        
                                 <tr>                            
                                     <td width="60%" height="40" align="left" valign="middle">&nbsp;</td>                            
                                     <td width="40%" height="40" align="left" valign="middle">                                
                                         <input name="submit" type="button" class="button" id="submit" value="Submit"  onclick="GetFeedback_kr()"/>                            
                                     </td>                        
                                 </tr>                       
                             </table>                
                         </form>';     
