...
$day = date('j');
list($arr_step1,$arr_box_title1,$arr_banner_type1,$arr_banner1,$arr_box_desc1,$arr_anger_vent_box_id1,$arr_credit_line1,$arr_credit_line_url1,$arr_day1,$arr_sound_clip_id1) =  getAngerVentBoxDetails(1,$day);
list($arr_step2,$arr_box_title2,$arr_banner_type2,$arr_banner2,$arr_box_desc2,$arr_anger_vent_box_id2,$arr_credit_line2,$arr_credit_line_url2,$arr_day2,$arr_sound_clip_id2) =  getAngerVentBoxDetails(2,$day);
list($arr_step3,$arr_box_title3,$arr_banner_type3,$arr_banner3,$arr_box_desc3,$arr_anger_vent_box_id3,$arr_credit_line3,$arr_credit_line_url3,$arr_day3,$arr_sound_clip_id3) =  getAngerVentBoxDetails(3,$day);
...
list($user_area_box_title1,$user_area_box_desc1) = getUserarea('1','Angervent');
list($user_area_box_title2,$user_area_box_desc2) = getUserarea('2','Angervent');
list($user_area_box_title3,$user_area_box_desc3) = getUserarea('3','Angervent');
list($music1,$music_id1,$credit1,$credit_url1) = getAngerVentBKMusic(1,$day);
...
list($music2,$music_id2,$credit2,$credit_url2) = getAngerVentBKMusic(2,$day);
...
list($music3,$music_id3,$credit3,$credit_url3) = getAngerVentBKMusic(3,$day);
...
if(isset($_POST['btnUpload1']))	
{
	...
	$user_title1 = strip_tags(trim($_POST['user_title1']));
	...
	if(!$error)
	{
		if($user_banner1 != '')
		{
			...
			{
				InsertAngerVentPDF(1,$user_title1,$user_banner_type1,$user_banner1,$day,$user_id);
			}
			else
			{
				InsertAngerVentStep(1,$user_title1,$user_banner_type1,$user_banner1,$day,$user_id);
			}
		}								
	}  
}
...

	{
...

		{
...

			{
				...
				InsertAngerVentPDF(2,$user_title2,$user_banner_type2,$user_banner2,$day,$user_id);
...

			{
				...
				InsertAngerVentStep(2,$user_title2,$user_banner_type2,$user_banner2,$day,$user_id);
...

	{
...

		{
...

			{
				...
				InsertAngerVentPDF(3,$user_title3,$user_banner_type3,$user_banner3,$day,$user_id);
...

			{
				...
				InsertAngerVentStep(3,$user_title3,$user_banner_type3,$user_banner3,$day,$user_id);
...
{   
...

	{
		...
		{  
			...
			$uavb_id = InsertAngerVentAllDetails($user_stressed1,$user_select1,$user_adv1,$fav1_comma_separated,$user_select2,$user_adv2,$fav2_comma_separated,$user_select3,$user_adv3,$fav3_comma_separated,$user_id);
...

		{
			...
			$ref = base64_encode('anger_vent_box.php');
...
{   
	...
	{  
		...
		addAngerIntensityMeter($intensity_scale_1,$intensity_scale_2,$user_id,$uavb_id);
	...
	{	
		...
		$final_message = 'CONGRATS, you have succeeded in controlling your Anger';
...

	{
		...
		$final_message = 'Hey, CHILL, Cool down. Anger hurts onself & his dear ones more than Others. So Cool down';
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                            	<td align="center" valign="top" id="bgimage" background="<?php  echo $image; ?>" bgcolor="#FFFFFF" style=" padding:10px;">
                                    <form id="frm_StressBusterBox1" name="frm_StressBusterBox1" method="post" action="#" enctype="multipart/form-data">
                                    	<input type="hidden" name="hdnuavb_id" id="hdnuavb_id" value="<?php echo $uavb_id;?>"  />
                                            ...
                                            <table width="570" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td height="50" colspan="2" align="left" valign="top">
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                             <tr>
                                                                <td width="50%" height="35" align="left" valign="top" ><span class="Header_brown"><div id="tooltip"><?php echo getPageName($page_id);?></div></span></td>          
                                                                <td width="50%" height="35" align="right" valign="top"><img src="images/screen1.jpg" width="90" height="30" /></td>
                                                            </tr>
                                                        </table>
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                <td width="50%" height="35" align="left" valign="top" >&nbsp;</td>
                                                                <td width="50%" height="35" align="right" valign="top">
                                                                    <select name="theam_id1" id="theam_id" onchange="ChangeTheam()">
                                                    ...
                                                    <td colspan="2" align="left" valign="top">
                                                    	...
                                                    	<table width="100%" border="0" cellspacing="0" cellpadding="2">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td height="30" align="left" valign="middle" class="Header_brown">My Current Anger Intensity</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2" align="left" valign="top"><strong>I AM ANGRY BECAUSE </strong></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2" align="left" valign="top"><textarea name="user_stressed1" id="user_stressed1" cols="65" rows="4"><?php echo $user_stressed1; ?></textarea></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2" align="center" valign="top">
                                                                ...
                                                                <div class="slider_inner">
                                                                    ...
                                                                    <table align="center" width="290" border="0" cellspacing="0" cellpadding="0" style="padding-left:10px; padding-right:10px;">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td height="25" align="right" valign="top" class="footer"><a href="<?php echo $arr_credit_line_url1[$i]; ?>" target="_blank"><?php echo $arr_credit_line1[$i]; ?></a></td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td height="50" align="left" valign="middle">
                                                                                ...
                                                                                <input type="radio" <?php if($user_select1 == $arr_anger_vent_box_id1[$i]){ ?> checked="checked" <?php } ?> id="select_banner_1_<?php echo $i; ?>" name="select_banner1" value="<?php echo $arr_anger_vent_box_id1[$i]; ?>" onclick="PlayAngerventsound('<?php echo $arr_sound_clip_id1[$i]; ?>'); Display_Angervent_Banner('1')" /><br>



                                                                                <span class="footer">(Please select / tick mark only one as applicable to you.)</span>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td height="50" align="left" valign="middle">
                                                                                ...
                                                                                <input type="checkbox" name="favourite1[]" <?php if (in_array($arr_anger_vent_box_id1[$i] , $fav1)) { ?> checked="checked" <?php } ?> id="favourite_1_<?php echo $i; ?>" value="<?php echo $arr_anger_vent_box_id1[$i]; ?>" /><br>



                                                                                <span class="footer">(Mark above as your favourite.)</span>
                                                        ...
                                                        { ?>
                                                            ...
                                                            <span>Thank you for being on this page,<br />data is not available, please try after some time !  </span>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2" align="center" valign="top">
                                                        ...
                                                        <div id="disply_banner1" class="slider_main2" style="display:<?php echo $display_banner1; ?>">
                                                            ...
                                                            <?php echo get_AngerventBoxCode($user_select1);?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td height="50" colspan="2" align="left" valign="top">
                                                        ...
                                                        <input type="checkbox" class="chk_pdf" id="chk_pdf_<?php echo $arr_pdf_id1[$i]; ?>" name="chk_pdf[]" value="<?php echo $arr_pdf_id1[$i]; ?>" /><br />



                                                        <a href="<?php echo $arr_credit_url1[$i]; ?>" target="_blank"><span class="footer"><?php echo $arr_credit1[$i];  ?></span></a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" width="100%" colspan="2" bgcolor="#FFF2C1" style="padding-left:15px; padding-right:15px;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2" bgcolor="#FFF2C1" style="padding-left:15px;">&nbsp;</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2" bgcolor="#FFF2C1" style="padding-left:15px; padding-right:15px;">
                                                        ...
                                                        <input name="btnUpload1" type="submit" class="button" id="btnUpload1" value="Upload" />
                                        ...
                                        <div id="step2" style="display:<?php echo $step2; ?>">
                                            ...
                                            <table width="570" border="0" cellspacing="0" cellpadding="0">
                                                    ...
                                                    <td height="50" colspan="2" align="left" valign="top">
                                                        ...
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <tr>
                                                               ...
                                                               <td width="100%" height="35" align="right" valign="top" colspan="2">Theme -:
                                                ...
                                                <tr>
                                                    ...
                                                    <span class="Header_brown">My Current ANGER Reaction would be...</span>
                                                                ...
                                                                <embed type="application/x-shockwave-flash" flashvars="audioUrl=<?php echo SITE_URL."/uploads/".$arr_banner2[$i];?>" src="http://www.google.com/reader/ui/3523697345-audio-player.swf" width="270" height="27" quality="best"  wmode="transparent"></embed>
                                                                   ...
                                                                   <?php }  ?>
                                                                      ...
                                                                      <tr>
                                                                       ...
                                                                       <td height="25" align="right" valign="top" class="footer"><a href="<?php echo $arr_credit_line_url2[$i]; ?>" target="_blank"><?php echo $arr_credit_line2[$i]; ?></a></td>
                                                                    ...
                                                                    <input type="radio"   <?php if($user_select2 == $arr_anger_vent_box_id2[$i]){ ?> checked="checked" <?php } ?> id="select_banner_2_<?php echo $i; ?>" name="select_banner2" value="<?php echo $arr_anger_vent_box_id2[$i]; ?>" 



                                                                   onclick="PlayAngerventsound('<?php echo $arr_sound_clip_id2[$i]; ?>'); Display_Angervent_Banner('2')" />
                                                                    ...
                                                                    <input type="checkbox" name="favourite2[]" <?php if (in_array($arr_anger_vent_box_id2[$i] , $fav2)) { ?> checked="checked" <?php } ?> id="favourite_2_<?php echo $i; ?>" value="<?php echo $arr_anger_vent_box_id2[$i]; ?>" />
                                                ...
                                                <tr>
                                                 ...
                                                 <tr>
                                                    ...
                                                    <?php $output = get_AngerventBoxCode($user_select2);
                                               ...
                                               <?php } ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td height="30" colspan="2" align="left" valign="top" bgcolor="#FFF2C1" style="padding-left:15px; padding-right:15px;"><?php echo $user_area_box_desc2 ?></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" width="100%" colspan="2" bgcolor="#FFF2C1" style="padding-left:15px; padding-right:15px;"><strong>Title:</strong>



                                                          <input type="text" size="55" name="user_title2" id="user_title2" value="<?php echo $user_title2; ?>" /></td>
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td width="65%" align="left" bgcolor="#FFF2C1" >
                                                            ...
                                                            <div id="user_trfile2" style="display:<?php echo $user_display_trfile2;?>">
                                                                ...
                                                                <input type="file" name="user_banner2" id="user_banner2" />
                                                ...
                                                <tr>
                                                    ...
                                                    <input name="btnSubmit2" type="submit" class="button" id="btnSubmit2" value="Continue" />



                                                    <input name="back2" type="submit" class="button" id="back2" value="Back" /></td>
                                            ...
                                            <table width="570" border="0" cellspacing="0" cellpadding="0">
                                                               ...
                                                               <embed type="application/x-shockwave-flash" flashvars="audioUrl=<?php echo SITE_URL."/uploads/".$arr_banner3[$i];?>" src="http://www.google.com/reader/ui/3523697345-audio-player.swf" width="270" height="27" quality="best"  wmode="transparent"></embed>
                                                                ...
                                                                <?php }  ?>
                                                                      ...
                                                                      <tr>
                                                                       ...
                                                                       <td height="25" align="right" valign="top" class="footer"><a href="<?php echo $arr_credit_line_url3[$i]; ?>" target="_blank"><?php echo $arr_credit_line3[$i]; ?></a></td>
                                                                    ...
                                                                    <input type="radio"   <?php if($user_select3 == $arr_anger_vent_box_id3[$i]){ ?> checked="checked" <?php } ?> id="select_banner_3_<?php echo $i; ?>" name="select_banner3" value="<?php echo $arr_anger_vent_box_id3[$i]; ?>" 



                                                                    onclick="PlayAngerventsound('<?php echo $arr_sound_clip_id3[$i]; ?>'); Display_Angervent_Banner('3')" />
                                                                    ...
                                                                    <input type="checkbox" name="favourite3[]" <?php if (in_array($arr_anger_vent_box_id3[$i] , $fav3)) { ?> checked="checked" <?php } ?> id="favourite_3_<?php echo $i; ?>" value="<?php echo $arr_anger_vent_box_id3[$i]; ?>" /><br />
                                                ...
                                                <tr>
                                                 ...
                                                 <tr>
                                                    ...
                                                    <?php $output = get_AngerventBoxCode($user_select3);
                                              ...
                                              <tr>
                                                  ...
                                                  <span><input name="adv3" <?php if($user_adv3 == 1) { ?> checked="checked"  <?php } ?> type="radio" class="star" value="1" onclick="HideRateIt();"/>
                                                        ...
                                                        <input name="adv3" <?php if($user_adv3 == 5) { ?> checked="checked"  <?php } ?> type="radio" class="star" value="5" onclick="HideRateIt();"/></span></td>
                                               ...
                                               <?php } ?>
                                                ...
                                                <?php  for($i=0;$i<count($arr_pdf3);$i++)
                                                ...
                                                <tr>
                                                    ...
                                                    <input type="checkbox" class="chk_pdf" id="chk_pdf_<?php echo $arr_pdf_id3[$i]; ?>" name="chk_pdf[]" value="<?php echo $arr_pdf_id3[$i]; ?>" />



                                                     <br /><a href="<?php echo $arr_credit_url3[$i]; ?>" target="_blank"><span class="footer"><?php echo $arr_credit3[$i];  ?></span></a></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td height="30" colspan="2" align="left" valign="top" bgcolor="#FFF2C1" style="padding-left:15px; padding-right:15px;"><?php echo $user_area_box_desc3; ?></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" width="100%" colspan="2" bgcolor="#FFF2C1" style="padding-left:15px; padding-right:15px;"><strong>Title:</strong>
                                                          ...
                                                          <input type="text" size="55" name="user_title3" id="user_title3" value="<?php echo $user_title3; ?>" /></td>
                                              ...
                                              <tr>
                                                ...
                                                <td width="65%" align="left" bgcolor="#FFF2C1" >
                                                            ...
                                                            <div id="user_trfile3" style="display:<?php echo $user_display_trfile3;?>">
                                                                ...
                                                                <input type="file" name="user_banner3" id="user_banner3" />
                                                 ...
                                                 <tr>
                                                   ...
                                                   <td colspan="2" bgcolor="#FFF2C1" style="padding-left:15px; padding-right:15px;">
                                                        ...
                                                        <input name="btnUpload3" type="submit" class="button" id="btnUpload3" value="Upload" /></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td  colspan="2" width="100%"  bgcolor="#FFF2C1" style="padding-left:15px; ">
                                                      ...
                                                      <a href="https://twitter.com/share" class="twitter-share-button" data-url="<?php echo SITE_URL."/anger_vent_box.php" ;?>" data-via="your_screen_name" data-lang="en">Tweet</a>
    ...
    <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
                                                ...
                                                <tr>
                                                    ...
                                                    <input name="btnSubmit3" type="submit" class="button" id="btnSubmit3" value="Continue" />



                                                     <input name="back3" type="submit" class="button" id="back3" value="Back" /></td>
                                                                ...
                                                                <td width="100%" height="35" align="left" valign="top">
                                                                    ...
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="2">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td height="30" align="left" valign="middle" class="Header_brown">Check your Anger Intensity Meter NOW </td>
