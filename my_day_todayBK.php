                ...
                <tr>
                    <td width="620" align="left" valign="top">
                        ...
                        <table width="580" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                                <td align="left" valign="top" >
                                    <table width="580" id="color_code"  align="center" border="0" cellpadding="0" cellspacing="1" bgcolor="#339900">
                                        <tr>
                                            <td id="bgimage" width="570" align="left" valign="top" bgcolor="#FFFFFF" style="background-repeat:repeat; padding:5px;">
                                                <form action="#" id="frmdaily_meal" method="post" name="frmdaily_meal">
                                                    ...
                                                    <table width="570" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            ...
                                                            <td width="25%" height="50" align="left" valign="middle">
                                                                <input style="display:<?php echo $divaddformmdt;?>" type="submit" name="btnEditPostedData" id="btnEditPostedData" value="Edit Posted Data">&nbsp;
                                                                    <input style="display:<?php echo $diveditformmdt;?>" type="submit" name="btnAddFreshData" id="btnAddFreshData" value="Add Fresh Data">&nbsp;
                                                            </td>
                                                            <td width="20%" height="50" align="left" valign="middle">
                                                                <select name="theam_id1" id="theam_id" onchange="ChangeTheamMDT()" style="width:110px;">
                                                        ...
                                                        <tr id="tr_err_bes_date" style="display:<?php echo $tr_err_bes_date;?>;" valign="top">
                                                            <td align="left" colspan="4" class="err_msg_blink" valign="top"><?php echo $err_bes_date;?></td>
                                                        </tr>
                                                    </table>
                                                    <table width="570" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                    ...
                                                    <div id="divaddformmdt" style="display:<?php echo $divaddformmdt;?>">
                                                    <table width="570" border="0" cellspacing="0" cellpadding="0">    
                                                        <tr>
                                                            <td align="left" valign="top">          
                                                                <table width="570" border="0" cellspacing="0" cellpadding="0">
                                                                    <tr>
                                                                        <td align="left" valign="top">
                                                                            ...
                                                                            <table width="560" border="0" cellspacing="0" cellpadding="0">
                                                                                <tr>
                                                                                    <td width="50%" height="35" align="left" valign="top">
                                                                                        &nbsp;&nbsp;&bull; Time:&nbsp;
                                                                                        <select name="bes_time" id="bes_time">
                                                                                            <option value="">Select Time</option>
                                                                                            <?php echo getTimeOptionsNew('0','23',$bes_time ); ?>
                                                                                        </select>
                                                                                    </td>
                                                                                    <td width="50%" height="35" align="left" valign="top">
                                                                                       &bull;&nbsp;Duration in Mins:&nbsp;&nbsp<input style="width:30px;" type="text" maxlength="3" name="bes_duration" id="bes_duration" value="<?php echo $bes_duration;?>" class="mins">
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                            <table width="560" border="0" cellspacing="0" cellpadding="0" id="tblbes">
                                                                                <tr>
                                                                                    <td width="5%" height="35" align="left" valign="top" class="Header_brown">(A)</td>
                                                                                    <td width="40%" height="35" align="center" valign="top" class="Header_brown">My Current Situation</td>
                                                                                    <td width="45%" height="35" align="center" valign="top" class="Header_brown">Intensity Scale</td>
                                                                                    <td width="10%" height="35" align="left" valign="top" class="Header_brown">&nbsp;</td>
                                                                                </tr>
                                                                            <?php
                                                                            for($i=0,$t=1;$i<$totalRow;$i++,$t++)
                                                                            { ?>
                                                                                <tr class="tr_bes_<?php echo $i;?>">
                                                                                    <td height="35" align="left" valign="top">(<?php echo $t;?>)</td>
                                                                                    ...
                                                                                    if($i == 0)
                                                                                    { ?>
                                                                                        <span style="font-size:11px;color:#0000FF;">(You can post multiple situations)</span>
                                                                                    <?php
                                                                                    } ?>
                                                                                    </td>
                                                                                    <td height="35" align="left" valign="top">
                                                                                    ...
                                                                                    if($i > 0)
                                                                                    { ?>
                                                                                        <a href="javascript:;" onclick="removeMultipleRows('tr_bes_<?php echo $i;?>','totalRow');"><img border="0" style="margin-top:5px;padding-right:5px;" src="images/delete-icon.png" height="20" alt="Remove Entry" title="Remove Entry"  ></a>
                                                                                    <?php
                                                                                    } ?>    
                                                                                    </td>
                                                                                </tr>
                                                                                <tr class="tr_bes_<?php echo $i;?>">
                                                                                    <td align="left" height="10" colspan="4" valign="top"><img src="images/spacer.gif" width="1" height="1" /></td>
                                                                                </tr>
                                                                            <?php
                                                                            } ?>
                                                                                <tr id="add_before_this_bes">
                                                                                    <td align="right" colspan="4" valign="top">
                                                                                        <a href="javascript:void(0);" id="addMoreBES" name="addMoreBES"><img border="0" style="padding-right:5px;" src="images/add_more.png" height="24" alt="You can post multiple situations" title="You can post multiple situations"  ></a>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="left" height="10" colspan="4" valign="top"><img src="images/spacer.gif" width="1" height="1" /></td>
                                                                            ...
                                                                            <div id="div_trigger" style="display:<?php echo $div_trigger;?>;border:1px solid #CCCCCC; padding:5px;">
                                                                            <table width="560" border="0" cellspacing="0" cellpadding="0" id="tbltrigger">
                                                                                <tr>
                                                                                    <td width="5%" height="35" align="left" valign="top" class="Header_brown">(B)</td>
                                                                                    <td width="40%" height="35" align="center" valign="top" class="Header_brown">Triggers/Reasons</td>
                                                                                    <td width="45%" height="35" align="center" valign="top" class="Header_brown">Triggers Scale</td>
                                                                                    <td width="5%" height="35" align="left" valign="top" class="Header_brown"></td>
                                                                                    <td width="5%" height="35" align="left" valign="top" class="Header_brown"></td>
                                                                                </tr>
                                                                            <?php
                                                                            for($i=0,$t=1;$i<$totalRow_t;$i++,$t++)
                                                                            { ?>
                                                                                <tr class="tr_trigger_<?php echo $i;?>">
                                                                                    <td height="35" align="left" valign="top">(<?php echo $t;?>)</td>
                                                                                    <td height="35" align="left" valign="top">
                                                                                        <input name="trigger_id[]" type="text" class="input" id="trigger_id_<?php echo $i;?>" value="<?php echo $trigger_id_arr[$i];?>" />
                                                                                    <?php
                                                                                    if($i == 0)
                                                                                    { ?>
                                                                                        <span style="font-size:11px;color:#0000FF;">(You can post multiple triggers)</span>
                                                                                    <?php
                                                                                    } ?>
                                                                                    </td>
                                                                                    <td height="35" align="left" valign="top">
                                                                                        <?php echo getScaleSliderCodeSecond($i,$tr_response_img_t[$i],$tr_response_slider_t[$i],$scale_t_arr[$i]);?>
                                                                                    </td>
                                                                                    <td height="35" align="left" valign="top">
                                                                                        <input name="remarks_t[]" type="hidden" id="remarks_t_<?php echo $i;?>" value="<?php echo $remarks_t_arr[$i];?>" />
                                                                                        <a href="javascript:void(0);" onclick="showTriggerRemarksPopup('<?php echo $i;?>')"><img border="0" style="" src="images/comment-bubble-icon.png" width="30" alt="Add comments for this trigger" title="Add comments for this trigger"  ></a>
                                                                                    </td>
                                                                                    <td height="35" align="left" valign="top">
                                                                                    <?php
                                                                                    if($i > 0)
                                                                                    { ?>
                                                                                        <a href="javascript:void(0);" onclick="removeMultipleRows('tr_trigger_<?php echo $i;?>','totalRow_t');"><img border="0" style="margin-top:5px;" src="images/delete-icon.png" height="20" alt="Remove Entry" title="Remove Entry"  ></a>
                                                                                    <?php
                                                                                    } ?>    
                                                                                    </td>
                                                                                </tr>
                                                                            ...
                                                                            <?php    
                                                                                ...
                                                                                <tr id="add_before_this_trigger">
                                                                                    <td height="30" colspan="5" align="right" valign="top">
                                                                                        <a href="javascript:void(0);" id="addMoreTrigger" name="addMoreTrigger"><img border="0" style="padding-right:5px;" src="images/add_more.png" height="24" alt="You can post multiple triggers" title="You can post multiple triggers"  ></a>
                                                                                    </td>
                                                                                </tr>	
                                                                            </table>
                                                                            </div>      
                                                    ...
                                                    <table width="380" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            ...
                                                            <td width="70%" align="left" valign="top">
                                                                <input style="display:<?php echo $display_submit;?>" type="submit" name="btnSubmit" id="btnSubmit" value="Submit" />
                                                                <input style="display:<?php echo $display_goto;?>" type="button" value="Post Reason" title="Post Reasons for above situations" alt="Post Reasons for above situations" id="btnGotoTrigger" name="btnGotoTrigger" disabled />&nbsp;
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    </div>
                                                    <div id="diveditformmdt" style="display:<?php echo $diveditformmdt;?>">
                                                    <?php
                                                    for($k=0;$k<$cnt_main;$k++)
                                                    { ?>
                                                    <input type="hidden" name="cnt_edit[]" id="cnt_edit_<?php echo $k;?>" value="<?php echo $cnt_edit_arr[$k]; ?>" >    
                                                    <input type="hidden" name="totalRow_edit[]" id="totalRow_edit_<?php echo $k;?>" value="<?php echo $totalRow_edit_arr[$k]; ?>" >    
                                                    <input type="hidden" name="cnt_t_edit[]" id="cnt_t_edit_<?php echo $k;?>" value="<?php echo $cnt_t_edit_arr[$k]; ?>" >    
                                                    <input type="hidden" name="totalRow_t_edit[]" id="totalRow_t_edit_<?php echo $k;?>" value="<?php echo $totalRow_t_edit_arr[$k]; ?>" >    
                                                    <table width="570" border="0" cellspacing="0" cellpadding="0">    
                                                        <tr>
                                                            <td align="left" valign="top">          
                                                                <table width="570" border="0" cellspacing="0" cellpadding="0">
                                                                        ...
                                                                        <td align="left" valign="top">
                                                                            ...
                                                                            <table width="560" border="0" cellspacing="0" cellpadding="0">
                                                                                <tr>
                                                                                    <td width="50%" height="35" align="left" valign="top">
                                                                                        &nbsp;&nbsp;&bull; Time:&nbsp;
                                                                                        <select name="bes_time_edit[]" id="bes_time_edit_<?php echo $k;?>">
                                                                                            <option value="">Select Time</option>
                                                                                            <?php echo getTimeOptionsNew('0','23',$bes_time_edit_arr[$k] ); ?>
                                                                                        </select>
                                                                                    </td>
                                                                                    <td width="50%" height="35" align="left" valign="top">
                                                                                       &bull;&nbsp;Duration in Mins:&nbsp;&nbsp<input style="width:30px;" type="text" maxlength="3" name="bes_duration_edit[]" id="bes_duration_edit_<?php echo $k;?>" value="<?php echo $bes_duration_edit_arr[$k];?>" class="mins">
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                            <table width="560" border="0" cellspacing="0" cellpadding="0" id="tblbes_edit_<?php echo $k;?>">
                                                                                <tr>
                                                                                    <td width="5%" height="35" align="left" valign="top" class="Header_brown">(A)</td>
                                                                                    <td width="40%" height="35" align="center" valign="top" class="Header_brown">My Current Situation</td>
                                                                                    <td width="45%" height="35" align="center" valign="top" class="Header_brown">Intensity Scale</td>
                                                                            ...
                                                                            <?php
                                                                            for($i=0,$t=1;$i<$totalRow_edit_arr[$k];$i++,$t++)
                                                                            { ?>
                                                                                <tr class="tr_bes_edit_<?php echo $k;?>_<?php echo $i;?>">
                                                                                    <td height="35" align="left" valign="top">(<?php echo $t;?>)</td>
                                                                                    <td height="35" align="left" valign="top">
                                                                                        <input name="bes_id_edit[]" type="text" class="input" id="bes_id_edit_<?php echo $k;?>_<?php echo $i;?>" value="<?php echo $bms_id_edit_arr[$k][$i];?>" />
                                                                                    <?php
                                                                                    if($i == 0)
                                                                                    { ?>
                                                                                        <span style="font-size:11px;color:#0000FF;">(You can post multiple situations)</span>
                                                                                    ...
                                                                                    <td height="35" align="left" valign="top">
                                                                                        <?php echo getScaleSliderCodeMultiLevel('edit_'.$k.'_'.$i,$tr_response_img_edit[$k][$i],$tr_response_slider_edit[$k][$i],$scale_edit_arr[$k][$i]);?>
                                                                                    </td>
                                                                                    <td height="35" align="right" valign="top">
                                                                                    <?php
                                                                                    if($i > 0)
                                                                                    { ?>
                                                                                        <a href="javascript:;" onclick="removeMultipleRows('tr_bes_edit_<?php echo $k;?>_<?php echo $i;?>','totalRow_edit_<?php echo $k;?>');"><img border="0" style="margin-top:5px;padding-right:5px;" src="images/delete-icon.png" height="20" alt="Remove Entry" title="Remove Entry"  ></a>
                                                                                    <?php
                                                                                    } ?>    
                                                                                    </td>
                                                                                </tr>
                                                                            ...
                                                                            <?php
                                                                                ...
                                                                                <tr id="add_before_this_bes_edit_<?php echo $k;?>">
                                                                                    <td align="right" colspan="4" valign="top">
                                                                                        <a href="javascript:void(0);" class="addMoreBES" id="addMoreBES_edit_<?php echo $k;?>" name="addMoreBES_edit_<?php echo $k;?>"><img border="0" style="padding-right:5px;" src="images/add_more.png" height="24" alt="You can post multiple situations" title="You can post multiple situations"  ></a>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="left" height="10" colspan="4" valign="top"><img src="images/spacer.gif" width="1" height="1" /></td>
                                                                            ...
                                                                            <div style="clear:both; height:10px;"></div>
                                                                            <div id="div_trigger_<?php echo $k;?>" style="display:<?php //echo $div_trigger;?>;border:1px solid #CCCCCC; padding:5px;">
                                                                            <table width="560" border="0" cellspacing="0" cellpadding="0" id="tbltrigger_edit_<?php echo $k;?>">
                                                                                <tr>
                                                                                    <td width="5%" height="35" align="left" valign="top" class="Header_brown">(B)</td>
                                                                                    <td width="40%" height="35" align="center" valign="top" class="Header_brown">Triggers/Reasons</td>
                                                                                    <td width="45%" height="35" align="center" valign="top" class="Header_brown">Triggers Scale</td>
                                                                            ...
                                                                            <?php
                                                                            for($i=0,$t=1;$i<$totalRow_t_edit_arr[$k];$i++,$t++)
                                                                            { ?>
                                                                                <tr class="tr_trigger_edit_<?php echo $k;?>_<?php echo $i;?>">
                                                                                    <td height="35" align="left" valign="top">(<?php echo $t;?>)</td>
                                                                                    <td height="35" align="left" valign="top">
                                                                                        <input name="trigger_id_edit[]" type="text" class="input" id="trigger_id_edit_<?php echo $k;?>_<?php echo $i;?>" value="<?php echo $trigger_id_edit_arr[$k][$i];?>" />
                                                                                    <?php
                                                                                    if($i == 0)
                                                                                    { ?>
                                                                                        <span style="font-size:11px;color:#0000FF;">(You can post multiple triggers)</span>
                                                                                    ...
                                                                                    <td height="35" align="left" valign="top">
                                                                                        <?php echo getScaleSliderCodeSecondMultiLevel('edit_'.$k.'_'.$i,$tr_response_img_t_edit[$k][$i],$tr_response_slider_t_edit[$k][$i],$scale_t_edit_arr[$k][$i]);?>
                                                                                    </td>
                                                                                    <td height="35" align="left" valign="top">
                                                                                        <input name="remarks_t_edit_<?php echo $k;?>_<?php echo $i;?>" type="hidden" id="remarks_t_edit_<?php echo $k;?>_<?php echo $i;?>" value="<?php echo $remarks_t_edit_arr[$k][$i];?>" />
                                                                                        <a href="javascript:void(0);" onclick="showTriggerRemarksPopup('edit_<?php echo $k;?>_<?php echo $i;?>')"><img border="0" style="" src="images/comment-bubble-icon.png" width="30" alt="Add comments for this trigger" title="Add comments for this trigger"  ></a>
                                                                                    </td>
                                                                                    <td height="35" align="left" valign="top">
                                                                                    <?php
                                                                                    if($i > 0)
                                                                                    { ?>
                                                                                        <a href="javascript:void(0);" onclick="removeMultipleRows('tr_trigger_edit_<?php echo $k;?>_<?php echo $i;?>','totalRow_t_edit_<?php echo $k;?>');"><img border="0" style="margin-top:5px;" src="images/delete-icon.png" height="20" alt="Remove Entry" title="Remove Entry"  ></a>
                                                                                    <?php
                                                                                    } ?>    
                                                                                    </td>
                                                                                </tr>
                                                                            ...
                                                                            <?php    
                                                                                ...
                                                                                <tr id="add_before_this_trigger_edit_<?php echo $k;?>">
                                                                                    <td height="30" colspan="5" align="right" valign="top">
                                                                                        <a href="javascript:void(0);"class="addMoreTrigger" id="addMoreTrigger_edit_<?php echo $k;?>" name="addMoreTrigger_edit_<?php echo $k;?>"><img border="0" style="padding-right:5px;" src="images/add_more.png" height="24" alt="You can post multiple triggers" title="You can post multiple triggers"  ></a>
                                                                                    </td>
                                                                                </tr>	
                                                                            </table>
                                                                            </div>      
                                                    ...
                                                    <table width="380" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <td width="30%" height="35" align="left" valign="top">&nbsp;</td>
                                                            <td width="70%" align="left" valign="top">
                                                                <input style="display:<?php //echo $display_submit;?>" type="submit" name="btnUpdate" id="btnUpdate" value="Update" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    </div>
