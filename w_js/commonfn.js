...

{
    ...
    if($('#report_module').val() == 'mdt_report')
...

{
    ...
    link='remote.php?action=getmodulewisekeywordsoptions&report_module='+report_module+'&pro_user_id='+pro_user_id;
...
function getModuleWiseCriteriaOptions(num)
...
//    link='remote.php?action=getmodulewisecriteriaoptions&report_module='+report_module+'&pro_user_id='+pro_user_id;
 
    link='remote.php?action=getmodulewisecriteriaoptionsVivek&report_module='+report_module+'&pro_user_id='+pro_user_id;
        ...
        obj.callback = function (responseTxt, responseStat) {
                ...
                $('#tdcriteriaresult_'+num).html(result);
...

{
    ...
    link='remote.php?action=getmodulewisecriteriascaleoptions&report_module='+report_module+'&pro_user_id='+pro_user_id+'&module_criteria='+module_criteria;
...
// Simple event handler, called from onChange and onSelect
...

                {
                  ...
                  $('#hdnbps_image_x1').val(c.x);

                  $('#hdnbps_image_y1').val(c.y);

                  $('#hdnbps_image_x2').val(c.x2);

                  $('#hdnbps_image_y2').val(c.y2);

                  $('#hdnbps_image_w').val(c.w);

                  $('#hdnbps_image_h').val(c.h);
...
function setCurrentPhysicalState()

{
    ...
    //var spotx = $('#hdnspotx').val();

    //var spoty = $('#hdnspoty').val();

    var bps_image_x1 = $('#hdnbps_image_x1').val();

    var bps_image_x2 = $('#hdnbps_image_x2').val();

    var bps_image_y1 = $('#hdnbps_image_y1').val();

    var bps_image_y2 = $('#hdnbps_image_y2').val();

    var bps_image_w = $('#hdnbps_image_w').val();

    var bps_image_h = $('#hdnbps_image_h').val();

    

    

    var bp_id = $('#hdnbp_id').val();

    var scale = $('#scale').val(); 

    

    var obj_bms_id = document.getElementById('bms_id');

    var str_bms_id = "";



    for (var x=0;x<obj_bms_id.length;x++)

    {

            if (obj_bms_id[x].selected)

            {

                    str_bms_id = str_bms_id + obj_bms_id[x].value + "," ;
    ...
    else if(bps_image_x1 == '' || bps_image_y1 == '' || bps_image_x2 == '' || bps_image_y2 == '')
...

{
    ...
    link='remote.php?action=getuserbpsbox&day='+day+'&month='+month+'&year='+year;
...
function deleteUserBPS(user_bps_id)

{

    

        link='remote.php?action=deleteuserbps&user_bps_id='+user_bps_id;
...

{
    ...
    link='remote.php?action=getuserbodypartimagebox&bp_id='+bp_id;
    ...
    obj.callback = function (responseTxt, responseStat) {
        ...
        $('#divBodyPartImage').html(result);

        $('#bms_id_0').removeAttr('disabled');

         //$('#tr_response_img_0').hide();

         //$('#tr_response_slider_0').show();

          $('#btnSubmit').removeAttr('disabled');

           $('#addMoreBPS').removeAttr('disabled');

         //var abc = $('#scale').selectToUISlider().next();
         ...
         var jcrop_api;
                ...
                $('#coords').on('change','input',function(e){
                  ...
                  var x1 = $('#hdnbps_image_x1').val(),

                      x2 = $('#hdnbps_image_x2').val(),

                      y1 = $('#hdnbps_image_y1').val(),

                      y2 = $('#hdnbps_image_y2').val();
          ...
          var originalBGplaypen = $("#playpen").css("background-color"),
            ...
            gradientSize = 10;
                ...
                $('#playpen').mousemove(function(e) {
                        ...
                        bgMoz    = "-moz-radial-gradient(" + x + "px " + y + "px 45deg, circle, " + lightColor + " 5%, " + originalBGplaypen + " " + gradientSize + "px)";
...
function getUserFullBodyImageBox()

{

    var bp_side = $('#bp_side').val();

    link='remote.php?action=getuserfullbodyimagebox&bp_side='+bp_side;
...
function toggleDateSelectionTypeUserNew(id_val)

{
    ...
    {   
            ...
            document.getElementById('tbldaysofmonth').style.display = 'none';

            document.getElementById('tbldaysofweek').style.display = 'none';
    ...
    {   
            ...
            document.getElementById('tbldaysofmonth').style.display = '';
    ...
    {   
            ...
            document.getElementById('tbldaysofweek').style.display = '';
    ...
    obj.callback = function (responseTxt, responseStat) {
        ...
        //alert(result);
...

                {
                    ...
                    document.getElementById('idreference2').innerHTML = result;  
...
function viewAdviserPopup(vid)

{
    
    //startPageLoading();

    link='remote.php?action=viewadviserpopup&vid='+vid;
        ...
        obj.callback = function (responseTxt, responseStat) {
...

            {
...

                {
                    ...
                    $(".QTPopup").css('display', 'none!important');
...
function updateAdviserQuery()
{   

    var parent_aq_id = document.getElementById('parent_aq_id').value;
    var query_old = escape(document.getElementById('feedback_text_old').value);
    var query_new = escape(document.getElementById('feedback_text_new').value);
    ...
    else
    {
        ...
        link='remote.php?action=updateAdviserQuery&parent_aq_id='+parent_aq_id+'&query_old='+query_old+'&query_new='+query_new;
        var linkComp = link.split( "?");
        var result;
        var obj = new ajaxObject(linkComp[0], fin);
        obj.update(linkComp[1],"GET");
...
function showTriggerRemarksPopup(idval)

{

    var temp_trigger_id = $('#as-values-trigger_id_'+idval).val();

    var remark = escape($('#remarks_t_'+idval).val());
    ...
    link='remote.php?action=showtriggerremarkspopup&idval='+idval+'&remark='+remark;
    ...
    obj.callback = function (responseTxt, responseStat) {
        ...
        //alert(parent_aq_id);
                ...
                document.getElementById('caption_text').innerHTML = 'Add your comments'; 
...
function setTriggerRemark()

{

    var idval = $('#hdntempidval').val();

    var remark = escape($('#temp_remark').val());
...

{
...

    {
        ...
        link='remote.php?action=proceedtogopage&gotopage='+gotopage;
...
function showAdviserQueryPopup(parent_aq_id,vendor_id)

{   

    //startPageLoading();

    link='remote.php?action=showadviserquerypopup&parent_aq_id='+parent_aq_id+'&vendor_id='+vendor_id;
...
//add by ample 06-04-20
function updateSelfQueryPopup(parent_aq_id)
{   

    link='remote.php?action=showSelfQueryPopup&parent_aq_id='+parent_aq_id;
    var linkComp = link.split( "?");
    var result;
    var obj = new ajaxObject(linkComp[0], fin);
    obj.update(linkComp[1],"GET");
    obj.callback = function (responseTxt, responseStat) {
        ...
        document.getElementById('caption_text').innerHTML = 'Update My Query'; 
...
// function name update by ample 25-10-19
function showDeclineAdviserInvitation(ar_id,puid)

{
...

    {
        ...
        link='remote.php?action=declineadviserinvitation&ar_id='+ar_id+'&puid='+puid+'&status_reason='+status_reason;
...
function doDeclineAdviserInvitation(ar_id,puid)

{

    //startPageLoading();

    link='remote.php?action=doDeclineAdviserInvitation&ar_id='+ar_id+'&puid='+puid;
...
function showDeactivateAdviserInvitationPopup(ar_id,puid,vid)

{

    //startPageLoading();

    link='remote.php?action=showdeactivateadviserinvitationpopup&ar_id='+ar_id+'&puid='+puid+'&vid='+vid;
...
function showActivateAdviserInvitationPopup(ar_id,puid,vid)

{

    //startPageLoading();

    link='remote.php?action=showactivateadviserinvitationpopup&ar_id='+ar_id+'&puid='+puid+'&vid='+vid;
...
function deactivateAdviserInvitation(ar_id,puid,vid)

{
...

    {
...

        {
            ...
            link='remote.php?action=deactivateadviserinvitation&ar_id='+ar_id+'&puid='+puid+'&vid='+vid+'&status_reason='+status_reason;
...
function activateAdviserInvitation(ar_id,puid,vid)

{
...

    {
...

        {
            ...
            link='remote.php?action=activateadviserinvitation&ar_id='+ar_id+'&puid='+puid+'&vid='+vid+'&status_reason='+status_reason;
...
function showPatternsPopup(ar_id,vid)
{
    ...
    link='remote.php?action=showPatternsPopup&ar_id='+ar_id+'&vid='+vid;
...

{
    ...
    link='remote.php?action=getallbmsautolist';
...
function addMoreRowsAutoSuggest(tblid,trid,idval,rowtype)

{

    var cnt = parseInt($('#cnt_'+idval).val());

        var totalRow = parseInt($('#totalRow_'+idval).val());
            ...
            link='remote.php?action=addmorerowsautosuggest&cnt='+cnt+'&idval='+idval+'&rowtype='+rowtype;
            ...
            obj.callback = function (responseTxt, responseStat) {
                ...
                $('#'+tblid+' tr[id="'+trid+'"]').before(result2);
...

                {
                    ...
                    $("#bes_id_"+idval+'_'+cnt).autoSuggest(data.items, {asHtmlID:"bes_id_"+idval+"_"+cnt, preFill: {}, selectedItemProp: "name", searchObjProps: "name", selectedValuesProp: "value", extraParams: "bes_id_"+idval+"_"+cnt });
...
function showRewardCatlogUpdated()
{
    ...
    var reward_type = document.getElementById('appreciation').value; 
    //startPageLoading();
    link='remote.php?action=showrewardcatlog&module_id='+module_id+'&reward_type='+reward_type;
    var linkComp = link.split( "?");
    var result;
    var obj = new ajaxObject(linkComp[0], fin);
    obj.update(linkComp[1],"GET");
    obj.callback = function (responseTxt, responseStat) {
        ...
        //alert(result);
        //document.getElementById('prwcontent').innerHTML = result;  
        document.getElementById('reward_catlog').innerHTML = result;  
        imagePreview();
        //stopPageLoading();
    }
}
...
function addScrollingContentToFav(str_sc_id,type_id="",cat_id="")

{
    ...
    //{
        ...
        link='remote.php?action=addscrollingcontenttofav&page_id='+page_id+'&str_sc_id='+str_sc_id+'&type_id='+type_id+'&cat_id='+cat_id;
...
function saveScrollingContentToFav()
{
   var note = document.getElementById('fav_note').value;
   var page_id = document.getElementById('sb_page_id').value;
   var sc_id = document.getElementById('sc_id').value;
   var priority = document.getElementById('priority').value;
   var type_id = document.getElementById('type_id').value;
   var cat_id = document.getElementById('cat_id').value;

   link='remote.php?action=savescrollingcontenttofav&page_id='+page_id+'&sc_id='+sc_id+'&note='+note+'&priority='+priority+'&type_id='+type_id+'&cat_id='+cat_id;
        ...
        obj.callback = function (responseTxt, responseStat) {
            ...
            if(responseTxt==true)
            {
                alert('Add to Fav successfully');
            }
            else
            {
                 alert('Kindly login to save it to your Fav List');
            }
...
//add by ample 10-06-20
  function openFavLibraryBox(type="",file="",title="",category="",type_id="",section="",data_type="")
  {
    

      var dataString ='type='+type +'&file='+file +'&title='+title +'&category='+category +'&type_id='+type_id+'&section='+section +'&data_type='+data_type +'&action=openFavLibraryBox';
  ...
  function saveFavLibraryBoxData()
  {
      ...
      var dataString ='type='+type +'&file='+file +'&title='+title +'&category='+category +'&note='+note +'&type_id='+type_id+'&section='+section +'&data_type='+data_type +'&priority='+priority +'&action=saveFavLibraryBoxData';
...

{
    ...
    link='remote.php?action=changtheammws&theam_id='+theam_id;
...

{
    ...
    link='remote.php?action=getmwsboxcode&sol_cat_id='+sol_cat_id+'&mid='+mid+'&date='+date;
...

{
    ...
    var theam_id = document.getElementById('theam_id').value;
//    var theme_display_size = document.getElementById('theme_display_size').value;
    //alert(theam_id);
...
//       if(theme_display_size == '1')
//        {
//          $('#fullbgimage').css("background-image", "url("+result[0]+")");
//          $('#color_code').css("background-color", result[1]); 
//        }
//       
//      else if(theme_display_size == '2')
//        {
         $('#bgimage').css("background-image", "url("+result[0]+")");
         $('#color_code').css("background-color", result[1]); 
//        }
...

{
...

    {
        ...
        link='remote.php?action=Delete_FavLibrary&id='+id;
...
function PlaysoundNew(sound_clip_id,idval)

{

    //alert(idval);

    //if($("#"+idval).attr("checked")==true)
...
function Display_BannerMWS(idval)

{
    ...
    link='remote.php?action=display_bannermws&banner_id='+banner_id;
...

{
...

    {
        ...
        $('.tr_response_slider_'+tid).show();
                ...
                //$("#remarks_"+tid).removeAttr('disabled');

                //$("#my_target_"+tid).removeAttr('disabled');

                //$("#adviser_target_"+tid).removeAttr('disabled');
...

    {
        ...
        $('#tr_response_slider_'+tid).hide();
                ...
                //$("#remarks_"+tid).attr("disabled", "disabled");

                //$("#my_target_"+tid).attr("disabled", "disabled");

                //$("#adviser_target_"+tid).attr("disabled", "disabled");
...
function toggleMyResponseScaleSelectBox(objid,tid)

{

    var check = $('#'+objid+tid).val(); 

    if(check != '')

    {

            //alert('#tr_response_slider_'+tid);
...
function view_reward(page_id,button_id)
{   

      var dataString ='page_id='+page_id+'&button_id='+button_id +'&action=view_reward_box_data';
...
function open_reward_redeem_box(user_id)
{   

      var dataString ='user_id='+user_id+'&action=open_reward_redeem_box';
  ...
  function point_redeem_process()
  {
      ...
      if(!prize_id)
      {
        ...
        $.ajax({
         url:'remote.php',
         method: 'post',
         data: $('#point_redeem_form').serialize(),
         //dataType: 'json',
         success: function(response){
            if(response==true)
            {
                alert('Redeem process successfully done!');
                window.location.href = "my_rewards_redeem.php";
                window.location = "my_rewards_redeem.php";
            }
            else
            {
                alert('try later');
   ...
   function point_redeem_process_all_module()
  {
      var my_point=parseInt($('#max_total_encash').val());
      var redeem_point=parseInt($('#total_encash').val());

      var prize_id = $("input[name='prize_ids']:checked").val();
      ...
      if(!prize_id)
      {
        ...
        $.ajax({
         url:'remote.php',
         method: 'post',
         data: $('#point_redeem_form_all_module').serialize(),
         //dataType: 'json',
         success: function(response){
            if(response==true)
            {
