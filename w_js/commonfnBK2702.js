...
//        alert(booking_slot);
	...
	{
		var dataString = 'action=addtocart&event_id='+event_id+'&qty='+qty+'&booking_slot='+booking_slot+'&booking_date='+booking_date+'&type='+type+'&registraion_type='+registraion_type;
		$.ajax({
			type: "POST",
			url: "remote2.php",
			data: dataString,
...
function sendRequst()
	...
	function openNextDelaveryDate(name,event_id,type)
		...
		if(event_id == '' || event_id == 'null' || event_id == 'undefined')
			...
			{
                            //alert(event_id);
		    var dataString ='action=getAllDelaveyListOfItem&event_id='+event_id+'&type='+type;
			$.ajax({
			type: "POST",
			url: "remote2.php",
			data: dataString,
...
//					permission_type.push($('select[id="permission_type_'+i+'"]').val());
		...
		link='remote2.php?action=doacceptadviserinvitation&ar_id='+ar_id+'&report_id='+report_id+'&puid='+puid+'&permission_type='+permission_type;
		var linkComp = link.split( "?");
		var result;
		var obj = new ajaxObject(linkComp[0], fin);
		obj.update(linkComp[1],"GET");
...

{
	...
	link='remote2.php?action=showdeactivateadviserinvitationpopup&ar_id='+ar_id+'&puid='+puid;
...

{
...

	{
...

		{
			...
			link='remote2.php?action=deactivateadviserinvitation&ar_id='+ar_id+'&puid='+puid+'&status_reason='+status_reason;
...

{
	...
	link='remote2.php?action=showactivateadviserinvitationpopup&ar_id='+ar_id+'&puid='+puid;
...

{
...

	{
...

		{
			...
			link='remote2.php?action=activateadviserinvitation&ar_id='+ar_id+'&puid='+puid+'&status_reason='+status_reason;
