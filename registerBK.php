			...
			<table width="980" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td width="620" align="center" valign="top" >  
						...
						<table width="580" border="0" cellpadding="0" cellspacing="1" bgcolor="#339900">
							<tr>
								<td align="center" valign="middle" bgcolor="#FFFFFF" style="background-repeat:repeat-x; padding:10px;">
									<form action="<?php echo SITE_URL.'/register.php'?>" name="frmregister" id="frmregister" method="post">
										...
										<table width="500" border="0" cellspacing="0" cellpadding="0">
											...
											<tr>
												<td width="173" height="30" align="left" valign="bottom">Name:</td>
												<td width="327" height="30" align="left" valign="bottom"><input name="name" type="text" class="input" id="name" size="45" value="<?php echo $name;?>" /></td>
											</tr>
