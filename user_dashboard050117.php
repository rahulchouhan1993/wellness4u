    ...
    <section class="content">
      ...
      <div class="row">
       ...
       <a href="http://wellnessway4u.com/pages.php?id=148" target="_blank">   <div class="info-box">
         ...
         <center> <span><b>This Month's Challenge </b></span><br/>
       ...
       <center>  <span><b>Rewards Catlog</b></span><br/>
        ...
        <div class="col-md-2 col-sm-6 col-xs-12">
          ...
          <a href="http://wellnessway4u.com/pages.php?id=165" target="_blank">
        ...
        <div class="col-md-8">
          ...
          <div class="box box-info">
            ...
            <div class="box-header with-border">
              ...
              <h3 class="fontCap"><b>GENERATE YOUR KYS-WIM Identity for</b></h3>
           ...
           <!-- Your Natural Energy Rejuvenators-->
            ...
            <div class="col-md-12">
              ...
              <h5 class="box-title">(Your Inputs at below KEYS are just like Social Media, simply talk / review about quality of your daily routine)</h5>            
...
?>
  ...
  <?php
	...
	$ysleepCount = getMySleepCountByDate($yesterdayDate, $_SESSION['user_id']);

?>

							<span><?php echo $ysleepCount;?></span>
...
<?php	
	...
	$tsleepCount = getMySleepCountByDate($todayDate, $_SESSION['user_id']);

?>

							<span><?php echo $tsleepCount;?></span>
        ...
        <!-- Bar-->
           ...
           <div class="col-md-12">
              ...
              <h4 class="box-title">KNOW more about your Emotions Management @</h4>            
  ...
  <?php
	...
	$ysituationCount = getMySituationByDate($yesterdayDate, $_SESSION['user_id']);

?>

							<span><?php echo $ysituationCount;?></span>
  ...
  <?php	
	...
	$tsituationCount = getMySituationByDate($todayDate, $_SESSION['user_id']);

?>

							<span><?php echo $tsituationCount;?></span>
...
<?php
	...
	$ycommunicationsCount = getMyCommunicationsByDate($yesterdayDate, $_SESSION['user_id']);

?>

							<span><?php echo $ycommunicationsCount;?></span>
  ...
  <?php	
	...
	$tcommunicationsCount = getMyCommunicationsByDate($todayDate, $_SESSION['user_id']);

?>

							<span><?php echo $tcommunicationsCount;?></span>
...
<?php
	...
	$yworkplaceCount = getMyWorkplaceByDate($yesterdayDate, $_SESSION['user_id']);

?>

							<span><?php echo $yworkplaceCount;?></span>
 ...
 <?php	
	...
	$tworkplaceCount = getMyWorkplaceByDate($todayDate, $_SESSION['user_id']);

?>

							<span><?php echo $tworkplaceCount;?></span>
        ...
        <div class="col-md-12">
            ...
            <div class="box-header with-border">
              ...
              <h3 class="fontCap"><b>Your KYS-Wim Patterns ... Your AEEAM tool to drive positive outcomes</b></h3>
        ...
        <!-- /.col -->
         ...
         <!--   <h5 class="box-title">My Lifestyle/Routine @</h5>-->
          ...
          <a href="../general_stressors.php" target="_blank">    
           ...
           <h5 class="box-title subKey5">My Stress Tracker</h5>
<!--  <em>entries</em>-->
  <!--<strong>Yesterday</strong>-->
 <img src="uploads/General-Stress-wellness-way-4-u-06.jpg" width="100" height="100" alt="My Stress Management">
            </a>
         ...
         <!--   <h5 class="box-title">My BODY Speak @</h5>   -->
           <h5 class="box-title subKey5">My Addiction Tracker</h5>
<!--  <em>entries</em>-->
  <!--<strong>Yesterday</strong>-->
 <img src="uploads/My-Addiction-wellness-way-4-u-10.jpg" width="100" height="100" alt="My Addiction Management">
           </a>
        ...
        <div class="box-body"> 
         ...
         <!--   <h5 class="box-title">My Lifestyle/Routine @</h5>-->
          <a href="../my_relations.php" target="_blank">    
           ...
           <h5 class="box-title subKey5">My Anger Tracker</h5>
<!--  <em>entries</em>-->
  <!--<strong>Yesterday</strong>-->
 <img src="uploads/My-Relations-wellness.jpg" width="100" height="100" alt="My Anger Management">
            </a>
            </center>
           </div>   
            </div>
