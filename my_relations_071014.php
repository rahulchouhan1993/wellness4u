...
$ref = base64_encode('my_relations.php');
if(!isLoggedIn())
{
...
$mr_date = $today_year.'-'.$today_month.'-'.$today_day;
$yesterday = $now - 86400;
...

{
	...
	$empty_selected_mr_id_arr = true;

	for($i=0;$i<$cnt;$i++)

	{

		$selected_mr_id = strip_tags(trim($_POST['selected_mr_id_'.$i]));

		if($selected_mr_id != '')

		{

			$empty_selected_mr_id_arr = false;
		...
		array_push($selected_mr_id_arr,$selected_mr_id);
...

	{
		...
		$err_mr_date = 'Please select date!';
...

	{
		...
		$err_mr_date = 'Please select valid date!';
...

	{
		...
		$err_mr_date = 'Please select today or previous date!';
...

	{
...

		{
			...
			array_push($tr_err_mr , $temp_tr_err);

			array_push($err_mr , $temp_err);	
...

	{
		...
		$addUsersMRQuestion = addUsersMRQuestion($user_id,$mr_date,$selected_mr_id_arr,$scale_arr,$remarks_arr,$my_target_arr,$adviser_target_arr,$pro_user_id);

		

		if($addUsersMRQuestion)
									...
									<table width="570" border="0" cellspacing="0" cellpadding="0">
										...
										<tr>
											...
											<td height="50" align="left" valign="top">
												...
												<table width="550" border="0" cellspacing="0" cellpadding="0">
														...
														<td colspan="4" height="50" align="left" valign="top">
                                                        	<table width="550" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    ...
                                                                    <td height="50" align="left" valign="middle" class="Header_brown">My Relations</td>
                                                                </tr>
                                                             </table>       
                                                        </td>
													</tr>
                                                    <tr> 
                                                        ...
                                                        <td width="150" height="30" align="left" valign="middle">
															<select name="pro_user_id" id="pro_user_id" onchange="getUsersMRQuestionDetails(); updateUserFormTheme();" style="width:120px;">
														...
														<td width="180" height="30" align="left" valign="middle">
															<select name="day" id="day" onchange="getUsersMRQuestionDetails();" style="width:40px;">
															...
															<select name="month" id="month" onchange="getUsersMRQuestionDetails();" style="width:60px;">
																<?php echo getMonthOptions($month,$yesterday_month,$today_month); ?>
															</select>
															<select name="year" id="year" onchange="getUsersMRQuestionDetails();" style="width:60px;">
															<?php
													...
													<tr id="tr_err_mr_date" style="display:<?php echo $tr_err_mr_date;?>;" valign="top">

														<td align="right" valign="top">&nbsp; </td>

														<td align="right" valign="top">&nbsp; </td>

														<td align="left" colspan="2" class="err_msg" valign="top"><?php echo $err_mr_date;?></td>
												...
												<table width="560" border="0" cellspacing="0" cellpadding="0" id="tblmr">
...

											{
												...
												{ ?>
													...
													<tr style="display:<?php echo $tr_err_mr[$i];?>;" valign="top">

														<td align="left" colspan="2" class="err_msg" valign="top"><?php echo $err_mr[$i];?></td>
													...
													<tr>
														...
														<td width="430" height="35" align="left" valign="top">
															...
															<input type="checkbox" name="selected_mr_id_<?php echo $i;?>" id="selected_mr_id_<?php echo $i;?>" value="<?php echo $arr_mr_id[$i];?>" <?php if($selected_mr_id_arr[$i] == $arr_mr_id[$i]) { ?> checked="checked" <?php } ?> onclick="toggleMyResponseScale('selected_mr_id_','<?php echo $i;?>')" />&nbsp;<strong><span style="font-family:<?php echo $arr_situation_font_family[$i];?>;font-size:<?php echo $arr_situation_font_size[$i];?>px;color:#<?php echo $arr_situation_font_color[$i];?>;"><?php echo $arr_situation[$i]; ?></span></strong>
                                                                                                                ...
                                                                                                                <table width="560" border="0" cellspacing="0" cellpadding="0">
                                                                                                                    <tr>
                                                                                                                        ...
                                                                                                                        <td width="150" align="left" valign="top">
                                                                                                                            ...
                                                                                                                            </select><br><?php echo getUsersLastMyTargetMRDateString($user_id,$pro_user_id,$arr_mr_id[$i]);?>
                                                                                                                            </div>
                                                                                                                        ...
                                                                                                                        <td width="150" align="left" valign="top">
                                                                                                                            ...
                                                                                                                            </select><br><?php echo getUsersLastAdviserTargetMRDateString($user_id,$pro_user_id,$arr_mr_id[$i]);?>
                                                                                                                            </div>
