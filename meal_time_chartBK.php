...
$ref = base64_encode('meal_time_chart.php');
...
if(chkUserPlanFeaturePermission($user_id,'7'))
{
	$meal_chart = 1;
}
else
...

{
...

	{
		$start_date = date('Y-m-d',strtotime($start_date));
		$end_date = date('Y-m-d',strtotime($end_date));
		$output = getMealTimeChartHTML($user_id,$start_date,$end_date);	
                                                ...
                                                <tbody>	
												 ...
												 <table width="920" border="0" cellpadding="2" cellspacing="1" bgcolor="#999999">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td height="50" align="center" valign="middle" bgcolor="#E1E1E1" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal; color:#0000FF;">SNo</td>

                                                        <td height="50" align="center" valign="middle" bgcolor="#E1E1E1" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal; color:#0000FF;">Date/Days</td>

                                                        <td height="50" align="center" valign="middle" bgcolor="#E1E1E1" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal; color:#0000FF;">Breakfast</td>

                                                        <td height="50" align="center" valign="middle" bgcolor="#E1E1E1" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal; color:#0000FF;">Brunch</td>

                                                        <td height="50" align="center" valign="middle" bgcolor="#E1E1E1" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal; color:#0000FF;">Lunch</td>

                                                        <td height="50" align="center" valign="middle" bgcolor="#E1E1E1" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal; color:#0000FF;">Snacks</td>

                                                        <td height="50" align="center" valign="middle" bgcolor="#E1E1E1" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal; color:#0000FF;">Dinner</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td height="50" align="center" valign="middle" bgcolor="#E1E1E1" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal; color:#0000FF;"><?php echo $j;?></td>

                                                        <td height="50" align="center" valign="middle" bgcolor="#E1E1E1" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal; color:#0000FF;"><?php echo date("d M Y",strtotime($arr_date[$i]));?><br />(<?php echo date("l",strtotime($arr_date[$i]));?>)</td>

                                                        <td height="50" align="center" valign="middle" bgcolor="#FFFFFF" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal;"><?php if($arr_breakfast_time[$arr_date[$i]]==''){echo 'NA';}else {echo $arr_breakfast_time[$arr_date[$i]];}?></td>

                                                        <td height="50" align="center" valign="middle" bgcolor="#FFFFFF" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal;"><?php if($arr_brunch_time[$arr_date[$i]]==''){echo 'NA';}else {echo $arr_brunch_time[$arr_date[$i]];}?></td>

                                                        <td height="50" align="center" valign="middle" bgcolor="#FFFFFF" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal;"><?php if($arr_lunch_time[$arr_date[$i]]==''){echo 'NA';}else {echo $arr_lunch_time[$arr_date[$i]];}?></td>

                                                        <td height="50" align="center" valign="middle" bgcolor="#FFFFFF" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal;"><?php if($arr_snacks_time[$arr_date[$i]]==''){echo 'NA';}else {echo $arr_snacks_time[$arr_date[$i]];}?></td>

                                                        <td height="50" align="center" valign="middle" bgcolor="#FFFFFF" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal;"><?php if($arr_dinner_time[$arr_date[$i]]==''){echo 'NA';}else {echo $arr_dinner_time[$arr_date[$i]];}?></td>
