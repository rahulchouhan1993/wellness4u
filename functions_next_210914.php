...
function search_myfavlist($user_id,$page_id,$start_date,$end_date,$ufs_cat_id)
  	{	
		list($arr_ufs_id,$arr_page_id,$arr_menu_title,$arr_sc_id,$arr_ufs_note,$arr_ufs_cat_id,$arr_ufs_cat,$arr_ufs_priority,$arr_ufs_add_date,$arr_user_name) = GetMyFavListDetails($user_id,$page_id,$start_date,$end_date,$ufs_cat_id);
...
function chkIfScrollingWindowActivateForPage($page_id)
{
	...
	$sql = "SELECT * FROM `tblpages` WHERE `page_id` = '".$page_id."' AND `show_in_manage_menu` = '1' AND `show_in_list` = '1' AND `adviser_panel` = '0'";
	//echo'<br><br>sql = '.$sql;
	$result = mysql_query($sql,$link);
	if( ($result) && (mysql_num_rows($result) > 0) )
	{	
...
function getTotalEntriesOfModule($reward_module_id,$start_date,$end_date,$user_id)
{
	...
	{
		$sql = "SELECT * FROM `tbluserswae` WHERE `wae_date` >= '".$start_date."' AND `wae_date` <= '".$end_date."' ".$str_user_id." ORDER BY `wae_date` ASC ";
	}
	elseif($reward_module_id == '8')
	{
		$sql = "SELECT * FROM `tblusersgs` WHERE `gs_date` >= '".$start_date."' AND `gs_date` <= '".$end_date."' ".$str_user_id." ORDER BY `gs_date` ASC ";
	}
	elseif($reward_module_id == '9')
	{
		$sql = "SELECT * FROM `tbluserssleep` WHERE `sleep_date` >= '".$start_date."' AND `sleep_date` <= '".$end_date."' ".$str_user_id." ORDER BY `sleep_date` ASC ";
	}
	elseif($reward_module_id == '10')
	{
		$sql = "SELECT * FROM `tblusersmc` WHERE `mc_date` >= '".$start_date."' AND `mc_date` <= '".$end_date."' ".$str_user_id." ORDER BY `mc_date` ASC ";
	}
	elseif($reward_module_id == '11')
	{
		$sql = "SELECT * FROM `tblusersmr` WHERE `mr_date` >= '".$start_date."' AND `mr_date` <= '".$end_date."' ".$str_user_id." ORDER BY `mr_date` ASC ";
	}
	elseif($reward_module_id == '12')
	{
		$sql = "SELECT * FROM `tblusersmle` WHERE `mle_date` >= '".$start_date."' AND `mle_date` <= '".$end_date."' ".$str_user_id." ORDER BY `mle_date` ASC ";
	}
	elseif($reward_module_id == '13')
	{
		$sql = "SELECT * FROM `tblusersadct` WHERE `adct_date` >= '".$start_date."' AND `adct_date` <= '".$end_date."' ".$str_user_id." ORDER BY `adct_date` ASC ";
	}
...
function getTotalNoOfDaysOfEntries($reward_module_id,$start_date,$end_date,$user_id)
{
	...
	elseif($reward_module_id == '7')
	{
		$sql = "SELECT DISTINCT `wae_date` FROM `tbluserswae` WHERE `wae_date` >= '".$start_date."' AND `wae_date` <= '".$end_date."' ".$str_user_id." ORDER BY `wae_date` ASC ";
	}
	elseif($reward_module_id == '8')
	{
		$sql = "SELECT DISTINCT `gs_date` FROM `tblusersgs` WHERE `gs_date` >= '".$start_date."' AND `gs_date` <= '".$end_date."' ".$str_user_id." ORDER BY `gs_date` ASC ";
	}
	elseif($reward_module_id == '9')
	{
		$sql = "SELECT DISTINCT `sleep_date` FROM `tbluserssleep` WHERE `sleep_date` >= '".$start_date."' AND `sleep_date` <= '".$end_date."' ".$str_user_id." ORDER BY `sleep_date` ASC ";
	}
	elseif($reward_module_id == '10')
	{
		$sql = "SELECT DISTINCT `mc_date` FROM `tblusersmc` WHERE `mc_date` >= '".$start_date."' AND `mc_date` <= '".$end_date."' ".$str_user_id." ORDER BY `mc_date` ASC ";
	}
	elseif($reward_module_id == '11')
	{
		$sql = "SELECT DISTINCT `mr_date` FROM `tblusersmr` WHERE `mr_date` >= '".$start_date."' AND `mr_date` <= '".$end_date."' ".$str_user_id." ORDER BY `mr_date` ASC ";
	}
	elseif($reward_module_id == '12')
	{
		$sql = "SELECT DISTINCT `mle_date` FROM `tblusersmle` WHERE `mle_date` >= '".$start_date."' AND `mle_date` <= '".$end_date."' ".$str_user_id." ORDER BY `mle_date` ASC ";
	}
	elseif($reward_module_id == '13')
	{
		$sql = "SELECT DISTINCT `adct_date` FROM `tblusersadct` WHERE `adct_date` >= '".$start_date."' AND `adct_date` <= '".$end_date."' ".$str_user_id." ORDER BY `adct_date` ASC ";
	}
	elseif($reward_module_id == '14')
	{
...
function addScrollingContentToFav($user_id,$page_id,$str_sc_id)
{
	global $link;
	$return = false;
	$arr_sc_id = array();
	...
	if($str_sc_id != '')
	{
		...
		{
			if(!chkIfOptionAlreadyAddedToFav($user_id,$page_id,$sc_id))
			{
				$sql = "INSERT INTO `tblusersfavscrolling` (`user_id`,`page_id`,`sc_id`,`ufs_status`) VALUES ('".$user_id."','".$page_id."','".$arr_sc_id[$i]."','1')";
				//echo"<br>".$sql;
				$result = mysql_query($sql,$link);
				if($result)
				{
...
function chkIfOptionAlreadyAddedToFav($user_id,$page_id,$sc_id)
{
	global $link;
	$return = false;
	
	$sql = "SELECT * FROM `tblusersfavscrolling` WHERE `page_id` = '".$page_id."' AND `user_id` = '".$user_id."'  AND `sc_id` = '".$sc_id."' ";
	//echo'<br><br>sql = '.$sql;
	$result = mysql_query($sql,$link);
	if( ($result) && (mysql_num_rows($result) > 0) )
	{	
...
function getScrollingWindowsCode($page_id)
{
	...
	$sql1 = "SELECT * FROM `tblscrollingwindows` WHERE `page_id` = '".$page_id."' AND `sw_status` = '1' ORDER BY `sw_order` ASC , `sw_add_date` DESC ";
	...
	if( ($result1) && (mysql_num_rows($result1) > 0) )
	{
		...
		while ($row1 = mysql_fetch_assoc($result1)) 
		{
			...
			{
				$sw_header = '<a href="'.stripslashes($row1['sw_header_credit_link']).'" target="_blank" style="color:#ffffff;">'.$sw_header.'</a>';			
			}
			...
			{
				$sw_footer = '<a href="'.stripslashes($row1['sw_footer_credit_link']).'" target="_blank" style="color:#ffffff;">'.$sw_footer.'</a>';			
			}
			...
			if( ($result) && (mysql_num_rows($result) > 0) )
			{
				...
				$output .= '	<tr>';
				$output .= '		<td width="125" height="30" align="left" valign="middle" style="color:#FFFFFF;font-weight:bold;'.$header_style.'" >'.$sw_header.'</td>';
				$output .= '		<td width="35" height="30" align="right" valign="middle" >'.$sw_header_image.'</td>';
				$output .= '	</tr>';
				$output .= '	<tr>';
				...
				while ($row = mysql_fetch_assoc($result)) 
				{
					...
					$output .= '				<tr>';
					$output .= '					<td height="30" colspan="2" align="center" valign="top" style="'.$sc_title_style.'" ><strong>'.$sc_title.'</strong></td>';
					$output .= '				</tr>';
					...
					if($sc_content_type == 'text')
					{
						...
						$output .= '				<tr>';
						$output .= '					<td colspan="2" height="60" align="left" valign="top" style="padding-left:3px;'.$sc_content_style.'">'.$sc_content.'</td>';
						$output .= '				</tr>';
					...
					elseif($sc_content_type == 'text_and_image')
					{
						...
						$output .= '							<tr>';
						$output .= '								<td align="left" valign="top" bgcolor="#FFFFFF" style="padding-left:10px;">'.$sc_image.'</td>';
						$output .= '							</tr>';
						$output .= '						</table>';
						$output .= '					</td>';
						$output .= '					<td width="90" height="60" align="left" valign="top" style="padding-left:3px;'.$sc_content_style.'">'.$sc_content.'</td>';
						$output .= '				</tr>';	
					...
					elseif($sc_content_type == 'image')
					{
						...
						$output .= '				<tr>';
						$output .= '					<td colspan="2" height="60" align="left" valign="top">'.$sc_image.'</td>';
						$output .= '				</tr>';	
					}	
					elseif($sc_content_type == 'video')
					{
						...
						$output .= '				<tr>';
						$output .= '					<td colspan="2" height="60" align="left" valign="top">'.$sc_video.'</td>';
						$output .= '				</tr>';	
					}	
					elseif($sc_content_type == 'flash')
					{
					...
					elseif($sc_content_type == 'rss')
					{
						...
						$output .= '				<tr>';
						$output .= '					<td colspan="2" height="60" align="left" valign="top">'.$rss_feed_item_title.'</td>';
						$output .= '				</tr>';	
						$output .= '				<tr>';
						$output .= '					<td colspan="2" height="60" align="left" valign="top">'.$rss_feed_item_desc.'</td>';
						$output .= '				</tr>';	
					}	
				...
				$output .= '	</tr>';
				$output .= '	<tr>';
				$output .= '		<td height="30" align="left" valign="middle" style="color:#FFFFFF;font-weight:bold;'.$footer_style.'">'.$sw_footer.'</td>';
				$output .= '		<td height="30" align="right" valign="middle">'.$sw_footer_image.'</td>';
				$output .= '	</tr>';
				$output .= '</table>
		...
		if($output != '')
		{
			$output .= '<table width="160" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td>
									<input type="submit" name="btnAddToFav" id="btnAddToFav" value="Add to Fav">
...
function getWelcomeUserBoxCode($name,$user_id)
{
	global $link;
	$output = '';
	$output .= '<table width="160" border="0" cellpadding="2" cellspacing="0">';
	$output .= '	<tr>';
	$output .= '		<td align="left" valign="top" bgcolor="#FFFFFF">';
	$output .= '			<table width="160" border="0" cellpadding="0" cellspacing="1" bgcolor="#666666">';
	$output .= '				<tr>';
	$output .= '					<td align="left" valign="top" bgcolor="#FFFFCC" class="breadcrumb">';
	$output .= '						<table width="150" border="0" cellspacing="0" cellpadding="0">';
	$output .= '							<tr>';
	$output .= '								<td height="30" align="left" valign="top" style="padding-left:10px;">Welcome<br />'.$name.'</td>';
	$output .= '							</tr>';
	$output .= '							<tr>';
	$output .= '								<td height="30" align="left" valign="top" style="padding-left:10px;">Cust Id: '.getUserUniqueId($user_id).'</td>';
	$output .= '							</tr>';
	$output .= '						</table>';
	$output .= '					</td>';
	$output .= '				</tr>';
...
function addUsersWAEQuestion($user_id,$wae_date,$selected_wae_id_arr,$scale_arr,$remarks_arr)
{
	global $link;
	$return = false;
	
	$sql = "DELETE FROM `tbluserswae` WHERE `user_id` = '".$user_id."' AND  `wae_date` = '".$wae_date."'";
	$result = mysql_query($sql,$link);
	...
	for($i=0;$i<count($selected_wae_id_arr);$i++)
	{
		...
		{
			$sql = "INSERT INTO `tbluserswae` (`user_id`,`wae_date`,`selected_wae_id`,`scale`,`remarks`) VALUES ('".$user_id."','".$wae_date."','".$selected_wae_id_arr[$i]."','".$scale_arr[$i]."','".$remarks_arr[$i]."')";
			//echo"<br>".$sql;
			$result = mysql_query($sql,$link);
			if($result)
			{
...
function addUsersGSQuestion($user_id,$gs_date,$selected_gs_id_arr,$scale_arr,$remarks_arr)
{
	global $link;
	$return = false;
	
	$sql = "DELETE FROM `tblusersgs` WHERE `user_id` = '".$user_id."' AND  `gs_date` = '".$gs_date."'";
	$result = mysql_query($sql,$link);
	...
	for($i=0;$i<count($selected_gs_id_arr);$i++)
	{
		...
		{
			$sql = "INSERT INTO `tblusersgs` (`user_id`,`gs_date`,`selected_gs_id`,`scale`,`remarks`) VALUES ('".$user_id."','".$gs_date."','".$selected_gs_id_arr[$i]."','".$scale_arr[$i]."','".$remarks_arr[$i]."')";
			//echo"<br>".$sql;
			$result = mysql_query($sql,$link);
			if($result)
			{
...
function addUsersMCQuestion($user_id,$mc_date,$selected_mc_id_arr,$scale_arr,$remarks_arr)
{
	global $link;
	$return = false;
	
	$sql = "DELETE FROM `tblusersmc` WHERE `user_id` = '".$user_id."' AND  `mc_date` = '".$mc_date."'";
	$result = mysql_query($sql,$link);
	...
	for($i=0;$i<count($selected_mc_id_arr);$i++)
	{
		...
		{
			$sql = "INSERT INTO `tblusersmc` (`user_id`,`mc_date`,`selected_mc_id`,`scale`,`remarks`) VALUES ('".$user_id."','".$mc_date."','".$selected_mc_id_arr[$i]."','".$scale_arr[$i]."','".$remarks_arr[$i]."')";
			//echo"<br>".$sql;
			$result = mysql_query($sql,$link);
			if($result)
			{
...
function addUsersMRQuestion($user_id,$mr_date,$selected_mr_id_arr,$scale_arr,$remarks_arr)
{
	global $link;
	$return = false;
	
	$sql = "DELETE FROM `tblusersmr` WHERE `user_id` = '".$user_id."' AND  `mr_date` = '".$mr_date."'";
	$result = mysql_query($sql,$link);
	...
	for($i=0;$i<count($selected_mr_id_arr);$i++)
	{
		...
		{
			$sql = "INSERT INTO `tblusersmr` (`user_id`,`mr_date`,`selected_mr_id`,`scale`,`remarks`) VALUES ('".$user_id."','".$mr_date."','".$selected_mr_id_arr[$i]."','".$scale_arr[$i]."','".$remarks_arr[$i]."')";
			//echo"<br>".$sql;
			$result = mysql_query($sql,$link);
			if($result)
			{
...
function addUsersMLEQuestion($user_id,$mle_date,$selected_mle_id_arr,$scale_arr,$remarks_arr)
{
	global $link;
	$return = false;
	
	$sql = "DELETE FROM `tblusersmle` WHERE `user_id` = '".$user_id."' AND  `mle_date` = '".$mle_date."'";
	$result = mysql_query($sql,$link);
	...
	for($i=0;$i<count($selected_mle_id_arr);$i++)
	{
		...
		{
			$sql = "INSERT INTO `tblusersmle` (`user_id`,`mle_date`,`selected_mle_id`,`scale`,`remarks`) VALUES ('".$user_id."','".$mle_date."','".$selected_mle_id_arr[$i]."','".$scale_arr[$i]."','".$remarks_arr[$i]."')";
			//echo"<br>".$sql;
			$result = mysql_query($sql,$link);
			if($result)
			{
...
function addUsersAdctQuestion($user_id,$adct_date,$selected_adct_id_arr,$scale_arr,$remarks_arr)
{
	global $link;
	$return = false;
	
	$sql = "DELETE FROM `tblusersadct` WHERE `user_id` = '".$user_id."' AND  `adct_date` = '".$adct_date."'";
	$result = mysql_query($sql,$link);
	...
	for($i=0;$i<count($selected_adct_id_arr);$i++)
	{
		...
		{
			$sql = "INSERT INTO `tblusersadct` (`user_id`,`adct_date`,`selected_adct_id`,`scale`,`remarks`) VALUES ('".$user_id."','".$adct_date."','".$selected_adct_id_arr[$i]."','".$scale_arr[$i]."','".$remarks_arr[$i]."')";
			//echo"<br>".$sql;
			$result = mysql_query($sql,$link);
			if($result)
			{
...
function getPageDetails($page_id)
{
	...
	return array($page_name,$page_title,$page_contents,$meta_title,$meta_keywords,$meta_description,$menu_title,$menu_link,$link_enable,$parent_menu);
}
...
function getActivitiesRows($today_wakeup_time,$mins_arr,$activity_id_arr,$other_activity_arr,$proper_guidance_arr,$precaution_arr,$tr_err_activity,$err_activity,$skip_time_arr)
{
	...
	$ret_str = '';
	$ret_str .='<table width="570" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="60" height="30" align="center" valign="middle" bgcolor="#CCCCCC" ><strong>Time</strong></td>
							<td width="10" height="30" align="center" valign="middle" bgcolor="#CCCCCC">&nbsp;</td>
							<td width="310" height="30" align="center" valign="middle" bgcolor="#CCCCCC"><strong>Activity</strong></td>
							<td width="190" height="30" align="center" valign="middle" bgcolor="#CCCCCC"><strong>Duration</strong></td>
						</tr>
						<tr>
...
function getUsersWAEQuestionDetails($user_id,$wae_date)
{
	global $link;
	...
	$sql = "SELECT * FROM `tbluserswae` WHERE `user_id` = '".$user_id."' AND `wae_date` = '".$wae_date."' ORDER BY `selected_wae_id` ASC";
	//secho "<br>Testkk sql = ".$sql;
	$result = mysql_query($sql,$link);
	if( ($result) && (mysql_num_rows($result) > 0) )
	{
		while($row = mysql_fetch_array($result))
	...
	return array($scale_arr,$remarks_arr,$selected_wae_id_arr);

}

function getUsersGSQuestionDetails($user_id,$gs_date)
{
	global $link;
	...
	$sql = "SELECT * FROM `tblusersgs` WHERE `user_id` = '".$user_id."' AND `gs_date` = '".$gs_date."' ORDER BY `selected_gs_id` ASC";
	//echo "<br>Testkk sql = ".$sql;
	$result = mysql_query($sql,$link);
	if( ($result) && (mysql_num_rows($result) > 0) )
	{
	...
	return array($scale_arr,$remarks_arr,$selected_gs_id_arr);
...
function getUsersMCQuestionDetails($user_id,$mc_date)
{
	global $link;
	...
	$sql = "SELECT * FROM `tblusersmc` WHERE `user_id` = '".$user_id."' AND `mc_date` = '".$mc_date."' ORDER BY `selected_mc_id` ASC";
	//echo "<br>Testkk sql = ".$sql;
	$result = mysql_query($sql,$link);
	if( ($result) && (mysql_num_rows($result) > 0) )
	{
	...
	return array($scale_arr,$remarks_arr,$selected_mc_id_arr);

}

function getUsersMRQuestionDetails($user_id,$mr_date)
{
	global $link;
	...
	$sql = "SELECT * FROM `tblusersmr` WHERE `user_id` = '".$user_id."' AND `mr_date` = '".$mr_date."' ORDER BY `selected_mr_id` ASC";
	//echo "<br>Testkk sql = ".$sql;
	$result = mysql_query($sql,$link);
	if( ($result) && (mysql_num_rows($result) > 0) )
	{
	...
	return array($scale_arr,$remarks_arr,$selected_mr_id_arr);

}

function getUsersMLEQuestionDetails($user_id,$mle_date)
{
	global $link;
	...
	$sql = "SELECT * FROM `tblusersmle` WHERE `user_id` = '".$user_id."' AND `mle_date` = '".$mle_date."' ORDER BY `selected_mle_id` ASC";
	//echo "<br>Testkk sql = ".$sql;
	$result = mysql_query($sql,$link);
	if( ($result) && (mysql_num_rows($result) > 0) )
	{
	...
	return array($scale_arr,$remarks_arr,$selected_mle_id_arr);

}

function getUsersADCTQuestionDetails($user_id,$adct_date)
{
	global $link;
	...
	$sql = "SELECT * FROM `tblusersadct` WHERE `user_id` = '".$user_id."' AND `adct_date` = '".$adct_date."' ORDER BY `selected_adct_id` ASC";
	//echo "<br>Testkk sql = ".$sql;
	$result = mysql_query($sql,$link);
	if( ($result) && (mysql_num_rows($result) > 0) )
	{
	...
	return array($scale_arr,$remarks_arr,$selected_adct_id_arr);
...
function GetMyFavListDetails($user_id,$page_id,$start_date,$end_date,$ufs_cat_id)
{
	...
	return array($arr_ufs_id,$arr_page_id,$arr_menu_title,$arr_sc_id,$arr_ufs_note,$arr_ufs_cat_id,$arr_ufs_cat,$arr_ufs_priority,$arr_ufs_add_date,$arr_user_name);
