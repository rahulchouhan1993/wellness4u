...
$day = date('j');
$sol_item_id_data=getTblSolutionDataBySolIdVivek($_GET['sol_item_id']);


//echo '<pre>';
//print_r($sol_item_id_data['sol_item_id']);
//echo '</pre>';
//die();
    ...
    <strong style="color: #993366; font-family: verdana, geneva; font-size: 12px;">
        <a href="index.php?theme_id=<?php // echo $theme_data[$i]['theam_id'];?>&icons_id=<?php // echo $_GET['icons_id'];?>">
            <div class="img-circle">
               <img title="<?php echo $sol_item_id_data['sol_box_banner'];?>" id="bgimage_<?php echo $i;?>"  src="uploads/<?php echo $sol_item_id_data['sol_box_banner'];?>"  width="150" height="150" />
            </div>
            <h4>Share Your Problem</h4>
            <h4  style="margin-top:20px;"><?php echo $sol_item_id_data['sol_box_title'];?></h4>
        </a> 
    </strong>
</div>
   ...
   <p style="color:red;font-size:14px; margin-top: 50px;">
    <b>
      ...
      <div class="form-group">
          ...
          <label style="color:red;font-size:10px; " class="col-lg-3 control-label">
              
              <a href="uploads/<?php echo $sol_item_id_data['sol_box_banner']; ?>" target="_blank">
              <?php 
                 $banner=$sol_item_id_data['sol_box_banner'];
                 if($sol_item_id_data['sol_box_type'] == 'Video'){
              ?>
         
               <iframe width="175" height="175" src="<?php echo getSressBusterBannerString($banner);?>" frameborder="0" allowfullscreen></iframe>
         <?php }
         else if($sol_item_id_data['sol_box_type'] == 'Image') {
         ?>      
               <img src="uploads/<?php echo $sol_item_id_data['sol_box_banner']; ?>" title="<?php echo $sol_item_id_data['sol_box_title'];?>"  style="height: 175px; width: 175px;" >
        
       
         <?php } ?> 
                </a>
               <!--<br> <h2 style="margin-left:50px;"><a href='<?php // echo $_GET['page_name'];?>'>Back</a></h2>-->
      ...
      <div  align="left" class="col-lg-4"style="font-size:13px; margin-left: -50px; ">
              <h5><b>
              <?php echo $sol_item_id_data['sol_box_title'];?>
                 </b> </h5>
          <p> <?php echo stripcslashes($sol_item_id_data['sol_box_desc']);?></p>
          <p><?php echo  getSressBusterBannerString($banner);?></p>
     </div>
