...
$sql = "SELECT * FROM `tblprofusers` WHERE (`email` = '".$email."' || `mobile` = '".$email."') AND `password` = '".md5($password)."' AND `status` = '1' ";
	$result = mysql_query($sql,$link);
	if( ($result) && (mysql_num_rows($result) > 0) )
	{
		$return = true;
...
$sql = "SELECT * FROM `tblcontracts` WHERE `contract_email` = '".$email."' || `mobile` = '".$email."') AND `password` = '".md5($password)."' AND `contract_status` = '1' ";
	//echo '<br>'.$sql;
        $result = mysql_query($sql,$link);
	if( ($result) && (mysql_num_rows($result) > 0) )
	{
...
function getProUserId($email)
{
	...
	$sql = "SELECT * FROM `tblprofusers` WHERE (`email` = '".$email."' || `mobile` = '".$email."') AND `status` = '1'";
	$result = mysql_query($sql,$link);
	if( ($result) && (mysql_num_rows($result) > 0) )
	{
		$row = mysql_fetch_array($result);
...
$sql = "SELECT * FROM `tblcontracts` WHERE `contract_email` = '".$email."' || `mobile` = '".$email."') AND `contract_status` = '1'";
	$result = mysql_query($sql,$link);
	if( ($result) && (mysql_num_rows($result) > 0) )
	{
		$row = mysql_fetch_array($result);
