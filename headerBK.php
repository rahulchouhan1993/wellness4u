...
<table width="1000" border="0" cellspacing="0" cellpadding="0">
    <tr>
    	<td width="10" >&nbsp;</td>
    	<td width="980" align="center" valign="top"  background="images/top_back.jpg" style="background-repeat: repeat-x; border-left: 1px solid #FFFFFF; border-right: 1px solid #FFFFFF;" bgcolor="#FFFFFF">
            ...
            <table width="960" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="184" height="100" align="center" valign="top">
            ...
            <table width="960" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td height="45" align="center" valign="bottom">
                    	<table width="960" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td width="960" height="32" align="center" valign="middle">
                                    <table height="30px"  border="0" cellspacing="0" cellpadding="0" width="960">
                                        <tr>
            	...
            	<tr>
                    <td height="150" align="left" valign="top">
                    	<div class="imgtopbanner">
                            ...
                            <?php //<div class="imgtopstrip"><img src="images/top_banner.png" width="408" height="28" /></div>
                        </div>
                    </td>
            	</tr>
            </table>
            ...
            <table width="960" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td height="2" bgcolor="#52D017"><img src="images/spacer.gif" width="1" height="1" /></td>
                </tr>
            </table> 
            <table width="960" border="0" cellspacing="0" cellpadding="0">
                <tr>
