...
{     
	...
	elseif(!$obj2->chkValidEmailID($email))
...
if(isset($_REQUEST['action']) && $_REQUEST['action'] =='resendotp')
	...
	elseif(!$obj2->chkVenderMobileExists($signup_mobile_no))
...

	{
		...
		$tdata['email'] = $obj2->getVendorEmailbyMobile($signup_mobile_no);
		...
		//change otp type by ample 02-06-20
...

		{
            ...
            $tdata_sms['email'] = $obj2->getVendorEmailbyMobile($signup_mobile_no);



			// $tdata_sms['sms_message'] = 'OTP to reset password is:'.$otp;



			//change by ample 02-06-20
			...
			$email = $obj2->getVendorEmailByMobile($signup_mobile_no);

			$name = $obj2->GetUserName_vendor($email);    	
			...
			$message = str_ireplace("[[OTP]]", $tdata['otp'], $message);
 ...
 if(isset($_REQUEST['action']) && $_REQUEST['action'] =='doverifyotpforgotpassword')
...

	{
		...
		if($obj2->doVerifyOTPForgotPassword($tdata))
...
if(isset($_REQUEST['action']) && $_REQUEST['action'] =='resetnewpassword')
...

	{
...

		{
			...
			if($obj2->resetUserPasswordByMobile($tdata))
...

			{
				...
				//$url = SITE_URL.'/messages.php?id=6';

				//change by ample 03-06-20

				$url = SITE_URL.'/message.php?msg=13';
								...
								<?php if($error){ ?>
									...
									<div id="forgot-box">
										...
										<div class="form-group">
											...
											<input type="text" name="email_mobile" id="email_mobile" placeholder="Enter your mobile number/Email ID" class="input-text-box" value="<?php echo $email;?>" autocomplete="false">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    Select your choice <input type="radio" name="otp_choice" id="otp_choice" checked="checked" value="Mobile" required=""> Mobile
										...
										<div class="form-group">
                                                                                            ...
                                                                                            <a class="btn-red" href="javascript:sendOTPForgotPassword();">Send OTP on Mobile</a>
...

			{
...

                   {
...

                      {
                          ...
                          window.location.href = 'message.php?msg=11&sess='+JSONObject[0]['send_to_page_data'];
