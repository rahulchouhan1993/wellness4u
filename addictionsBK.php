                        ...
                        <table width="570" align="center" border="0" id="color_code" cellpadding="0" cellspacing="1" bgcolor="<?php echo $bg_color_code; ?>">
                            <tr>
                                <td align="left" valign="top" id="bgimage" background="<?php echo $bg_image; ?>" bgcolor="#FFFFFF" style="background-repeat: repeat; padding:10px;">
                                    <form action="#" id="frmadct" method="post" name="frmadct">
								...
								<select name="pro_user_id" id="pro_user_id" onchange="getUsersADCTQuestionDetails(); updateUserFormTheme();" style="width:120px;">
                                                    ...
                                                    <div id="divadct"> 
                                                        <?php echo getUsersSleepQuestionDetailsCode($day,$month,$year,$pro_user_id,$user_id,$scale_arr,$remarks_arr,$selected_adct_id_arr,$my_target_arr,$adviser_target_arr);?>                   
                                                    </div>
                                                </td>
                                            </tr>
                                        </table>
