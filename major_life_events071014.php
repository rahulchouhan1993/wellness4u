...
$ref = base64_encode('major_life_events.php');
...
$mle_date = $today_year.'-'.$today_month.'-'.$today_day;
...

{
	...
	$empty_selected_mle_id_arr = true;

	for($i=0;$i<$cnt;$i++)

	{

		$selected_mle_id = strip_tags(trim($_POST['selected_mle_id_'.$i]));

		if($selected_mle_id != '')

		{

			$empty_selected_mle_id_arr = false;
		...
		array_push($selected_mle_id_arr,$selected_mle_id);
...

	{
		...
		$err_mle_date = 'Please select date!';
...

	{
		...
		$err_mle_date = 'Please select valid date!';
...

	{
		...
		$err_mle_date = 'Please select today or previous date!';
...

	{
...

		{
			...
			array_push($tr_err_mle , $temp_tr_err);

			array_push($err_mle , $temp_err);	
...

	{
		...
		$addUsersMLEQuestion = addUsersMLEQuestion($user_id,$mle_date,$selected_mle_id_arr,$scale_arr,$remarks_arr,$my_target_arr,$adviser_target_arr,$pro_user_id);

		

		if($addUsersMLEQuestion)
									...
									<table width="570" border="0" cellspacing="0" cellpadding="0">
										...
										<tr>
											...
											<td height="50" align="left" valign="top">
												...
												<table width="550" border="0" cellspacing="0" cellpadding="0">
														...
														<td colspan="4" height="50" align="left" valign="top">
                                                        	<table width="550" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    ...
                                                                    <td height="50" align="left" valign="middle" class="Header_brown">Major Life Events</td>
                                                                </tr>
                                                             </table>       
                                                        </td>
													</tr>
                                                    <tr> 
                                                        ...
                                                        <td width="150" height="30" align="left" valign="middle">
															<select name="pro_user_id" id="pro_user_id" onchange="getUsersMLEQuestionDetails(); updateUserFormTheme();" style="width:120px;">
														...
														<td width="180" height="30" align="left" valign="middle">
															<select name="day" id="day" onchange="getUsersMLEQuestionDetails();" style="width:40px;">
															...
															<select name="month" id="month" onchange="getUsersMLEQuestionDetails();" style="width:60px;">
																<?php echo getMonthOptions($month,$yesterday_month,$today_month); ?>
															</select>
															<select name="year" id="year" onchange="getUsersMLEQuestionDetails();" style="width:60px;">
															<?php
                                                    ...
                                                    <tr id="tr_err_mle_date" style="display:<?php echo $tr_err_mle_date;?>;" valign="top">

														<td align="right" valign="top">&nbsp; </td>

														<td align="right" valign="top">&nbsp; </td>

														<td align="left" colspan="2" class="err_msg" valign="top"><?php echo $err_mle_date;?></td>
												...
												<table width="560" border="0" cellspacing="0" cellpadding="0" id="tblmle">
...

											{
												...
												{ ?>
													...
													<tr style="display:<?php echo $tr_err_mle[$i];?>;" valign="top">

														<td align="left" colspan="2" class="err_msg" valign="top"><?php echo $err_mle[$i];?></td>
													...
													<tr>
														...
														<td width="430" height="35" align="left" valign="top">
															...
															<input type="checkbox" name="selected_mle_id_<?php echo $i;?>" id="selected_mle_id_<?php echo $i;?>" value="<?php echo $arr_mle_id[$i];?>" <?php if($selected_mle_id_arr[$i] == $arr_mle_id[$i]) { ?> checked="checked" <?php } ?> onclick="toggleMyResponseScale('selected_mle_id_','<?php echo $i;?>')" />&nbsp;<strong><span style="font-family:<?php echo $arr_situation_font_family[$i];?>;font-size:<?php echo $arr_situation_font_size[$i];?>px;color:#<?php echo $arr_situation_font_color[$i];?>;"><?php echo $arr_situation[$i]; ?></span></strong>
                                                                                                                ...
                                                                                                                <table width="560" border="0" cellspacing="0" cellpadding="0">
                                                                                                                    <tr>
                                                                                                                        ...
                                                                                                                        <td width="150" align="left" valign="top">
                                                                                                                            ...
                                                                                                                            </select><br><?php echo getUsersLastMyTargetMLEDateString($user_id,$pro_user_id,$arr_mle_id[$i]);?>
                                                                                                                            </div>
                                                                                                                        ...
                                                                                                                        <td width="150" align="left" valign="top">
                                                                                                                            ...
                                                                                                                            </select><br><?php echo getUsersLastAdviserTargetMLEDateString($user_id,$pro_user_id,$arr_mle_id[$i]);?>
                                                                                                                            </div>
