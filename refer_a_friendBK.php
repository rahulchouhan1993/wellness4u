...
$ref = base64_encode('refer_a_friend.php');
if(!isLoggedIn())
{
...
if(isset($_POST['submit']))
{
    ...
    $tdata['message'] = strip_tags(trim($_POST['msg']));
         ...
         else
         {
            ...
            else
            {
				...
				if($id > 0)
				{
					...
					$body = '<p><strong>Hi '.$tdata['user_name'].', </strong><p>';
					$body .= '<p>'.$from_name.' says :'.  ucfirst(trim($tdata['message'])).'</p>';
					...
					*/
					...
					list($email_ar_subject,$email_ar_from_name,$email_ar_from_email,$email_ar_to_email,$email_ar_body) = getEmailAutoresponderDetails('8');
					...
					$subject = str_ireplace("[[FROM_USER]]", $user_data[1], $subject);
					
					$message = $email_ar_body;
					$message = str_ireplace("[[USER_NAME]]", $tdata['user_name'], $message);
					$message = str_ireplace("[[FROM_USER]]", $user_data[1], $message);
                                    ...
                                    <form action='#' method="post">
                                        <table border="0" width="580" cellpadding="0" cellspacing="0">
                                        	<tr>
                                        		...
                                        		<td width="480"  height="30" align="left" valign="top"><input style="width: 200px;" type="text" name="email" id="email" value="<?php echo $tdata['email']; ?>"/><span style="color:red;">*</span></td>
                                        	</tr>
                                        	<tr>
                                            ...
                                            <tr>
                                        		...
                                        		<td height="30" align="left" valign="top"><textarea rows="8" cols="30" name="msg" id="msge"></textarea><span style="color:red;">*</span></td>
                                            </tr>
                                            <tr>
                                        		<td colspan="2" height="30" align="left" valign="top">&nbsp;</td>
                                            </tr>
