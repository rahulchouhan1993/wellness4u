	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">	
					...
					<input type="text" value="<?php echo $account_id;?>" name="account_id"/>
					...
					<input type="text" value="<?php echo $card_brand;?>" name="card_brand"/>
					<input type="text" value="<?php echo $channel;?>" name="channel"/>
					<input type="text" value="<?php echo $city;?>" name="city"/>
					<input type="text" value="<?php echo $country;?>" name="country"/>
					<input type="text" value="<?php echo $currency;?>" name="currency"/>
					<input type="text" value="<?php echo $description;?>" name="description"/>
					<input type="text" value="<?php echo $display_currency;?>" name="display_currency"/>
					<input type="text" value="<?php echo $display_currency_rates;?>" name="display_currency_rates"/>
					<input type="text" value="<?php echo $email;?>" name="email"/>
					<input type="text" value="<?php echo $emi;?>" name="emi"/>
					<input type="text" value="<?php echo $mode;?>" name="mode"/>
					<input type="text" value="<?php echo $name;?>" name="name"/>
					<input type="text" value="<?php echo $ebs_page_id;?>" name="page_id"/>
					<input type="text" value="<?php echo $payment_mode;?>" name="payment_mode"/>
					<input type="text" value="<?php echo $payment_option;?>" name="payment_option"/>
					<input type="text" value="<?php echo $phone;?>" name="phone"/>
					<input type="text" value="<?php echo $postal_code;?>" name="postal_code"/>
					<input type="text" value="<?php echo $reference_no;?>" name="reference_no"/>
					<input type="text" value="<?php echo $return_url; ?>" name="return_url"/>
					<input type="text" value="<?php echo $ship_address;?>" name="ship_address"/>
					<input type="text" value="<?php echo $ship_city;?>" name="ship_city"/>
					<input type="text" value="<?php echo $ship_country;?>" name="ship_country"/>
					<input type="text" value="<?php echo $ship_name;?>" name="ship_name"/>
					<input type="text" value="<?php echo $ship_phone;?>" name="ship_phone"/>
					<input type="text" value="<?php echo $ship_postal_code;?>" name="ship_postal_code"/>
					<input type="text" value="<?php echo $ship_state;?>" name="ship_state"/>
		...
		<div class="row">
			...
			<div class="col-md-4">
				...
				<div style="float:left;width:100%;margin:20px;">
					...
					<p class="payment_msg">Donot refresh/reload the page</p>
				</div>
			</div>
			<div class="col-md-4">
