											...
											{ ?>
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    ...
                                                    <tr id="tr_err_date" style="display:<?php echo $tr_err_date;?>;" valign="top">
														...
														<td align="left" colspan="4" class="err_msg" id="err_date" valign="top"><?php echo $err_date;?></td>
												...
												<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#999999" >
													...
													<tr>
														...
														<td width="100%" align="left" valign="top" bgcolor="#E1E1E1" class="report_header">&nbsp;&nbsp;Stressbuster Intensity Report</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left">
                                                            ...
                                                            <form action="#" method="post" name="frmpdfreports" id="frmpdfreports">
                                                                ...
                                                                <input type="submit" name="btnPdfReport" id="btnPdfReport" value="Save to Excel" class="btn btn-primary" />
