...
$obj->debuglog('[EDIT_DISCOUNT_COUPON] REQUEST:<pre>'.print_r($_REQUEST,true).'</pre>');
...
if(isset($_POST['btnSubmit']))
{
	...
	$dc_status = strip_tags(trim($_POST['dc_status']));
	...
	elseif($obj->chkIfDiscountCouponAlreadyExists_Edit($discount_coupon,$dc_id))
	{
		$error = true;
	...
	if(!$error)
	{
		...
		$tdata['dc_status'] = $dc_status;
		$tdata['modified_by_admin'] = 0;
		$tdata['vendor_id'] = $adm_vendor_id;
		if($obj->updateDiscountCoupon($tdata))
		{
