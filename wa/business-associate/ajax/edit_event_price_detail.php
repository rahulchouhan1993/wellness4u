...

{
    ...
    $event_loc_price_id = strip_tags(trim($_POST['event_loc_price_id'])); //add by ample 15-09-20
...

	{
		...
		$tdata['event_id'] = $event_id;
            ...
            $tdata['event_loc_price_id'] = $event_loc_price_id;
...
//		$tdata['ordering_size_show'] = $arr_ordering_size_show;
		...
		if($obj->updateEventPriceDetail($tdata))
