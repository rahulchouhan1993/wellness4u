	...
	<div class="row">
		<div class="col-md-10">
			<div class="panel">
				...
				<?php
				if($obj->chkIfAccessOfMenuAction($vendor_id,$add_action_id))
				{ ?>
				...
				<?php
				if($obj->chkIfAccessOfMenuAction($vendor_id,$view_action_id))
				{ ?>
...
<?php
if($obj->chkIfAccessOfMenuAction($vendor_id,$delete_action_id))
{ ?>	
