...
if(isset($_GET['token']) && $_GET['token'] != '')
{
	...
	if($arr_record['vendor_id'] != $adm_vendor_id)
	{
		header("Location: manage_cusines.php");
		exit(0);
	}
				...
				<div class="panel-body">
					...
					{ ?>	
						...
						{ ?>
							...
							{ ?>
								<input type="hidden" name="cucat_parent_cat_id[]" id="cucat_parent_cat_id_<?php echo $i;?>" value="<?php echo $arr_cucat_parent_cat_id[$i];?>">	
							<?php
							} ?>
							...
							{ ?>
								<input type="hidden" name="cucat_cat_id[]" id="cucat_cat_id_<?php echo $i;?>" value="<?php echo $arr_cucat_cat_id[$i];?>">	
							<?php
							} ?>
