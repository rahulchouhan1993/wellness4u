var Script = function () {
	$.validator.setDefaults({
		...
		{ 
			var formData = new FormData($('#edit_discount_coupon')[0]);
			...
			jQuery.ajax({
				url: 'ajax/edit_discount_coupon.php',
				type: "POST",
				data:formData,
				processData: false,
				contentType: false,
				beforeSend: function(){ $("#loader").show();$("#btnSubmit").hide();},
