...
if(isset($_GET['token']) && $_GET['token'] != '' && !empty($_GET['event'] != ''))

{
    ...
    $event_id = base64_decode($_GET['event']);
    ...
    $arr_event_id=array(); //add by ample 09-10-20
    ...
    $arr_participants_profile = array();
...

	{
            ...
            {
                array_push($arr_event_id,$arr_loc_record[$i]['event_id']); //add by ample 09-10-20
                ...
                //add by ample
                // array_push($arr_participants_profile, $arr_loc_record[$i]['participants_profile']);
               ...
               // $arr_cert_cnt[$i] = $arr_cert_total_cnt[$i] - 1;
                 ...
                 $arr_vc_cert_total_cnt[$i] = count($arr_loc_record[$i]['participant_certificate']);

                 $arr_vc_cert_cnt[$i] = $arr_vc_cert_total_cnt[$i] - 1;
                ...
                for($k=0;$k<count($arr_loc_record[$i]['participant_certificate']);$k++)

                {

                  array_push($arr_vc_cert_id[$i], $arr_loc_record[$i]['participant_certificate'][$k]['certificate_type']);

                  array_push($arr_vc_cert_type_id[$i], $arr_loc_record[$i]['participant_certificate'][$k]['certificate_type']);

                  array_push($arr_vc_cert_name[$i], $arr_loc_record[$i]['participant_certificate'][$k]['certificate_name']);

                  array_push($arr_vc_cert_no[$i], $arr_loc_record[$i]['participant_certificate'][$k]['certificate_number']);

                  array_push($arr_vc_cert_issued_by[$i], $arr_loc_record[$i]['participant_certificate'][$k]['certificate_issue_by']);

                  

                  if($arr_loc_record[$i]['participant_certificate'][$k]['certificate_issue_date'] != '' && $arr_loc_record[$i]['participant_certificate'][$k]['certificate_issue_date'] != '0000-00-00')

                  {

                    $arr_vc_cert_reg_date[$i][$k] = date('d-m-Y',strtotime($arr_loc_record[$i]['participant_certificate'][$k]['certificate_issue_date']));
                  ...
                  if($arr_loc_record[$i]['participant_certificate'][$k]['certificate_validity_date'] != '' && $arr_loc_record[$i]['participant_certificate'][$k]['certificate_validity_date'] != '0000-00-00')

                  {

                    $arr_vc_cert_validity_date[$i][$k] = date('d-m-Y',strtotime($arr_loc_record[$i]['participant_certificate'][$k]['certificate_validity_date']));
                  ...
                  array_push($arr_vc_cert_scan_file[$i], $arr_loc_record[$i]['participant_certificate'][$k]['certificate_scan_copy']);
		...
		<div class="col-sm-10">
			...
			<div class="panel">
				...
				<div class="panel-body">
					...
					<form role="form" class="form-horizontal" id="add_event_info" name="add_event_info" enctype="multipart/form-data" method="post"> 
					...
					{ ?>
						...
						<div id="row_loc_<?php if($i == 0){ echo 'first';}else{ echo $i;}?>" style="border:1px solid #CCC;padding:5px;margin: 10px 0px;">
							...
							<div class="form-group left-label">
                                ...
                                <input type="hidden" name="event_id" value="<?=base64_decode($_GET['event'])?>" />
           ...
           <div class="form-group">
             ...
             <div class="form-group">
                               ...
                               <option value="">To Time</option>
								...
								{ ?>
									...
									<?php		
										...
										<a href="javascript:void(0);" onclick="removeFileOfRow('venue_image_file_<?php echo $i;?>');" class="btn btn-default btn-sm" data-toggle="tooltip" data-placement="right" title="Remove it" style="margin-bottom:10px;" data-original-title=""><i class="fa fa-remove"></i></a>
                ...
                <?php
								...
								{ ?>
									...
									<?php		
										...
										<a href="javascript:void(0);" onclick="removeFileOfRow('event_image_file_<?php echo $i;?>');" class="btn btn-default btn-sm" data-toggle="tooltip" data-placement="right" title="Remove it" style="margin-bottom:10px;" data-original-title=""><i class="fa fa-remove"></i></a>
              ...
              <!-- <div class="form-group">
                ...
                <label class="col-lg-2 control-label">Participants Profile</label>

                <div class="col-lg-4">

                  <select  name="participants_profile[]" id="participants_profile_<?php echo $i;?>" class="form-control" required>        
                     <option value="">Select Profile</option>                                                                     
                    <?php echo $participants_profile=$obj->getFavCategoryRamakant('69',$arr_participants_profile[$i]);?>
								...
								<div class="col-lg-4">
									...
									<select  name="participants_title[]" id="participants_title_<?php echo $i;?>" class="form-control" required>                                                                              
                                                                                ...
                                                                                <option value="Other" <?php if($arr_participants_title[$i] == 'Other') { echo 'selected';  } ?>>Other</option>
							...
							<!-- <?php 
              // update by ample
							for($k=0;$k<$arr_vc_cert_total_cnt[$i];$k++)
                  ...
                  <?php
                                ...
                                { ?>
                                    ...
                                    <?php       
                                        ...
                                        <a href="javascript:void(0);" onclick="removeFileOfRow('org_cert_scan_file_<?php echo $i;?>_<?php echo $k;?>');" class="btn btn-default btn-sm" data-toggle="tooltip" data-placement="right" title="Remove it" style="margin-bottom:10px;" data-original-title=""><i class="fa fa-remove"></i></a>
...
<script src="admin-js/edit-event-loc-validator.js" type="text/javascript"></script>
