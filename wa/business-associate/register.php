					...
					<form role="form" class="form-horizontal" id="register" name="register" enctype="multipart/form-data" method="post"> 
						...
						<label class="col-lg-2 control-label">Admin Email<span style="color:red">*</span></label>
							...
							<div class="col-lg-4">
								...
								<input type="text" name="vendor_email" id="vendor_email" value="<?php echo $vendor_email;?>" placeholder="Vendor Email" class="form-control" onchange="get_referal_id()" required>
               ...
               //                               		if (in_array($value, $food_products_offered))
						...
						<label class="col-lg-2 control-label">Reference ID</label>
							...
							<div class="col-lg-4">
								...
								<input type="text" name="reference_id" id="reference_id" value="<?php echo $reference_id;?>" placeholder="Reference ID (Optional)" class="form-control" onchange="get_reference_name()">
                              	...
                              	<div class="col-lg-6"><span id='reference_name' style="font-weight: 600;padding-left: 5px;"></span></div>                        
...
<!--									<select name="city_id[]" id="city_id_<?php echo $i;?>" onchange="getAreaOptionAddMore(<?php echo $i;?>)" class="form-control" required>
							...
							{ ?>	
								...
								<div class="col-lg-10">
									...
									<select name="vloc_speciality_offered_<?php echo $i;?>[]" id="vloc_speciality_offered_<?php echo $i;?>" multiple="multiple" class="form-control vloc_speciality_offered" >
										 ...
										 //echo $obj->getFavCategoryVendor('13,53,42,64',''); 
               ...
               //                               		if (in_array($value, $arr_vloc_speciality_offered[$i]))
					...
					<?php 
						...
						<button type="button" class="btn btn-success" data-toggle="popover" data-placement="right" data-content="Available After Registration" data-original-title="" title="">ADD More Company-Location Details</button>
...
<script>
   ...
   //                                                                              '<?php echo $obj->getFavCategoryRamakant('44','');?>'+
			...
			new_row +=			'<label class="col-lg-2 control-label"><?=($tag_level_2['tag_heading'])? $tag_level_2['tag_heading'] : 'Speciality';?></label>'+
								...
								'<div class="col-lg-10">'+
									...
									'<select name="vloc_speciality_offered_'+cat_cnt+'[]" id="vloc_speciality_offered_'+cat_cnt+'" multiple="multiple" class="form-control vloc_speciality_offered" >'+
										...
										'<?php if(!empty($tag_level_2['tag_data']))
