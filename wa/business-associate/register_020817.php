					...
					{ ?>
						<div id="row_loc_<?php if($i == 0){ echo 'first';}else{ echo $i;}?>" style="border:1px solid #CCC;padding:5px;margin: 10px 0px;">
							...
							{ 
								...
								<div class="col-lg-4">
									<select name="vloc_parent_cat_id[]" id="vloc_parent_cat_id_<?php echo $i;?>" class="form-control"  onchange="getMainCategoryOptionAddMoreCommon('vloc',<?php echo $i;?>,'<?php echo $default_vloc_cat_id;?>');" required  >
	...
	function addMoreRowLocation()
	{
		...
		var new_row = 	'<div id="row_loc_'+cat_cnt+'" style="border:1px solid #CCC;padding:5px;margin: 10px 0px;">'+
			...
			new_row +=			'<label class="col-lg-2 control-label">City<span style="color:red">*</span></label>'+
								'<div class="col-lg-4">'+
									'<select name="city_id[]" id="city_id_'+cat_cnt+'" onchange="getAreaOptionAddMore('+cat_cnt+')" class="form-control" required>'+
