...
public function chkVendorEmailExists($vendor_email)
...

    {
		...
		try {
			...
			$sql = "INSERT INTO `tblvendors` (`vendor_mobile`,`vendor_username`,`vendor_password`,`vendor_email`,`vendor_name`,`vendor_parent_cat_id`,`vendor_cat_id`,`vendor_status`,`vendor_add_date`,`added_by_admin`,`va_id`,`new_vendor`,`vendor_otp`) 

					VALUES (:vendor_mobile,:vendor_username,:vendor_password,:vendor_email,:vendor_name,:vendor_parent_cat_id,:vendor_cat_id,:vendor_status,:vendor_add_date,:added_by_admin,:va_id,:new_vendor,:vendor_otp)";
   ...
   // echo $sql="SELECT DISTINCT(event_id) FROM tbl_event_details WHERE event_master_id IN (SELECT DISTINCT(event_master_id) FROM tbl_event_master WHERE organiser_id = '".$vendor_id."' AND is_deleted = '0')";
...

	{
			...
			$message = str_ireplace("[[USER_EMAIL]]", $to_email, $message);
...
public function getAllEvents($txtsearch='',$status='',$cucat_parent_cat_id='',$cucat_cat_id='',$vendor_id='',$added_by_admin='',$added_date_type='',$added_days_of_month='',$added_days_of_week='',$added_single_date='',$added_start_date='',$added_end_date='',$country_id='',$state_id='',$city_id='',$area_id='',$delivery_date='')

	{
...

		{
			...
			$sql_area_id_str = " AND ( TBD.area_id = '".$area_id."' OR TBD.area_id = '-1' OR TBD.area_id = '-1' OR  FIND_IN_SET(".$area_id.", TBD.area_id) > 0 ) ";
		       ...
		       $sql = "SELECT TBE.*,TBD.event_master_id,TBC.event_master_id
                        ...
                        WHERE TBE.is_deleted = '0' AND TBD.event_deleted = '0' AND TBC.certificate_deleted = '0'  ".$sql_search_str." ".$sql_status_str." ".$sql_vendor_id_str." ".$sql_country_id_str." ".$sql_state_id_str." ".$sql_city_id_str." ".$sql_area_id_str."  ".$sql_added_by_admin_str."   ORDER BY TBE.add_date DESC";	
...
//        echo '</pre>';
		...
		try {
			...
			$STH = $DBH->prepare($sql);
				...
				':reference_number' => addslashes($tdata['reference_number']),
...
public function GetAllEventDetails($txtsearch,$status,$city_id,$area_id,$vendor_id)

   {
		...
		//$sql = "SELECT * from tbl_event_details where `event_status` = 1  and  `end_date` >= '".$date."'  order by event_id ASC";
                ...
                $sql = "SELECT TEM.posted_by,TED.event_add_date,TED.event_id,TED.event_master_id,TED.venue_details,TED.city_id,TED.start_date,TED.event_deleted,TED.start_time,TED.end_date,TED.end_time,TED.event_status,TEM.event_master_id,TEM.reference_number,TEM.organiser_id,TEM.institution_id,TEM.event_name from tbl_event_details TED "
                        ...
                        . " LEFT JOIN tbl_event_master TEM ON TED.event_master_id = TEM.event_master_id WHERE TEM.organiser_id = $vendor_id AND TED.event_status = 1 AND TED.event_deleted = 0 order by TED.event_id ASC";		
...

{
    ...
    $return = false;
        ...
        $sql = "SELECT * FROM `tbladviserreferrals` WHERE `vendor_id` = '".$pro_user_id."' AND `user_email` = '".$user_email."' ";
...
// 
				...
				':vendor_id'=>addslashes($pro_user_id),
...
public function getAllAdviserUserReferrals($vendor_id,$user_id,$status,$invite_start_date,$invite_end_date,$status_start_date,$status_end_date)

{
    ...
    $sql = "SELECT * FROM `tbladviserreferrals` WHERE "
            ...
            // . " ORDER BY request_sent_date";
             ...
             . "(`vendor_id` = '".$vendor_id."' ".$str_sql_user_id1." ".$str_sql_status1." ".$str_sql_invite_date1." ".$str_sql_status_date1." AND `invite_by_user` = '0') "
...

{
    ...
    $sql = "SELECT * FROM `tbladviserreferrals` AS tar "
            ...
            . "LEFT JOIN `tblusers` AS tpf ON tar.user_id = tpf.user_id "

            . "WHERE tar.user_id = '".$user_id."' AND tar.vendor_id = '".$vendor_id."'  AND (tar.request_status = '1' OR tar.request_status = '3')"
...

{
	...
	$sql = "SELECT * FROM `tbladviserreferrals` AS tar "
                ...
                . "LEFT JOIN `tblusers` AS tpu ON tar.pro_user_id = tpu.user_id  "

                . "WHERE tar.user_email = '".$email."' AND tar.invite_by_user = '1' AND tar.request_status = '1' "
	...
	$STH = $DBH->query($sql);
        ...
        $sql = "SELECT * FROM `tbladviserreferrals` AS tar "
                ...
                . "LEFT JOIN `tblusers` AS tpu ON tar.user_email = tpu.email  "

                . "WHERE tar.pro_user_id = '".$pro_user_id."' AND tar.invite_by_user = '0' AND tar.request_status = '1'  "
...
public function showUserQueryPopup($pro_user_id,$parent_aq_id)
				...
				<form id="frmadviserquery" name="frmadviserquery" method="post" action="#" enctype="multipart/form-data">
					...
					<table cellpadding="0" cellspacing="0" width="75%" align="center" border="0">
						...
						<tr>
							...
							<td width="40%" height="40" align="left" valign="top">'.$this->getReportTypeName($temp_page_id).'</td>
...

{
	...
	$output .= '		<tr>
		...
		$output .= '		<tr>
							...
							<td colspan="2" height="30" align="left" valign="middle"><strong><input type="button" name="btnDoAccept" id="btnDoAccept" value="Activate" onclick="activateUserInvitation(\''.$ar_id.'\',\''.$pro_user_id.'\',\''.$vendor_id.'\')" />&nbsp;&nbsp;<input type="button" name="btnCancelPopup" id="btnCancelPopup" value="Cancel" /></strong></td>
...

{
	...
	$output .= '		<tr>
		...
		$output .= '		<tr>
							...
							<td colspan="2" height="30" align="left" valign="middle"><strong><input type="button" name="btnDoAccept" id="btnDoAccept" value="Deactivate" onclick="deactivateUserInvitation(\''.$ar_id.'\',\''.$pro_user_id.'\',\''.$vendor_id.'\')" />&nbsp;&nbsp;<input type="button" name="btnCancelPopup" id="btnCancelPopup" value="Cancel" /></strong></td>
...
public function deactivateUserInvitation($ar_id,$user_id,$pro_user_id,$status_reason,$vendor)
...

{
	...
	$sql = "UPDATE `tbladviserreferrals` SET "
                ...
                . "`request_status` = '3' , `last_status_updated_by_adviser` = '1' "
...

	{
		...
		$sql2 = "INSERT INTO `tbladviseractivation`(`ar_id`,`user_id`,`pro_user_id`,`aa_status`,`aa_status_reason`,`aa_status_updated_by_adviser`,`vendor_id`) VALUES('".$ar_id."','".$user_id."','".$pro_user_id."','3','".addslashes($status_reason)."','1','".$vendor."')";
...
public function activateUserInvitation($ar_id,$user_id,$pro_user_id,$status_reason,$vendor_id)
...

{
	...
	$sql = "UPDATE `tbladviserreferrals` SET "
                ...
                . "`request_status` = '1' , `last_status_updated_by_adviser` = '1' "
...

	{
		...
		$sql2 = "INSERT INTO `tbladviseractivation`(`ar_id`,`user_id`,`pro_user_id`,`aa_status`,`aa_status_reason`,`aa_status_updated_by_adviser`,`vendor_id`) VALUES('".$ar_id."','".$user_id."','".$pro_user_id."','1','".addslashes($status_reason)."','1','".$vendor_id."')";
  ...
  //                       . "WHERE `ar_id` = '".$ar_id."'";
	...
	// {
		...
		$sql = "UPDATE `tbladviserreferrals` SET "
                        ...
                        . "`request_accept_date` = NOW(), `request_status` = '1', `last_status_updated_by_adviser` = '1',`vendor_id`='".$_SESSION['adm_vendor_id']."' "
...

{
	...
	$sql = "SELECT * FROM `tbladviserreferrals` "
                ...
                . "WHERE `user_id` = '".$pro_user_id."' AND `user_email` = '".$user_email."' AND `request_accept_date` = '0000-00-00 00:00:00'";
...

{
	...
	$sql = "UPDATE `tbladviserreferrals` SET "
                ...
                . "`request_accept_date` = NOW() , `request_status` = '2' , `last_status_updated_by_adviser` = '1' "
...
$sql = "SELECT tar.* ,tpu.name FROM `tbladviserreferrals` AS tar "
                ...
                . "WHERE tar.vendor_id = '".$vendor_id."' AND ( tar.request_status = '1' OR tar.request_status = '3') "

                . "GROUP BY tar.user_id ORDER BY tpu.name ASC";
