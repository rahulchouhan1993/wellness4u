...

{
...

    {
		...
		try {
			...
			$sql = "SELECT * FROM `tbl_wa_admin` WHERE `admin_id` = '".$admin_id."' AND `status` = '1' AND `deleted` = '0' ";
...

    {
        ...
        try {
			...
			$sql = "SELECT * FROM `tbl_wa_admin` WHERE `username` = '".$username."' AND `password` = '".md5($password)."' AND `status` = '1' AND `deleted` = '0' ";
...

    {
		...
		try {
			...
			$sql = "SELECT * FROM `tbl_wa_admin` WHERE `admin_id` = '".$admin_id."' AND `password` = '".md5($password)."' AND `deleted` = '0' ";
...

    {
		...
		try {
			...
			$sql = "SELECT * FROM `tbl_wa_admin` WHERE `username` = '".$username."' AND `deleted` = '0' ";
...

    {
        ...
        $sql = "SELECT email FROM `tbl_wa_admin` WHERE `admin_id` = '".$admin_id."' AND `deleted` = '0' ";
...

    {
        ...
        $sql = "SELECT username FROM `tbl_wa_admin` WHERE `admin_id` = '".$admin_id."' AND `deleted` = '0' ";
...

    {
        ...
        $sql = "SELECT * FROM `tbl_wa_admin` WHERE `admin_id` = '".$admin_id."' AND `deleted` = '0' ";
...

    {
		...
		try {
			...
			$sql = "INSERT INTO `tbl_wa_admin` (`username`,`password`,`email`,`fname`,`lname`,`contact_no`,`super_admin`,`am_id`,`aa_id`,`status`) 
...

    {
		...
		try {
			...
			$sql = "UPDATE `tbl_wa_admin` SET `password` = :password WHERE `admin_id` = :admin_id ";
...

    {
        ...
        $sql = "SELECT * FROM `tbl_wa_admin` WHERE `username` = '".$username."' AND `admin_id` != '".$admin_id."' AND `deleted` = '0' ";
...

    {
        ...
        $sql = "SELECT * FROM `tbl_wa_admin` WHERE `email` = '".$email."' AND `deleted` = '0' ";
...

    {
        ...
        $sql = "SELECT * FROM `tbl_wa_admin` WHERE `email` = '".$email."' AND `admin_id` != '".$admin_id."' AND `deleted` = '0' ";
...

	{
...

		{
			...
			$sql = "SELECT TAM.* FROM `tblwaadminmenu` AS TAM WHERE TAM.am_status = '1' AND TAM.am_deleted = '0' AND TAM.parent_am_id = '0' ORDER BY TAM.am_order ASC";	
...

		{
			...
			$sql = "SELECT TAM.* FROM `tblwaadminmenu` AS TAM WHERE TAM.am_status = '1' AND TAM.am_deleted = '0' AND TAM.parent_am_id = '0' AND FIND_IN_SET(TAM.am_id, ( SELECT am_id FROM `tbl_wa_admin` WHERE admin_id = '".$admin_id."' AND `status` = '1' AND `deleted` = '0' )) > 0 ORDER BY TAM.am_order ASC";	
...

			{
...

				{
...

					{
						...
						$sql2 = "SELECT TAM.* FROM `tblwaadminmenu` AS TAM WHERE TAM.am_status = '1' AND TAM.am_deleted = '0' AND TAM.parent_am_id = '".$r['am_id'] ."' ORDER BY TAM.am_order ASC";	
...

					{
						...
						$sql2 = "SELECT TAM.* FROM `tblwaadminmenu` AS TAM WHERE TAM.am_status = '1' AND TAM.am_deleted = '0' AND TAM.parent_am_id = '".$r['am_id'] ."' AND FIND_IN_SET(TAM.am_id, ( SELECT am_id FROM `tbl_wa_admin` WHERE admin_id = '".$admin_id."' AND `status` = '1' AND `deleted` = '0' )) > 0 ORDER BY TAM.am_order ASC";	
...

    {
...

		{
			...
			$sql = "SELECT TAM.* FROM `tblwaadminmenu` AS TAM WHERE TAM.am_status = '1' AND TAM.am_deleted = '0' AND TAM.parent_am_id = '0' AND FIND_IN_SET('".$admin_main_menu_id."', ( SELECT am_id FROM `tbl_wa_admin` WHERE admin_id = '".$admin_id."' AND `status` = '1' AND `deleted` = '0' )) > 0 ORDER BY TAM.am_order ASC";	
...

	{
...

		{
			...
			$sql = "SELECT TAA.* FROM `tblwaadminactions` AS TAA WHERE TAA.aa_status = '1' AND TAA.aa_deleted = '0' AND FIND_IN_SET('".$action_id."', ( SELECT aa_id FROM `tbl_wa_admin` WHERE admin_id = '".$admin_id."' AND `status` = '1' AND `deleted` = '0' )) > 0 ";	
...

	{
		...
		$sql = "SELECT * FROM `tbl_wa_admin` WHERE `super_admin` = '0' AND `deleted` = '0' ".$sql_search_str." ".$sql_status_str." ORDER BY username ASC";	
...

    {
	 ...
	 public function GetParentCategory($cat_id,$parent_cat_id='0') 
...

	{
		...
		$sql = "SELECT * FROM `tblwaadminmenu` WHERE `am_deleted` = '0' ".$sql_search_str." ".$sql_status_str." ".$sql_added_by_admin_str." ".$sql_add_date_str."  ORDER BY am_order ASC ";	
...

    {
        ...
        $sql = "SELECT * FROM `tblwaadminmenu` WHERE `am_title` = '".addslashes($am_title)."' AND `am_deleted` = '0' ";
...

    {
        ...
        $sql = "SELECT * FROM `tblwaadminmenu` WHERE `am_title` = '".addslashes($am_title)."' AND `am_id` != '".$am_id."' AND `am_deleted` = '0' ";
...

    {
		...
		try {
			...
			$sql = "INSERT INTO `tblwaadminmenu` (`am_title`,`am_link`,`am_icon`,`am_order`,`am_status`,`added_by_admin`) 
...

	{
		...
		$sql = "SELECT * FROM `tblwaadminactions` WHERE `am_id` = '".$am_id."' AND `aa_deleted` = '0' ".$sql_search_str." ".$sql_status_str." ".$sql_added_by_admin_str." ".$sql_add_date_str."  ORDER BY aa_add_date ASC ";	
...

    {
		...
		try {
			...
			$sql = "UPDATE `tblwaadminactions` SET 
...

    {
        ...
        $sql = "SELECT * FROM `tblwaadminactions` WHERE `aa_title` = '".addslashes($aa_title)."' AND `am_id` = '".$am_id."' AND `aa_deleted` = '0' ";
...

    {
        ...
        $sql = "SELECT * FROM `tblwaadminactions` WHERE `aa_title` = '".addslashes($aa_title)."' AND `am_id` = '".$am_id."'  AND `aa_id` != '".$aa_id."' AND `aa_deleted` = '0' ";
...

    {
		...
		try {
			...
			$sql = "INSERT INTO `tblwaadminactions` (`am_id`,`aa_title`,`aa_link`,`aa_status`,`added_by_admin`) 
	...
	public function getMainCategoryOption($parent_cat_id,$cat_id,$type='1',$multiple='')
			...
			try {
				...
				//$sql = "SELECT fav_cat_id,fav_cat FROM `tblfavcategory` WHERE 1 ORDER BY fav_cat ASC";	
				 ...
				 $sql = "SELECT * FROM `tblcustomfavcategory` "
                                     ...
                                     . "LEFT JOIN tblfavcategory ON tblcustomfavcategory.favcat_id = tblfavcategory.fav_cat_id WHERE $sql_parent_cat_id_str and tblfavcategory.fav_cat_status = 1 and tblfavcategory.fav_cat_deleted = 0 and tblcustomfavcategory.cat_deleted=0 and tblcustomfavcategory.cat_status = 1 ORDER BY tblfavcategory.fav_cat ASC"; 
	...
	public function getDateTypeOptionCustom($date_type)

	{
		...
		$output .= '<option value="single_date" >Single Date</option>';

		$output .= '<option value="date_range" >Date Range</option>';
...

	{
...

		{
...

			{
				...
				$sql_search_str = " AND ( TVR.vendor_name LIKE '%".$txtsearch."%' OR TVR.vendor_id = '".$vc_vendor_id."' OR TVR.vendor_username LIKE '%".$txtsearch."%' )";
...

			{
				...
				$sql_search_str = " AND ( TVR.vendor_name LIKE '%".$txtsearch."%' OR TVR.vendor_username LIKE '%".$txtsearch."%' ) ";	
...

		{
		 ...
		 $sql = "SELECT TVR.*, TBC1.prct_cat_id AS main_profile_id, TBC1.prct_cat AS main_profile, TBC2.fav_cat_id AS category_id, TBC2.fav_cat AS category_name

				FROM `tblvendors` AS TVR 

				LEFT JOIN `tblprofilecustomcategories` AS TBC1 ON TVR.vendor_parent_cat_id = TBC1.prct_cat_id   

				LEFT JOIN `tblfavcategory` AS TBC2 ON TVR.vendor_cat_id = TBC2.fav_cat_id   

				WHERE TVR.vendor_deleted = '0'  
...
public function addVendor($tdata)

    {
		...
		try {
			...
			$sql = "INSERT INTO `tblvendors` (`vendor_username`,`vendor_password`,`vendor_email`,`vendor_name`,`vendor_parent_cat_id`,`vendor_cat_id`,`vendor_status`,`vendor_add_date`,`added_by_admin`,`add_type`,`vendor_mobile`,`food_products_offered`) 

					VALUES (:vendor_username,:vendor_password,:vendor_email,:vendor_name,:vendor_parent_cat_id,:vendor_cat_id,:vendor_status,:vendor_add_date,:added_by_admin,:add_type,:vendor_mobile,:food_products_offered)";
            ...
            $STH->execute(array(
				...
				':food_products_offered' => $tdata['food_products_offered'],
				...
				':added_by_admin' =>$tdata['admin_id'],
                                ...
                                ':vendor_mobile' => $tdata['vendor_mobile']
...

    {
		...
		try {
            ...
            $STH->execute(array(
				...
				':food_products_offered' => addslashes($tdata['food_products_offered']),
...

	{
		...
		try {
			...
			$sql = "SELECT admin_id,username FROM `tbl_wa_admin` WHERE `deleted` = '0' ORDER BY username ASC";	
 ...
 //  	public function getStateNameOfCity($city_id)
	...
	// 					$return = $this->getStateName($r['state_id']);
	...
	public function getAllShippingPrices($txtsearch='',$status='',$added_by_admin='',$added_date_type='',$added_days_of_month='',$added_days_of_week='',$added_single_date='',$added_start_date='',$added_end_date='',$country_id='',$state_id='',$city_id='',$area_id='',$sp_type='',$sp_applied_on='',$sp_effective_date='')

	{
		...
		$sql = "SELECT * FROM `tblshippingprices` 
				...
				WHERE `sp_deleted` = '0' ".$sql_search_str." ".$sql_status_str." ".$sql_country_id_str." ".$sql_state_id_str." ".$sql_city_id_str." ".$sql_area_id_str." ".$sql_added_by_admin_str." ".$sql_add_date_str." ".$sql_sp_type_str." ".$sql_sp_applied_on_str." ".$sql_sp_effective_date_str." ORDER BY sp_add_date DESC";	
...

    {
		...
		try {
			...
			$sql = "UPDATE `tblshippingprices` SET 
					...
					WHERE `sp_id` = :sp_id AND `sp_deleted` != '1' ";
...

    {
		...
		try {
			...
			$sql = "INSERT INTO `tblshippingprices` (`shipping_price`,`min_order_amount`,`max_order_amount`,`sp_type`,`sp_percentage`,`sp_min_qty_id`,
					...
					`sp_area_id`,`sp_comments`,`sp_status`,`sp_add_date`,`added_by_admin`) 
...

    {
		...
		try {
			...
			$sql = "INSERT INTO `tbltaxes` (`tax_parent_cat_id`,`tax_cat_id`,`tax_name`,`tax_type`,`tax_amount`,`tax_percentage`,`tax_qty_id`,`tax_qty_val`,`tax_applied_on`,
					...
					VALUES (:tax_parent_cat_id,:tax_cat_id,:tax_name,:tax_type,:tax_amount,:tax_percentage,:tax_qty_id,:tax_qty_val,:tax_applied_on,
            ...
            $STH->execute(array(
				...
				':tax_parent_cat_id' => addslashes($tdata['tax_parent_cat_id']),

				':tax_cat_id' => addslashes($tdata['tax_cat_id']),
...

    {
		...
		try {
			...
			$sql = "UPDATE `tbltaxes` SET 
					...
					`tax_parent_cat_id` = :tax_parent_cat_id,
	...
	public function getAllOrderDelivery($txtsearch='',$delivery_status='',$delivery_date='',$logistic_partner_type_cat_id='',$logistic_partner_id='',$added_by_admin='',$added_date_type='',$added_days_of_month='',$added_days_of_week='',$added_single_date='',$added_start_date='',$added_end_date='')

	{
...

		{
			...
			$sql_logistic_partner_type_str = " AND ( logistic_partner_type_cat_id = '".$logistic_partner_type_cat_id."' ) ";
		...
		$sql = "SELECT * FROM `tblorderdelivery` 
				...
				WHERE `delivery_deleted` = '0' ".$sql_search_str." ".$sql_delivery_status_str." ".$sql_delivery_date_str." ".$sql_logistic_partner_type_str." ".$sql_logistic_partner_id_str." ".$sql_added_by_admin_str." ".$sql_add_date_str."  ORDER BY delivery_add_date DESC";	
...

    {
		...
		try {
			...
			$sql = "INSERT INTO `tbldiscountcoupons` (`discount_coupon`,`discount_price`,`min_order_amount`,`max_order_amount`,`dc_type`,`dc_percentage`,
					...
					`dc_city_id`,`dc_area_id`,`dc_comments`,`dc_multiuser`,`dc_status`,`dc_add_date`,`added_by_admin`,`dc_trade_discount`) 
...

    {
		...
		try {
			...
			$sql = "UPDATE `tbldiscountcoupons` SET 
					...
					WHERE `dc_id` = :dc_id AND `dc_deleted` != '1' ";
	...
	public function getAllDiscountCoupons($txtsearch='',$status='',$added_by_admin='',$added_date_type='',$added_days_of_month='',$added_days_of_week='',$added_single_date='',$added_start_date='',$added_end_date='',$country_id='',$state_id='',$city_id='',$area_id='',$dc_type='',$dc_applied_on='',$dc_effective_date='')

	{
		...
		$sql = "SELECT * FROM `tbldiscountcoupons` 
				...
				WHERE `dc_deleted` = '0' ".$sql_search_str." ".$sql_status_str." ".$sql_country_id_str." ".$sql_state_id_str." ".$sql_city_id_str." ".$sql_area_id_str." ".$sql_added_by_admin_str." ".$sql_add_date_str." ".$sql_dc_type_str." ".$sql_dc_applied_on_str." ".$sql_dc_effective_date_str." ORDER BY dc_add_date DESC";	
...

			{
...

				{
...

					{
						...
						$output .= '<strong>'.$delivery_name.'</strong><br>';
	...
	public function chkVendorAccessCategoryExists($va_cat_id,$va_sub_cat_id)

    {
        ...
        $sql = "SELECT * FROM `tblvendoraccess` WHERE `va_cat_id` = '".$va_cat_id."' AND va_sub_cat_id IN($va_sub_cat_id) AND `va_deleted` = '0' ";
	...
	public function chkVendorAccessCategoryExists_edit($va_cat_id,$va_id,$va_sub_cat_id)

    {
        ...
        $sql = "SELECT * FROM `tblvendoraccess` WHERE `va_cat_id` = '".$va_cat_id."' AND `va_sub_cat_id` = '".$va_sub_cat_id."' AND `va_id` != '".$va_id."' AND `va_deleted` = '0' ";
...

	{
		...
		echo $sql = "SELECT va_am_id FROM `tblvendoraccess` WHERE `va_id` = '".$va_id."' AND `va_deleted` = '0' ";	
...

	{
		...
		// {
			...
			//comment code and added new conditions by ample 20-07-20
			$sql = "SELECT * FROM `tblvendoraccessformsmaster` WHERE  `vafm_deleted` = '0' ORDER BY vafm_title ASC ";	
...

	{
...

		{
			...
			$arr_records = 	array(
								...
								'rules_regulation_pdf',	

								'institution_profile_pdf',	

								'participants_gender',	

								'participants_special_remark',	

								'participants_from_age_group',	

								'participants_to_age_group',	

								'participants_from_height',	

								'participants_to_height',	

								'participants_from_weight',	

								'participants_to_weight',	

								'vc_certificate_type',	

								'vc_certificate_name',	

								'vc_certificate_number',

                                                                'vc_certificate_issue_by',	

								'vc_certificate_issue_date',	

								'vc_certificate_validity_date',	

								'vc_certificate_scan_copy',	

								'judge_gender',	

								'judge_special_remark',	

								'judge_certificate_type',	

								'judge_certificate_name',	

								'judge_certificate_number',	

								'judge_certificate_issue_by',	

								'judge_certificate_issue_date',

                                                                'judge_certificate_validity_date',	

								'judge_certificate_scan_copy',

								'organiser_facebook_page',	

								'organiser_twitter_page',	

								'organiser_instagram_page',	

								'organiser_youtube_channel',	

								'organiser_gender',	

								'organiser_contact_person',	

								'organiser_email',	

								'organiser_contact_number',

                                                                'organiser_designation',	

								'organiser_remarks',	

								'org_certificate_type',	

								'org_certificate_name',	

								'org_certificate_number',	

								'org_certificate_issue_by',	

								'org_certificate_issue_date',	

								'org_certificate_validity_date',	

								'org_certificate_scan_copy'
...

	{
...

		{
				...
				$output = '	<div style="border:1px solid #CCC;padding:5px;margin: 10px 0px;">
								...
								<div style="border:1px solid #CCC;padding:5px;margin: 10px 0px;">
									...
									<div class="form-group">
										...
										<label class="col-lg-2 control-label">Show Contact Designation</label>
									...
									<div class="form-group">
										...
										<label class="col-lg-2 control-label">Show Remark</label>
									...
									<div class="form-group">
										...
										<label class="col-lg-2 control-label">Show Speciality Offered</label>
									...
									<div class="form-group">
										...
										<label class="col-lg-2 control-label">Show Menu Image/Pdf</label>
...

			{
                                ...
                                $reference_number_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'reference_number');    

                                $wellbeing_id_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'wellbeing_id'); 

                                $organiser_id_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'organiser_id'); 

                                $institution_id_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'institution_id'); 

                                $sponsor_id_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'sponsor_id'); 

                                $event_name_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'event_name'); 

                                $event_contents_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'event_contents'); 

                                

                                $profile_cat_1_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'prof_cat_id_1');    

                                $fav_cat_1_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'fav_cat_id_1'); 

                                $profile_cat_2_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'prof_cat_id_2');    

                                $fav_cat_2_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'fav_cat_id_2'); 

                                $profile_cat_3_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'prof_cat_id_3');    

                                $fav_cat_3_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'fav_cat_id_3'); 

                                $profile_cat_4_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'prof_cat_id_4');    

                                $fav_cat_4_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'fav_cat_id_4'); 

                                $profile_cat_5_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'prof_cat_id_5');    

                                $fav_cat_5_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'fav_cat_id_5'); 

                                

                                $vloc_parent_cat_id_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'location_category');

                                $arr_vloc_parent_cat_id = $this->getVendorAccessFormFieldCategoryValue($va_id,$vafm_id,'location_category');

                                $vloc_cat_id_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'location_sub_category');

                                $arr_vloc_cat_id = $this->getVendorAccessFormFieldCategoryValue($va_id,$vafm_id,'location_sub_category');
                                ...
                                $venue_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'venue_details');    

                                $start_date_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'start_date'); 

                                $start_time_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'start_time');    

                                $end_date_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'end_date'); 

                                $end_time_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'end_time');    

                                $time_zone_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'time_zone_id'); 

                                

                                $venue_image_file_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'venue_image');    

                                $event_image_file_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'event_image'); 

                                $no_of_groups_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'no_of_groups');    

                                $no_of_teams_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'no_of_teams'); 

                                $no_of_participants_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'no_of_participants');    

                                $no_of_judges_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'no_of_judges'); 

                                $vloc_menu_file_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'rules_regulation_pdf');    

                                $vloc_doc_file_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'institution_profile_pdf'); 

                                $participants_title_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'participants_gender');    

                                $parti_remarks_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'participants_special_remark');

                                

                                $from_age_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'participants_from_age_group');    

                                $to_age_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'participants_to_age_group'); 

                                $from_height_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'participants_from_height');    

                                $to_height_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'participants_to_height'); 

                                $from_weight_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'participants_from_weight');    

                                $to_weight_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'participants_to_weight'); 

                                

                                $vc_cert_type_id_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'vc_certificate_type');    

                                $vc_cert_name_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'vc_certificate_name'); 

                                $vc_cert_number_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'vc_certificate_number'); 

                                $vc_cert_issued_by_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'vc_certificate_issue_by');    

                                $vc_cert_reg_date_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'vc_certificate_issue_date'); 

                                $vc_cert_validity_date_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'vc_certificate_validity_date');    

                                $vc_cert_scan_file_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'vc_certificate_scan_copy'); 

                                

                                $judge_title_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'judge_gender');    

                                $judge_remarks_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'judge_special_remark'); 

                                

                                $judge_cert_type_id_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'judge_certificate_type');    

                                $judge_cert_name_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'judge_certificate_name'); 

                                $judge_cert_number_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'judge_certificate_number'); 

                                $judge_cert_issued_by_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'judge_certificate_issue_by');    

                                $judge_cert_reg_date_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'judge_certificate_issue_date'); 

                                $judge_cert_validity_date_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'judge_certificate_validity_date');    

                                $judge_cert_scan_file_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'judge_certificate_scan_copy'); 

                                

                                $facebook_page_link_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'organiser_facebook_page');    

                                $twitter_page_link_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'organiser_twitter_page'); 

                                $instagram_page_link_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'organiser_instagram_page'); 

                                $youtube_page_link_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'organiser_youtube_channel');    

                                $contact_person_title_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'organiser_gender'); 

                                $contact_person_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'organiser_contact_person');    

                                $contact_email_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'organiser_email'); 

                                

                                $contact_number_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'organiser_contact_number');    

                                $contact_designation_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'organiser_designation'); 

                                $contact_remark = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'organiser_remarks'); 

                                

                                $org_cert_type_id_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'org_certificate_type');    

                                $org_cert_name_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'org_certificate_name'); 

                                $org_cert_number_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'org_certificate_number'); 

                                $org_cert_issued_by_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'org_certificate_issue_by');    

                                $org_cert_reg_date_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'org_certificate_issue_date'); 

                                $org_cert_validity_date_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'org_certificate_validity_date');    

                                $org_cert_scan_file_show = $this->getVendorAccessFormFieldShowValue($va_id,$vafm_id,'org_certificate_scan_copy'); 
				...
				$output = '	<div style="border:1px solid #CCC;padding:5px;margin: 10px 0px;">
								...
								<div class="form-group left-label">
									...
									<label class="col-lg-4 control-label"><strong>Event Master:</strong></label>
								...
								<div style="border:1px solid #CCC;padding:5px;margin: 10px 0px;">
									...
									<div class="form-group">
										...
										<label class="col-lg-2 control-label">Reference Number<span style="color:red">*</span></label>

										<div class="col-lg-4">

											<select name="reference_number_show" id="reference_number_show" class="form-control" required>

												'.$this->getShowHideOption($reference_number_show).'

											</select>

										</div>

                                                                                <label class="col-lg-2 control-label">Healthcare / Wellbeing System<span style="color:red">*</span></label>

										<div class="col-lg-4">

											<select name="wellbeing_id_show" id="wellbeing_id_show" class="form-control" required>

												'.$this->getShowHideOption($wellbeing_id_show).'
									...
									<div class="form-group">
										...
										<div class="col-lg-4">
											...
											<select name="organiser_id_show" id="organiser_id_show" class="form-control" required>

												'.$this->getShowHideOption($organiser_id_show).'
										...
										<div class="col-lg-4">
											...
											<select name="institution_id_show" id="institution_id_show" class="form-control" required>

												'.$this->getShowHideOption($institution_id_show).'
                                                                        ...
                                                                        <div class="col-lg-4">
                                                                            ...
                                                                            <select name="sponsor_id_show" id="sponsor_id_show" class="form-control">

                                                                                        '.$this->getShowHideOption($sponsor_id_show).'
                                                                        ...
                                                                        <div class="col-lg-4">
                                                                            ...
                                                                            <select name="event_name_show" id="event_name_show" class="form-control">

                                                                                        '.$this->getShowHideOption($event_name_show).'
									...
									<div class="form-group">
										...
										<div class="col-lg-4">
											...
											<select name="event_contents_show" id="event_contents_show" class="form-control" required>

												'.$this->getShowHideOption($event_contents_show).'
									...
									<div class="form-group">
										...
										<div class="col-lg-4">
											...
											<select name="prof_cat_id_1_show" id="prof_cat_id_1_show" class="form-control">

												'.$this->getShowHideOption($profile_cat_1_show).'
										...
										<div class="col-lg-4">
											...
											<select name="fav_cat_id_1_show" id="fav_cat_id_1_show" class="form-control">

												'.$this->getShowHideOption($fav_cat_1_show).'
										...
										<div class="col-lg-4">
											...
											<select name="prof_cat_id_2_show" id="prof_cat_id_2_show" class="form-control">

												'.$this->getShowHideOption($profile_cat_2_show).'
										...
										<div class="col-lg-4">
											...
											<select name="fav_cat_id_2_show" id="fav_cat_id_2_show" class="form-control">

												'.$this->getShowHideOption($fav_cat_2_show).'
										...
										<div class="col-lg-4">
											...
											<select name="prof_cat_id_3_show" id="prof_cat_id_3_show" class="form-control">

												'.$this->getShowHideOption($profile_cat_3_show).'
										...
										<div class="col-lg-4">
											...
											<select name="fav_cat_id_3_show" id="fav_cat_id_3_show" class="form-control">

												'.$this->getShowHideOption($fav_cat_3_show).'
										...
										<div class="col-lg-4">
											...
											<select name="prof_cat_id_4_show" id="prof_cat_id_4_show" class="form-control">

												'.$this->getShowHideOption($profile_cat_4_show).'
										...
										<div class="col-lg-4">
											...
											<select name="fav_cat_id_4_show" id="fav_cat_id_4_show" class="form-control">

												'.$this->getShowHideOption($fav_cat_4_show).'
										...
										<div class="col-lg-4">
											...
											<select name="prof_cat_id_5_show" id="prof_cat_id_5_show" class="form-control">

												'.$this->getShowHideOption($profile_cat_5_show).'
										...
										<div class="col-lg-4">
											...
											<select name="fav_cat_id_5_show" id="fav_cat_id_5_show" class="form-control">

												'.$this->getShowHideOption($fav_cat_5_show).'
								...
								<div class="form-group left-label">
									...
									<label class="col-lg-4 control-label"><strong>Event Details:</strong></label>
								...
								<div style="border:1px solid #CCC;padding:5px;margin: 10px 0px;">
									...
									<div class="form-group">
										...
										<div class="col-lg-4">
											...
											<select name="location_category_show" id="location_category_show" class="form-control" required>
										...
										<div class="col-lg-4">
											...
											<select name="location_category[]" id="location_parent_cat_id" class="form-control" multiple required onchange="getMainCategoryOptionCommonMultiple(\'location\',\'2\',\'1\');" required>
									...
									<label class="col-lg-2 control-label">Show sub Category<span style="color:red">*</span></label>

										<div class="col-lg-4">

											<select name="location_sub_category_show" id="location_sub_category_show" class="form-control" required>
										...
										<div class="col-lg-4">
											...
											<select name="location_sub_category[]" id="location_cat_id" class="form-control" multiple required>

                                                                                                '.$this->getMainCategoryOption($arr_vloc_parent_cat_id,$arr_vloc_cat_id,1,1).'
									...
									<div class="form-group">
										...
										<label class="col-lg-2 control-label">Show Venue<span style="color:red">*</span></label>

										<div class="col-lg-4">

											<select name="venue_details_show" id="venue_details_show" class="form-control" required>

												'.$this->getShowHideOption($venue_show).'
										...
										<label class="col-lg-2 control-label">Show Start Date<span style="color:red">*</span></label>

										<div class="col-lg-4">

											<select name="start_date_show" id="start_date_show" class="form-control" required>

												'.$this->getShowHideOption($start_date_show).'

											</select>

										</div>

                                                                                <label class="col-lg-2 control-label">Show Start Time<span style="color:red">*</span></label>

										<div class="col-lg-4">

											<select name="start_time_show" id="start_time_show" class="form-control" required>

												'.$this->getShowHideOption($start_time_show).'
										...
										<label class="col-lg-2 control-label">Show End Date<span style="color:red">*</span></label>

										<div class="col-lg-4">

											<select name="end_date_show" id="end_date_show" class="form-control" required>

												'.$this->getShowHideOption($end_date_show).'

											</select>

										</div>

                                                                                <label class="col-lg-2 control-label">Show End Time<span style="color:red">*</span></label>

										<div class="col-lg-4">

											<select name="end_time_show" id="end_time_show" class="form-control" required>

												'.$this->getShowHideOption($end_time_show).'
									...
									<div class="form-group">
										...
										<label class="col-lg-2 control-label">Show Time Zone</label>

										<div class="col-lg-4">

											<select name="time_zone_id_show" id="time_zone_id_show" class="form-control">

												'.$this->getShowHideOption($time_zone_show).'
									...
									<div class="form-group">
										...
										<label class="col-lg-2 control-label">Show Venue Image/Pdf<span style="color:red">*</span></label>

										<div class="col-lg-4">

											<select name="venue_image_show" id="venue_image_show" class="form-control" required>

												'.$this->getShowHideOption($venue_image_file_show).'

											</select>

										</div>

                                                                                <label class="col-lg-2 control-label">Show Event Image/Pdf<span style="color:red">*</span></label>

										<div class="col-lg-4">

											<select name="event_image_show" id="event_image_show" class="form-control" required>

												'.$this->getShowHideOption($event_image_file_show).'
									...
									<div class="form-group">
										...
										<label class="col-lg-2 control-label">Show No of Groups<span style="color:red">*</span></label>

										<div class="col-lg-4">

											<select name="no_of_groups_show" id="no_of_groups_show" class="form-control" required>

												'.$this->getShowHideOption($no_of_groups_show).'

											</select>

										</div>

                                                                                <label class="col-lg-2 control-label">Show No of Teams<span style="color:red">*</span></label>

										<div class="col-lg-4">

											<select name="no_of_teams_show" id="no_of_teams_show" class="form-control" required>

												'.$this->getShowHideOption($no_of_teams_show).'
										...
										<label class="col-lg-2 control-label">Show No of Participants per team<span style="color:red">*</span></label>

										<div class="col-lg-4">

											<select name="no_of_participants_show" id="no_of_participants_show" class="form-control" required>

												'.$this->getShowHideOption($no_of_participants_show).'

											</select>

										</div>

                                                                                <label class="col-lg-2 control-label">Show No of Judges<span style="color:red">*</span></label>

										<div class="col-lg-4">

											<select name="no_of_judges_show" id="no_of_judges_show" class="form-control" required>

												'.$this->getShowHideOption($no_of_judges_show).'
										...
										<label class="col-lg-2 control-label">Show Rules and regulation Image/Pdf<span style="color:red">*</span></label>

										<div class="col-lg-4">

											<select name="rules_regulation_pdf_show" id="rules_regulation_pdf_show" class="form-control" required>
												...
												'.$this->getShowHideOption($vloc_menu_file_show).'
                                                                                ...
                                                                                <label class="col-lg-2 control-label">Show Institution Profile Pdf<span style="color:red">*</span></label>

										<div class="col-lg-4">

											<select name="institution_profile_pdf_show" id="institution_profile_pdf_show" class="form-control" required>
												...
												'.$this->getShowHideOption($vloc_doc_file_show).'
                                                                        ...
                                                                        <div class="form-group left-label">
                                                                            ...
                                                                            <label class="col-lg-4 control-label"><strong>Participants Criteria:</strong></label>
										...
										<div class="col-lg-4">
											...
											<select name="participants_gender_show" id="participants_gender_show" class="form-control" required>

												'.$this->getShowHideOption($participants_title_show).'

											</select>

										</div>

                                                                                <label class="col-lg-2 control-label">Show Special Remarks</label>

										<div class="col-lg-4">

											<select name="participants_special_remark_show" id="participants_special_remark_show" class="form-control">

												'.$this->getShowHideOption($parti_remarks_show).'
										...
										<label class="col-lg-2 control-label">Show From Age Group<span style="color:red">*</span></label>

										<div class="col-lg-4">

											<select name="participants_from_age_group_show" id="participants_from_age_group_show" class="form-control" required>

												'.$this->getShowHideOption($from_age_show).'

											</select>

										</div>

                                                                                <label class="col-lg-2 control-label">Show To Age Group</label>

										<div class="col-lg-4">

											<select name="participants_to_age_group_show" id="participants_to_age_group_show" class="form-control">

												'.$this->getShowHideOption($to_age_show).'
										...
										<label class="col-lg-2 control-label">Show Height From<span style="color:red">*</span></label>

										<div class="col-lg-4">

											<select name="participants_from_height_show" id="participants_from_height_show" class="form-control" required>

												'.$this->getShowHideOption($from_height_show).'

											</select>

										</div>

                                                                                <label class="col-lg-2 control-label">Show Height To</label>

										<div class="col-lg-4">

											<select name="participants_to_height_show" id="participants_to_height_show" class="form-control">

												'.$this->getShowHideOption($to_height_show).'
										...
										<label class="col-lg-2 control-label">Show Weight From<span style="color:red">*</span></label>

										<div class="col-lg-4">

											<select name="participants_from_weight_show" id="participants_from_weight_show" class="form-control" required>

												'.$this->getShowHideOption($from_weight_show).'

											</select>

										</div>

                                                                                <label class="col-lg-2 control-label">Show Weight To</label>

										<div class="col-lg-4">

											<select name="participants_to_weight_show" id="participants_to_weight_show" class="form-control">

												'.$this->getShowHideOption($to_weight_show).'
								...
								<div class="form-group left-label">
									...
									<label class="col-lg-12 control-label"><strong>Participants Registration, Certification & Memberships:(As applicable)</strong></label>
								...
								<div style="border:1px solid #CCC;padding:5px;margin: 10px 0px;">
									...
									<div class="form-group">
										...
										<div class="col-lg-4">
											...
											<select name="vc_certificate_type_show" id="vc_certificate_type_show" class="form-control" required>
										...
										<div class="col-lg-4">
											...
											<select name="vc_certificate_name_show" id="vc_certificate_name_show" class="form-control"  required  >
										...
										<div class="col-lg-4">
											...
											<select name="vc_certificate_number_show" id="vc_certificate_number_show" class="form-control"  required  >

												'.$this->getShowHideOption($vc_cert_number_show).'
									...
									<div class="form-group">
										...
										<div class="col-lg-4">
											...
											<select name="vc_certificate_issue_by_show" id="vc_certificate_issue_by_show" class="form-control" required>
										...
										<div class="col-lg-4">
											...
											<select name="vc_certificate_issue_date_show" id="vc_certificate_issue_date_show" class="form-control" required  >
									...
									<div class="form-group">
										...
										<div class="col-lg-4">
											...
											<select name="vc_certificate_validity_date_show" id="vc_certificate_validity_date_show" class="form-control" required>
										...
										<div class="col-lg-4">
											...
											<select name="vc_certificate_scan_copy_show" id="vc_certificate_scan_copy_show" class="form-control" required  >
												...
												'.$this->getShowHideOption($vc_cert_scan_file_show).'
                                                                     ...
                                                                     <div class="form-group left-label">
                                                                            ...
                                                                            <label class="col-lg-12 control-label"><strong>Judge Criteria:</strong></label>
										...
										<div class="col-lg-4">
											...
											<select name="judge_gender_show" id="judge_gender_show" class="form-control" required>

												'.$this->getShowHideOption($judge_title_show).'

											</select>

										</div>

										<label class="col-lg-2 control-label">Show Special Remarks<span style="color:red">*</span></label>

										<div class="col-lg-4">

											<select name="judge_special_remark_show" id="judge_special_remark_show" class="form-control" required  >

												'.$this->getShowHideOption($judge_remarks_show).'
									...
									<label class="col-lg-12 control-label"><strong>Judge Registration, Certification & Memberships:(As applicable)</strong></label>
								...
								<div style="border:1px solid #CCC;padding:5px;margin: 10px 0px;">
									...
									<div class="form-group">
										...
										<div class="col-lg-4">
											...
											<select name="judge_certificate_type_show" id="judge_certificate_type_show" class="form-control" required>

												'.$this->getShowHideOption($judge_cert_type_id_show).'
										...
										<div class="col-lg-4">
											...
											<select name="judge_certificate_name_show" id="judge_certificate_name_show" class="form-control"  required  >

												'.$this->getShowHideOption($judge_cert_name_show).'
										...
										<div class="col-lg-4">
											...
											<select name="judge_certificate_number_show" id="judge_certificate_number_show" class="form-control"  required  >

												'.$this->getShowHideOption($judge_cert_number_show).'
									...
									<div class="form-group">
										...
										<div class="col-lg-4">
											...
											<select name="judge_certificate_issue_by_show" id="judge_certificate_issue_by_show" class="form-control" required>

												'.$this->getShowHideOption($judge_cert_issued_by_show).'
										...
										<div class="col-lg-4">
											...
											<select name="judge_certificate_issue_date_show" id="judge_certificate_issue_date_show" class="form-control" required  >

												'.$this->getShowHideOption($judge_cert_reg_date_show).'
									...
									<div class="form-group">
										...
										<div class="col-lg-4">
											...
											<select name="judge_certificate_validity_date_show" id="judge_certificate_validity_date_show" class="form-control" required>

												'.$this->getShowHideOption($judge_cert_validity_date_show).'
										...
										<div class="col-lg-4">
											...
											<select name="judge_certificate_scan_copy_show" id="judge_certificate_scan_copy_show" class="form-control" required  >

												'.$this->getShowHideOption($judge_cert_scan_file_show).'
                                                                    ...
                                                                    <div class="form-group left-label">
                                                                            ...
                                                                            <label class="col-lg-12 control-label"><strong>Organiser Social Media Details:</strong></label>

                                                                        </div>

                                                                        <div class="form-group">

										<label class="col-lg-2 control-label">Show Facebook<span style="color:red">*</span></label>

										<div class="col-lg-4">

											<select name="organiser_facebook_page_show" id="organiser_facebook_page_show" class="form-control" required>

												'.$this->getShowHideOption($facebook_page_link_show).'

											</select>

										</div>

										<label class="col-lg-2 control-label">Show Twitter<span style="color:red">*</span></label>

										<div class="col-lg-4">

											<select name="organiser_twitter_page_show" id="organiser_twitter_page_show" class="form-control" required  >

												'.$this->getShowHideOption($twitter_page_link_show).'
										...
										<label class="col-lg-2 control-label">Show Instagram<span style="color:red">*</span></label>

										<div class="col-lg-4">

											<select name="organiser_instagram_page_show" id="organiser_instagram_page_show" class="form-control" required>

												'.$this->getShowHideOption($instagram_page_link_show).'

											</select>

										</div>

										<label class="col-lg-2 control-label">Show Youtube<span style="color:red">*</span></label>

										<div class="col-lg-4">

											<select name="organiser_youtube_channel_show" id="organiser_youtube_channel_show" class="form-control" required  >

												'.$this->getShowHideOption($youtube_page_link_show).'
                                                                        ...
                                                                        <div class="form-group left-label">
                                                                            ...
                                                                            <label class="col-lg-12 control-label"><strong>Organiser Contact Details:</strong></label>
										...
										<div class="col-lg-4">
											...
											<select name="organiser_gender_show" id="organiser_gender_show" class="form-control" required>
										...
										<div class="col-lg-4">
											...
											<select name="organiser_contact_person_show" id="organiser_contact_person_show" class="form-control" required  >
										...
										<div class="col-lg-4">
											...
											<select name="organiser_email_show" id="organiser_email_show" class="form-control" required>
										...
										<div class="col-lg-4">
											...
											<select name="organiser_contact_number_show" id="organiser_contact_number_show" class="form-control" required  >
										...
										<div class="col-lg-4">
											...
											<select name="organiser_designation_show" id="organiser_designation_show" class="form-control" required>
										...
										<div class="col-lg-4">
											...
											<select name="organiser_remarks_show" id="organiser_remarks_show" class="form-control" required  >

												'.$this->getShowHideOption($contact_remark).'
									...
									<label class="col-lg-12 control-label"><strong>Organisers Licences, Registration, Certification & Memberships:</strong></label>
								...
								<div style="border:1px solid #CCC;padding:5px;margin: 10px 0px;">
									...
									<div class="form-group">
										...
										<div class="col-lg-4">
											...
											<select name="org_certificate_type_show" id="org_certificate_type_show" class="form-control" required>

												'.$this->getShowHideOption($org_cert_type_id_show).'
										...
										<div class="col-lg-4">
											...
											<select name="org_certificate_name_show" id="org_certificate_name_show" class="form-control"  required  >

												'.$this->getShowHideOption($org_cert_name_show).'
										...
										<div class="col-lg-4">
											...
											<select name="org_certificate_number_show" id="org_certificate_number_show" class="form-control"  required  >

												'.$this->getShowHideOption($org_cert_number_show).'
									...
									<div class="form-group">
										...
										<div class="col-lg-4">
											...
											<select name="org_certificate_issue_by_show" id="org_certificate_issue_by_show" class="form-control" required>

												'.$this->getShowHideOption($org_cert_issued_by_show).'
										...
										<div class="col-lg-4">
											...
											<select name="org_certificate_issue_date_show" id="org_certificate_issue_date_show" class="form-control" required  >

												'.$this->getShowHideOption($org_cert_reg_date_show).'
									...
									<div class="form-group">
										...
										<div class="col-lg-4">
											...
											<select name="org_certificate_validity_date_show" id="org_certificate_validity_date_show" class="form-control" required>

												'.$this->getShowHideOption($org_cert_validity_date_show).'
										...
										<div class="col-lg-4">
											...
											<select name="org_certificate_scan_copy_show" id="org_certificate_scan_copy_show" class="form-control" required  >

												'.$this->getShowHideOption($org_cert_scan_file_show).'
	...
	public function sendProfileActivationEmailToVendor($email)

	{
...

        {
			...
			$subject = "Your business associate profile is activated";
			...
			$emailHTML .= '<p>Your profile is successfully activated at Tastes of states.</p>';

			$emailHTML .= '<p>Please <a href="'.BA_URL.'">Click here</a> to login.</p>';

			$emailHTML .= '<p>Or Copy and paste the link into browser :'.BA_URL.'.</p>';
			...
			$subject = "New Business Associate profile is activated";
			...
			$emailHTML .= '<p>New Business associate profile is activated with name:'.$fname.'.</p>';
			...
			// SENDSMS TO VENDOR - PROFILE ACTIVATION - START

			$tdata_sms_vendor = array();

			$tdata_sms_vendor['mobile_no'] = $this->getVendorContactNumber($vendor_id);

			$tdata_sms_vendor['sms_message'] = "Dear ".$fname.",Your business associate profile at Tastes of States is activated";

			$obj->sendSMS($tdata_sms_vendor);		

			// SENDSMS TO VENDOR - PROFILE ACTIVATION - END

			

			// SENDSMS TO ADMIN - PROFILE ACTIVATION - START

			$tdata_sms_admin = array();

			$tdata_sms_admin['mobile_no'] = '8828033111';

			$tdata_sms_admin['sms_message'] = "Dear Admin, business associate profile of ".$fname." is activated";

			$obj->sendSMS($tdata_sms_admin);

			// SENDSMS TO ADMIN - PROFILE ACTIVATION - END
	...
	public function chkIfNewVendor($vendor_id)

    {
		...
		try {
			...
			$sql = "SELECT * FROM `tblvendors` WHERE `vendor_id` = '".$vendor_id."' AND `vendor_status` = '0' AND `new_vendor` = '1' AND `vendor_deleted` = '0' ";

			$this->debuglog('[chkIfNewVendor] sql:'.$sql);
			...
			$stringData = '[chkIfNewVendor] Catch Error:'.$e->getMessage().' , sql:'.$sql;
	...
	public function getCommaSepratedVendorInvoiceIdsOfInvoice($invoice)
...

		{
...

			{
...

				{
					...
					$arr_vendor_id[] = $invoice.'-'.$arr_cusine_records['vendor_id'];
   ...
   public function getFavCategoryTypeOptions($prct_cat_id)
...

	{
		...
		try {
                    ...
                    . "LEFT JOIN tblfavcategory ON tblcustomfavcategory.favcat_id = tblfavcategory.fav_cat_id WHERE tblcustomfavcategory.fav_cat_type_id = '".$parent_cat_id."' and tblcustomfavcategory.cat_deleted ='0' and tblfavcategory.fav_cat_status = 1 ORDER BY tblfavcategory.fav_cat ASC";
    ...
    //Ramakant code started on 23/10/2018

    

    public function getAllCategoryChkeckbox($parent_cat_id,$arr_selected_cat_id,$cat_id='',$adviser_panel = '',$width = '300',$height = '250')
           ...
           $sql = "SELECT * FROM `tblcustomfavcategory` "
...

            {
...

                {
                    ...
                    $output .= '<li style="padding:0px;width:'.$liwidth.'px;float:left;"><input type="checkbox" '.$selected.' name="selected_cat_id[]" id="selected_cat_id1_'.$i.'" value="'.$prct_cat_id.'"  />&nbsp;<strong>'.$cat_name.'</strong></li>';
...
//            $DBH->beginTransaction();
...

	{
        ...
        public function getVendorAccessFormOptionRam($va_id,$vafm_id,$type='1')

	{
...

		{
			...
			$output = $this->getFavCatBYProfileId($vafm_id,'');
...

{
...

	{
		...
		{	              
			...
			$option_str .= '<option value="'.$row['city_id'].'" >'.stripslashes($row['city']).'</option>';
...
public function getCityOptionsKR()
...
public function getPlaceOptions($city_id,$place_id)
...

    {
       ...
       // die('asndjksh');
		...
		try {
			...
			$sql = "INSERT INTO `tbl_event_master`(`reference_number`,`wellbeing_id`,`prof_cat_id_1`, `fav_cat_id_1`, `prof_cat_id_2`, `fav_cat_id_2`, `prof_cat_id_3`, `fav_cat_id_3`, `prof_cat_id_4`, `fav_cat_id_4`, `prof_cat_id_5`, `fav_cat_id_5`, `organiser_id`, `institution_id`, `sponsor_id`, `event_name`, `event_contents`,`posted_by`, `admin_type`,`event_tags`) "

                                . "VALUES (:reference_number,:healcareandwellbeing,:prof_cat_id_1,:fav_cat_id_1,:prof_cat_id_2,:fav_cat_id_2,:prof_cat_id_3,:fav_cat_id_3,:prof_cat_id_4,:fav_cat_id_4,:prof_cat_id_5,:fav_cat_id_5,:organiser_id,:institution_id,:sponsor_id,:event_name,:event_contents,:posted_by,:admin_type,:event_tags)";

			$STH = $DBH->prepare($sql);

                        $STH->execute(array(

				':reference_number' => $this->getnextrefernceNumber(),

                                ':healcareandwellbeing' => addslashes($tdata['healcareandwellbeing']),

				':prof_cat_id_1' => $tdata['profile_cat_1'],

				':fav_cat_id_1' => addslashes($tdata['fav_cat_1']),

				':prof_cat_id_2' => $tdata['profile_cat_2'],

				':fav_cat_id_2' => addslashes($tdata['fav_cat_2']),

				':prof_cat_id_3' => $tdata['profile_cat_3'],

				':fav_cat_id_3' => addslashes($tdata['fav_cat_3']),

				':prof_cat_id_4' => $tdata['profile_cat_4'],

				':fav_cat_id_4' =>addslashes($tdata['fav_cat_4']),

                                ':prof_cat_id_5' =>$tdata['profile_cat_5'],

                                ':fav_cat_id_5' =>addslashes($tdata['fav_cat_5']),

                                ':organiser_id' =>$tdata['organiser_id'],

                                ':institution_id' =>$tdata['institution_id'],

                                ':sponsor_id' =>$tdata['sponsor_id'],

                                ':event_name' =>addslashes($tdata['event_name']),

                                ':event_contents' =>  addslashes($tdata['event_contents']),

                                ':posted_by' =>$tdata['admin_id'],

                                ':admin_type' =>'Admin',

                                ':event_tags' =>$tdata['event_tags']
...
public function addEventLocation($tdata)

    {
		...
		try {
			...
			$sql = "INSERT INTO `tbl_event_details`(`event_master_id`, `location_category`, `location_sub_category`,`country_id`,`state_id`,`city_id`, `area_id`, `venue_details`, `start_date`, `start_time`, `end_date`, `end_time`, `time_zone_id`, `venue_image`, `event_image`, `no_of_groups`, `no_of_teams`, `no_of_participants`, `no_of_judges`, `rules_regulation_pdf`, `institution_profile_pdf`, `participants_gender`, `participants_special_remark`, `participants_from_age_group`, `participants_to_age_group`, `participants_from_height`,`participants_to_height`, `participants_from_weight`,`participants_to_weight`, `judge_gender`, `judge_special_remark`, `organiser_facebook_page`, `organiser_twitter_page`, `organiser_instagram_page`, `organiser_youtube_channel`, `organiser_gender`, `organiser_contact_person`, `organiser_email`, `organiser_contact_number`, `organiser_designation`, `organiser_remarks`,`event_format`,`slot1_start_time`,`slot1_end_time`,`slot2_start_time`,`slot2_end_time`,`slot3_start_time`,`slot3_end_time`,`slot4_start_time`,`slot4_end_time`,`slot5_start_time`,`slot5_end_time`,`slot6_start_time`,`slot6_end_time`,`online_registration_link`,`online_registration_id`) "
                                ...
                                . "VALUES (:event_master_id,:location_category,:location_sub_category,:country_id,:state_id,:city_id,:area_id,:venue_details,:start_date,:start_time,:end_date,:end_time,:time_zone_id,:venue_image,:event_image,:no_of_groups,:no_of_teams,:no_of_participants,:no_of_judges,:rules_regulation_pdf,:institution_profile_pdf,:participants_gender,:participants_special_remark,:participants_from_age_group,:participants_to_age_group,:participants_from_height,:participants_to_height,:participants_from_weight,:participants_to_weight,:judge_gender,:judge_special_remark,:organiser_facebook_page,:organiser_twitter_page,:organiser_instagram_page,:organiser_youtube_channel,:organiser_gender,:organiser_contact_person,:organiser_email,:organiser_contact_number,:organiser_designation,:organiser_remarks,:event_format,:slot1_start_time,:slot1_end_time,:slot2_start_time,:slot2_end_time,:slot3_start_time,:slot3_end_time,:slot4_start_time,:slot4_end_time,:slot5_start_time,:slot5_end_time,:slot6_start_time,:slot6_end_time,:online_registration_link,:online_registration_id)";
			...
			$STH = $DBH->prepare($sql);
				...
				':location_category' => $tdata['location_category'],

				':location_sub_category' =>$tdata['location_sub_category'],
				...
				':venue_details' => addslashes($tdata['venue_details']),

				':start_date' => date("Y-m-d",strtotime($tdata['start_date'])),

				':start_time' => addslashes($tdata['start_time']),

				':end_date' => date("Y-m-d",strtotime($tdata['end_date'])),

				':end_time' => addslashes($tdata['end_time']),

				':time_zone_id' => $tdata['time_zone_id'],

				':venue_image' => addslashes($tdata['venue_image']),

				':event_image' => addslashes($tdata['event_image']),

				':no_of_groups' => $tdata['no_of_groups'],

				':no_of_teams' => $tdata['no_of_teams'],

				':no_of_participants' => $tdata['no_of_participants'],

				':no_of_judges' => $tdata['no_of_judges'],

				':rules_regulation_pdf' => addslashes($tdata['rules_regulation_pdf']),

				':institution_profile_pdf' => addslashes($tdata['institution_profile_pdf']),

				':participants_gender' => addslashes($tdata['participants_gender']),

                                ':participants_special_remark' => addslashes($tdata['participants_special_remark']),

                                ':participants_from_age_group'=>$tdata['participants_from_age_group'],

                                ':participants_to_age_group'=>$tdata['participants_to_age_group'],

                                ':participants_from_height'=>addslashes($tdata['participants_from_height']),

                                ':participants_to_height'=>addslashes($tdata['participants_to_height']),

                                ':participants_from_weight'=>addslashes($tdata['participants_from_weight']),

                                ':participants_to_weight'=>addslashes($tdata['participants_to_weight']),

                                ':judge_gender'=>addslashes($tdata['judge_gender']),

                                ':judge_special_remark'=>addslashes($tdata['judge_special_remark']),

                                ':organiser_facebook_page'=>addslashes($tdata['organiser_facebook_page']),

                                ':organiser_twitter_page'=>addslashes($tdata['organiser_twitter_page']),

                                ':organiser_instagram_page'=>addslashes($tdata['organiser_instagram_page']),

                                ':organiser_youtube_channel'=>addslashes($tdata['organiser_youtube_channel']),

                                ':organiser_gender'=>addslashes($tdata['organiser_gender']),

                                ':organiser_contact_person'=>addslashes($tdata['organiser_contact_person']),

                                ':organiser_email'=>addslashes($tdata['organiser_email']),

                                ':organiser_contact_number'=>addslashes($tdata['organiser_contact_number']),

                                ':organiser_designation'=>addslashes($tdata['organiser_designation']),

                                ':organiser_remarks'=>addslashes($tdata['organiser_remarks']),

                                ':event_format'=>addslashes($tdata['event_format']),

                                ':slot1_start_time'=>addslashes($tdata['slot1_start_time']),

                                ':slot1_end_time'=>addslashes($tdata['slot1_end_time']),

                                ':slot2_start_time'=>addslashes($tdata['slot2_start_time']),

                                ':slot2_end_time'=>addslashes($tdata['slot2_end_time']),

                                ':slot3_start_time'=>addslashes($tdata['slot3_start_time']),

                                ':slot3_end_time'=>addslashes($tdata['slot3_end_time']),

                                ':slot4_start_time'=>addslashes($tdata['slot4_start_time']),

                                ':slot4_end_time'=>addslashes($tdata['slot4_end_time']),

                                ':slot5_start_time'=>addslashes($tdata['slot5_start_time']),

                                ':slot5_end_time'=>addslashes($tdata['slot5_end_time']),

                                ':slot6_start_time'=>addslashes($tdata['slot6_start_time']),

                                ':slot6_end_time'=>addslashes($tdata['slot6_end_time']),

								':online_registration_link' => addslashes($tdata['online_registration_link']), 
								':online_registration_id' => $tdata['online_registration_id']
...

    {
		...
		try {
			...
			$sql = "INSERT INTO `tbl_event_certificates`(`user_id`, `user_type`, `event_master_id`, `event_id`, `certificate_type`, `certificate_name`, `certificate_number`, `certificate_issue_date`, `certificate_issue_by`, `certificate_validity_date`, `certificate_scan_copy`,data_type) "

                                . "VALUES (:user_id,:user_type,:event_master_id,:event_id,:certificate_type,:certificate_name,:certificate_number,:certificate_issue_date,:certificate_issue_by,:certificate_validity_date,:certificate_scan_copy,:data_type)";
			...
			$STH = $DBH->prepare($sql);
				...
				':user_type' => addslashes($tdata['user_type']),

				':event_master_id' => addslashes($tdata['event_master_id']),

				':event_id' => addslashes($tdata['event_id']),

				':certificate_type' => addslashes($tdata['certificate_type']),

				':certificate_name' => addslashes($tdata['certificate_name']),

				':certificate_number' => addslashes($tdata['certificate_number']),

				':certificate_issue_date' => date("Y-m-d",strtotime($tdata['certificate_issue_date'])),

				':certificate_issue_by' => addslashes($tdata['certificate_issue_by']),

				':certificate_validity_date' => date("Y-m-d",strtotime($tdata['certificate_validity_date'])),

				':certificate_scan_copy' => $tdata['certificate_scan_copy'],

				':data_type' => addslashes($tdata['data_type'])
    ...
    public function getAllEvent($txtsearch = '', $status = '', $parent_cat_id = '', $sub_cat_id = '', $vendor_id = '',$added_single_date='',$added_start_date = '', $added_end_date = '')

	{
        ...
        $sql_main_cat_id = "";
        if ($parent_cat_id != '') {
            $sql_main_cat_id = " AND (TBE.prof_cat_id_1 = " . $parent_cat_id . " OR TBE.prof_cat_id_2 = " . $parent_cat_id . " OR TBE.prof_cat_id_3 = " . $parent_cat_id . " OR TBE.prof_cat_id_4 = " . $parent_cat_id . " OR TBE.prof_cat_id_5 = " . $parent_cat_id . ")  ";
        }
        $sql_sub_cat_id = "";
        if ($sub_cat_id != '') {
            $sql_sub_cat_id = " AND (TBE.fav_cat_id_1 = " . $sub_cat_id . " OR TBE.fav_cat_id_2 = " . $sub_cat_id . " OR TBE.fav_cat_id_3 = " . $sub_cat_id . " OR TBE.fav_cat_id_4 = " . $sub_cat_id . " OR TBE.fav_cat_id_5 = " . $sub_cat_id . ")  ";
        }
        ...
        if($added_single_date != '' && $added_single_date != '0000-00-00')

				{
					...
					$sql_add_date_str = " AND DATE(TBE.add_date) = '".date('Y-m-d',strtotime($added_single_date))."' ";	
...

				{
					...
					$sql_add_date_str = " AND DATE(TBE.add_date) >= '".date('Y-m-d',strtotime($added_start_date))."'  AND DATE(TBE.add_date) <= '".date('Y-m-d',strtotime($added_end_date))."' ";	

				}	

		$sql = "SELECT * from tbl_event_master TBE where TBE.is_deleted = 0 " . $sql_search_str . " " . $sql_status_str . " " . $sql_vendor_id_str . " " . $sql_main_cat_id . " " . $sql_sub_cat_id . " ".$sql_add_date_str." order by TBE.event_master_id DESC";
...
public function getAllEventLocation($txtsearch='',$status='',$city_id='',$area_id='',$event_master_id)
...

   {
        ...
        $sql = "SELECT * from tbl_event_master where `event_master_id` = '".$event_master_id."' and `is_deleted` = 0";	
...

   {
		...
		//$sql = "SELECT * from tbl_event_details where `event_status` = 1  and  `end_date` >= '".$date."'  order by event_id ASC";
               ...
               $sql = "SELECT TEM.posted_by,TED.event_add_date,TED.event_id,TED.event_master_id,TED.venue_details,TED.city_id,TED.start_date,TED.event_deleted,TED.start_time,TED.end_date,TED.end_time,TED.event_status,TEM.event_master_id,TEM.reference_number,TEM.organiser_id,TEM.institution_id,TEM.event_name from tbl_event_details TED "

                        . " LEFT JOIN tbl_event_master TEM ON TED.event_master_id = TEM.event_master_id WHERE TED.event_status = 1 AND TED.event_deleted = 0 " . $sql_search_str . " " . $sql_status_str . " " . $sql_main_cat_id . " " . $sql_sub_cat_id . " " . $sql_country_str . " " . $sql_state_str . " " . $sql_city_str . " " . $sql_area_str . " order by TED.event_id ASC";		
...

   {
		...
		//$sql = "SELECT * from tbl_event_details where `event_status` = 1  and  `end_date` >= '".$date."'  order by event_id ASC";
               ...
               $sql = "SELECT TEM.posted_by,TED.event_add_date,TED.event_id,TED.event_master_id,TED.venue_details,TED.city_id,TED.start_date,TED.start_time,TED.end_date,TED.end_time,TED.event_status,TEM.event_master_id,TEM.reference_number,TEM.organiser_id,TEM.institution_id,TEM.event_name,TEM.admin_type from tbl_event_details TED "

                        . " LEFT JOIN tbl_event_master TEM ON TED.event_master_id = TEM.event_master_id WHERE TED.event_status = 1  AND  TED.event_id = '".$event_id."'  order by TED.event_id ASC";		
...
public function addEventPrice($tdata)

    {
		...
		try {
                    ...
                    $sql = "INSERT INTO `tbl_event_price`(`event_id`,`publish_date_type`, `publish_days_of_month`, "

                            . "`publish_days_of_week`, `publish_single_date`, `publish_start_date`, `publish_end_date`, "

                            . "`event_desc_1`, `event_desc_show_1`, `event_desc_2`, `event_desc_show_2`, `event_price_status`, "

                            . "`added_by_admin`,`cancel_cutoff_time`, `cancel_cutoff_time_show`, "

                            . "`cgst_tax`, `sgst_tax`, `cess_tax`, `gst_tax`, `registration_cutoff_time`, `registration_time_show`,`admin_type`) "

                            . "VALUES (:event_id,:publish_date_type,:publish_days_of_month,:publish_days_of_week,:publish_single_date,:publish_start_date,:publish_end_date,:event_desc_1,"

                            . ":event_desc_show_1,:event_desc_2,:event_desc_show_2,:event_price_status,:added_by_admin,:cancel_cutoff_time,:cancel_cutoff_time_show,:cgst_tax,"

                            . ":sgst_tax,:cess_tax,:gst_tax,:registration_cutoff_time,:registration_time_show,:admin_type)";
			...
			$STH = $DBH->prepare($sql);
				...
				':event_desc_1' => addslashes($tdata['cusine_desc_1']),

				':event_desc_show_1' => addslashes($tdata['cusine_desc_show_1']),

				':event_desc_2' => addslashes($tdata['cusine_desc_2']),

				':event_desc_show_2' => addslashes($tdata['cusine_desc_show_2']),

				':event_price_status' => '1',

				':added_by_admin' => addslashes($tdata['added_by_admin']),

                                ':admin_type' => addslashes($tdata['admin_type']),

				':cancel_cutoff_time' => addslashes($tdata['cancel_cutoff_time']),

				':cancel_cutoff_time_show' => addslashes($tdata['cancel_cutoff_time_show']),
				...
				':registration_cutoff_time' => addslashes($tdata['registration_cutoff_time']),

				':registration_time_show' => addslashes($tdata['registration_time_show'])
...

    {
		...
		try {
			...
			$sql = "INSERT INTO `tbl_event_loc_price`(`event_id`, `event_price_id`, `ticket_name`, "

                                . "`ordering_type_id`, `max_order`, `min_order`, `cusine_qty`, `currency_id`, "

                                . "`cusine_price`, `default_price`, `culoc_status`,`culoc_add_date`,"

                                . "`added_by_admin`,`cusine_qty_show`, "

                                . "`sold_qty_show`, `is_offer`, `offer_price`, `offer_date_type`, `offer_days_of_month`, `offer_days_of_week`,"

                                . "`offer_single_date`, `offer_start_date`, `offer_end_date`, `registration_type`, `registration_fees`, "

                                . "`currency_fees`, `registration_criteria`, `discount_date_type`, `discount_days_of_month`, "

                                . "`discount_days_of_week`, `discount_single_date`, `discount_start_date`, `discount_end_date`, "

                                . "`bulk_booking_allowed`, `is_discount_applicable`, `discount_code`,`registration_show`) "

                                . "VALUES (:event_id,:event_price_id,:ticket_name,:ordering_type_id,:max_order,:min_order,:cusine_qty,"

                                . ":currency_id,:cusine_price,:default_price,:culoc_status,:culoc_add_date,:added_by_admin,:cusine_qty_show,"

                                . ":sold_qty_show,:is_offer,:offer_price,:offer_date_type,:offer_days_of_month,:offer_days_of_week,:offer_single_date,:offer_start_date,"

                                . ":offer_end_date,:registration_type,:registration_fees,:currency_fees,:registration_criteria,:discount_date_type,:discount_days_of_month,:discount_days_of_week,"

                                . ":discount_single_date,:discount_start_date,:discount_end_date,:bulk_booking_allowed,:is_discount_applicable,:discount_code,:registration_show)";
			...
			$STH = $DBH->prepare($sql);
				...
				':event_price_id' => addslashes($tdata['event_price_id']),

				':ticket_name' => addslashes($tdata['ticket_name']),
				...
				':offer_end_date' => addslashes($tdata['offer_end_date']),
                                ...
                                ':is_discount_applicable' => addslashes($tdata['is_discount']),

				':discount_code' => addslashes($tdata['discount_code']),

				':discount_date_type' => addslashes($tdata['discount_date_type']),

				':discount_days_of_month' => addslashes($tdata['discount_days_of_month']),

				':discount_days_of_week' => addslashes($tdata['discount_days_of_week']),

				':discount_single_date' => addslashes($tdata['discount_single_date']),

				':discount_start_date' => addslashes($tdata['discount_start_date']),

				':discount_end_date' => addslashes($tdata['discount_end_date']),

                                ':bulk_booking_allowed' => addslashes($tdata['bulk_booking_allowed']),

                                ':registration_type' => addslashes($tdata['registration_type']),

				':currency_fees' => addslashes($tdata['currency_fees']),

				':registration_fees' => addslashes($tdata['registration_fees']),

                                ':registration_criteria' => addslashes($tdata['registration_criteria']),

                                ':registration_show' => addslashes($tdata['registration_show'])
...

    {
        ...
        $sql = "SELECT * FROM `tbl_event_price` WHERE `event_id` = '".$event_id."' AND `event_deleted` = 0 ";
...

    {
		...
		try {
			...
			$STH = $DBH->prepare($sql);
				...
				':publish_single_date' => $tdata['publish_single_date'],

				':publish_start_date' => $tdata['publish_start_date'],

				':publish_end_date' => $tdata['publish_end_date'],
				...
				':event_price_status' => addslashes($tdata['event_status']),

				':event_modified_date' => date('Y-m-d H:i:s'),

				':modified_by_admin' => addslashes($tdata['modified_by_admin']),

				':order_cutoff_time' => addslashes($tdata['order_cutoff_time']),
    ...
    //copy and update by ample 17-09-20
...
//update by ample 30-12-19 & update 16-09-20
				...
				$tdata_vloc = array();
                                ...
                                if($vloc_id > 0)
                                    ...
                                    {	
                                        ...
                                        //add by ample for judge 30-12-19
										for($k=0;$k<count($tdata['judge_cert_type_id'][$i]);$k++)
										{
...

    {
		...
		try {
            ...
            $STH->execute(array(
				...
				':event_updated_date' => date('Y-m-d H:i:s'),

				':event_deleted_by' => $tdata['admin_id'],
...

    {
        ...
        if($tdata['event_id'])
        {
            ...
            $STH->execute(array(
				...
				':certificate_deleted_date' => date('Y-m-d H:i:s'),

				':certificate_deleted_by' => $tdata['admin_id'],
...

{
            ...
            $sql = "SELECT * FROM `tblcustomfavcategory` "
                    ...
                    . "LEFT JOIN tblfavcategory ON tblcustomfavcategory.favcat_id = tblfavcategory.fav_cat_id WHERE tblcustomfavcategory.fav_cat_type_id IN('".$parent_cat_id."') and tblfavcategory.fav_cat_status = 1 and tblfavcategory.fav_cat_deleted = 0 and tblcustomfavcategory.cat_deleted=0 and tblcustomfavcategory.cat_status = 1 ORDER BY tblfavcategory.fav_cat ASC";
			...
			try {
				...
				//$sql = "SELECT fav_cat_id,fav_cat FROM `tblfavcategory` WHERE 1 ORDER BY fav_cat ASC";	
                                ...
                                $sql = "SELECT * FROM `tblcustomfavcategory` "
                                     ...
                                     . "LEFT JOIN tblfavcategory ON tblcustomfavcategory.favcat_id = tblfavcategory.fav_cat_id WHERE ".$sql_parent_cat_id_str." ".$sql_default_cat_id_str." and tblfavcategory.fav_cat_status = 1 and tblfavcategory.fav_cat_deleted = 0 and tblcustomfavcategory.cat_deleted=0 and tblcustomfavcategory.cat_status = 1 ORDER BY tblfavcategory.fav_cat ASC";
...
//            echo '</pre>';
		...
		try {
			...
			$STH = $DBH->prepare($sql);
				...
				':event_start_date' =>  addslashes($tdata['event_start_date']),

				':event_end_date' => addslashes($tdata['event_end_date']),

				':event_start_time' =>$tdata['event_start_time'],

				':event_end_time' => $tdata['event_end_time'],

				':event_days' => $tdata['event_days']
...

{
 ...
 public function getusersponsor($get_fav_cat_id,$adviser_panel,$width,$height,$participant_profile)

        {
           ...
           // $this->connectDB();
            ...
            while($row = $STH->fetch(PDO::FETCH_ASSOC)) 
               ...
               // <div style="width:'.$width.'px;float:left;margin-bottom:20px;">
        ...
        public function getsponsordetails($get_id,$values)

        {
...

            {
             ...
             $sponsor="UPDATE `tblvendors` SET `participant_profile`='".$values."' WHERE `vendor_id`=".$get_id."";

             $STH1 = $DBH->prepare($sponsor);
			...
			$stringData = '[upadtevendor] Catch Error:'.$e->getMessage().', sql:'.$sponsor;
   ...
   //add by ample 30-12-19
    public function addEventCriteria($tdata)
    {
        ...
        $return = 0;
		try {
			$sql = "INSERT INTO `tbl_event_participants_criteria`(`event_master_id`, `event_id`, `profile`, `gender`, `special_remark`, `from_age_group`, `to_age_group`, `from_height`, `to_height`, `from_weight`, `to_weight`,`added_by`) "

                                . "VALUES (:event_master_id,:event_id,:profile,:gender,:special_remark,:from_age_group,:to_age_group,:from_height,:to_height,:from_weight,:to_weight,:added_by)";
				$STH = $DBH->prepare($sql);
                $STH->execute(array(
				':event_master_id' => addslashes($tdata['event_master_id']),
				':event_id' => addslashes($tdata['event_id']),
				':profile' => addslashes($tdata['profile']),
				':gender' => addslashes($tdata['gender']),
				':special_remark' => addslashes($tdata['special_remark']),
				':from_age_group' => addslashes($tdata['from_age_group']),
				':to_age_group' => addslashes($tdata['to_age_group']),
				':from_height' => addslashes($tdata['from_height']),
				':to_height' => addslashes($tdata['to_height']),
				':from_weight' => addslashes($tdata['from_weight']),
				':to_weight' => addslashes($tdata['to_weight']),
				':added_by' => addslashes($tdata['added_by'])
            ));
			$return = $DBH->lastInsertId();
			$DBH->commit();
		} catch (Exception $e) {
...
// write by ample 28-12-19
 ...
 //function added by ample 28-12-19
    ...
    //add by ample 18-09-20
    public function vendorStatusUpdate($id,$status)
    {
        $DBH = new DatabaseHandler();
        $sql = "UPDATE `tblvendors` SET `vendor_status`=".$status." WHERE `vendor_id`=".$id."";
        $STH = $DBH->query($sql);
        if ($STH->rowCount() > 0) {
            return true;
        }
    ...
    public function getAllMyUserInvitations($vendor_id="", $user_id="") {
        ...
        $sql = "SELECT * FROM `tbladviserreferrals` AS tar " . "LEFT JOIN `tblusers` AS tpf ON tar.user_id = tpf.user_id " . "WHERE  (tar.request_status = '1' OR tar.request_status = '3')  ". $search_vendor_id ." ". $search_user_id ." ORDER BY tar.request_sent_date DESC";
        $STH = $DBH->query($sql);
        if ($STH->rowCount() > 0) {
            while ($row = $STH->fetch(PDO::FETCH_ASSOC)) {
                $temp_arr[] = $row;
           ...
           $data = array();
            ...
            if (!empty($data)) {
                foreach ($data as $key => $value) {
                    ...
                    $option_str.= '<option value="' . $value["page_cat_id"] . '|tbl_recordshow_dropdown" '.$sel.'>' . $value["report_name"] . ' </option>';
                }
            }
    ...
    public function getAllAdviserUserQueries($pro_user_id, $user_id, $pg_id, $start_date, $end_date, $search_keywords) {
        ...
        $temp_arr = array();
        if ($pro_user_id != '') {
            $str_sql_pro_user_id = " AND `vendor_id` = '" . $pro_user_id . "' ";
        } else {
            $str_sql_pro_user_id = '';
        }
        if ($user_id != '') {
        ...
        $sql = "SELECT * FROM `tbladviserqueries` WHERE  `parent_aq_id` = '0' AND DATE(aq_add_date) >= '" . date('Y-m-d', strtotime($start_date)) . "' AND DATE(aq_add_date) <= '" . date('Y-m-d', strtotime($end_date)) . "' " . $str_sql_user_id . " " . $str_sql_pro_user_id . " " . $str_sql_pg_id . "  " . $str_sql_search_keywords . "  ORDER BY `aq_add_date` DESC";
        $STH = $DBH->query($sql);
        if ($STH->rowCount() > 0) {
            while ($row = $STH->fetch(PDO::FETCH_ASSOC)) {
                $temp_arr[] = $row;
    ...
    public function getUserFromAdviserReffral($user_id = "") {
        $DBH = new DatabaseHandler();
        $option_str = '';
        $sql = "SELECT DISTINCT tar.user_id ,tpu.name,tpu.unique_id FROM `tbladviserreferrals` AS tar " . "LEFT JOIN `tblusers` AS tpu ON tar.user_id = tpu.user_id " . "WHERE tpu.user_deleted=0 GROUP BY tar.user_id ORDER BY user_id";
        $STH = $DBH->query($sql);
        if ($STH->rowCount() > 0) {
            while ($row = $STH->fetch(PDO::FETCH_ASSOC)) {
                if ($row['user_id'] != 0 && $row['user_id'] != '') {
                    if ($row['user_id'] == $user_id) {
                        $option_str.= '<option value="' . $row['user_id'] . '" selected>' . stripslashes($row['name']) . ' ('.$row['unique_id'].')</option>';
                    } else {
                        $option_str.= '<option value="' . $row['user_id'] . '">' . stripslashes($row['name']) . ' ('.$row['unique_id'].')</option>';
                    }
                }
            }
        }
    ...
    //add by ample 07-10-20
    public function getVendorFromAdviserReffral($vendor_id = "") {
        $DBH = new DatabaseHandler();
        $option_str = '';
        $sql = "SELECT DISTINCT tar.vendor_id ,tv.vendor_name,tv.vendor_unique_id FROM `tbladviserreferrals` AS tar " . "LEFT JOIN `tblvendors` AS tv ON tar.vendor_id = tv.vendor_id " . "WHERE tv.vendor_deleted=0 GROUP BY tar.vendor_id ORDER BY vendor_id";
        $STH = $DBH->query($sql);
        if ($STH->rowCount() > 0) {
            while ($row = $STH->fetch(PDO::FETCH_ASSOC)) {
                if ($row['vendor_id'] != 0 && $row['vendor_id'] != '') {
                    if ($row['vendor_id'] == $vendor_id) {
                        $option_str.= '<option value="' . $row['vendor_id'] . '" selected>' . stripslashes($row['vendor_name']) . ' ('.$row['vendor_unique_id'].')</option>';
                    } else {
                        $option_str.= '<option value="' . $row['vendor_id'] . '">' . stripslashes($row['vendor_name']) . ' ('.$row['vendor_unique_id'].')</option>';
                    }
                }
            }
        }
