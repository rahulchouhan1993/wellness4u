...
{
	//$adm_id = $_GET['id'];
	$state_id = base64_decode($_GET['token']);
	$arr_state_record = $obj->getStateDetails($state_id);
	if(count($arr_state_record) == 0)
	{
		header("Location: manage_states.php");
		exit(0);
	}
	
	$country_id = $arr_state_record['country_id'];
	$state_name = $arr_state_record['state_name'];
	$status = $arr_state_record['state_status'];
		...
		<div class="col-md-12">
			<div class="panel">
				<div class="panel-body">
					...
					<form role="form" class="form-horizontal" id="edit_state" name="edit_state" method="post"> 
						...
						<div class="form-group"><label class="col-lg-2 control-label">State Name<span style="color:red">*</span></label>
							<div class="col-lg-5">
								<input type="text" name="state_name" id="state_name" placeholder="State Name" class="form-control" value="<?php echo $state_name;?>" required>
							</div>
						</div>							
						...
						<div class="form-group">
							<div class="col-lg-offset-3 col-lg-10">
								<div class="pull-left">
									...
									<a href="manage_states.php"><button type="button" class="btn btn-danger rounded">Cancel</button></a>
								</div>
							</div>
						</div>
					</form>	
...
<script src="admin-js/edit-state-validator.js" type="text/javascript"></script>
</body>
</html>