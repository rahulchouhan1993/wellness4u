			...
			<div class="panel">
				<div class="panel-body">
					...
					<form role="form" class="form-horizontal" id="edit_admin_action" name="edit_admin_action" method="post"> 
						...
						<input type="hidden" name="hdnaa_id" id="hdnaa_id" value="<?php echo $aa_id;?>" >
						<div class="form-group"><label class="col-lg-2 control-label">Action Title<span style="color:red">*</span></label>
							<div class="col-lg-5">
								<input type="text" name="aa_title" id="aa_title" placeholder="Action Title" class="form-control" value="<?php echo $aa_title;?>" required>
							</div>
						</div>
						<div class="form-group"><label class="col-lg-2 control-label">Action Page Link<span style="color:red">*</span></label>
							<div class="col-lg-5">
								<input type="text" name="aa_link" id="aa_link" placeholder="Action Page Link" class="form-control" value="<?php echo $aa_link;?>" required>
							</div>
						</div>
						<div class="form-group"><label class="col-lg-2 control-label">Status<span style="color:red">*</span></label>
							<div class="col-lg-5">
								<select name="aa_status" id="aa_status" class="form-control">
									<option value="1" <?php if($aa_status == '1'){?> selected <?php } ?>>Active</option> 
									<option value="0" <?php if($aa_status == '0'){?> selected <?php } ?>>Inactive</option> 
								</select>
							</div>
						</div>	
						<hr>
