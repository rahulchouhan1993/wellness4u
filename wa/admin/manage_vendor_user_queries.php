...
{
    $pro_user_id = strip_tags(trim($_POST['vendor_id']));
...
elseif (isset($_SESSION['user_query_prouser_id']))

{

    $pro_user_id = $_SESSION['user_query_prouser_id'];
                        ...
                        <form name="frmadviserquery" method="post" action="#" >
                           <table width="100%" border="0" align="left" cellpadding="5" cellspacing="1" >
                              <tr>
                                 ...
                                 <td width="25%">
                                    <input name="start_date" id="start_date" type="text" value="<?php echo $start_date; ?>" class="form-control datepicker" />
                                 </td>
                                 <td width="5%"></td>
                                 <td width="20%"><strong class="Header_brown">To date</strong></td>
                                 <td width="30%">
                                    <input name="end_date" id="end_date" type="text" value="<?php echo $end_date; ?>" class="form-control datepicker" />
                                 </td>
                              </tr>
                              <tr>
                                 ...
                                 <td width="5%"></td>
                                 <td width="20%">
                                    <strong class="Header_brown">   My Patterns </strong>
                                 </td>
                                 <td width="30%">
                              ...
                              <tr>
                                 <td width="20%" align="left" valign="middle" bgcolor="#FFFFFF" height="50">
                                   <strong class="Header_brown">Vendor</strong>
                                 </td>
                                 <td width="25%">
                                    <select name="vendor_id" id="vendor_id" class="form-control" >
                                       <option value="">All Vendors</option>
                                       <?php 
                                      echo $obj->getVendorFromAdviserReffral($pro_user_id);
                                 ...
                                 <td width="5%"></td>
                                 <td width="20%">
                                    <strong class="Header_brown">User</strong>
                                 </td>
                                 <td width="30%">
...
?>
                                    ...
                                    <td align="center" valign="middle" class="<?php echo $td_class; ?>">
                                       ...
                                       <td id="td6id_<?php echo $record['aq_id']; ?>" height="30" align="center" valign="middle" class="<?php echo $td_class; ?>">
...
?>
                                    <tr onmouseover="showRoundIcon('<?php echo $record2['aq_id']; ?>')" onmouseout="hideRoundIcon('<?php echo $record2['aq_id']; ?>')">
                                       ...
                                       <td id="td5id_<?php echo $record2['aq_id']; ?>" align="center" valign="top" class="<?php echo $td_class; ?>"><?php echo $date; ?></td>
                                        ...
                                        <td align="center" valign="top" class="<?php echo $td_class; ?>">&nbsp;&nbsp;</td>
                                       <td id="td6id_<?php echo $record2['aq_id']; ?>" align="center" valign="top" class="<?php echo $td_class; ?>">
