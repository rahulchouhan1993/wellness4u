					...
					<div class="row mail-header">
						...
						<div class="col-md-6">
							...
							<h3><?php echo $obj->getAdminActionName($edit_action_id);?>
                                                        ...
                                                        <?php if($cusine_status == '0'){?>

                                                        <input type="button" name="activate" id="activate"  style="width: 100px; height: 30px;" value="Activate" onclick="Activate('<?php echo $arr_record['event_price_id'];?>')"/>

                                                        <?php } ?>

                                                        <?php if($cusine_status == '1'){?>

                                                        <input type="button" name="deactivate" id="deactivate"  style="width: 100px; height: 30px;" value="Deactivate" onclick="Deactivate('<?php echo $arr_record['event_price_id'];?>')"/>
...
<script src="admin-js/add_event_price_info.js" type="text/javascript"></script>
