		...
		<div class="col-md-12">
			...
			<div class="panel">
				...
				{ ?>
                                        ...
                                        <a href="add-vendor-selector.php" class="btn btn-default btn-sm" data-toggle="tooltip" data-placement="top" title="<?php echo $obj->getAdminActionName($add_action_id);?>" data-original-title=""><i class="fa fa-plus"></i></a>
				...
				<div class="search-panel">
					...
					<div class="row">
						...
						<div class="col-lg-3"><strong>Items:</strong>&nbsp;<br>
...
{ 
    ...
    var dataString ='action=vendorslist';
