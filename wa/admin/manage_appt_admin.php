                     ...
                     <div class="col-md-10">
                        <table width="100%" align="center" cellpadding="5" cellspacing="1" class="table table-bordered table-hover">
                           ...
                           <tr>
                              ...
                              <td align="left" valign="top" >
                              		<a href="update-appt-specifiq-admin.php?DYL_id=<?=$value['id'];?>" target="_blank"><button>Form Setting</button></a>
                              		<br> &nbsp; <br>
                              		<a href="<?=MAIN_URL;?>appointment-request.php?ref_code=<?=$value['ref_code'];?>&group_id=<?=$value['group_code_id'];?>&vendor_id=" target="_blank"><button>Form Preview</button></a>
                              </td>
                           </tr>
                           <?php } ?>
                           </tbody>
