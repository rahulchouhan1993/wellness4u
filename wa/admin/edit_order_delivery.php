				...
				<div class="panel-body">
					...
					<form role="form" class="form-horizontal" id="edit_order_delivery" name="edit_order_delivery" method="post"> 
						...
						<div class="form-group">
							...
							<label class="col-lg-10 control-label" style="text-align:left;"><a href="javascript:void(0);" onclick="doOpenPopupInvoiceDetails('<?php echo $invoice;?>');"><strong><?php echo $obj->getInvoiceStrWithNameAnddate($invoice);?></strong></a></label>
