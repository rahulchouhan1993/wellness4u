				...
				<div class="panel-body">
					...
					<form role="form" class="form-horizontal" id="add_admin_menu" name="add_admin_menu" method="post">                                             
						<div class="form-group"><label class="col-lg-2 control-label">Menu Title<span style="color:red">*</span></label>
							<div class="col-lg-5">
								<input type="text" name="am_title" id="am_title" placeholder="Menu Title" class="form-control" required>
							</div>
						</div>
						<div class="form-group"><label class="col-lg-2 control-label">Menu Link<span style="color:red">*</span></label>
							<div class="col-lg-5">
								<input type="text" name="am_link" id="am_link" placeholder="Menu Link" class="form-control" required>
							</div>
						</div>                                     
						<div class="form-group"><label class="col-lg-2 control-label">Menu Order<span style="color:red">*</span></label>
							<div class="col-lg-5">
								<input type="text" name="am_order" id="am_order" placeholder="Menu Order" class="form-control" required>
							</div>
						</div>
						<hr>
