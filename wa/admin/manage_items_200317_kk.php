				...
				<div class="search-panel">
					<div class="row" >
						...
						*/
						...
						<div class="col-sm-2">
							<input type="button" id="btnsearch" name="btnsearch" value="Seach" class="btn btn-primary btn-search" onclick="refineSearch();">
						</div>
					</div>
				</div>
				<?php
...
function change_page(page_id)  
{
	...
	var dataString ='page_id='+page_id +'&txtsearch='+escape(txtsearch)+'&status='+status+'&country_id='+country_id+'&state_id='+state_id+'&action=itemslist';
	$.ajax({
		type: "POST",
		url: "ajax/remote.php",
		data: dataString,
...
function refineSearch()  
{
	...
	var dataString ='txtsearch='+escape(txtsearch)+'&status='+status+'&country_id='+country_id+'&state_id='+state_id+'&action=itemslist';
	$.ajax({
		type: "POST",
		url: "ajax/remote.php",
		data: dataString,
