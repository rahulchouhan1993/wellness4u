var Script = function () {
	$.validator.setDefaults({
		...
		{ 
			var formData = new FormData($('#add_admin_menu')[0]);
			formData.append("btn_submit",'btn_submit');
			 
			jQuery.ajax({
				url: 'ajax/add_admin_menu.php',
				type: "POST",
				data:formData,
				processData: false,
				contentType: false,
