var Script = function () {
	$.validator.setDefaults({
		...
		{ 
			var formData = new FormData($('#edit_items')[0]);
			...
			var ing = [];
			$(".form-control#ingredient_name").each(function(){
                    ing.push($(this).val());
            });
			...
			if(cat_id2 != 'undefined' && cat_id2 != '')
			{
				parent_cat = parent_cat+','+cat_id2;
			}		
			
			if(cat_id3 != 'undefined' && cat_id3 != '')
			{
				parent_cat = parent_cat+','+cat_id3;
			}	
			
			if(cat_id4 != 'undefined' && cat_id4 != '')
			{
				parent_cat = parent_cat+','+cat_id4;
			}	
			
			if(cat_id5 != 'undefined' && cat_id5 != '')
			{
			...
			var sub_cat_id = sub_cat1;
			
			if(sub_cat2 != 'undefined' && sub_cat2 != '')
			{
				sub_cat_id = sub_cat_id+','+sub_cat2;
			}

			if(sub_cat3 != 'undefined' && sub_cat3 != '')
			{
				sub_cat_id = sub_cat_id+','+sub_cat3;
			}	
			
			if(sub_cat4 != 'undefined' && sub_cat4 != '')
			{
				sub_cat_id = sub_cat_id+','+sub_cat4;
			}	
			
			if(sub_cat5 != 'undefined' && sub_cat5 != '')
			{
				sub_cat_id = sub_cat_id+','+sub_cat5;
			}	
			...
			jQuery.ajax({
				url: 'ajax/edit_items.php',
				type: "POST",
				data:'item_name='+item_name+'&item_code='+item_code+'&parent_cat='+parent_cat+'&sub_cat_id='+sub_cat_id+'&show='+show+'&item_id='+item_id+'&item_status='+item_status+'&item_disc1='+item_disc1+'&item_disc2='+item_disc2+'&item_disc_show1='+item_disc_show1+'&item_disc_show2='+item_disc_show2+'&ingredient_type='+ingredient_type+'&ingredient_id='+ingredient_id+'&ingredient_show='+ingredient_show+'&btnSubmit='+btnSubmit,
