...

{
	...
	var dataString = 'action=getmaincategoryoption&parent_cat_id='+parent_cat_id+'&id='+id;
...
function getMainCategoryOptionCommonVendor(idval,type)

{
	...
	var dataString = 'action=getmaincategoryoptionnew&parent_cat_id='+parent_cat_id+'&id='+id;
...

{
	...
	var dataString = 'action=getmaincategoryoptionform&parent_cat_id='+parent_cat_id+'&type='+type+'&multiple='+multiple;
...
function doOpenPopupInvoiceDetails(invoice)

{

	var dataString = 'action=doopenpopupinvoicedetails&invoice='+invoice;
	...
	$.ajax({
...

		{
			...
			BootstrapDialog.show({
				...
				title: 'Order Details for Invoice: '+invoice,

				/*message:'<p>This is sample msg1</p><p>This is sample msg2</p><p>This is sample msg3</p>'*/
...
function viewVendorProfilePopup(vendor_id="")

	{

		var dataString = 'action=viewVendorProfilePopup&vendor_id='+vendor_id;
