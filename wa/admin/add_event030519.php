...
$vendor_details = $obj->getVendorUserDetails($_GET['organiser_id']);
$va_id = $obj->getVendorVAID($_GET['organiser_id']);
				...
				<div class="panel-body">
					...
					<form role="form" class="form-horizontal" id="add_event" name="add_event" enctype="multipart/form-data" method="post"> 
						...
						<input type="hidden" name="cat_total_cnt" id="cat_total_cnt" value="<?php echo $cat_total_cnt;?>">
                                                ...
                                                <input type="hidden" name="organiser_id" id="organiser_id" value="<?php echo $_GET['organiser_id'];?>">
...
<!--								<select name="institution_id" id="institution_id" class="form-control" required>
									<?php //echo $obj->getVendorOption($arr_record['institution_id'],$type='1',$multiple='0');?>
                                                            ...
                                                            <input type="text" name="institution_id" id="institution_id" value="" class="form-control" required>
...
<!--                                                            <select name="sponsor_id" id="sponsor_id" class="form-control">
									<?php //echo $obj->getVendorOption($sponsor_id,$type='1',$multiple='0');?>
                                                            ...
                                                            <input type="text" name="sponsor_id" id="sponsor_id" value="" class="form-control" required>
							</div>
							...
							<div class="col-lg-8">
								<div class="summernote-theme-1">
									<div class="event_contents" name="event_contents" id="event_contents"><?php echo $event_contents;?></div>
                                                ...
                                                <div class="form-group">
                                                    <label class="col-lg-2 control-label" id="prof_header1">Profile Category</label>
                                                        <div class="col-lg-4">
                                                ...
                                                <div class="form-group">
                                                        <label class="col-lg-2 control-label" id="prof_header2">Profile Category</label>
                                                        <div class="col-lg-4">
							...
							<label class="col-lg-2 control-label">Fav Category</label>
                                                ...
                                                <div class="form-group">
                                                        <label class="col-lg-2 control-label" id="prof_header3">Profile Category</label>
                                                        <div class="col-lg-4">
							...
							<label class="col-lg-2 control-label">Fav Category</label>
                                                ...
                                                <div class="form-group">
                                                        <label class="col-lg-2 control-label" id="prof_header4">Profile Category</label>
                                                        <div class="col-lg-4">
							...
							<label class="col-lg-2 control-label">Fav Category</label>
                                                ...
                                                <div class="form-group">
                                                        <label class="col-lg-2 control-label" id="prof_header5">Profile Category</label>
                                                        <div class="col-lg-4">
