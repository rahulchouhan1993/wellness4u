...
$event_data = $obj->GETEVENTDETAILSBYID($_GET['event_id']);
				...
				<div class="panel-body">
					...
					<form role="form" class="form-horizontal" id="add_event" name="add_event" method="post" > 
						...
						<input type="hidden" name="cw_total_cnt" id="cw_total_cnt" value="<?php echo $cw_total_cnt;?>">
                                                ...
                                                <input type="hidden" name="hdnevent_id" id="hdnevent_id" value="<?php echo $_GET['event_id'];?>">
...
<!--									<label class="col-lg-2 control-label">Ordering Size<span style="color:red">*</span></label>
								...
								<button type="button" class="btn btn-success" data-toggle="popover" data-placement="right" data-content="Available After Submit Event Price" data-original-title="" title="">ADD More Pricing details</button>
