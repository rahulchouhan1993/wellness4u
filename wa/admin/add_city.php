		...
		<div class="col-sm-12">
			<div class="panel">
				<div class="panel-body">
					...
					<form role="form" class="form-horizontal" id="add_city" name="add_city" method="post"> 
						...
						<div class="form-group"><label class="col-lg-2 control-label">City Name<span style="color:red">*</span></label>
							<div class="col-lg-5">
								<input type="text" name="city_name" id="city_name" placeholder="City Name" class="form-control" required>
							</div>
						</div>
...
<script src="admin-js/add-city-validator.js" type="text/javascript"></script>
<script>
	function getstate()
	{
