		...
		<div class="col-sm-12">
			<div class="panel">
				<div class="panel-body">
					...
					<form role="form" class="form-horizontal" id="add_order_delivery" name="add_order_delivery" method="post" > 
						<input type="hidden" name="hdnstr_order_cart_id" id="hdnstr_order_cart_id" value="<?php  echo $str_order_cart_id?>" >
						<div class="form-group">
							<label class="col-lg-2 control-label">Order Invoice<span style="color:red">*</span></label>
							<div class="col-lg-4">
								<select name="invoice" id="invoice" class="form-control" required onchange="getOrderCartItemsListOfInvoice('0')">
						...
						<div class="form-group" >
							...
							<div class="col-lg-10" id="od_items_list">
								<?php echo $obj->getOrderCartItemsListOfInvoice($invoice,$arr_order_cart_id,'0'); ?>
							</div>
							<div class="col-lg-1"></div>
						</div>
						<div class="form-group">
...
<script src="admin-js/add-order-delivery-validator.js" type="text/javascript"></script>
<script>
