			...
			<div class="panel">
				<div class="panel-body">
					...
					<center><div id="error_msg"></div></center>
                                        <form role="form" class="form-horizontal" action="add_event.php" enctype="multipart/form-data" method="GET"> 						
						<div class="form-group">
<!--                                                        <label class="col-lg-3 control-label">select Oragnisar<span style="color:red">*</span></label>
                                                        <div class="col-lg-3">
                                                            
                                                            <select name="healcareandwellbeing" required="" id="healcareandwellbeing" class="form-control">
