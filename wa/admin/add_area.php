		...
		<div class="col-sm-12">
			<div class="panel">
				<div class="panel-body">
					...
					<form role="form" class="form-horizontal" id="add_area" name="add_area" method="post"> 
						...
						<div class="form-group"><label class="col-lg-2 control-label">Area Name<span style="color:red">*</span></label>
							<div class="col-lg-5">
								<input type="text" name="area_name" id="area_name" placeholder="Area Name" class="form-control" required>
							</div>
						</div>
						<div class="form-group"><label class="col-lg-2 control-label">Area Pincode<span style="color:red">*</span></label>
							<div class="col-lg-5">
								<input type="text" name="area_pincode" id="area_pincode" placeholder="Area Pincode" class="form-control" required>
							</div>
						</div>
...
<script src="admin-js/add-area-validator.js" type="text/javascript"></script>
<script>
	function getcity()
	{
