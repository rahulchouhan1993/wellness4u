...
$obj->debuglog('[EDIT_CANCELLATION_PRICE] REQUEST:<pre>'.print_r($_REQUEST,true).'</pre>');
...
if(isset($_POST['btnSubmit']))
{
	...
	$cp_status = strip_tags(trim($_POST['cp_status']));
	...
	if(!$error)
	{
		...
		$tdata['cp_status'] = $cp_status;
		$tdata['modified_by_admin'] = $admin_id;
		if($obj->updateCancellationPrice($tdata))
		{
