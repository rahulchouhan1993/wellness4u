...
$obj->debuglog('[ADD_MAIN_CATEGORY] REQUEST:<pre>'.print_r($_REQUEST,true).'</pre>, FILES:<pre>'.print_r($_FILES,true).'</pre>');
...
if(isset($_POST['btnSubmit']))
{
	...
	elseif($obj->chkCategoryExists($cat_name))
	{
		$error = true;
