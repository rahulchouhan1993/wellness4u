...
$obj->debuglog('[ADD_ADMIN_ACTION] REQUEST:<pre>'.print_r($_REQUEST,true).'</pre>');
...
if(isset($_POST['btn_submit']))
{
	...
	{
		$tdata = array();
		//$tdata['tablename'] = 'tbladminactions'; //comment by ample 20-07-20
		$tdata['tablename'] = 'tblwaadminactions'; //change by ample 20-07-20
		$tdata['am_id'] = $am_id;
		$tdata['aa_title'] = $aa_title;
		$tdata['aa_link'] = $aa_link;
		$tdata['aa_status'] = '1';
		$tdata['aa_vendor_menu'] = $aa_vendor_menu;
		$tdata['aa_add_date'] = date('Y-m-d H:i:s');
