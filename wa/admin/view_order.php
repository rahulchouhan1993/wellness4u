			...
			<div class="panel">
				<div class="panel-body">
					...
					<form role="form" class="form-horizontal" id="edit_order" name="edit_order" method="post"> 
						...
						<?php echo $obj_comm->getOrderInvoiceHtml($invoice,1,1);?>
						...
						<div class="form-group">
							...
							<div class="col-lg-9">
								...
								<p><strong>EBS Amount</strong> : <?php echo $arr_order_record['order_total_amt'];?><?php echo ' ( '.$obj->getCommaSepratedVendorInvoiceIdsOfInvoice($invoice).' ) ';?></p>
							</div>
						</div>
						<?php
						} ?>
