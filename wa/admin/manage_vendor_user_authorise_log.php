...
{ 
    ...
    var dataString ='action=useraccesslog&user_id=<?php echo $_GET['uid'];?>&vendor_id=<?php echo $_GET['vid'];?>';
...
{	
	...
	var dataString ='action=useraccesslog&user_id=<?php echo $_GET['uid'];?>&vendor_id=<?php echo $_GET['vid'];?>'+'&page_id='+page_id;
