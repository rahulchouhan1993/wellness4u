...
function wpaal_actions() {
	...
	if(isset($_POST['aal_export_check'])) {				
		...
		foreach($myrows as $row) {
			...
			echo "\"" .  $row->keywords . "\"" . $separator . "\"" . $row->link ."\"" . $separator . "\"" . $row->stats ."\"" . $separator . "\"" . $ltitle . "\"" . $separator . "\"" . $lsamelink . "\"" . $separator . "\"" . $ldisclosureoff . "\"" ."\n";
		...
		$aalsort = strtolower(filter_input(INPUT_GET, 'aalsort', FILTER_SANITIZE_SPECIAL_CHARS));
		  		...
		  		$order_list = '<br />Order by: ';
			  		...
			  		if('id' == $aalorder && 'asc' == $aalsort) 
			  			{
			  				$order_list .= '<a href="?page=aal_topmenu&aalorder=id&aalsort=desc" class="aal-sort-box aal-sorted-asc">Date added <span class="sorting-indicator aal-sort-span"></span></a> ';
			  			}
			  			else if('id' == $aalorder && 'desc' == $aalsort) {
			  				$order_list .= '<a href="?page=aal_topmenu&aalorder=id&aalsort=asc" class="aal-sort-box  aal-sorted-desc">Date added <span class="sorting-indicator aal-sort-span aal-sort-desc"></span></a>  ';
			  			}
			  			 else {
			  			 	$order_list .= '<a href="?page=aal_topmenu&aalorder=id&aalsort=asc" class="aal-sort-box aal-sort-asc">Date added  <span class="sorting-indicator aal-sort-span"></span></a>  ';
			  			 }
		  		...
		  		?>
			  		...
			  		if('keywords' == $aalorder && 'asc' == $aalsort) 
			  			{
			  				$order_list .= '<a href="?page=aal_topmenu&aalorder=keywords&aalsort=desc" class="aal-sort-box aal-sorted-asc">Keyword <span class="sorting-indicator aal-sort-span"></span></a>';
			  			}
			  			else if('keywords' == $aalorder && 'desc' == $aalsort) {
			  				$order_list .= '<a href="?page=aal_topmenu&aalorder=keywords&aalsort=asc" class="aal-sort-box  aal-sorted-desc">Keyword <span class="sorting-indicator aal-sort-span aal-sort-desc"></span></a>';
			  			}
			  			 else {
			  			 	$order_list .= '<a href="?page=aal_topmenu&aalorder=keywords&aalsort=asc" class="aal-sort-box aal-sort-asc">Keyword <span class="sorting-indicator aal-sort-span"></span></a>';
			  			 }	
					...
					?>	
			  		...
			  		if('url' == $aalorder && 'asc' == $aalsort) 
			  			{
			  				$order_list .= '<a href="?page=aal_topmenu&aalorder=url&aalsort=desc" class="aal-sort-box aal-sorted-asc">URL <span class="sorting-indicator aal-sort-span"></span></a>';
			  			}
			  			else if('url' == $aalorder && 'desc' == $aalsort) {
			  				$order_list .= '<a href="?page=aal_topmenu&aalorder=url&aalsort=asc" class="aal-sort-box  aal-sorted-desc">URL <span class="sorting-indicator aal-sort-span aal-sort-desc"></span></a>';
			  			}
			  			 else {
			  			 	$order_list .= '<a href="?page=aal_topmenu&aalorder=url&aalsort=asc" class="aal-sort-box aal-sort-asc">URL <span class="sorting-indicator aal-sort-span"></span></a>';
			  			 }
					$order_list .= '<br />';	
