...
function aal_admin_notice() {  
	...
	$aal_notice_dismissed = get_option('aal_option_dismissed85'); 
    ...
    <div id="aal_notice_div" class="updated">
     <div style="float: right;padding-top: 10px;margin-left: 100px;"><a id="aal_dismiss_link" href="javascript:;" >Dismiss this notice</a></div>
      <p><?php    
    	 ...
    	 _e( 'Thank you for using Auto Affiliate Links. Upgrade to <a href="https://autoaffiliatelinks.com/wp-auto-affiliate-links-pro/">Auto Affiliate Links PRO</a> to get access to advanced linking features. ', 'wp-auto-affiliate-links' ); 
		 ...
		 //_e( 'Auto Affiliate Links PRO special offer: $79 lifetime subscription, exclusive on <a href="https://appsumo.com/products/auto-affiliate-links/">AppSumo</a>. ', 'wp-auto-affiliate-links' ); 
...
function aalDismissNotice() {
		...
		delete_option('aal_option_dismissed81');
		delete_option('aal_option_dismissed82');
		delete_option('aal_option_dismissed83');
		delete_option('aal_option_dismissed84');
		add_option('aal_option_dismissed85',true);
