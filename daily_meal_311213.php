			...
			var getUsersDailyMealsDetails = function() {
				...
				obj.callback = function (responseTxt, responseStat) {
					...
					for(var i=0; i < brunch_cnt; i++)
					{
						...
						//alert("new: "+new_brunch_prefill_arr[i]);
					...
					for(var i=0; i < lunch_cnt; i++)
					{
						...
						//alert("new: "+new_lunch_prefill_arr[i]);
					...
					for(var i=0; i < snacks_cnt; i++)
					{
						...
						//alert("new: "+new_snacks_prefill_arr[i]);
					...
					for(var i=0; i < dinner_cnt; i++)
					{
						...
						//alert("new: "+new_dinner_prefill_arr[i]);
				...
				<tr>
					...
					<td width="620" align="center" valign="top">
						...
						<table width="580" align="center" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td height="40" align="left" valign="top" class="breadcrumb"><a href="index.php" target="_self" class="breadcrumb_link">Home</a> &gt;<a href="user_home.php" target="_self" class="breadcrumb_link"> My Wellness Tracker </a> &gt; My Food Today</td>
							</tr>
						</table>  
							...
							<tr>
								<td align="left" valign="top" bgcolor="#FFFFFF" style="background-repeat:repeat-x; padding:10px;">
									...
									<table width="500" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td width="250" height="50" align="left" valign="top" class="header_title"><?php echo getPageContents($page_id);?></td>
										</tr>
										<tr>
											<td align="left" valign="top" class="err_msg"><?php echo $err_msg;?></td>
										</tr>
										<tr>
											<td height="50" align="left" valign="top">
												<table width="500" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td width="100" height="50" align="left" valign="middle" class="Header_brown">Breakfast</td>
														<td width="40" height="50" align="left" valign="middle" class="Header_brown">Date:</td>
														<td width="310" height="50" align="left" valign="middle">
													...
													<tr id="tr_err_meal_date" style="display:<?php echo $tr_err_meal_date;?>;" valign="top">
														...
														<td align="right" valign="top">&nbsp; </td>
														<td align="left" colspan="2" class="err_msg" valign="top"><?php echo $err_meal_date;?></td>
													</tr>
												</table>
												<div id="divbreakfast">                          
												<table width="500" border="0" cellspacing="0" cellpadding="0" id="tblbreakfast">
													<tr>
														<td width="100" height="35" align="left" valign="top">&nbsp;&nbsp;&bull; Time:</td>
												...
												{ ?>
													<tr id="tr_breakfast_1_<?php echo $i;?>">
														<td width="100" height="35" align="left" valign="top">&nbsp;&nbsp;&bull; Item:</td>
														<td width="400" height="35" align="left" valign="top">
													...
													<tr id="tr_breakfast_3_<?php echo $i;?>">
														<td width="100" height="35" align="left" valign="top">&nbsp;&nbsp;&bull; Quantity:</td>
														<td width="400" height="35" align="left" valign="top">
													...
													<tr id="tr_breakfast_4_<?php echo $i;?>">
														<td width="100" height="35" align="left" valign="top">&nbsp;&nbsp;&bull; My Desire:</td>
														<td width="400" height="35" align="left" valign="top">
                                                        	<table width="400" border="0" cellspacing="0" cellpadding="0">
                                                            	<tr>
                                                                    ...
                                                                    <td width="300" height="35" align="left" valign="top" id="spn_breakfast_meal_like_icon_<?php echo $i;?>"><?php echo getMealLikeIcon($breakfast_meal_like_arr[$i]); ?></td>
                                                               </tr>
                                                            </table>
														</td>
													</tr>
													<tr id="tr_breakfast_5_<?php echo $i;?>">
														<td width="100" align="left" valign="top">&nbsp;&nbsp;&bull; Item Remarks:</td>
													...
													<tr id="add_before_this_breakfast">
														...
														<td width="400" height="30" align="left" valign="top">
                                                        	...
                                                        	<!--<a href="javascript:void(0)" target="_self" class="body_link" id="addMoreBreakfast">add more</a>--></td>
													</tr>	
												</table>
												</div>
											</td>
									...
									<table width="500" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td width="250" height="50" align="left" valign="top">
												<table width="500" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td width="50" height="50" align="left" valign="top"><img src="images/icon_brunch.jpg" width="40" height="40" /></td>
														<td width="100" height="50" align="left" valign="middle" class="Header_brown">Brunch</td>
														<td width="40" height="50" align="left" valign="middle">&nbsp;</td>
														<td width="310" height="50" align="left" valign="middle">&nbsp;</td>
													</tr>
												</table>
												<div id="divbrunch"> 
												<table width="500" border="0" cellspacing="0" cellpadding="0" id="tblbrunch">
													<tr>
														<td width="100" height="35" align="left" valign="top">&nbsp;&nbsp;&bull; Time:</td>
														<td width="400" height="35" align="left" valign="top">
                                                        ...
                                                        <td width="400" height="35" align="left" valign="top">
                                                            <table width="400" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    ...
                                                                    <td width="300" height="35" align="left" valign="top" id="spn_brunch_meal_like_icon_<?php echo $i;?>"><?php echo getMealLikeIcon($brunch_meal_like_arr[$i]); ?></td>
                                                               </tr>
                                                            </table>
                                                        </td>
                                                    </tr>
											...
											<td width="250" height="50" align="left" valign="top">
												<table width="500" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td width="100" height="50" align="left" valign="middle" class="Header_brown">Lunch</td>
														<td width="40" height="50" align="left" valign="middle">&nbsp;</td>
														<td width="310" height="50" align="left" valign="middle">&nbsp;</td>
													</tr>
												</table>
												<div id="divlunch"> 
												<table width="500" border="0" cellspacing="0" cellpadding="0" id="tbllunch">
													<tr>
														<td width="100" height="35" align="left" valign="top">&nbsp;&nbsp;&bull; Time:</td>
														<td width="400" height="35" align="left" valign="top">
												...
												{ ?>
                                                        ...
                                                        <td width="400" height="35" align="left" valign="top">
                                                            <table width="400" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    ...
                                                                    <td width="300" height="35" align="left" valign="top" id="spn_lunch_meal_like_icon_<?php echo $i;?>"><?php echo getMealLikeIcon($lunch_meal_like_arr[$i]); ?></td>
                                                               </tr>
                                                            </table>
                                                        </td>
                                                    </tr>
													...
													<tr id="add_before_this_lunch">
														...
														<td width="400" height="30" align="left" valign="top">
                                                         ...
                                                         <!--<a href="javascript:void(0)" target="_self" class="body_link" id="addMoreLunch">add more</a>--></td>
													</tr>	
												</table>
												</div>
											</td>
											...
											<td width="250" height="50" align="left" valign="top">
												<table width="500" border="0" cellspacing="0" cellpadding="0">
													<tr>
														...
														<td width="100" height="50" align="left" valign="middle" class="Header_brown">Snacks</td>
														<td width="40" height="50" align="left" valign="middle">&nbsp;</td>
														<td width="310" height="50" align="left" valign="middle">&nbsp;</td>
													</tr>
												</table>
												<div id="divsnacks"> 
												<table width="500" border="0" cellspacing="0" cellpadding="0" id="tblsnacks">
													<tr>
														<td width="100" height="35" align="left" valign="top">&nbsp;&nbsp;&bull; Time:</td>
														<td width="400" height="35" align="left" valign="top">
												...
												{ ?>
                                                        ...
                                                        <td width="400" height="35" align="left" valign="top">
                                                            <table width="400" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    ...
                                                                    <td width="300" height="35" align="left" valign="top" id="spn_snacks_meal_like_icon_<?php echo $i;?>"><?php echo getMealLikeIcon($snacks_meal_like_arr[$i]); ?></td>
                                                               </tr>
                                                            </table>
                                                        </td>
                                                    </tr>
													...
													<tr id="add_before_this_snacks">
                                                        ...
                                                        <!--<a href="javascript:void(0)" target="_self" class="body_link" id="addMoreSnacks">add more</a>--></td>
													</tr>	
												</table>
												</div>
											</td>
										...
										<tr>
											<td width="250" height="50" align="left" valign="top">
												<table width="500" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td width="50" height="50" align="left" valign="top"><img src="images/icon_lunch.jpg" width="40" height="40" /></td>
														<td width="100" height="50" align="left" valign="middle" class="Header_brown">Dinner</td>
														<td width="40" height="50" align="left" valign="middle">&nbsp;</td>
														<td width="310" height="50" align="left" valign="middle">&nbsp;</td>
													</tr>
												</table>
												<div id="divdinner"> 
												<table width="500" border="0" cellspacing="0" cellpadding="0" id="tbldinner">
													<tr>
														<td width="100" height="35" align="left" valign="top">&nbsp;&nbsp;&bull; Time:</td>
														<td width="400" height="35" align="left" valign="top">
												...
												{ ?>
													...
													<tr id="add_before_this_dinner">
                                                        ...
                                                        <!--<a href="javascript:void(0)" target="_self" class="body_link" id="addMoreDinner">add more</a>--></td>
													</tr>	
												</table>
												</div>
											</td>
