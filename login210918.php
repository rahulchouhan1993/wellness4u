...
<h4 style="color:#AA1144; text-align:center">Your 24x7 Guide & Friend</h4>
		...
		<input type="hidden" name="ref_url" id="ref_url" value="<?php echo $ref_url;?>" />
            ...
            <tr id="tr_err_msg" style="display:<?php echo $tr_err_msg;?>;">
                ...
                <p align="center"><input type="checkbox" name="remember_me" id="remember_me" />&nbsp;Remember me<br>
                	...
                	<input name="btnSubmit" type="submit" class="btn btn-primary" id="btnSubmit" value="Submit" style="background-color: #98c8f1;" />
                ...
                <p align="center">
                    ...
                    <a href="<?php echo SITE_URL.'/register.php';?>" target="_self">
