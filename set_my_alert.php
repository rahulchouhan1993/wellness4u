...

{
...

    {
...

        {
            ...
            header("Location: message.php?msg=7");  //16 is old message id
                                                  ...
                                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" >
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="150" height="50" align="left" valign="top" class="Header_brown">Module:</td>

                                                            <td width="250" align="left" valign="top">

                                                                <select  class="form-control" name="report_module" id="report_module" onchange="toggleScaleShow(); getModuleWiseKeywordsOptions(); getModuleWiseCriteriaOptions();resetReportForm(); ">
                                                            ...
                                                            <td width="150" align="left" valign="top" class="Header_brown">&nbsp;</td>

                                                            <td width="100" height="50" align="left" valign="top" class="Header_brown">Set:</td>

                                                            <td width="250" align="left" valign="top">

                                                                <select name="pro_user_id" id="pro_user_id"  class="form-control"  onchange="getModuleWiseKeywordsOptions(); getModuleWiseCriteriaOptions();">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left" valign="top" id="tdkeywordresult">
                                                                ...
                                                                <select name="module_keyword" id="module_keyword"  class="form-control" >

                                                                    <option value="" <?php if($module_keyword == '') {?> selected="selected" class="form-control" <?php } ?>>All</option>
                                                            ...
                                                            <td align="left" valign="top" class="Header_brown"></td>
                                                        ...
                                                        <tr id="idscaleshow" style="display:<?php echo $idscaleshow;?>">
                                                            ...
                                                            <td height="50" align="left" valign="top" class="Header_brown">Keyword Scale:</td>

                                                            <td align="left" valign="top">

                                                                <select  class="form-control" name="scale_range" id="scale_range" onchange="toggleScaleRangeType('scale_range','div_start_scale_value','div_end_scale_value')">
                                                            ...
                                                            <td height="50" align="left" valign="top" class="Header_brown">Scale value:</td>

                                                            <td align="left" valign="top">

                                                                <span id="div_start_scale_value" style="display:<?php echo $div_start_scale_value;?>">

                                                                <select  class="form-control" name="start_scale_value" id="start_scale_value" style="width:50px;">
                                                                ...
                                                                <span id="div_end_scale_value" style="display:<?php echo $div_end_scale_value;?>">
                                                                    ...
                                                                    <select  class="form-control"  name="end_scale_value" id="end_scale_value" style="width:50px;">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td height="50" align="left" valign="top" class="Header_brown">Criteria:</td>

                                                            <td align="left" valign="top" id="tdcriteriaresult">

                                                                <select name="module_criteria" id="module_criteria"  class="form-control"  onchange="getModuleWiseCriteriaScaleOptions();getModuleWiseCriteriaScaleValues();toggleCriteriaScaleShow();">
                                                        ...
                                                        <tr id="idcriteriascaleshow" style="display:<?php echo $idcriteriascaleshow;?>">
                                                            ...
                                                            <td height="50" align="left" valign="top" class="Header_brown">Criteria Scale:</td>
                                                            ...
                                                            <td colspan="3" align="left" valign="top" id="idcriteriascalevalues">
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                          ...
                                                          <td width="150" height="50" align="left" valign="top" class="Header_brown">Alert Date Type:</td>

                                                            <td width="250" align="left" valign="top">

                                                                <select  class="form-control" name="date_type" id="date_type" onchange="toggleDateSelectionTypeUserNew('date_type')">
                                                           ...
                                                           <td width="150" align="left" valign="top" class="Header_brown">&nbsp;</td>
                                                            ...
                                                            <td width="100" height="50" align="left" valign="top" class="Header_brown"></td>
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="tbldaterange" style="display:<?php echo $tbldaterange;?>">
                                                        ...
                                                        <tr>
                                                          ...
                                                          <td width="150" height="50" align="left" valign="top" class="Header_brown">Start Date:</td>
                                                            ...
                                                            <td width="100" height="50" align="left" valign="top" class="Header_brown">End Date:</td>
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="tblsingledate" style="display:<?php echo $tblsingledate;?>">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="150" height="50" align="left" valign="top" class="Header_brown">Date:</td>
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="tblmonthdate" style="display:<?php echo $tblmonthdate;?>">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="150" height="50" align="left" valign="top" class="Header_brown">Month:</td>

                                                            <td width="250" align="left" valign="top">

                                                                <select class="form-control" style="width:50px"name="start_month" id="start_month">

                                                                    <?php echo getMonthOptions($start_month); ?>

                                                                </select>

                                                                <select class="form-control" style="width:50px;" name="start_year" id="start_year">
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="tbldaysofmonth" style="display:<?php echo $tbldaysofmonth;?>">

                                                        <tr>

                                                            <td width="150" height="50" align="left" valign="top" class="Header_brown">Days of Month:</td>
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="tbldaysofweek" style="display:<?php echo $tbldaysofweek;?>">

                                                        <tr>

                                                            <td width="150" height="50" align="left" valign="top" class="Header_brown">Days of Week:</td>

                                                            <td width="250" align="left" valign="top">

                                                                <select id="days_of_week" name="days_of_week[]" multiple="multiple"  class="form-control" >
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" >
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="150" height="50" align="left" valign="top" class="Header_brown">Alert Message:</td>

                                                            <td width="450" align="left" valign="top">

                                                                <textarea id="alert_msg" name="alert_msg" style="height:200px;"  class="form-control" ><?php echo stripslashes($alert_msg);?></textarea>
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" >
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="150" height="50" align="left" valign="top" class="Header_brown">Alert Mode:</td>

                                                            <td width="450" align="left" valign="top">

                                                                <select id="alert_mode" name="alert_mode"  class="form-control" >
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td height="50" align="left" valign="middle"><input type="submit" name="btnSubmit" id="btnSubmit" value="Set Alert" class="btn btn-primary" /></td>
