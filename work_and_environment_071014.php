...
$ref = base64_encode('work_and_environment.php');
if(!isLoggedIn())
{
...
$wae_date = $today_year.'-'.$today_month.'-'.$today_day;
...
if(isset($_POST['btnSubmit']))	
{
	...
	$empty_selected_wae_id_arr = true;
	for($i=0;$i<$cnt;$i++)
	{
		$selected_wae_id = trim($_POST['selected_wae_id_'.$i]);
		if($selected_wae_id != '')
		{
			$empty_selected_wae_id_arr = false;
		...
		array_push($selected_wae_id_arr,$selected_wae_id);
	}
	...
	if( ($day == '') || ($month == '') || ($year == '') )
	{
		$error = true;
		$tr_err_wae_date = '';
		$err_wae_date = 'Please select date!';
	}
	elseif(!checkdate($month,$day,$year))
	{
		$error = true;
		$tr_err_wae_date = '';
		$err_wae_date = 'Please select valid date!';
	}
	elseif(mktime(0,0,0,$month,$day,$year) > $now)
	{
		$error = true;
		$tr_err_wae_date = '';
		$err_wae_date = 'Please select today or previous date!';
	}
	else
	{
	...
	//Validations for wae - START	
	if($empty_selected_wae_id_arr)
	{
		$error = true;
	...
	else
	{
		for($i=0;$i<count($selected_wae_id_arr);$i++)
		{
			...
			array_push($tr_err_wae , $temp_tr_err);
			array_push($err_wae , $temp_err);	
		}
	}

	//Validations for wae - END		

	if(!$error)
	{
		$addUsersWAEQuestion = addUsersWAEQuestion($user_id,$wae_date,$selected_wae_id_arr,$scale_arr,$remarks_arr,$my_target_arr,$adviser_target_arr,$pro_user_id);
		if($addUsersWAEQuestion)
		{
						...
						<table width="570" align="center" border="0" id="color_code" cellpadding="0" cellspacing="1" bgcolor="<?php echo $bg_color_code; ?>">
                        	<tr>
								<td align="left" valign="top" id="bgimage" background="<?php echo $bg_image; ?>" bgcolor="#FFFFFF" style="background-repeat: repeat; padding:10px;">
									<form action="<?php echo SITE_URL.'/work_and_environment.php'?>" id="frmwae" method="post" name="frmwae">
												...
												<table width="550" border="0" cellspacing="0" cellpadding="0">
														...
														<td colspan="4" height="50" align="left" valign="top">
                                                        	<table width="550" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    ...
                                                                    <td height="50" align="left" valign="middle" class="Header_brown">Work &amp; Environment</td>
                                                                </tr>
                                                             </table>       
                                                        </td>
													</tr>
                                                    <tr> 
                                                        ...
                                                        <td width="150" height="30" align="left" valign="middle">
															<select name="pro_user_id" id="pro_user_id" onchange="getUsersWAEQuestionDetails(); updateUserFormTheme();" style="width:120px;">
														...
														<td width="180" height="30" align="left" valign="middle">
															<select name="day" id="day" onchange="getUsersWAEQuestionDetails();" style="width:40px;">
															...
															<select name="month" id="month" onchange="getUsersWAEQuestionDetails();" style="width:60px;">
																<?php echo getMonthOptions($month,$yesterday_month,$today_month); ?>
															</select>
															<select name="year" id="year" onchange="getUsersWAEQuestionDetails();" style="width:60px;">
															<?php
                                                    ...
                                                    <tr id="tr_err_wae_date" style="display:<?php echo $tr_err_wae_date;?>;" valign="top">
														<td align="right" valign="top">&nbsp; </td>
														<td align="right" valign="top">&nbsp; </td>
														<td align="left" colspan="2" class="err_msg" valign="top"><?php echo $err_wae_date;?></td>
													</tr>
												</table>
												<div id="divwae">                          
												<table width="560" border="0" cellspacing="0" cellpadding="0" id="tblwae">
											<?php
											if(count($arr_wae_id) > 0)
											{
												for($i=0;$i<count($arr_wae_id);$i++)
												{ ?>
													<tr style="display:<?php echo $tr_err_wae[$i];?>;" valign="top">
														<td align="left" colspan="2" class="err_msg" valign="top"><?php echo $err_wae[$i];?></td>
													</tr>
													<tr>
													...
													<tr>
														...
														<td width="430" height="35" align="left" valign="top">
															<input type="checkbox" name="selected_wae_id_<?php echo $i;?>" id="selected_wae_id_<?php echo $i;?>" value="<?php echo $arr_wae_id[$i];?>" <?php if($selected_wae_id_arr[$i] == $arr_wae_id[$i]) { ?> checked="checked" <?php } ?> onclick="toggleMyResponseScale('selected_wae_id_','<?php echo $i;?>')" />&nbsp;<strong><span style="font-family:<?php echo $arr_situation_font_family[$i];?>;font-size:<?php echo $arr_situation_font_size[$i];?>px;color:#<?php echo $arr_situation_font_color[$i];?>;"><?php echo $arr_situation[$i]; ?></span></strong>
														</td>
													</tr>
                                                                                                                ...
                                                                                                                <table width="560" border="0" cellspacing="0" cellpadding="0">
                                                                                                                    <tr>
                                                                                                                        ...
                                                                                                                        <td width="150" align="left" valign="top">
                                                                                                                            ...
                                                                                                                            </select><br><?php echo getUsersLastMyTargetWAEDateString($user_id,$pro_user_id,$arr_wae_id[$i]);?>
                                                                                                                            </div>
                                                                                                                        ...
                                                                                                                        <td width="150" align="left" valign="top">
                                                                                                                            ...
                                                                                                                            </select><br><?php echo getUsersLastAdviserTargetWAEDateString($user_id,$pro_user_id,$arr_wae_id[$i]);?>
                                                                                                                            </div>
