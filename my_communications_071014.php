									...
									<table width="570" border="0" cellspacing="0" cellpadding="0">
										...
										<tr>
											...
											<td height="50" align="left" valign="top">
												...
												<table width="560" border="0" cellspacing="0" cellpadding="0" id="tblmc">
...

											{
												...
												{ ?>
													...
													<tr style="display:<?php echo $tr_err_mc[$i];?>;" valign="top">

														<td align="left" colspan="2" class="err_msg" valign="top"><?php echo $err_mc[$i];?></td>
													...
													<tr>
														...
														<td width="430" height="35" align="left" valign="top">
															...
															<input type="checkbox" name="selected_mc_id_<?php echo $i;?>" id="selected_mc_id_<?php echo $i;?>" value="<?php echo $arr_mc_id[$i];?>" <?php if($selected_mc_id_arr[$i] == $arr_mc_id[$i]) { ?> checked="checked" <?php } ?> onclick="toggleMyResponseScale('selected_mc_id_','<?php echo $i;?>')" />&nbsp;<strong><span style="font-family:<?php echo $arr_situation_font_family[$i];?>;font-size:<?php echo $arr_situation_font_size[$i];?>px;color:#<?php echo $arr_situation_font_color[$i];?>;"><?php echo $arr_situation[$i]; ?></span></strong>
                                                                                                                ...
                                                                                                                <table width="560" border="0" cellspacing="0" cellpadding="0">
                                                                                                                    <tr>
                                                                                                                        ...
                                                                                                                        <td width="150" align="left" valign="top">
                                                                                                                            ...
                                                                                                                            </select><br><?php echo getUsersLastMyTargetMCDateString($user_id,$pro_user_id,$arr_mc_id[$i]);?>
                                                                                                                            </div>
                                                                                                                        ...
                                                                                                                        <td width="150" align="left" valign="top">
                                                                                                                            ...
                                                                                                                            </select><br><?php echo getUsersLastAdviserTargetMCDateString($user_id,$pro_user_id,$arr_mc_id[$i]);?>
                                                                                                                            </div>
