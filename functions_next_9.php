...

{
    ...
    $output .= '<table width="100%" border="0" cellspacing="0" cellpadding="0" id="tbladct">';
    ...
    $output .= '                    <td width="130" align="left" valign="top">Adviser Set Target:</td>';
...

{
    ...
    $output .= '<table width="100%" border="0" cellspacing="0" cellpadding="0" id="tblgs">';
...

{
    ...
    $output .= '<table width="100%" border="0" cellspacing="0" cellpadding="0" id="tblwae">';
...

{
	...
	$output .= '<table width="100%" border="0" cellspacing="0" cellpadding="0" id="tblmc">';
...

{
	...
	$output .= '<table width="100%" border="0" cellspacing="0" cellpadding="0" id="tblmr">';
...

{
	...
	$output .= '<table width="100%" border="0" cellspacing="0" cellpadding="0" id="tblmle">';
...
function getScaleSliderCodeVivek($i,$tr_response_img,$tr_response_slider,$scale_val)
