...
//header("Location: message.php?msg=14&gotopage=".$page_id); 
            ...
            header("Location: my_wellness_solutions.php?mid=".$page_id."&date=".$mr_date); 
...
<div class="col-md-8">	
                        ...
                        <table width="100%" align="center" border="0" id="color_code" cellpadding="0" cellspacing="1" bgcolor="<?php echo $bg_color_code; ?>">
                            ...
                            <tr>
                                ...
                                <td align="left" valign="top" id="bgimage" background="<?php echo $bg_image; ?>" bgcolor="#FFFFFF" style="background-repeat: repeat; padding:10px;">
                                    ...
                                    <form action="#" id="frmmr" method="post" name="frmmr">
                                                ...
                                                <td height="50" align="left" valign="top">
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <td colspan="4" height="50" align="left" valign="top">
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="20%" height="50" align="left" valign="top"><img src="images/icon_fitness.jpg" width="40" height="40" /></td>

                                                                        <td height="50" width="80%" align="left" valign="middle" class="Header_brown">My Relations</td>
                                                        ...
                                                        <tr> 
                                                            ...
                                                            <td width="40%" height="50" align="left" valign="middle" class="Header_brown">My Digital Diary Notings:</td>

                                                            <td colspan="3" width="60%" height="30" align="left" valign="middle">

                                                                <select name="pro_user_id" id="pro_user_id" onchange="getUsersMRQuestionDetails(); updateUserFormTheme();" class="form-control">
   ...
   <tr>                                                        <td width="40%" height="30" align="left" valign="middle" class="Header_brown">Date:</td>

                                                            <td  colspan="3" width="60%" height="30" align="left" valign="middle">

        <div class="row" style="margin-top:15px;">

<div class="col-xs-4">                                                        <select name="day" id="day" onchange="getUsersMRQuestionDetails();" class="form-control">
       ...
       <div class="col-xs-4">                                                         <select name="month" id="month" onchange="getUsersMRQuestionDetails();" class="form-control">
      ...
      <div class="col-xs-4">                                                          <select name="year" id="year" onchange="getUsersMRQuestionDetails();" class="form-control">
                                                    ...
                                                    <div id="divmr"> 
                                                        ...
                                                        <?php echo getUsersMRQuestionDetailsCode($day,$month,$year,$pro_user_id,$user_id,$scale_arr,$remarks_arr,$selected_mr_id_arr,$my_target_arr,$adviser_target_arr);?>                   
