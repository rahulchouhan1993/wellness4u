...
$ref = base64_encode('datewise_emotions_report.php');
...
if(chkUserPlanFeaturePermission($user_id,'9'))
{
	$datewise_emotions_report = 1;
}
else
{
...

{
	...
	if(!$error)
	{
		...
		$output = getDatewiseEmotionsReportHTML($user_id,$start_date,$end_date,$wae_report,$gs_report,$sleep_report,$mc_report,$mr_report,$mle_report,$adct_report,$temp_permission_type,$temp_pro_user_id);	
