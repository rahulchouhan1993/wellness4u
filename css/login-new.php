...
//        die();
	...
	if(!$error)
	{
               if($gestid != '')
                  {
		    $signUpUser = $obj->updatesSignUpUserVivek($gestid,$name,$middle_name,$last_name,$gender,$email,$mobile,$city_id,$place_id,$password);
		  }
               else
                  {
		    $signUpUser = $obj->signUpUser($name,$middle_name,$last_name,$gender,$email,$mobile,$city_id,$place_id,$password);
		  }
								...
								<div id="checkout-signup-tab">
									...
									<div id="signup-box">
										<div class="form-group">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <input type="text" name="signup_last_name" id="signup_last_name" placeholder="Last Name" class="input-text-box input-half-width input-half-width" autocomplete="false">
