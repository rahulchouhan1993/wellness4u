...
@set_time_limit(10000000);session_start();date_default_timezone_set('Asia/Calcutta');
define('DB_TYPE', 'mysql');//Local //
//define('DB_HOST', 'localhost');//
//define('DB_USERNAME', 'root');//
//define('DB_PASSWORD', '');
define('DB_NAME', 'wellness');//Live
...
define('SITE_URL', 'http://localhost/wellnessway4you');
