    ...
    <script type="text/javascript"> 
        $(document).ready(function() {
                ...
                $('#addMoreBreakfast').click(function() {
                        ...
                        $('#tblbreakfast tr[id="add_before_this_breakfast"]').before('<tr id="tr_breakfast_1_'+breakfast_cnt+'"><td width="50%" height="35" align="left" valign="top">&nbsp;&nbsp;&bull; Item:</td><td width="50%" height="35" align="left" valign="top"><input name="breakfast_item[]" type="text" class="input" id="breakfast_item_'+breakfast_cnt+'" value="" /></td></tr><tr id="tr_breakfast_2_'+breakfast_cnt+'"  style="display:none;"><td height="35" align="left" valign="top">&nbsp;</td><td height="35" align="left" valign="top"><input name="breakfast_other_item[]" type="text" class="input" id="breakfast_other_item_'+breakfast_cnt+'" value="" /></td></tr><tr id="tr_breakfast_3_'+breakfast_cnt+'"><td width="50%" height="35" align="left" valign="top">&nbsp;&nbsp;&bull; Quantity:</td><td width="50%" height="35" align="left" valign="top"><select name="breakfast_quantity[]" id="breakfast_quantity_'+breakfast_cnt+'"><?php echo getMealQuantityOptions(''); ?></select>&nbsp;<span id="spn_breakfast_'+breakfast_cnt+'"></span><input type="hidden" name="breakfast_measure[]" id="breakfast_measure_'+breakfast_cnt+'" value="" /></td></tr><tr id="tr_breakfast_4_'+breakfast_cnt+'"><td width="50%" height="35" align="left" valign="top">&nbsp;&nbsp;&bull; My Desire:</td><td width="50%" height="35" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td width="50%" height="35" align="left" valign="top"><select name="breakfast_meal_like[]" id="breakfast_meal_like_'+breakfast_cnt+'" onchange="toggleMealLikeIcon(\'breakfast\',\''+breakfast_cnt+'\');"><?php echo getMealLikeOptions(''); ?></select></td><td width="50%" height="35" align="left" valign="top" id="spn_breakfast_meal_like_icon_'+breakfast_cnt+'"></td></tr></table></td></tr><tr id="tr_breakfast_5_'+breakfast_cnt+'"><td width="50%" align="left" valign="top">&nbsp;&nbsp;&bull; Item Remarks:</td><td width="50%" align="left" valign="top"><textarea name="breakfast_consultant_remark[]" id="breakfast_consultant_remark_'+breakfast_cnt+'" cols="25" rows="3"></textarea></td></tr><tr id="tr_breakfast_6_'+breakfast_cnt+'" style="display:none;" valign="top"><td align="left" colspan="2" class="err_msg" valign="top"></td></tr><tr id="tr_breakfast_7_'+breakfast_cnt+'"><td align="left" colspan="2" valign="top"></td></tr><tr id="tr_breakfast_8_'+breakfast_cnt+'"><td align="right" colspan="2" valign="top"><input type="button" value="Remove Item" onclick="removeMealRow(\'breakfast\','+breakfast_cnt+')"/></td></tr><tr id="tr_breakfast_9_'+breakfast_cnt+'"><td align="left" colspan="2" valign="top">&nbsp;</td></tr>');
                ...
                $('#addMoreBrunch').click(function() {
                        var brunch_cnt = parseInt($('#brunch_cnt').val());
                        var brunch_totalRow = parseInt($('#brunch_totalRow').val());
                        $('#tblbrunch tr[id="add_before_this_brunch"]').before('<tr id="tr_brunch_1_'+brunch_cnt+'"><td width="50%" height="35" align="left" valign="top">&nbsp;&nbsp;&bull; Item:</td><td width="50%" height="35" align="left" valign="top"><input name="brunch_item[]" type="text" class="input" id="brunch_item_'+brunch_cnt+'" value="" /></td></tr><tr id="tr_brunch_2_'+brunch_cnt+'"  style="display:none;"><td height="35" align="left" valign="top">&nbsp;</td><td height="35" align="left" valign="top"><input name="brunch_other_item[]" type="text" class="input" id="brunch_other_item_'+brunch_cnt+'" value="" /></td></tr><tr id="tr_brunch_3_'+brunch_cnt+'"><td width="50%" height="35" align="left" valign="top">&nbsp;&nbsp;&bull; Quantity:</td><td width="50%" height="35" align="left" valign="top"><select name="brunch_quantity[]" id="brunch_quantity_'+brunch_cnt+'"><?php echo getMealQuantityOptions(''); ?></select>&nbsp;<span id="spn_brunch_'+brunch_cnt+'"></span><input type="hidden" name="brunch_measure[]" id="brunch_measure_'+brunch_cnt+'" value="" /></td><tr id="tr_brunch_4_'+brunch_cnt+'"><td width="50%" height="35" align="left" valign="top">&nbsp;&nbsp;&bull; My Desire:</td><td width="50%" height="35" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td width="50%" height="35" align="left" valign="top"><select name="brunch_meal_like[]" id="brunch_meal_like_'+brunch_cnt+'" onchange="toggleMealLikeIcon(\'brunch\',\''+brunch_cnt+'\');"><?php echo getMealLikeOptions(''); ?></select></td><td width="50%" height="35" align="left" valign="top" id="spn_brunch_meal_like_icon_'+brunch_cnt+'"></td></tr></table></td></tr><tr id="tr_brunch_5_'+brunch_cnt+'"><td width="50%" align="left" valign="top">&nbsp;&nbsp;&bull; Item Remarks:</td><td width="50%" align="left" valign="top"><textarea name="brunch_consultant_remark[]" id="brunch_consultant_remark_'+brunch_cnt+'" cols="25" rows="3"></textarea></td></tr><tr id="tr_brunch_6_'+brunch_cnt+'" style="display:none;" valign="top"><td align="left" colspan="2" class="err_msg" valign="top"></td></tr><tr id="tr_brunch_7_'+brunch_cnt+'"><td align="left" colspan="2" valign="top"></td></tr><tr id="tr_brunch_8_'+brunch_cnt+'"><td align="right" colspan="2" valign="top"><input type="button" value="Remove Item" onclick="removeMealRow(\'brunch\','+brunch_cnt+')"/></td></tr><tr id="tr_brunch_9_'+brunch_cnt+'"><td align="left" colspan="2" valign="top">&nbsp;</td></tr>');
                ...
                $('#addMoreLunch').click(function() {
                        var lunch_cnt = parseInt($('#lunch_cnt').val());
                        var lunch_totalRow = parseInt($('#lunch_totalRow').val());
                        $('#tbllunch tr[id="add_before_this_lunch"]').before('<tr id="tr_lunch_1_'+lunch_cnt+'"><td width="50%" height="35" align="left" valign="top">&nbsp;&nbsp;&bull; Item:</td><td width="50%" height="35" align="left" valign="top"><input name="lunch_item[]" type="text" class="input" id="lunch_item_'+lunch_cnt+'" value="" /></td></tr><tr id="tr_lunch_2_'+lunch_cnt+'"  style="display:none;"><td height="35" align="left" valign="top">&nbsp;</td><td height="35" align="left" valign="top"><input name="lunch_other_item[]" type="text" class="input" id="lunch_other_item_'+lunch_cnt+'" value="" /></td></tr><tr id="tr_lunch_3_'+lunch_cnt+'"><td width="50%" height="35" align="left" valign="top">&nbsp;&nbsp;&bull; Quantity:</td><td width="50%" height="35" align="left" valign="top"><select name="lunch_quantity[]" id="lunch_quantity_'+lunch_cnt+'"><?php echo getMealQuantityOptions(''); ?></select>&nbsp;<span id="spn_lunch_'+lunch_cnt+'"></span><input type="hidden" name="lunch_measure[]" id="lunch_measure_'+lunch_cnt+'" value="" /></td></tr><tr id="tr_lunch_4_'+lunch_cnt+'"><td width="50%" height="35" align="left" valign="top">&nbsp;&nbsp;&bull; My Desire:</td><td width="50%" height="35" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td width="50%" height="35" align="left" valign="top"><select name="lunch_meal_like[]" id="lunch_meal_like_'+lunch_cnt+'" onchange="toggleMealLikeIcon(\'lunch\',\''+lunch_cnt+'\');"><?php echo getMealLikeOptions(''); ?></select></td><td width="50%" height="35" align="left" valign="top" id="spn_lunch_meal_like_icon_'+lunch_cnt+'"></td></tr></table></td></tr><tr id="tr_lunch_5_'+lunch_cnt+'"><td width="50%" align="left" valign="top">&nbsp;&nbsp;&bull; Item Remarks:</td><td width="50%" align="left" valign="top"><textarea name="lunch_consultant_remark[]" id="lunch_consultant_remark_'+lunch_cnt+'" cols="25" rows="3"></textarea></td></tr><tr id="tr_lunch_6_'+lunch_cnt+'" style="display:none;" valign="top"><td align="left" colspan="2" class="err_msg" valign="top"></td></tr><tr id="tr_lunch_7_'+lunch_cnt+'"><td align="left" colspan="2" valign="top"></td></tr><tr id="tr_lunch_8_'+lunch_cnt+'"><td align="right" colspan="2" valign="top"><input type="button" value="Remove Item" onclick="removeMealRow(\'lunch\','+lunch_cnt+')"/></td></tr><tr id="tr_lunch_9_'+lunch_cnt+'"><td align="left" colspan="2" valign="top">&nbsp;</td></tr>');
                ...
                $('#addMoreSnacks').click(function() {
                        var snacks_cnt = parseInt($('#snacks_cnt').val());
                        var snacks_totalRow = parseInt($('#snacks_totalRow').val());
                        $('#tblsnacks tr[id="add_before_this_snacks"]').before('<tr id="tr_snacks_1_'+snacks_cnt+'"><td width="50%" height="35" align="left" valign="top">&nbsp;&nbsp;&bull; Item:</td><td width="50%" height="35" align="left" valign="top"><input name="snacks_item[]" type="text" class="input" id="snacks_item_'+snacks_cnt+'" value="" /></td></tr><tr id="tr_snacks_2_'+snacks_cnt+'"  style="display:none;"><td height="35" align="left" valign="top">&nbsp;</td><td height="35" align="left" valign="top"><input name="snacks_other_item[]" type="text" class="input" id="snacks_other_item_'+snacks_cnt+'" value="" /></td></tr><tr id="tr_snacks_3_'+snacks_cnt+'"><td width="50%" height="35" align="left" valign="top">&nbsp;&nbsp;&bull; Quantity:</td><td width="50%" height="35" align="left" valign="top"><select name="snacks_quantity[]" id="snacks_quantity_'+snacks_cnt+'"><?php echo getMealQuantityOptions(''); ?></select>&nbsp;<span id="spn_snacks_'+snacks_cnt+'"></span><input type="hidden" name="snacks_measure[]" id="snacks_measure_'+snacks_cnt+'" value="" /></td></tr><tr id="tr_snacks_4_'+snacks_cnt+'"><td width="50%" height="35" align="left" valign="top">&nbsp;&nbsp;&bull; My Desire:</td><td width="50%" height="35" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td width="50%" height="35" align="left" valign="top"><select name="snacks_meal_like[]" id="snacks_meal_like_'+snacks_cnt+'" onchange="toggleMealLikeIcon(\'snacks\',\''+snacks_cnt+'\');"><?php echo getMealLikeOptions(''); ?></select></td><td width="50%" height="35" align="left" valign="top" id="spn_snacks_meal_like_icon_'+snacks_cnt+'"></td></tr></table></td></tr><tr id="tr_snacks_5_'+snacks_cnt+'"><td width="50%" align="left" valign="top">&nbsp;&nbsp;&bull; Item Remarks:</td><td width="50%" align="left" valign="top"><textarea name="snacks_consultant_remark[]" id="snacks_consultant_remark_'+snacks_cnt+'" cols="25" rows="3"></textarea></td></tr><tr id="tr_snacks_6_'+snacks_cnt+'" style="display:none;" valign="top"><td align="left" colspan="2" class="err_msg" valign="top"></td></tr><tr id="tr_snacks_7_'+snacks_cnt+'"><td align="left" colspan="2" valign="top"></td></tr><tr id="tr_snacks_8_'+snacks_cnt+'"><td align="right" colspan="2" valign="top"><input type="button" value="Remove Item" onclick="removeMealRow(\'snacks\','+snacks_cnt+')"/></td></tr><tr id="tr_snacks_9_'+snacks_cnt+'"><td align="left" colspan="2" valign="top">&nbsp;</td></tr>');
                ...
                $('#addMoreDinner').click(function() {
                    var dinner_cnt = parseInt($('#dinner_cnt').val());
                    var dinner_totalRow = parseInt($('#dinner_totalRow').val());
                    $('#tbldinner tr[id="add_before_this_dinner"]').before('<tr id="tr_dinner_1_'+dinner_cnt+'"><td width="50%" height="35" align="left" valign="top">&nbsp;&nbsp;&bull; Item:</td><td width="50%" height="35" align="left" valign="top"><input name="dinner_item[]" type="text" class="input" id="dinner_item_'+dinner_cnt+'" value="" /></td></tr><tr id="tr_dinner_2_'+dinner_cnt+'"  style="display:none;"><td height="35" align="left" valign="top">&nbsp;</td><td height="35" align="left" valign="top"><input name="dinner_other_item[]" type="text" class="input" id="dinner_other_item_'+dinner_cnt+'" value="" /></td></tr><tr id="tr_dinner_3_'+dinner_cnt+'"><td width="50%" height="35" align="left" valign="top">&nbsp;&nbsp;&bull; Quantity:</td><td width="50%" height="35" align="left" valign="top"><select name="dinner_quantity[]" id="dinner_quantity_'+dinner_cnt+'"><?php echo getMealQuantityOptions(''); ?></select>&nbsp;<span id="spn_dinner_'+dinner_cnt+'"></span><input type="hidden" name="dinner_measure[]" id="dinner_measure_'+dinner_cnt+'" value="" /></td></tr><tr id="tr_dinner_4_'+dinner_cnt+'"><td width="50%" height="35" align="left" valign="top">&nbsp;&nbsp;&bull; My Desire:</td><td width="50%" height="35" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td width="50%" height="35" align="left" valign="top"><select name="dinner_meal_like[]" id="dinner_meal_like_'+dinner_cnt+'" onchange="toggleMealLikeIcon(\'dinner\',\''+dinner_cnt+'\');"><?php echo getMealLikeOptions(''); ?></select></td><td width="50%" height="35" align="left" valign="top" id="spn_dinner_meal_like_icon_'+dinner_cnt+'"></td></tr></table></td></tr><tr id="tr_dinner_5_'+dinner_cnt+'"><td width="50%" align="left" valign="top">&nbsp;&nbsp;&bull; Item Remarks:</td><td width="50%" align="left" valign="top"><textarea name="dinner_consultant_remark[]" id="dinner_consultant_remark_'+dinner_cnt+'" cols="25" rows="3"></textarea></td></tr><tr id="tr_dinner_6_'+dinner_cnt+'" style="display:none;" valign="top"><td align="left" colspan="2" class="err_msg" valign="top"></td></tr><tr id="tr_dinner_7_'+dinner_cnt+'"><td align="left" colspan="2" valign="top"></td></tr><tr id="tr_dinner_8_'+dinner_cnt+'"><td align="right" colspan="2" valign="top"><input type="button" value="Remove Item" onclick="removeMealRow(\'dinner\','+dinner_cnt+')"/></td></tr><tr id="tr_dinner_9_'+dinner_cnt+'"><td align="left" colspan="2" valign="top">&nbsp;</td></tr>');
                ...
                var getUsersDailyMealsDetails = function() {
                        ...
                        obj.callback = function (responseTxt, responseStat) {
                                ...
                                $('#addMoreBrunch').click(function() {
                                    var brunch_cnt = parseInt($('#brunch_cnt').val());
                                    var brunch_totalRow = parseInt($('#brunch_totalRow').val());
                                    $('#tblbrunch tr[id="add_before_this_brunch"]').before('<tr id="tr_brunch_1_'+brunch_cnt+'"><td width="50%" height="35" align="left" valign="top">&nbsp;&nbsp;&bull; Item:</td><td width="50%" height="35" align="left" valign="top"><input name="brunch_item[]" type="text" class="input" id="brunch_item_'+brunch_cnt+'" value="" /></td></tr><tr id="tr_brunch_2_'+brunch_cnt+'"  style="display:none;"><td height="35" align="left" valign="top">&nbsp;</td><td height="35" align="left" valign="top"><input name="brunch_other_item[]" type="text" class="input" id="brunch_other_item_'+brunch_cnt+'" value="" /></td></tr><tr id="tr_brunch_3_'+brunch_cnt+'"><td width="50%" height="35" align="left" valign="top">&nbsp;&nbsp;&bull; Quantity:</td><td width="50%" height="35" align="left" valign="top"><select name="brunch_quantity[]" id="brunch_quantity_'+brunch_cnt+'"><?php echo getMealQuantityOptions(''); ?></select>&nbsp;<span id="spn_brunch_'+brunch_cnt+'"></span><input type="hidden" name="brunch_measure[]" id="brunch_measure_'+brunch_cnt+'" value="" /></td></tr><tr id="tr_brunch_4_'+brunch_cnt+'"><td width="50%" height="35" align="left" valign="top">&nbsp;&nbsp;&bull; My Desire:</td><td width="50%" height="35" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td width="50%" height="35" align="left" valign="top"><select name="brunch_meal_like[]" id="brunch_meal_like_'+brunch_cnt+'" onchange="toggleMealLikeIcon(\'brunch\',\''+brunch_cnt+'\');"><?php echo getMealLikeOptions(''); ?></select></td><td width="50%" height="35" align="left" valign="top" id="spn_brunch_meal_like_icon_'+brunch_cnt+'"></td></tr></table></td></tr><tr id="tr_brunch_5_'+brunch_cnt+'"><td width="50%" align="left" valign="top">&nbsp;&nbsp;&bull; Item Remarks:</td><td width="50%" align="left" valign="top"><textarea name="brunch_consultant_remark[]" id="brunch_consultant_remark_'+brunch_cnt+'" cols="25" rows="3"></textarea></td></tr><tr id="tr_brunch_6_'+brunch_cnt+'" style="display:none;" valign="top"><td align="left" colspan="2" class="err_msg" valign="top"></td></tr><tr id="tr_brunch_7_'+brunch_cnt+'"><td align="left" colspan="2" valign="top"></td></tr><tr id="tr_brunch_8_'+brunch_cnt+'"><td align="right" colspan="2" valign="top"><input type="button" value="Remove Item" onclick="removeMealRow(\'brunch\','+brunch_cnt+')"/></td></tr><tr id="tr_brunch_9_'+brunch_cnt+'"><td align="left" colspan="2" valign="top">&nbsp;</td></tr>');
                                    $("#brunch_item_"+brunch_cnt).autoSuggest(data.items, {asHtmlID:"brunch_item_"+brunch_cnt, preFill: {}, selectedItemProp: "name", searchObjProps: "name"  , selectedValuesProp: "value", extraParams: "brunch_"+brunch_cnt});
                                    brunch_cnt = brunch_cnt + 1;       
                                    $('#brunch_cnt').val(brunch_cnt);
                                    brunch_totalRow = brunch_totalRow + 1;       
                ...
                <tr>
                    <td width="50%" align="left" valign="top">
                        <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td height="50%" align="left" valign="top" class="breadcrumb">
                                ...
                                <td align="left" valign="top" bgcolor="#FFFFFF" style="background-repeat:repeat-x; padding:10px;">
                                    <form action="<?php echo SITE_URL.'/daily_meal.php';?>" id="frmdaily_meal" method="post" name="frmdaily_meal">
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td height="30" align="left" valign="top">
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <td width="50%" height="50" align="left" valign="middle" class="Header_brown">Date:</td>
                                            ...
                                            <tr>
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    <tr>
                                                                        <td align="left" valign="top">
                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                <tr>
                                                                                    <td width="50%" height="50" align="left" valign="top"><img src="images/icon_breakfast.jpg" width="40" height="40" /></td>
                                                                                    <td width="50%" height="50" align="left" valign="middle" class="Header_brown">Breakfast</td>
                                                                                    <td width="50%" height="50" align="left" valign="middle" class="Header_brown"></td>
                                                                            ...
                                                                            <div id="divbreakfast">                          
                                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0" id="tblbreakfast">
                                                                                    <tr>
                                                                                        <td width="50%" height="35" align="left" valign="top">&nbsp;&nbsp;&bull; Time:</td>
                                                                                        <td width="50%" height="35" align="left" valign="top">
                                                                                ...
                                                                                { ?>
                                                                                    <tr id="tr_breakfast_1_<?php echo $i;?>">
                                                                                        <td width="50%" height="35" align="left" valign="top">&nbsp;&nbsp;&bull; Item:</td>
                                                                                        <td width="50%" height="35" align="left" valign="top">
                                                                                            <input name="breakfast_item[]" type="text" class="input" id="breakfast_item_<?php echo $i;?>" value="<?php echo $breakfast_item_arr[$i];?>" />
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr id="tr_breakfast_2_<?php echo $i;?>"  style="display:<?php echo $tr_breakfast_other_item[$i];?>;">
                                                                                        ...
                                                                                        <td width="50%" height="35" align="left" valign="top">
                                                                                            <input name="breakfast_other_item[]" type="text" class="input" id="breakfast_other_item_<?php echo $i;?>" value="<?php echo $breakfast_other_item_arr[$i];?>" />
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr id="tr_breakfast_3_<?php echo $i;?>">
                                                                                        <td width="50%" height="35" align="left" valign="top">&nbsp;&nbsp;&bull; Quantity:</td>
                                                                                        <td width="50%" height="35" align="left" valign="top">
                                                                                    ...
                                                                                    <tr id="tr_breakfast_4_<?php echo $i;?>">
                                                                                        <td width="50%" height="35" align="left" valign="top">&nbsp;&nbsp;&bull; My Desire:</td>
                                                                                        <td width="50%" height="35" align="left" valign="top">
                                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                <tr>
                                                                                                    <td width="50%" height="35" align="left" valign="top">
                                                                                                    ...
                                                                                                    <td width="50%" height="35" align="left" valign="top" id="spn_breakfast_meal_like_icon_<?php echo $i;?>"><?php echo getMealLikeIcon($breakfast_meal_like_arr[$i]); ?></td>
                                                                                                </tr>
                                                                                            </table>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr id="tr_breakfast_5_<?php echo $i;?>">
                                                                                        <td width="50%" align="left" valign="top">&nbsp;&nbsp;&bull; Item Remarks:</td>
                                                                                        <td width="50%" align="left" valign="top">
                                                                                    ...
                                                                                    <tr id="tr_breakfast_8_<?php echo $i;?>">
                                                                                        <td align="right" colspan="2" valign="top">
                                                                                            <input type="button" value="Remove Item" onclick="removeMealRow('breakfast','<?php echo $i;?>')"/>
                                                                                        </td>
                                                                                    </tr>
									            ...
									            <?php
                                                                                    ...
                                                                                    <tr id="add_before_this_breakfast">
                                                                                        <td width="50%" height="30" align="left" valign="top">&nbsp;</td>
                                                                                        <td width="50%" height="30" align="left" valign="top">
                                                                                            <input type="button" value="add more" id="addMoreBreakfast" name="addMoreBreakfast" />
                                                                                        </td>
                                                                                    </tr>	
                                                                                </table>
                                                                            </div>
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    <tr>
                                                                        <td width="50%" height="50" align="left" valign="top">
                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                <tr>
                                                                                    <td width="50%" height="50" align="left" valign="top"><img src="images/icon_brunch.jpg" width="40" height="40" /></td>
                                                                                    <td width="50%" height="50" align="left" valign="middle" class="Header_brown">Brunch</td>
                                                                                    <td width="50%" height="50" align="left" valign="middle">&nbsp;</td>
                                                                                    <td width="50%" height="50" align="left" valign="middle">&nbsp;</td>
                                                                                </tr>
                                                                            </table>
                                                                            ...
                                                                            <div id="divbrunch"> 
                                                                                ...
                                                                                { ?>
                                                                                    <tr id="tr_brunch_1_<?php echo $i;?>">
                                                                                        <td width="50%" height="35" align="left" valign="top">&nbsp;&nbsp;&bull; Item:</td>
                                                                                        <td width="50%" height="35" align="left" valign="top">
                                                                                            <input name="brunch_item[]" type="text" class="input" id="brunch_item_<?php echo $i;?>" value="<?php echo $brunch_item_arr[$i];?>" />
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr id="tr_brunch_2_<?php echo $i;?>"  style="display:<?php echo $tr_brunch_other_item[$i];?>;">
                                                                                        <td width="50%" height="35" align="left" valign="top">&nbsp;</td>
                                                                                        <td width="50%" height="35" align="left" valign="top">
                                                                                            <input name="brunch_other_item[]" type="text" class="input" id="brunch_other_item_<?php echo $i;?>" value="<?php echo $brunch_other_item_arr[$i];?>" />
                                                                                        </td>
                                                                                    </tr>
                                                                                        ...
                                                                                        <td width="50%" height="35" align="left" valign="top">
                                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td width="50%" height="35" align="left" valign="top" id="spn_brunch_meal_like_icon_<?php echo $i;?>"><?php echo getMealLikeIcon($brunch_meal_like_arr[$i]); ?></td>
                                                                                               </tr>
                                                                                            </table>
                                                                                        </td>
                                                                                    </tr>
                                                                                    ...
                                                                                    <tr id="tr_brunch_8_<?php echo $i;?>">
                                                                                        <td align="right" colspan="2" valign="top">
                                                                                            <input type="button" value="Remove Item" onclick="removeMealRow('brunch','<?php echo $i;?>')"/>
                                                                                        </td>
                                                                                    </tr>
                                                                                    ...
                                                                                    <tr id="add_before_this_brunch">
                                                                                        <td width="50%" height="30" align="left" valign="top">&nbsp;</td>
                                                                                        <td width="50%" height="30" align="left" valign="top">
                                                                                            <input type="button" value="add more" id="addMoreBrunch" name="addMoreBrunch" />
                                                                                        </td>
                                                                                    </tr>	
                                                                                </table>
                                                                            </div>
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    <tr>
                                                                        <td width="50%" height="50" align="left" valign="top">
                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                <tr>
                                                                                    <td width="50%" height="50" align="left" valign="top"><img src="images/icon_lunch.jpg" width="40" height="40" /></td>
                                                                                    <td width="50%" height="50" align="left" valign="middle" class="Header_brown">Lunch</td>
                                                                                    <td width="50%" height="50" align="left" valign="middle">&nbsp;</td>
                                                                                    <td width="50%" height="50" align="left" valign="middle">&nbsp;</td>
                                                                                </tr>
                                                                            </table>
                                                                            <div id="divlunch"> 
                                                                                ...
                                                                                { ?>
                                                                                    <tr id="tr_lunch_1_<?php echo $i;?>">
                                                                                        <td width="50%" height="35" align="left" valign="top">&nbsp;&nbsp;&bull; Item:</td>
                                                                                        <td width="50%" height="35" align="left" valign="top">
                                                                                            <input name="lunch_item[]" type="text" class="input" id="lunch_item_<?php echo $i;?>" value="<?php echo $lunch_item_arr[$i];?>" />
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr id="tr_lunch_2_<?php echo $i;?>"  style="display:<?php echo $tr_lunch_other_item[$i];?>;">
                                                                                        <td width="50%" height="35" align="left" valign="top">&nbsp;</td>
                                                                                        <td width="50%" height="35" align="left" valign="top">
                                                                                            <input name="lunch_other_item[]" type="text" class="input" id="lunch_other_item_<?php echo $i;?>" value="<?php echo $lunch_other_item_arr[$i];?>" />
                                                                                        </td>
                                                                                    </tr>
                                                                                        ...
                                                                                        <td width="50%" height="35" align="left" valign="top">
                                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td width="50%" height="35" align="left" valign="top" id="spn_lunch_meal_like_icon_<?php echo $i;?>"><?php echo getMealLikeIcon($lunch_meal_like_arr[$i]); ?></td>
                                                                                               </tr>
                                                                                            </table>
                                                                                        </td>
                                                                                    </tr>
                                                                                    ...
                                                                                    <tr id="tr_lunch_8_<?php echo $i;?>">
                                                                                        <td align="right" colspan="2" valign="top">
                                                                                            <input type="button" value="Remove Item" onclick="removeMealRow('lunch','<?php echo $i;?>')"/>
                                                                                        </td>
                                                                                    </tr>
                                                                                    ...
                                                                                    <tr id="add_before_this_lunch">
                                                                                        <td width="50%" height="30" align="left" valign="top">&nbsp;</td>
                                                                                        <td width="50%" height="30" align="left" valign="top">
                                                                                            <input type="button" value="add more" id="addMoreLunch" name="addMoreLunch" />
                                                                                        </td>
                                                                                    </tr>	
                                                                                </table>
                                                                            </div>
                                                            	...
                                                            	<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    <tr>
                                                                        <td width="50%" height="50" align="left" valign="top">
                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                <tr>
                                                                                    <td width="50%" height="50" align="left" valign="top"><img src="images/icon_snacks.jpg" width="40" height="40" /></td>
                                                                                    <td width="50%" height="50" align="left" valign="middle" class="Header_brown">Snacks</td>
                                                                                    <td width="50%" height="50" align="left" valign="middle">&nbsp;</td>
                                                                                    <td width="50%" height="50" align="left" valign="middle">&nbsp;</td>
                                                                                </tr>
                                                                            </table>
                                                                            <div id="divsnacks"> 
                                                                                ...
                                                                                { ?>
                                                                                    <tr id="tr_snacks_1_<?php echo $i;?>">
                                                                                        <td width="50%" height="35" align="left" valign="top">&nbsp;&nbsp;&bull; Item:</td>
                                                                                        <td width="50%" height="35" align="left" valign="top">
                                                                                            <input name="snacks_item[]" type="text" class="input" id="snacks_item_<?php echo $i;?>" value="<?php echo $snacks_item_arr[$i];?>" />
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr id="tr_snacks_2_<?php echo $i;?>"  style="display:<?php echo $tr_snacks_other_item[$i];?>;">
                                                                                        <td width="50%" height="35" align="left" valign="top">&nbsp;</td>
                                                                                        <td width="50%" height="35" align="left" valign="top">
                                                                                            <input name="snacks_other_item[]" type="text" class="input" id="snacks_other_item_<?php echo $i;?>" value="<?php echo $snacks_other_item_arr[$i];?>" />
                                                                                        </td>
                                                                                    </tr>
                                                                                        ...
                                                                                        <td width="50%" height="35" align="left" valign="top">
                                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td width="50%" height="35" align="left" valign="top" id="spn_snacks_meal_like_icon_<?php echo $i;?>"><?php echo getMealLikeIcon($snacks_meal_like_arr[$i]); ?></td>
                                                                                               </tr>
                                                                                            </table>
                                                                                        </td>
                                                                                    </tr>
                                                                                    ...
                                                                                    <tr id="tr_snacks_8_<?php echo $i;?>">
                                                                                        <td align="right" colspan="2" valign="top">
                                                                                            <input type="button" value="Remove Item" onclick="removeMealRow('snacks','<?php echo $i;?>')"/>
                                                                                        </td>
                                                                                    </tr>
                                                                                    ...
                                                                                    <tr id="add_before_this_snacks">
                                                                                        <td width="50%" height="30" align="left" valign="top">&nbsp;</td>
                                                                                        <td width="50%" height="30" align="left" valign="top">
                                                                                            <input type="button" value="add more" id="addMoreSnacks" name="addMoreSnacks" />
                                                                                        </td>
                                                                                    </tr>	
                                                                                </table>
                                                                            </div>
                                                                    ...
                                                                    <tr>
                                                                        <td width="50%" height="50" align="left" valign="top">
                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                <tr>
                                                                                    <td width="50%" height="50" align="left" valign="top"><img src="images/icon_lunch.jpg" width="40" height="40" /></td>
                                                                                    <td width="50%" height="50" align="left" valign="middle" class="Header_brown">Dinner</td>
                                                                                    <td width="50%" height="50" align="left" valign="middle">&nbsp;</td>
                                                                                    <td width="50%" height="50" align="left" valign="middle">&nbsp;</td>
                                                                                </tr>
                                                                            </table>
                                                                            <div id="divdinner"> 
                                                                                ...
                                                                                { ?>
                                                                                    <tr id="tr_dinner_1_<?php echo $i;?>">
                                                                                        <td width="50%" height="35" align="left" valign="top">&nbsp;&nbsp;&bull; Item:</td>
                                                                                        <td width="50%" height="35" align="left" valign="top">
                                                                                            <input name="dinner_item[]" type="text" class="input" id="dinner_item_<?php echo $i;?>" value="<?php echo $dinner_item_arr[$i];?>" />
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr id="tr_dinner_2_<?php echo $i;?>"  style="display:<?php echo $tr_dinner_other_item[$i];?>;">
                                                                                        <td width="50%" height="35" align="left" valign="top">&nbsp;</td>
                                                                                        <td width="50%" height="35" align="left" valign="top">
                                                                                            <input name="dinner_other_item[]" type="text" class="input" id="dinner_other_item_<?php echo $i;?>" value="<?php echo $dinner_other_item_arr[$i];?>" />
                                                                                        </td>
                                                                                    </tr>
                                                                                        ...
                                                                                        <td width="50%" height="35" align="left" valign="top">
                                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td width="50%" height="35" align="left" valign="top" id="spn_dinner_meal_like_icon_<?php echo $i;?>"><?php echo getMealLikeIcon($dinner_meal_like_arr[$i]); ?></td>
                                                                                               </tr>
                                                                                            </table>
                                                                                        </td>
                                                                                    </tr>
                                                                                    ...
                                                                                    <tr id="tr_dinner_8_<?php echo $i;?>">
                                                                                        <td align="right" colspan="2" valign="top">
                                                                                            <input type="button" value="Remove Item" onclick="removeMealRow('dinner','<?php echo $i;?>')"/>
                                                                                        </td>
                                                                                    </tr>
                                                                                    ...
                                                                                    <tr id="add_before_this_dinner">
                                                                                        <td width="50%" height="30" align="left" valign="top">&nbsp;</td>
                                                                                        <td width="50%" height="30" align="left" valign="top">
                                                                                            <input type="button" value="add more" id="addMoreDinner" name="addMoreDinner" />
                                                                                        </td>
                                                                                    </tr>	
                                                                                </table>
                                                                            </div>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td width="50%" height="35" align="left" valign="top">&nbsp;</td>
                                                <td width="50%" align="left" valign="top"><input type="submit" name="btnSubmit" id="btnSubmit" value="Submit" /></td>
                                            </tr>
                                        </table>
                                    </form>
                                </td>
