...
//            $sql = "SELECT * FROM `tblprofilecustomcategories` WHERE 1 ".$sql_str_search." ORDER BY `prct_cat` ASC";    
   ...
   public function getMessageName($messid)
   {
	...
	public function UpdateCommonMessage($cs_id,$cs_value,$cs_name,$status,$mess_action_id,$admin_comment)
	{
		$my_DBH = new mysqlConnection();
                $DBH = $my_DBH->raw_handle();
                $DBH->beginTransaction();
                $return = false;
		$upd_sql = "UPDATE `tblcommonsettings` SET `cs_status` = '".$status."', `cs_name` = '".addslashes($cs_name)."', `cs_value` = '".addslashes($cs_value)."',`cs_mess_name_id` = '".$mess_action_id."',`cs_admin_comm` = '".$admin_comment."' WHERE `cs_id` = '".$cs_id."'";
	...
	public function getCommonMessageDetails($cs_id)
	{
		...
		return array($cs_name,$cs_value,$cs_status,$mess_action_id,$cs_admin_comm);
	}
...
public function getAllTablDropdowns($search,$status)
 ...
 public function addMessageNameKR($mes_name)
   ...
   public function getMessageActionsOptions($mess_action_id)
    ...
    public function addTablDropdownKR($admin_comment,$tablm_id,$table_name_str,$table_name)
    {
            $my_DBH = new mysqlConnection();
            $DBH = $my_DBH->raw_handle();
            $DBH->beginTransaction();
            ...
            $sql = "INSERT INTO `tbltabldropdown` (`admin_comment`,`tablm_id`,`tabl_name`,`tabl_status`,`updated_on_date`,`plan_table`)"
                ."VALUES ('".addslashes($admin_comment)."','".addslashes($tablm_id)."','".addslashes($table_name_str)."','1','".$updated_on_date."','".$table_name."')";
                $STH = $DBH->prepare($sql);
                $STH->execute();
                $DBH->commit();
            if($STH->rowCount() > 0)
    ...
    public function getTablDropdownDetailsKR($tabl_id)
     {
            ...
            return array('admin_comment'=>$admin_comment,'tabl_name'=>$tabl_name,'tablm_id'=>$tablm_id,'tabl_status'=>$tabl_status,'plan_table'=>$plan_table);
    } 
 ...
 public function getTableNameOptionsCheckedEdit($multitable)
    ...
    public function updateTablDropdownKR($admin_comment,$tabl_id,$tablm_id,$page_id_str,$ftablm_name,$tabl_status,$table_name)
    {
...
// exit;
    ...
    // $reference_name = stripslashes($row['reference_name']);
            ...
            return array($admin_comment,$arr_heading,$healcareandwellbeing,$page_name,$ref_code,$prof_cat1,$pag_cat_status,$heading,$time_show,$location_show,$like_dislike_show,$set_goals_show,$scale_show,$reminder_show,$order_show,$duration_show,$comments_show,$location_category,$user_response_category,$user_what_next_category,$alerts_updates_category,$canv_sub_cat1_link,$canv_sub_cat1_show_fetch,$page_type,$reference_name,$table_name,$report_name,$collect_arr);
    }  
    ...
    public function updateRecordsCatDropdown($admin_comment,$arr_heading,$pag_cat_status,$admin_id,$ref_code,$page_name,$sub_cat1,$prof_cat1,$id,$time_show,$duration_show,$location_show,$like_dislike_show,$set_goals_show,$scale_show,$reminder_show,$heading,$order_show,$comments_show,$location_category,$user_response_category,$user_what_next_category,$alerts_updates_category,$cat_fetch_show_data,$canv_sub_cat_link,$data_source,$report_name,$arr,$checkvalue)
    {
      ...
      $getuniqu_id='ID'.time().date();
        ...
        foreach($getselected_data  as $upvalue)
        {
          ...
          if($upvalue[0]!='' && $upvalue[1]!='')
          {
               ...
               `col_report_order`=".$upvalue[9]." WHERE `col_id`=".$upvalue[1]." AND `uniqu_m_id`='".$upvalue[0]."'";
          ...
          else
          {
              ...
              //   }
               ...
               $inser="INSERT INTO `tblcolumndetails`(`col_name`,`uniqu_m_id`,`col_report_label`,`col_row_col`,`col_query_field`,`col_query_order`,`col_query_combo`,`col_report_feild`,`col_report_order`) VALUES('".$upvalue[2]."','".$getuniqu_id."','".$upvalue[3]."','".$upvalue[4]."','".$upvalue[5]."','".$upvalue[6]."','".$upvalue[7]."','".$upvalue[8]."','".$upvalue[9]."')";
                    ...
                    $html.=' <tr>
                                 <td width="15%" align="left">'.$row['column_name'].'
                                  ...
                                  <input class="chkbxapaid" type="checkbox" name="check_[]" id="check_'.$index.'" value="'.$row['column_name'].'" onclick="return selectcheck('.$index.',\''.$row['column_name'].'\');"></td>
                                    ...
                                    <td width="20%" align="left" valign="top">
                                        <input type="text" name="report_header[]" id="report_header'.$index.'" onkeyup="return oninput_reportname('.$index.');" disabled>
                                    </td>
                                    

                                     <td width="10%" valign="top">
                                        <select class="selapaid" name="query_field_Y_N[]" id="query_field_Y_N'.$index.'" style="width:60px;" onchange="return get_query_field('.$index.');" disabled>
                                     ...
                                     <td width="1%" valign="top">
                                        <select class="selapaid" name="query_order[]" id="query_order'.$index.'" style="width:60px;" onchange="return get_query_order('.$index.');" disabled>';
                                     ...
                                     <td width="9%" valign="top">
                                        <select class="selapaid" name="query_combo[]" id="query_combo'.$index.'" style="width:60px;" onchange="return get_query_combo('.$index.');" disabled>';
                                     ...
                                     <td align="left" valign="top">
                                        <select class="selapaid" name="row_col[]" id="row_col'.$index.'" style="width:60px;" onchange="return row_colums('.$index.');" disabled>
                                              <option value="">-Select-</option>
                                              <option value="Rows">Rows</option>
                                              <option value="Colums">Colums</option>
                                    ...
                                    <td width="9%" valign="top">
                                        <select class="selapaid" name="report_field_Y_N[]" id="report_field_Y_N'.$index.'" style="width:60px;" onchange="return get_report_field('.$index.');" disabled>
                                               <option value="">-Select-</option>
                                              <option value="Yes">Yes</option>
                                              <option value="No">No</option>
                                        </select>
                                     ...
                                     <td align="left" valign="top">
                                        <select class="selapaid" name="report_order[]" id="report_order'.$index.'" style="width:60px;" onchange="return get_report_order('.$index.');" disabled>
                                        ';
                                           $html.='<option value="0">-Select-</option>';
                                            for($i=1;$i<16;$i++)
                                            {
...
public function getcolumsNameOftable($tablm_name)
{
    ...
    public function addRecordsDropdown($ref_code,$admin_comment,$fav_cat_type_id_0,$healcareandwellbeing,$page_type,$page_name,$heading,$table_dropdown_ref,$data_source,$report_name,$prof_cat1,$arr_selected_cat_id1,$cat_fetch_show_data,$canv_sub_cat_link,$order_show,$admin_id,$arr,$checkvalue)
        {
       ...
       //     echo "<pre>";print_r($arr);echo "</pre>";
            ...
            // {  
                ...
                '".$data_source."',
                '".$page_type."')"; //$healcareandwellbeing[$i]
             ...
             // $DBH->commit();
               ...
               {
                  $sql2="INSERT INTO `tblcolumndetails`(`col_name`,`uniqu_m_id`,`col_report_label`,`col_row_col`,`col_query_field`,`col_query_order`,`col_query_combo`,`col_report_feild`,`col_report_order`)"
                  ."VALUES('".$value_table[0]."','". $getuniqu_id."','".$value_table[1]."','".$value_table[2]."','".$value_table[3]."','".$value_table[4]."','".$value_table[5]."','".$value_table[6]."','".$value_table[7]."')";
 ...
 //ramakant end 01-10-2018       
    ...
    //ramakant added 07/03/2019
    public function AddMessageContent($message_type,$message_contents,$admin_id,$mess_name_id,$admin_comment)
	{
		$my_DBH = new mysqlConnection();
                $DBH = $my_DBH->raw_handle();
                $DBH->beginTransaction();
                $return = false;
		$ins_sql = "INSERT INTO `tblcommonsettings`(`cs_name`,`cs_mess_name_id`,`cs_admin_comm`,`cs_value`,`cs_status`,`cs_type`) VALUES ('".addslashes($message_type)."','".$mess_name_id."','".$admin_comment."','".addslashes($message_contents)."','1','MSG')";
		$STH = $DBH->prepare($ins_sql);
                $STH->execute();
...
//                    $page_name_str = $obj2->getIdByProfileFavCategoryName($row['page_id_str']);           
     ...
     public function addPagePopup($admin_comment,$arr_heading,$fav_cat_type_id_0,$healcareandwellbeing,$ref_code,$page_name,$sub_cat1,$sub_cat2,$sub_cat3,$sub_cat4,$sub_cat5,$sub_cat6,$sub_cat7,$sub_cat8,$sub_cat9,$sub_cat10,$prof_cat1,$prof_cat2,$prof_cat3,$prof_cat4,$prof_cat5,$prof_cat6,$prof_cat7,$prof_cat8,$prof_cat9,$prof_cat10,$admin_id,$time_show,$duration_show,$location_show,$like_dislike_show,$set_goals_show,$scale_show,$reminder_show,$heading,$order_show,$comments_show,$location_category,$user_response_category,$user_what_next_category,$alerts_updates_category,$cat_fetch_show_data,$canv_sub_cat_link,$data_source,$page_type,$page_show)
    {
           ...
           $DBH->beginTransaction();
            ...
            // for($i=0;$i<count($healcareandwellbeing);$i++)
            // {
            $sql = "INSERT INTO `tbl_page_pop` (`admin_comment`,`system_cat`,`healcareandwellbeing`,`page_name`,`ref_code`,`sub_cat1`,`prof_cat1`,`pag_cat_status`,`added_by_admin`,`updated_by_admin`,`updated_on_date`,`heading`,`order_show`,`canv_sub_cat1_show_fetch`,`canv_sub_cat1_link`,`data_source`,`page_type`,`pop_show`) "
                . "VALUES ('".addslashes($admin_comment)."','".addslashes($fav_cat_type_id_0)."','".addslashes($healcareandwellbeing_collect)."','".addslashes($page_name)."','".addslashes($ref_code)."','".addslashes($sub_cat1)."','".addslashes($prof_cat1)."','1','".$admin_id."','".$admin_id."','".$updated_on_date."','".$heading."','".$order_show."','".$canv_sub_cat1_show_fetch."','".$canv_sub_cat_link['canv_sub_cat1_link']."','".$data_source."','".$page_type."','".$page_show."')";
                $STH = $DBH->prepare($sql);
                $STH->execute();
            // }
            if($STH->rowCount() > 0)
     ...
     public function getPagepopDetails($page_cat_id)
    {
            ...
            return array($admin_comment,$arr_heading,$healcareandwellbeing,$page_name,$ref_code,$prof_cat1,$pag_cat_status,$heading,$order_show,$canv_sub_cat1_link,$canv_sub_cat1_show_fetch,$page_type,$show_pop);
    }  
