...
// stripslashes($row['page_id'])
 ...
 public function addMessageNameKR($mes_name)
   ...
   public function getMessageActionsOptions($mess_action_id)
    ...
    public function addTablDropdownKR($admin_comment,$tablm_id,$table_name_str,$page_id,$admin_id)

    {
            ...
            $sql = "INSERT INTO `tbltabldropdown` (`admin_comment`,`tablm_id`,`tabl_name`,`tabl_status`,`updated_on_date`,`page_id`,`added_by_admin`)"

                ."VALUES ('".addslashes($admin_comment)."','".addslashes($tablm_id)."','".addslashes($table_name_str)."','1','".$updated_on_date."','".$page_id."','".$admin_id."')";
    ...
    public function getTablDropdownDetailsKR($tabl_id)

     {
            ...
            return array('admin_comment'=>$admin_comment,'tabl_name'=>$tabl_name,'tablm_id'=>$tablm_id,'tabl_status'=>$tabl_status,'page_id'=>$page_id);
...
// exit;
    ...
    // $reference_name = stripslashes($row['reference_name']);
            ...
            return array($admin_comment,$arr_heading,$healcareandwellbeing,$page_name,$ref_code,$prof_cat1,$pag_cat_status,$heading,$time_show,$location_show,$like_dislike_show,$set_goals_show,$scale_show,$reminder_show,$order_show,$duration_show,$comments_show,$location_category,$user_response_category,$user_what_next_category,$alerts_updates_category,$canv_sub_cat1_link,$canv_sub_cat1_show_fetch,$page_type,$reference_name,$table_name,$report_name,$collect_arr,$enduse,$wa_main_cat,$wa_sub_cat);
...

            {
...

                {
                     ...
                     $index++;
                        ...
                        $sql1 = "SELECT table_name FROM information_schema.tables where table_schema='wellness'";
...

{
 ...
 public function getTableNameOptions_dropdown_kr2($get,$select_value)
    ...
    public function addRecordsDropdown($ref_code,$admin_comment,$fav_cat_type_id_0,$healcareandwellbeing,$page_type,$page_name,$heading,$table_dropdown_ref,$data_source,$report_name,$prof_cat1,$arr_selected_cat_id1,$cat_fetch_show_data,$canv_sub_cat_link,$order_show,$admin_id,$arr,$checkvalue,$show_value,$va_cat_id,$va_sub_cat_id)
       ...
       //     echo "<pre>";print_r($arr);echo "</pre>";
            ...
            // {  
                ...
                '".$va_sub_cat_id."')"; //$healcareandwellbeing[$i]
