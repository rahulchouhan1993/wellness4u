...
if(isset($_POST['save']))
{
	...
	$res=$obj2->update_banners_DYL($id,$data,$count_row);
									...
									foreach ($data as $key => $value) {
				                        ...
				                        <table class="table table-borderless" id="row<?=$key;?>">
				                            ...
				                            <tr>
				                                ...
				                                <td>
				                                    <input type="text" class="form-control" name="credit_line_url[]" id="banner<?=$key;?>_credit_url" value="<?=$banner_credit_url;?>" readonly style="min-width: 250px;"> 
				                                </td> 
				                            </tr>
				                            <tr>
				                                <td>
			...
			if(x < max_fields){ //max input box allowed
				...
				html+='<table class="table table-borderless" id="row'+new_row+'">'+
                                    ...
                                    '<tr>'+
                                        ...
                                        '</td>'+
                                        '<td>'+
                                            '<input type="text" class="form-control" id="banner'+new_row+'_credit_url" value="http://" name="credit_line_url[]" readonly style="min-width: 250px;">'+ 
                                        '</td>'+
                                    '</tr>'+
                                    '<tr>'+
		                                '<td>'+
