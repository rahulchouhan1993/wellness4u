...
if(isset($_POST['btnSubmit']))
{
	...
	if(!$error)
	{
		$adviser_panel = '0';
                $vender_panel = '1';
		if($obj->AddContent($page_name,$page_title,$page_contents,$meta_title,$meta_keywords,$meta_description,$menu_title,$menu_link_enable,$adviser_panel,$page_contents2,$vender_panel))
		{
			...
			<td>
				...
				<tbody>
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Add Vender Panel Page </td>
