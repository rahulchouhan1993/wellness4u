            ...
            <td>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Clients Master</td>
                        ...
                        <td class="mainbox-body">
                            ...
                            <div id="pagination_contents" align="center"> 
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td width="6%" height="30" align="left" valign="middle"><strong>Client Type:</strong></td>
                                    ...
                                    <tr>
                                        ...
                                        <td height="30" align="left" valign="middle">&nbsp;</td>
                                        <td height="30" align="left" valign="middle"><strong>&nbsp;</td>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        { ?>
                                            <a href="index.php?mode=add_client"><img src="images/add.gif" width="10" height="8" border="0" />Add New Entry</a>
                                        <?php 
                                        } ?>
                                        </td>
                                    </tr>
                                    <tr class="manage-header">
                                        ...
                                        <td width="15%" class="manage-header" align="center">Client Name</td>
                                        <td width="10%" class="manage-header" align="center">Client Type</td>
                                        <td width="10%" class="manage-header" align="center">Authorise Person</td>
                                        <td width="10%" class="manage-header" align="center">Email</td>
                                    ...
                                    <?php
                                    echo $obj->getAllContracts($contract_person_type,$search,$status,$country_id,$arr_state_id,$arr_city_id,$arr_place_id);
                                    ?>
                                </tbody>
                                </table>
                                <p></p>
