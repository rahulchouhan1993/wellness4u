...

{
	...
	{
        //update by ample 03-01-20
	    if($obj->addMainSymptomRamakant($sub_cat_link,$key_fav_cat_id,$key_fav_cat_type_id,$keywords,$cat_total_cnt1,$daily_code,$bms_name,$comment,$show_hide,$arr_cucat_parent_cat_id,$arr_cucat_cat_id,$cat_total_cnt,$sub_cat_code))
...
<!--                                                <option value="">Select Type</option>-->
                                        ...
                                        <td width="15%" height="30" align="left" valign="middle">
                                            ...
                                            <select name="sub_cat_link[]" id="sub_cat_link_<?php echo $i;?>" style="width:150px; height: 23px;" onchange="get_column_names(this,'sub_cat_code_<?php echo $i;?>')">
                                               ...
                                               <!--  <option value="tbl_bodymainsymptoms" <?php if($sub_cat_link[$i] == 'tbl_bodymainsymptoms'){ echo 'selected'; } ?>>tbl_bodymainsymptoms</option>
                                                ...
                                                <?php 
                                                //add by ample 03-01-20
                                                echo $obj3->getTableNameFrom_tbltabldropdown('7');
                                                ?>
                                       ...
                                       <!--  <td width="2.5%" height="30" align="left" valign="middle"><strong>Keywords:</strong></td>
...
//                                            ?> -->
                                    ...
                                    <tr id="row_cats_<?php if($i == 0){ echo 'first';}else{ echo $i;}?>">
                                        ...
                                        <td width="15%" height="30" align="left" valign="middle">
                                           ...
                                           <!--  <input name="keywords[]" type="text" id="keywords_<?php echo $i;?>" onkeyup="autocompleteSportsTeams(<?php echo $i;?>); return false;" style="width:150px; height: 25px;"> -->
                                           <!-- update by ampple 08-01-20 -->
                                           <select name="keywords[]" id="keywords_<?php echo $i;?>" style="width:150px; height: 25px;">
                                                <option value="">Select</option>
                                            </select>
                               ...
                               '<td width="5%" height="30" align="left" valign="middle"><strong>Suggestions fav:</strong></td>'+
                                ...
                                '<tr class="row_cats_'+cat_cnt1+'">'+
                                        ...
                                        '<td width="15%" height="30" align="left" valign="middle">'+
                                            ...
                                            '<select name="keywords[]" id="keywords_'+cat_cnt1+'" style="width:150px; height: 25px;">'+
                                                '<option value="">Select</option>'+
                                            '</select>'+
