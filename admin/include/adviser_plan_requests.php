							...
							<div id="pagination_contents" align="center"> 
								...
								<tbody>
									...
									<tr class="manage-header">
									    ...
									    <td class="manage-header" align="center" width="20%">Adviser Name</td>
                                        <td class="manage-header" align="center" width="10%">Adviser Id</td>
									...
									<?php
									echo $obj->GetAllAdviserPlanRequests($search);
									?>
								</tbody>
								</table>
								<p></p>
