			...
			<td>
				...
				<tbody>
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Assign Interpretation</td>
							...
							<div id="pagination_contents" align="center"> 
								...
								<tbody>
									<tr>
                                        ...
                                        { ?>
											<a href="index.php?mode=add_interpretation"><img src="images/add.gif" width="10" height="8" border="0" />Add New Entry</a>
										<?php 
										} ?>
                                        </td>
									</tr>
									<tr class="manage-header">
										 <td width="5%" class="manage-header" align="center" >S.No.</td>
                                                                                       <td width="30%" class="manage-header" align="center">LAB</td>
                                                                                 <td width="30%" class="manage-header" align="center">ADVISER</td>
                                                                                 <td width="30%" class="manage-header" align="center">Interpretation System Code</td>
                                                                                 <!--<td width="30%" class="manage-header" align="center">Interpretation System Reference No</td>-->
										 <td width="30%" class="manage-header" align="center">Interpretation Criteria</td>
                                                                                 <td width="10%" class="manage-header" align="center">Scale From</td>
                                                                                 <td width="10%" class="manage-header" align="center">Scale To</td>
                                                                                 <td width="10%" class="manage-header" align="center">Symptom Type</td>
                                                                                 <td width="10%" class="manage-header" align="center">Symptom Name</td>
                                                                                 <td width="10%" class="manage-header" align="center">Interpretation</td>
                                                                                 <td width="10%" class="manage-header" align="center">Comment</td>
                                                                                 <td width="10%" class="manage-header" align="center">Share Type</td>
                                                                                 <td width="5%" class="manage-header" align="center">Order</td>
                                                                             
                                                                              
                                                                                 
<!--                                                                                <td width="10%" class="manage-header" align="center">Identity Type</td>
                                                                                <td width="10%" class="manage-header" align="center">Identity Id</td>-->
									...
									<?php
									echo $obj->getAllInterpretation($practitioner_id,$search,$status,$country_id,$arr_state_id,$arr_city_id,$arr_place_id,$start_date);
									?>
								</tbody>
								</table>
								<p></p>
