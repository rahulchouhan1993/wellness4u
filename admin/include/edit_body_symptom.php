...
if(isset($_POST['btnSubmit']))
{
	...
	if(!$error)
	{
            if($obj->updateBodySymptom($bms_id,$bp_id,$bs_remarks,$arr_min_rating,$arr_max_rating,$arr_interpretaion,$arr_treatment,$status,$bs_id))
            {
...
{
	$bs_id = $_GET['id'];
	list($bms_id,$bp_id,$bs_remarks,$status,$arr_min_rating,$arr_max_rating,$arr_interpretaion,$arr_treatment) = $obj->getBodySymptomDetails($bs_id);
	if($bms_id == '')
	{
		header('location: index.php?mode=body_symptoms');	
	}
			...
			<td>
				...
				<tbody>
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Edit Body Symptom</td>
				...
				<tbody>
					<tr>
						<td class="mainbox-body">
							...
							<input type="hidden" name="hdnbs_id" id="hdnbs_id" value="<?php echo $bs_id;?>" />
