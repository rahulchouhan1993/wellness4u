			...
			<td>
				...
				<tbody>
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Add Top Banner</td>
                            ...
                            <tr>
                                ...
                                <tr>
                                   <td align="right"><strong>Upload Image</strong>
                                    ...
                                    <td><input name="banner" type="file" id="banner" />
                                     </td>
                                  </tr>
                                  <tr height="30">
									<td colspan="2" align="center">&nbsp;</td>
                                    <td colspan="" align="left">Please upload image width with 960px and height with 150px.</td>
								</tr>
								<tr>
									<td colspan="3" align="center">&nbsp;</td>
								</tr>
