            ...
            <td>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Page Popup</td>
...
<!--                                        <td width="10%" height="30" align="left" valign="middle"><strong>Profile Category:</strong></td>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        { ?>
                                            <a href="index.php?mode=add_page_pop"><img src="images/add.gif" width="10" height="8" border="0" />Add New Entry</a>
                                        <?php 
                                        } ?>
                                        </td>
                                    </tr>
                                    ...
                                    echo $obj->getPagePopup($search,$status);
                                    ?>
                                </tbody>
                                </table>
                                <p></p>
