...
if(isset($_POST['btnSubmit']))
{
	...
	{
		$error = true;
		$err_msg .= "<br>Please Enter Stress Buster Box Title.";
	}
	...
	if(!$error)
		{   
			if($obj->Add_StressBuster($step,$box_title,$banner_type,$banner,$box_desc,$credit_line,$credit_line_url,$day,$sound_clip_id))
				{
					$msg = "Record Added Successfully!";
					header('location: index.php?mode=stressbuster&msg='.urlencode($msg));
				}
			else
				{
					$error = true;
			...
			<td>
				...
				<tbody>
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Add Stress Buster</td>
					...
					<tr>
						<td class="mainbox-body">
							...
							<tbody>
								...
								<tr>
									<td width="20%" align="right"><strong>Stress Buster Box Banner Type</strong></td>
									<td width="5%" align="center"><strong>:</strong></td>
