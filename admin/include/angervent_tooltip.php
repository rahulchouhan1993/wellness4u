...
if(isset($_POST['btnSubmit']))
{
	...
	if(!$error)
		{   
			if($angervent->AddAngerventToolTip($page_id,$contents))
				{
    ...
    
	{
		...
		$contents = $angervent->getAngerventToolTip();
			...
			<td>
				...
				<tbody>
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Anger Vent Tooltip</td>
				...
				<tbody>
					<tr>
						<td class="mainbox-body">
							<form action="#" method="post" name="frm_angervent" id="frm_angervent" enctype="multipart/form-data" >
							 ...
							 <tr>
								...
								<tr>
									...
									<td align="left"><input type="Submit" name="btnSubmit" value="Submit" />&nbsp;
                                    				<input type="button" name="btnSubmit" value="Back" onclick="window.location.href='index.php?mode=angervent';"/></td>
								</tr>
							</tbody>
							</table>
							</form>
