...
foreach($getselected_data as $key=>$tblvalue)
{
     ...
     // exit;
        ...
        // echo "<pre>";print_r($date_query_for_Qc);echo "</per>";
    ...
    if(!$error)
    {
        ...
        if($obj->addRecordsDropdown($ref_code,$admin_comment,$fav_cat_type_id_0,$healcareandwellbeing,$page_type,$page_name,$heading,$table_dropdown_ref,$data_source,$report_name,$prof_cat1,$arr_selected_cat_id1,$cat_fetch_show_data,$canv_sub_cat_link,$order_show,$admin_id,$arr,$checkvalue))
        {
...
if($('#check_'+num).is(":checked")) {
    $('#checkvalue'+num).val(colums);
     ...
     sessionStorage.setItem('checkvalue'+num, colums);
      ...
      document.getElementById("report_header"+num).disabled = false; 
      document.getElementById("query_field_Y_N"+num).disabled = false; 
      document.getElementById("query_order"+num).disabled = false; 
      document.getElementById("query_combo"+num).disabled = false; 
      document.getElementById("row_col"+num).disabled = false; 
      document.getElementById("report_field_Y_N"+num).disabled = false; 
      document.getElementById("report_order"+num).disabled = false; 

     getkeepling(num);


    sessionStorage.setItem('report_header_'+num,'');
    sessionStorage.setItem('header_arr_'+num,'report_header'+num);

    sessionStorage.setItem('query_field_Y_N'+num,'');
    sessionStorage.setItem('QF_Y_N_arr_'+num,'query_field_Y_N'+num);

    sessionStorage.setItem('query_order'+num,'');
    sessionStorage.setItem('query_order_arr_'+num,'query_order'+num);



     sessionStorage.setItem('query_combo'+num,'');
     sessionStorage.setItem('query_combo_arr_'+num,'query_combo'+num);

     sessionStorage.setItem('row_col'+num,'');
     sessionStorage.setItem('row_col_arr_'+num,'row_col'+num);

     sessionStorage.setItem('report_field_Y_N'+num,'');
     sessionStorage.setItem('report_field_Y_N_arr_'+num,'report_field_Y_N'+num);

      sessionStorage.setItem('report_order'+num,'');
     sessionStorage.setItem('report_order_arr_'+num,'report_order'+num);
       // allcol();
  }
   else
  {
     $('#checkvalue'+num).val('');
      ...
      document.getElementById("report_header"+num).disabled = true; 
      document.getElementById("query_field_Y_N"+num).disabled = true; 
      document.getElementById("query_order"+num).disabled = true; 
      document.getElementById("query_combo"+num).disabled = true; 
      document.getElementById("row_col"+num).disabled = true; 
      document.getElementById("report_field_Y_N"+num).disabled = true; 
      document.getElementById("report_order"+num).disabled = true;

     getkeepling(num);

        sessionStorage.setItem('report_header_'+num,'disabled');
        sessionStorage.setItem('header_arr_'+num,'report_header'+num);

        sessionStorage.setItem('query_field_Y_N'+num,'disabled');
        sessionStorage.setItem('QF_Y_N_arr_'+num,'query_field_Y_N'+num);

        sessionStorage.setItem('query_order'+num,'disabled');
        sessionStorage.setItem('query_order_arr_'+num,'query_order'+num);



       sessionStorage.setItem('query_combo'+num,'disabled');
       sessionStorage.setItem('query_combo_arr_'+num,'query_combo'+num);

       sessionStorage.setItem('row_col'+num,'disabled');
       sessionStorage.setItem('row_col_arr_'+num,'row_col'+num);

       sessionStorage.setItem('report_field_Y_N'+num,'disabled');
       sessionStorage.setItem('report_field_Y_N_arr_'+num,'report_field_Y_N'+num);

       sessionStorage.setItem('report_order'+num,'disabled');
       sessionStorage.setItem('report_order_arr_'+num,'report_order'+num);
...
function allcol()
{
     ...
     for(var i=0;i<countfeild;i++)
     {
         ...
         $('#'+sessionStorage.getItem('header_arr_'+a)).attr('disabled',sessionStorage.getItem('report_header_'+a));
         $('#'+sessionStorage.getItem('QF_Y_N_arr_'+a)).attr('disabled',sessionStorage.getItem('query_field_Y_N'+a));
         $('#'+sessionStorage.getItem('query_order_arr_'+a)).attr('disabled',sessionStorage.getItem('query_order'+a));

         $('#'+sessionStorage.getItem('query_combo_arr_'+a)).attr('disabled',sessionStorage.getItem('query_combo'+a));
         $('#'+sessionStorage.getItem('row_col_arr_'+a)).attr('disabled',sessionStorage.getItem('row_col'+a));
         $('#'+sessionStorage.getItem('report_field_Y_N_arr_'+a)).attr('disabled',sessionStorage.getItem('report_field_Y_N'+a));
         $('#'+sessionStorage.getItem('report_order_arr_'+a)).attr('disabled',sessionStorage.getItem('report_order'+a));
