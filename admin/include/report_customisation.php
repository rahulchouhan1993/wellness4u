            ...
            <td>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Report Costomisation</td>
...
<!--                                        <td width="10%" height="30" align="left" valign="middle"><strong>Profile Category:</strong></td>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        { ?>
                                            <a href="index.php?mode=add_report_customisation"><img src="images/add.gif" width="10" height="8" border="0" />Add New Entry</a>
                                        <?php 
                                        } ?>
                                        </td>
                                    </tr>
                                    <tr class="manage-header">
                                        ...
                                        <td width="5%" class="manage-header" align="center">Table dropdown ref.</td>
                                        <td width="5%" class="manage-header" align="center">Table Name</td>
                                        <td width="5%" class="manage-header" align="center">Report</td>
                                    ...
                                    <?php
                                    echo $obj->getAllRecordDropdowns($search,$status);
                                    ?>
                                </tbody>
                                </table>
                                <p></p>
