...
if(isset($_POST['save']))
{
	...
	$res=$obj2->update_banners_solutionItems($id,$data,$count_row);

	if($res)
	{	
		$_SESSION['banner_msg'] = 'Banners Updated Successfully!';
		header("Location: index.php?mode=edit_wellness_solution_item&id=".$id);
		exit(0);
	}

}

$data=$obj2->get_banners_solutionItems($id);
...
<!--notification_contents-->
	...
	<tbody>
			...
			<td>
				...
				<tbody>
                    <tr>
                        ...
                        <td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Update WSI Banners</td>
		...
		<tr>
			<td>
				<br>
				<a href="index.php?mode=edit_wellness_solution_item&id=<?=$_GET['item_id']?>"><button class="btn btn-default">Back</button></a>
								...
								if(empty($data))
								{
			                        ...
			                        <table class="table table-borderless" id="row0">
			                            ...
			                            <tr>
			                                ...
			                                <td>
			                                    <input type="text" class="form-control" value="http://" name="credit_line_url[]" style="min-width: 250px;"> 
			                                </td> 
			                            </tr>
			                            <tr>
			                                <td>
			                            ...
			                            <tr>
			                                ...
			                                <td>
			                                   <textarea id="narration" rows="3" cols="50" name="narration[]" class="form-control"></textarea>
			                                </td>
			                                <td></td>
			                                <td></td> 
			                            </tr>
									...
									foreach ($data as $key => $value) {
				                        ...
				                        <table class="table table-borderless" id="row<?=$key;?>">
				                            ...
				                            <tr>
				                            	...
				                            	<?php 
			                                        ...
			                                        if(!empty($value['banner_type']))
			                                        {
			                                            ...
			                                            {
			                                                $banner_data=$obj->get_data_from_tblsolutionitems('',$value['banner']);
				                            ...
				                            <tr>
				                                ...
				                                <td>
				                                    <input type="text" class="form-control" id="banner<?=$key;?>_credit" name="credit_line[]" value="<?=$banner_credit;?>"> 
				                                </td>
				                                <td>
				                                    <label>Credit Line URL:</label>
				                                </td>
				                                <td>
				                                    <input type="text" class="form-control" name="credit_line_url[]" id="banner<?=$key;?>_credit_url" value="<?=$banner_credit_url;?>" style="min-width: 250px;"> 
				                                </td> 
				                            </tr>
				                            <tr>
				                                <td>
				                            ...
				                            <tr>
				                                ...
				                                <td>
				                                   <textarea id="narration" rows="3" cols="50" name="narration[]" class="form-control"><?=$value['narration'];?></textarea>
				                                </td>
				                                <td></td>
				                                <td></td> 
				                            </tr>
			...
			if(x < max_fields){ //max input box allowed
				...
				html+='<table class="table table-borderless" id="row'+new_row+'">'+
                                    ...
                                    '<tr>'+
                                        ...
                                        '</td>'+
                                        '<td>'+
                                            '<input type="text" class="form-control" id="banner'+new_row+'_credit" name="credit_line[]">'+ 
                                        '</td>'+
                                        '<td>'+
                                            '<label>Credit Line URL:</label>'+
                                        '</td>'+
                                        '<td>'+
                                            '<input type="text" class="form-control" id="banner'+new_row+'_credit_url" value="http://" name="credit_line_url[]" style="min-width: 250px;">'+ 
                                        '</td>'+
                                    '</tr>'+
                                    '<tr>'+
		                                '<td>'+
