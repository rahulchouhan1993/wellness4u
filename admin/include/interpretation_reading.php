			...
			<td>
				...
				<tbody>
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%"> Interpretation Reading</td>
							...
							<div id="pagination_contents" align="center"> 
								...
								<tbody>
									<tr>
                                        ...
                                        { ?>
											<a href="index.php?mode=add_interpretation_reading"><img src="images/add.gif" width="10" height="8" border="0" />Add New Entry</a>
										<?php 
										} ?>
                                        </td>
									</tr>
									<tr class="manage-header">
										 ...
										 <td width="30%" class="manage-header" align="center">Hospital/Clinic/Lab</td>
                                                                                 <td width="10%" class="manage-header" align="center">Practitioner/Adviser</td>
                                                                                 <td width="10%" class="manage-header" align="center">Interpretation Code</td>
                                                                                ...
                                                                                <!--<td width="10%" class="manage-header" align="center">Identity Level</td>-->
									...
									<?php
									echo $obj->getAllInterpretationReading($practitioner_id,$search,$status,$country_id,$arr_state_id,$arr_city_id,$arr_place_id,$start_date);
									?>
								</tbody>
								</table>
								<p></p>
