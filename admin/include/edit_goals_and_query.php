...
elseif(isset($_GET['id']))
{
	...
	if($situation == '')
	{
		header('location: index.php?mode=set_goals_and_query');	
	}
			...
			<td>
				...
				<tbody>
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Edit goals and query</td>
