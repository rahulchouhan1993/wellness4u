			...
			<td>
				...
				<tbody>
					...
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Manage Reward & Prizes List </td>
								...
								<tbody>
									...
									<tr>
										...
										{ ?>
											...
											<a href="index.php?mode=add_reward_list"><img src="images/add.gif" width="10" height="8" border="0" />Add New Entry</a>
									...
									<tr class="manage-header">
										...
										<td width="10%" align="center" nowrap="nowrap" class="manage-header">Date</td>
                                        ...
                                        <td class="manage-header" align="center" width="15%">Reward File</td>
                                        ...
                                        <td class="manage-header" align="center" width="25%">SCHEDULE </td>

                                        <td class="manage-header" align="center" width="25%">Sponsor </td>
									...
									echo $obj->GetAllRewardsList($search,$module_id,$reward_type,$con_type,$eqv_type,$cut_type);
