			...
			<td>
				...
				<tbody>
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Manage Stress Buster PDF</td>
					...
					<tr>
						<td class="mainbox-body">
							...
							<div id="pagination_contents" align="center"> 
								<p>
                                <form action="#" method="post" name="frm_pdf" id="frm_pdf" enctype="multipart/form-data" >
                                   <table border="0" width="100%" align="center" cellpadding="0" cellspacing="0">
                                	<tr align="left">
                                    	<td align="left" colspan="2">
                                        	<input type="button" name="btnSubmit" value="Back" onclick="window.location.href='index.php?mode=stressbuster';"/>
                                       		</td>
                                        <td align="left">&nbsp;</td>             
                                    </tr>
                                 </table>
								...
								<tbody>
									<tr>
                                        ...
                                        <?php if($stressbuster->chkValidActionPermission($admin_id,$add_action_id))
											{	 ?>
											<a href="index.php?mode=add_stressbuster_pdf"><img src="images/add.gif" width="10" height="8" border="0" />Add New Page</a>
										<?php } ?>
                                        </td>
									</tr>
									<tr class="manage-header">
                                        ...
                                        <td class="manage-header" align="center" width="20%">PDF</td>
                                        <td class="manage-header" align="center" width="30%">Day</td>
                                        <td class="manage-header" align="center" width="10%">Uploaded By</td>
									...
									<?php
									echo $stressbuster->GetAllStressBusterPDFPages();
									?>
								</tbody>
								</table>
								<p></p>
