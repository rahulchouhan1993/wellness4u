			...
			<td>
				...
				<tbody>
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Manage Nutrients  </td>
								...
								<tbody>
									<tr>
										<td colspan="6" align="left">
											<!--<a href="index.php?mode=import_nutrientstdreq">Import CSV File</a>-->
										</td>
									</tr>
									<tr class="manage-header">
										...
										<td width="20%" class="manage-header" align="center"><strong>Recommend</strong></td>
										<td width="20%" class="manage-header" align="center"><strong>Guideline</strong></td>
										<td width="20%" class="manage-header" align="center"><strong>Benefits</strong></td>
										<td width="5%" class="manage-header" align="center"><strong>Edit</strong></td>
									</tr>
									<?php
									echo $obj->getAllNutrients($search);
									?>
								</tbody>
								</table>
								<p></p>
