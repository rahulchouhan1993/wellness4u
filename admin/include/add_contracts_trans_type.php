...
if(isset($_POST['btnSubmit']))
{
    ...
    elseif($obj->chkIfContractsTransactionTypeAlreadyExists($ctt_name))
    {
        $error = true;
    ...
    if(!$error)
    {
        if($obj->addContractsTransactionType($ctt_name))
        {
			...
			<td>
				...
				<tbody>
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Add Document Type</td>
