...
//        die();
	...
	$exl_name = strip_tags(trim($_POST['exl_name']));
        ...
        $selected_page_id = $_POST['selected_page_id'];
                if($obj->Add_Exclusion($exl_name,$page_type,$selected_page_id,$user_id))
                        {
			...
			<td>
				...
				<tbody>
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Add Exclusion</td>
				    ...
				    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td width="65%" align="left" valign="top">
                                            <select name="page_type" id="page_type" style="width:200px; height: 24px;" required="" onchange="getDatadropdownPage('17')">
                                    ...
                                    <tr>
                                                ...
                                                <td width="5%" align="center"><strong>:</strong></td>
                                                <td width="75%" align="left" id="page_name" >
...
<script>
    function getDatadropdownPage(idval)
    {
       ...
       var dataString = 'action=getPageDropdown&page_type='+page_type+'&page_id='+idval;
	$.ajax({
		type: "POST",
