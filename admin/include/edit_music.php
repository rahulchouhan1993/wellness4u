...
if(isset($_POST['btnSubmit']))
{
	...
	else
	{
		...
		if(!$error)
		{
			if($obj->Update_StressBusterMusic($step,$music,$day,$credit,$credit_url,$status,$music_id))
				{
	...
	elseif(isset($_GET['uid']))
	{
		...
		list($step,$music,$day,$credit,$credit_url,$status) = $obj->getSressBusterMusicDetails($bk_music_id);
	...
	{
		header('location: index.php?mode=manage_background_music');
	}	
