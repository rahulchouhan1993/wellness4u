			...
			<td>
				...
				<tbody>
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Manage Practitioners </td>
                            ...
                            <form action="#" method="post" name="frm_user" id="frm_user" enctype="multipart/form-data" AUTOCOMPLETE="off">
								...
								<tbody>
									<tr>
										<td colspan="12" align="right">
                                         <?php if($obj->chkValidActionPermission($admin_id,$add_action_id))
											{	 ?>
											<a href="index.php?mode=add_practitioner"><img src="images/add.gif" width="10" height="8" border="0" />Add New Practitioner</a>
										<?php } ?>
                                        </td>
									</tr>
									<tr class="manage-header">
                                        ...
                                        <td width="15%" class="manage-header" align="center">Place</td>
									...
									<?php
									echo $obj->GetAllPractitioners($search);
									?>
								</tbody>
								</table>
								<p></p>
