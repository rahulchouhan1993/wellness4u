							...
							if(!empty($data) ) 
							{
								...
								if($data[0] != '')
								{
									...
									if($obj->chkFoodConstituentExists($food_constituent))
									{
										...
										if($nid > 0)
										{
											if($obj->updateFoodConstituent($food_constituent,$nid))
											{
												$succ_cnt++;
											}
											else
									...
									{
										if($obj->addFoodConstituent($food_constituent))
										{
											$succ_cnt++;
										}
										else
			...
			<td>
				...
				<tbody>
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Import Nutrients </td>
