...
{   
    ...
    $reward_point_module_id = $_POST['reward_point_module_id'];

    $reward_point_conversion_type_id = trim($_POST['reward_point_conversion_type_id']);

    $reward_point_conversion_value = trim($_POST['reward_point_conversion_value']);

    $reward_point_cutoff_type_id = trim($_POST['reward_point_cutoff_type_id']);

    $reward_point_min_cutoff = trim($_POST['reward_point_min_cutoff']);

    $reward_point_max_cutoff = trim($_POST['reward_point_max_cutoff']);

    $reward_point_date = trim($_POST['reward_point_date']);
    ...
    if(empty($reward_point_module_id))
    ...
    //     $err_msg = "Please select close date.";

    // }

    

    if($reward_point_conversion_type_id == "")
    ...
    if($reward_point_conversion_value == "")
    ...
    if($reward_point_cutoff_type_id == "")
...

    {
        ...
        elseif(!is_numeric($reward_point_min_cutoff))
    ...
    {   
        if($event_close_date<$reward_point_date)
      {
...
if(!empty($reward_point_max_cutoff))
{

  if($reward_point_max_cutoff<$reward_point_min_cutoff)
  {
            ...
            <td>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Add Reward Point</td>
                                 ...
                                 <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td width="75%" align="left">
                                            ...
                                            <!-- <select id="reward_type" name="reward_type" style="width:400px;">

                                                <option value="">Select Module </option>

                                                <?php //echo $obj->getRewardModuleOptions($reward_point_module_id); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td width="75%" align="left">
                                            ...
                                            <!-- <select id="reward_point_module_id" name="reward_point_module_id[]" style="width:400px;" multiple="">
                                            ...
                                            <?php echo $obj->getRewardModuleCheckbox($reward_point_module_id,'reward_point_module_id'); ?>
...
<!-- 
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            ...
                                            <select id="reward_point_conversion_type_id" name="reward_point_conversion_type_id" style="width:400px;">

                                                <!--<option value="">Select Conversion Type</option>-->

                                                <?php //echo $obj->getRewardCriteriaOptions($reward_point_conversion_type_id); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left"><input name="reward_point_conversion_value" type="number" id="reward_point_conversion_value" value="<?php echo $reward_point_conversion_value; ?>" style="width:400px;" ></td>
                                ...
                                <td colspan="3" align="center">&nbsp;</td>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            ...
                                            <select id="reward_point_cutoff_type_id" name="reward_point_cutoff_type_id" style="width:400px;">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left"><input name="reward_point_min_cutoff" type="number" id="reward_point_min_cutoff" value="<?php echo $reward_point_min_cutoff; ?>" style="width:400px;" ></td>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left"><input name="reward_point_max_cutoff" type="number" id="reward_point_max_cutoff" value="<?php echo $reward_point_max_cutoff; ?>" style="width:400px;" ></td>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            ...
                                            <input name="reward_point_date" id="reward_point_date" type="text" value="<?php echo $reward_point_date;?>" style="width:200px;" autocomplete="off" />

                                            <script>$('#reward_point_date').datepicker({ todayHighlight:true,startDate: '-0d', dateFormat : 'dd-mm-yy'}); </script>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            ...
                                            <script>$('#reward_point_close_date').datepicker({ todayHighlight:true ,startDate: '-0d', dateFormat : 'dd-mm-yy'}); </script>
...
<script>
	...
	var dataString = 'action=show_event_data&event_id='+event_id;
