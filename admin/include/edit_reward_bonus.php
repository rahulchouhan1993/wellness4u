...

{
...

    {
        ...
        if($obj->updateRewardBonus($reward_bonus_id,$reward_bonus_status,$reward_type,$admin_comment,$event_close_date))
        ...
        {   
            ...
            $update_data=array(
                        'reward_id'=>$reward_bonus_id,
                        'reward_type'=>'reward_bonus',
...

{
    ...
    list($reward_title,$reward_sub_category_2,$reward_sub_category_1,$reward_main_category_2,$reward_main_category_1,$event_id,$identity_type,$identity_id,$reference_number,$event_close_date,$reward_bonus_module_id,$reward_bonus_conversion_type_id,$reward_bonus_conversion_value,$reward_bonus_cutoff_type_id,$reward_bonus_min_cutoff,$reward_bonus_max_cutoff,$reward_bonus_status,$reward_bonus_date,$reward_type,$admin_comment,$tables_select,$tables_select2,$columns_id,$columns_id2,$columns_value2,$equivalent_type,$equivalent_value) = $obj->getRewardBonusDetails($reward_bonus_id);

       $history_data=$obj->get_reward_close_history('reward_bonus',$reward_bonus_id); //added by ample 12-12-20
                                        ...
                                        <td align="left" align="top">
                                         ...
                                         <?php echo $obj->getTableNameOptions_dropdown_kr1(0,$tables_select,'disabled');?>
                                            ...
                                            <option value="<?php echo $columns_id;?>"><?php echo $columns_id;?></option>  
                                              ...
                                              <!-- comment by ample 07-11-19  --> <!-- comment by ample 20-08-20  -->
