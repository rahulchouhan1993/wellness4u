...
require_once('classes/class.addictions.php');
...
if(isset($_POST['btnSubmit']))
{
	...
	if(!$error)
	{
		...
		if($obj->updateQuestion($situation,$situation_font_family,$situation_font_size,$situation_font_color,$listing_date_type,$days_of_month,$single_date,$start_date,$end_date,$country_id,$str_state_id,$str_city_id,$str_place_id,$str_user_id,$practitioner_id,$keywords,$listing_order,$arr_min_rating,$arr_max_rating,$arr_interpretaion,$arr_treatment,$status,$adct_id))
		{
			...
			header('location: index.php?mode=addictions&msg='.urlencode($msg));
		}
		else
		{
			$error = true;
			...
			<td>
				...
				<tbody>
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Edit Addiction Question</td>
