...
if(isset($_POST['btnSubmit']))
{
	...
	if(!$error)
	{
		...
		if($obj->updateQuestion($situation,$situation_font_family,$situation_font_size,$situation_font_color,$listing_date_type,$days_of_month,$single_date,$start_date,$end_date,$country_id,$str_state_id,$str_city_id,$str_place_id,$str_user_id,$practitioner_id,$keywords,$listing_order,$arr_min_rating,$arr_max_rating,$arr_interpretaion,$arr_treatment,$status,$gs_id))
		{
...
<script type="text/javascript"> 
	$(document).ready(function() {
		$('#addMoreRows').click(function() {
			...
			//alert('row_cnt = '+row_cnt+' , row_totalRow = '+row_totalRow);
			...
			<td>
				...
				<tbody>
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Edit General Stressors Question</td>
					...
					<tr>
						<td class="mainbox-body">
							...
							<tbody>
									...
									<td align="center"><strong>:</strong></td>
									<td align="left">
                                                                           <select name="symptom_name" id="symptom_name" style="width:200px;">
									...
									<td width="65%" align="left"><select id="status" name="status">
...
<!--                                <tr>
							...
							{  ?>
								...
								<tr id="row_id_2_<?php echo $i;?>">
									<td colspan="3" align="center">&nbsp;</td>
								</tr>
								<tr id="row_id_3_<?php echo $i;?>">
									<td align="right" valign="top"><strong>Interpretation</strong></td>
									<td align="center" valign="top"><strong>:</strong></td>
                                                                        <td align="left">
                                                                            <select name="interpretaion[]" id="interpretaion_<?php echo $i; ?>" style="width:200px;" value="<?php echo $arr_interpretaion[$i]; ?>">
                                                                                      
                                                                                     <?php echo $obj1->getFavCategoryRamakant('17',$arr_cucat_cat_id[$i])?>
                                                                            </select>
                                                                        </td>
<!--									<td align="left" valign="top">
