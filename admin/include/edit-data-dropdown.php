...
if(isset($_POST['report_setting']))
{
    ...
    {
        $res=$obj->update_report_custom_data($arr,$checkvalue,$page_cat_id,$u_col_name,'tbl_data_dropdown','page_cat_id');
        if($res==true)
...

{
   ...
   if(isset($_POST['canv_sub_cat9_show_fetch']) && $_POST['canv_sub_cat9_show_fetch']!='')
...

    {
        ...
        /* update by ample 04-11-19 & 19-05-20 */

        if($obj->updateDataCatDropdown($admin_comment,$arr_heading,$pag_cat_status,$admin_id,$ref_code,$page_name,$sub_cat1,$sub_cat2,$sub_cat3,$sub_cat4,$sub_cat5,$sub_cat6,$sub_cat7,$sub_cat8,$sub_cat9,$sub_cat10,$prof_cat1,$prof_cat2,$prof_cat3,$prof_cat4,$prof_cat5,$prof_cat6,$prof_cat7,$prof_cat8,$prof_cat9,$prof_cat10,$id,$time_show,$duration_show,$location_show,$like_dislike_show,$set_goals_show,$scale_show,$reminder_show,$heading,$order_show,$comments_show,$location_category,$user_response_category,$user_what_next_category,$alerts_updates_category,$cat_fetch_show_data,$canv_sub_cat_link,$data_source, $location_ref_code, $ur_ref_code, $uw_ref_code, $au_ref_code,$prof_cat_heading,$prof_cat_ref_code,$level,$page_show,$special_key))
...
//       echo $oldvalue;
    ...
    $prof_cat1 = is_array($prof_cat1) ? $prof_cat1 : explode(',', $prof_cat1);
$prof_cat2 = is_array($prof_cat2) ? $prof_cat2 : explode(',', $prof_cat2);
$prof_cat3 = is_array($prof_cat3) ? $prof_cat3 : explode(',', $prof_cat3);
$prof_cat4 = is_array($prof_cat4) ? $prof_cat4 : explode(',', $prof_cat4);
$prof_cat5 = is_array($prof_cat5) ? $prof_cat5 : explode(',', $prof_cat5);
$prof_cat6 = is_array($prof_cat6) ? $prof_cat6 : explode(',', $prof_cat6);
$prof_cat7 = is_array($prof_cat7) ? $prof_cat7 : explode(',', $prof_cat7);
$prof_cat8 = is_array($prof_cat8) ? $prof_cat8 : explode(',', $prof_cat8);
$prof_cat9 = is_array($prof_cat9) ? $prof_cat9 : explode(',', $prof_cat9);
$prof_cat10 = is_array($prof_cat10) ? $prof_cat10 : explode(',', $prof_cat10);
...
<div id="central_part_contents">
    ...
    if($msg)
    {
        ...
        ?>
        <table class="notification-border" id="notification" align="center" border="0" width="97%" cellpadding="1" cellspacing="1" style="background: #d6ffd8eb;">
                ...
                <td class="notification-body">
                    ...
                    <tbody>
                            ...
                            <td width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="notification-title"><div class="text-success">Success</div></td>
                        ...
                        <tr>
                            ...
                            <td class="notification-body"><div class="text-success"><?php echo $msg; ?></div></td>
							...
							<tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td width="65%" align="left" valign="top">
                                            ...
                                            <input type="text" name="ref_code" id="ref_code" style="width:200px;height: 24px;" value="<?php echo $ref_code;?>" required readonly>
                                ...
                                <tr>                                                                    
                                        ...
                                        <td  align="left" valign="top">
                                            ...
                                            <select name="level" style="min-width: 100px;">
                                             ...
                                             &nbsp;&nbsp;&nbsp;Heading <input type="text" name="level_heading" id="level_heading" value="<?php echo $level['level_heading'];?>" >
                                ...
                                <tr>
                                 ...
                                 <tr>                                                                    
                                        ...
                                        <td  align="left" valign="top">
                                            ...
                                            <input type="text" name="level_title" id="level_title" value="<?php echo $level['level_title'];?>" style="width:200px;height: 24px;">

                                             &nbsp;&nbsp;&nbsp;Heading <input type="text" name="level_title_heading" id="level_title_heading" value="<?php echo $level['level_title_heading'];?>" >
                                ...
                                <tr>                                                                    
                                        ...
                                        <td  align="left" valign="top">
                                            ...
                                            <!-- <input type="text" name="level_icon" id="level_icon" value="<?php echo $level['level_icon'];?>" style="width:200px;height: 24px;"> -->
                                        ...
                                        <input type="hidden" name="level_icon" id="level_icon" value="<?=$level['level_icon']?>" readonly />
                                        <input type="text" name="level_icon_type" id="level_icon_type" value="<?=$level['level_icon_type']?>" readonly/>

                                        <?php 
                                        $banner_name=$banner_file="";
                                        if(!empty($level['level_icon_type']))
                                        {
                                            if($level['level_icon_type']=='Image')
                                            {
                                                $banner_data=$obj->get_data_from_tblicons('',$level['level_icon']);
                                                $banner_name=$banner_data[0]['icons_name'];
                                                $banner_file=$banner_data[0]['image'];
                                            }
                                            else
                                            {
                                                //$banner_data=$obj->get_data_from_tblmindjumble('',$level['level_icon']);
                                                 $banner_data=$obj->get_data_from_tblicons('',$level['level_icon']);
                                        ...
                                        <br>
                                             ...
                                             &nbsp;&nbsp;&nbsp;Heading <input type="text" name="level_icon_heading" id="level_icon_heading" value="<?php echo $level['level_icon_heading'];?>" >
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td width="65%" align="left" valign="top">
                                            ...
                                            <select name="canv_sub_cat1_link" id="canv_sub_cat1_link" class="tbl_link" onchange="get_column_names_new(this,'prof_cat1_ref_code','<?=$prof_cat_ref_code["prof_cat1_ref_code"];?>','<?=$special_key["special_ref_code1"]?>')">

                                                <?php echo $obj->getTableNameFrom_tbltabldropdown($tblID,$canv_sub_cat1_link); ?> 

                                            </select> 

                                            <!--Add by ample 21-11-19 -->
                                            <button type="button" class="btn btn-xs" onclick="getSelfColumnData('<?=$canv_sub_cat1_link;?>','<?=$prof_cat_ref_code['prof_cat1_ref_code'];?>','<?=$cat_uniq_id['prof_cat1_uid'];?>','prof_cat1_uid');">Setting</button>
                                    ...
                                    <tr>
                                        ...
                                        <div class="row" style="margin-top: 2.5px;">
                                            <div class="col-lg-4">
                                                 Heading <input type="text" name="prof_cat1_heading" id="prof_cat1_heading" value="<?php echo $prof_cat_heading['prof_cat1_heading'];?>" style="width: 157px;">
                                                  <br> 
                                                 <label class="checkbox-inline"><input type="checkbox" name="special_key1" value="1" <?=($special_key['special_key1']==1)? 'checked' : ''?> >Special Key</label>
                                            </div>
                                            <div class="col-lg-8">
                                                  Reference Code 
                                    ...
                                    <tr>
                                        ...
                                        <td width="65%" align="left" valign="top">
                                            ...
                                            <!-- make daynamic by ample-->
                                            <select name="canv_sub_cat2_link" id="canv_sub_cat2_link" class="tbl_link" onchange="get_column_names_new(this,'prof_cat2_ref_code','<?=$prof_cat_ref_code["prof_cat2_ref_code"];?>','<?=$special_key['special_ref_code2'];?>')">

                                                <?php echo $obj->getTableNameFrom_tbltabldropdown($tblID,$canv_sub_cat2_link); ?> 

                                            </select> 
                                            <!--Add by ample 21-11-19 -->
                                            <button type="button" class="btn btn-xs" onclick="getSelfColumnData('<?=$canv_sub_cat2_link;?>','<?=$prof_cat_ref_code['prof_cat2_ref_code'];?>','<?=$cat_uniq_id['prof_cat2_uid'];?>','prof_cat2_uid');">Setting</button>
                                    ...
                                    <tr>
                                        ...
                                        <div class="row" style="margin-top: 2.5px;">
                                            <div class="col-lg-4">
                                                 Heading <input type="text" name="prof_cat2_heading" id="prof_cat2_heading" value="<?php echo $prof_cat_heading['prof_cat2_heading'];?>" style="width: 157px;">
                                                  <br> 
                                                 <label class="checkbox-inline"><input type="checkbox" name="special_key2" value="1" <?=($special_key['special_key2']==1)? 'checked' : ''?> >Special Key</label>
                                            </div>
                                            <div class="col-lg-8">
                                                  Reference Code 
                                    ...
                                    <tr>
                                        ...
                                        <td width="65%" align="left" valign="top">
                                            ...
                                            <!-- make daynamic by ample 05-11-19 -->
                                            <select name="canv_sub_cat3_link" id="canv_sub_cat3_link" class="tbl_link" onchange="get_column_names_new(this,'prof_cat3_ref_code','<?=$prof_cat_ref_code["prof_cat3_ref_code"];?>','<?=$special_key['special_ref_code3'];?>')">

                                                <?php echo $obj->getTableNameFrom_tbltabldropdown($tblID,$canv_sub_cat3_link); ?> 

                                            </select> 
                                            <!--Add by ample 21-11-19 -->
                                            <button type="button" class="btn btn-xs" onclick="getSelfColumnData('<?=$canv_sub_cat3_link;?>','<?=$prof_cat_ref_code['prof_cat3_ref_code'];?>','<?=$cat_uniq_id['prof_cat3_uid'];?>','prof_cat3_uid');">Setting</button>
                                    ...
                                    <tr>
                                        ...
                                        <div class="row" style="margin-top: 2.5px;">
                                            <div class="col-lg-4">
                                                 Heading <input type="text" name="prof_cat3_heading" id="prof_cat3_heading" value="<?php echo $prof_cat_heading['prof_cat2_heading'];?>" style="width: 157px;">
                                                  <br> 
                                                 <label class="checkbox-inline"><input type="checkbox" name="special_key3" value="1" <?=($special_key['special_key3']==1)? 'checked' : ''?> >Special Key</label>
                                            </div>
                                            <div class="col-lg-8">
                                                  Reference Code 
                                    ...
                                    <tr>
                                        ...
                                        <td width="65%" align="left" valign="top">
                                            ...
                                            &nbsp;&nbsp;&nbsp;Link 
                                             ...
                                             <!-- make daynamic by ample 05-11-19 -->
                                            <select name="canv_sub_cat4_link" id="canv_sub_cat4_link" class="tbl_link" onchange="get_column_names(this,'prof_cat4_ref_code','<?=$prof_cat_ref_code["prof_cat4_ref_code"];?>')">

                                                <?php echo $obj->getTableNameFrom_tbltabldropdown($tblID,$canv_sub_cat4_link); ?> 

                                            </select> 
                                            <!--Add by ample 21-11-19 -->
                                            <button type="button" class="btn btn-xs" onclick="getSelfColumnData('<?=$canv_sub_cat4_link;?>','<?=$prof_cat_ref_code['prof_cat4_ref_code'];?>','<?=$cat_uniq_id['prof_cat4_uid'];?>','prof_cat4_uid');">Setting</button>
                                    ...
                                    <tr>
                                        ...
                                        <div class="row" style="margin-top: 2.5px;">
                                            <div class="col-lg-4">
                                                 Heading <input type="text" name="prof_cat4_heading" id="prof_cat4_heading" value="<?php echo $prof_cat_heading['prof_cat4_heading'];?>" style="width: 157px;">
                                            </div>
                                            <div class="col-lg-8">
                                                  Reference Code 
                                    ...
                                    <tr>
                                        ...
                                        <td width="65%" align="left" valign="top">
                                            ...
                                            <!-- make daynamic by ample 05-11-19 -->
                                            <select name="canv_sub_cat5_link" id="canv_sub_cat5_link" class="tbl_link" onchange="get_column_names(this,'prof_cat5_ref_code','<?=$prof_cat_ref_code["prof_cat5_ref_code"];?>')">

                                                <?php echo $obj->getTableNameFrom_tbltabldropdown($tblID,$canv_sub_cat5_link); ?> 

                                            </select> 
                                            <!--Add by ample 21-11-19 -->
                                            <button type="button" class="btn btn-xs" onclick="getSelfColumnData('<?=$canv_sub_cat5_link;?>','<?=$prof_cat_ref_code['prof_cat5_ref_code'];?>','<?=$cat_uniq_id['prof_cat5_uid'];?>','prof_cat5_uid');">Setting</button>
                                    ...
                                    <tr>
                                        ...
                                        <div class="row" style="margin-top: 2.5px;">
                                            <div class="col-lg-4">
                                                 Heading <input type="text" name="prof_cat5_heading" id="prof_cat5_heading" value="<?php echo $prof_cat_heading['prof_cat5_heading'];?>" style="width: 157px;">
                                            </div>
                                            <div class="col-lg-8">
                                                  Reference Code 
                                    ...
                                    <tr>
                                        ...
                                        <td width="65%" align="left" valign="top">
                                            ...
                                            <!-- make daynamic by ample 05-11-19 -->
                                            <select name="canv_sub_cat6_link" id="canv_sub_cat6_link" class="tbl_link" onchange="get_column_names(this,'prof_cat6_ref_code','<?=$prof_cat_ref_code["prof_cat6_ref_code"];?>')">

                                                <?php echo $obj->getTableNameFrom_tbltabldropdown($tblID,$canv_sub_cat6_link); ?> 

                                            </select> 
                                            <!--Add by ample 21-11-19 -->
                                            <button type="button" class="btn btn-xs" onclick="getSelfColumnData('<?=$canv_sub_cat6_link;?>','<?=$prof_cat_ref_code['prof_cat6_ref_code'];?>','<?=$cat_uniq_id['prof_cat6_uid'];?>','prof_cat6_uid');">Setting</button>
                                    ...
                                    <tr>
                                        ...
                                        <div class="row" style="margin-top: 2.5px;">
                                            <div class="col-lg-4">
                                                 Heading <input type="text" name="prof_cat6_heading" id="prof_cat6_heading" value="<?php echo $prof_cat_heading['prof_cat6_heading'];?>" style="width: 157px;">
                                            </div>
                                            <div class="col-lg-8">
                                                  Reference Code 
                                    ...
                                    <tr>
                                        ...
                                        <td width="65%" align="left" valign="top">
                                            ...
                                            <!-- make daynamic by ample 05-11-19 -->
                                            <select name="canv_sub_cat7_link" id="canv_sub_cat7_link" class="tbl_link" onchange="get_column_names(this,'prof_cat7_ref_code','<?=$prof_cat_ref_code["prof_cat7_ref_code"];?>')">

                                                <?php echo $obj->getTableNameFrom_tbltabldropdown($tblID,$canv_sub_cat7_link); ?> 

                                            </select> 
                                            <!--Add by ample 21-11-19 -->
                                            <button type="button" class="btn btn-xs" onclick="getSelfColumnData('<?=$canv_sub_cat7_link;?>','<?=$prof_cat_ref_code['prof_cat7_ref_code'];?>','<?=$cat_uniq_id['prof_cat7_uid'];?>','prof_cat7_uid');">Setting</button>
                                    ...
                                    <tr>
                                        ...
                                        <div class="row" style="margin-top: 2.5px;">
                                            <div class="col-lg-4">
                                                 Heading <input type="text" name="prof_cat7_heading" id="prof_cat7_heading" value="<?php echo $prof_cat_heading['prof_cat7_heading'];?>" style="width: 157px;">
                                            </div>
                                            <div class="col-lg-8">
                                                  Reference Code 
                                    ...
                                    <tr>
                                        ...
                                        <td width="65%" align="left" valign="top">
                                           ...
                                           <!-- make daynamic by ample 05-11-19 -->
                                            <select name="canv_sub_cat8_link" id="canv_sub_cat8_link" class="tbl_link" onchange="get_column_names(this,'prof_cat8_ref_code','<?=$prof_cat_ref_code["prof_cat8_ref_code"];?>')">

                                                <?php echo $obj->getTableNameFrom_tbltabldropdown($tblID,$canv_sub_cat8_link); ?> 

                                            </select> 
                                            <!--Add by ample 21-11-19 -->
                                            <button type="button" class="btn btn-xs" onclick="getSelfColumnData('<?=$canv_sub_cat8_link;?>','<?=$prof_cat_ref_code['prof_cat8_ref_code'];?>','<?=$cat_uniq_id['prof_cat8_uid'];?>','prof_cat8_uid');">Setting</button>
                                    ...
                                    <tr>
                                        ...
                                        <div class="row" style="margin-top: 2.5px;">
                                            <div class="col-lg-4">
                                                 Heading <input type="text" name="prof_cat8_heading" id="prof_cat8_heading" value="<?php echo $prof_cat_heading['prof_cat8_heading'];?>" style="width: 157px;">
                                            </div>
                                            <div class="col-lg-8">
                                                  Reference Code 
                                    ...
                                    <tr>
                                        ...
                                        <td width="65%" align="left" valign="top">
                                            ...
                                            <!-- make daynamic by ample 05-11-19 -->
                                            <select name="canv_sub_cat9_link" id="canv_sub_cat9_link" class="tbl_link" onchange="get_column_names(this,'prof_cat9_ref_code','<?=$prof_cat_ref_code["prof_cat9_ref_code"];?>')">

                                                <?php echo $obj->getTableNameFrom_tbltabldropdown($tblID,$canv_sub_cat9_link); ?> 

                                            </select> 
                                            <!--Add by ample 21-11-19 -->
                                            <button type="button" class="btn btn-xs" onclick="getSelfColumnData('<?=$canv_sub_cat9_link;?>','<?=$prof_cat_ref_code['prof_cat9_ref_code'];?>','<?=$cat_uniq_id['prof_cat9_uid'];?>','prof_cat9_uid');">Setting</button>
                                    ...
                                    <tr>
                                        ...
                                        <div class="row" style="margin-top: 2.5px;">
                                            <div class="col-lg-4">
                                                 Heading <input type="text" name="prof_cat9_heading" id="prof_cat9_heading" value="<?php echo $prof_cat_heading['prof_cat9_heading'];?>" style="width: 157px;">
                                            </div>
                                            <div class="col-lg-8">
                                                  Reference Code 
                                    ...
                                    <tr>
                                        ...
                                        <td width="65%" align="left" valign="top">
                                            ...
                                            <!-- make daynamic by ample 05-11-19 -->
                                            <select name="canv_sub_cat10_link" id="canv_sub_cat10_link" class="tbl_link" onchange="get_column_names(this,'prof_cat10_ref_code','<?=$prof_cat_ref_code["prof_cat10_ref_code"];?>')">

                                                <?php echo $obj->getTableNameFrom_tbltabldropdown($tblID,$canv_sub_cat10_link); ?> 

                                            </select> 
                                            <!--Add by ample 21-11-19 -->
                                            <button type="button" class="btn btn-xs" onclick="getSelfColumnData('<?=$canv_sub_cat10_link;?>','<?=$prof_cat_ref_code['prof_cat10_ref_code'];?>','<?=$cat_uniq_id['prof_cat10_uid'];?>','prof_cat10_uid');">Setting</button>
                                            ...
                                            <!-- <select name="canv_sub_cat10_link" id="canv_sub_cat10_link">
                                                ...
                                                <option value="tbl_event_master" <?php if($canv_sub_cat10_link == 'tbl_event_master'){ echo 'selected'; } ?>>tbl_event_master</option>
                                            </select> -->
                                    ...
                                    <tr>
                                        ...
                                        <div class="row" style="margin-top: 2.5px;">
                                            <div class="col-lg-4">
                                                 Heading <input type="text" name="prof_cat10_heading" id="prof_cat10_heading" value="<?php echo $prof_cat_heading['prof_cat10_heading'];?>" style="width: 157px;">
                                            </div>
                                            <div class="col-lg-8">
                                                  Reference Code 
                                                <select name="prof_cat10_ref_code" id="prof_cat10_ref_code" style="width: 169px;">
                                                <option value="">Select</option>
                                                </select>
                                            </div>
                                        </div>
                                     ...
                                     <tr>                                                                    
                                        ...
                                        <td  align="left" valign="top">
                                            ...
                                            <select name="time_show" style="width:200px; height: 24px;">
                                                ...
                                                <option value="1" <?php if($time_show == '1'){ ?> selected <?php } ?>>Individual</option>

                                                <option value="0" <?php if($time_show == '0'){ ?> selected <?php } ?>>No</option>

                                                <option value="2" <?php if($time_show == '2'){ ?> selected <?php } ?>>Common</option>

                                                <option value="3" <?php if($time_show == '3'){ ?> selected <?php } ?>>Both</option>
                                    ...
                                    <tr>                                                                    
                                        ...
                                        <td  align="left" valign="top">
                                            ...
                                            <select name="duration_show" style="width:200px; height: 24px;">
                                                ...
                                                <option value="1" <?php if($duration_show == '1'){ ?> selected <?php } ?>>Individual</option>

                                                <option value="0" <?php if($duration_show == '0'){ ?> selected <?php } ?>>No</option>

                                                <option value="2" <?php if($duration_show == '2'){ ?> selected <?php } ?>>Common</option>

                                                <option value="3" <?php if($duration_show == '3'){ ?> selected <?php } ?>>Both</option>
                                    ...
                                    <tr>                                                                    
                                        ...
                                        <td  align="left" valign="top">
                                            ...
                                            <select name="location_show" style="width:200px; height: 24px;">
                                                ...
                                                <option value="1" <?php if($location_show == '1'){ ?> selected <?php } ?>>Individual</option>

                                                <option value="0" <?php if($location_show == '0'){ ?> selected <?php } ?>>No</option>

                                                <option value="2" <?php if($location_show == '2'){ ?> selected <?php } ?>>Common</option>

                                                <option value="3" <?php if($location_show == '3'){ ?> selected <?php } ?>>Both</option>
                                    ...
                                    <tr>                                                                    
                                        ...
                                        <td  align="left" valign="top">
                                            ...
                                            &nbsp;&nbsp;
                                          <!--   <input type="text" name="location_ref_code" id="location_ref_code" placeholder="Reference Code" style="width:200px;height: 24px;" value="<?php echo $location_ref_code;?>"> -->
                                            &nbsp;&nbsp;

                                            <input type="radio" name="canv_loc_cat_show_fetch" value="1" <?php if($canv_loc_cat_show_fetch == 1){ echo 'checked'; } ?>>Show

                                             &nbsp;&nbsp;

                                            <input type="radio" name="canv_loc_cat_show_fetch" value="2" <?php if($canv_loc_cat_show_fetch == 2){ echo 'checked'; } ?>>Fetch

                                            &nbsp;&nbsp;&nbsp;Link 

                                            <!-- make daynamic by ample 05-11-19 -->
                                            <select name="canv_loc_cat_link" id="canv_loc_cat_link" class="tbl_link" onchange="get_column_names(this,'location_ref_code','<?=$location_ref_code;?>')">

                                                <?php echo $obj->getTableNameFrom_tbltabldropdown($tblID,$canv_loc_cat_link); ?> 
...
?>>tbldailyactivity</option>
                                                   ...
                                                   <option value="tbl_event_master" <?php if($canv_loc_cat_link == 'tbl_event_master'){ echo 'selected'; } ?>>tbl_event_master</option>
                                            ...
                                            <!--Add by ample 22-11-19 -->
                                            <button type="button" class="btn btn-xs" onclick="getSelfColumnData('<?=$canv_loc_cat_link;?>','<?=$location_ref_code;?>','<?=$cat_uniq_id['loc_cat_uid'];?>','loc_cat_uid');">Setting</button>
                                        </td>
                                    ...
                                    <tr>                                                                    
                                        ...
                                        <td  align="left" valign="top">
                                            ...
                                            <select name="like_dislike_show" style="width:200px; height: 24px;">
                                                ...
                                                <option value="1" <?php if($like_dislike_show == '1'){ ?> selected <?php } ?>>Individual</option>

                                                <option value="0" <?php if($like_dislike_show == '0'){ ?> selected <?php } ?>>No</option>

                                                <option value="2" <?php if($like_dislike_show == '2'){ ?> selected <?php } ?>>Common</option>

                                                <option value="3" <?php if($like_dislike_show == '3'){ ?> selected <?php } ?>>Both</option>
                                    ...
                                    <tr>                                                                    
                                        ...
                                        <td  align="left" valign="top">
                                            ...
                                            <input type="radio" name="canv_user_cat_show_fetch" value="1" <?php if($canv_user_cat_show_fetch == 1){ echo 'checked'; } ?>>Show

                                             &nbsp;&nbsp;

                                            <input type="radio" name="canv_user_cat_show_fetch" value="2"  <?php if($canv_user_cat_show_fetch == 2){ echo 'checked'; } ?>>Fetch

                                            &nbsp;&nbsp;&nbsp;Link 

                                              <!-- make daynamic by ample 05-11-19 -->
                                            <select name="canv_user_cat_link" id="canv_user_cat_link" class="tbl_link" onchange="get_column_names(this,'ur_ref_code','<?=$ur_ref_code;?>')">

                                                <?php echo $obj->getTableNameFrom_tbltabldropdown($tblID,$canv_user_cat_link); ?> 
...
?>>tbldailyactivity</option>
                                                <option value="tbl_event_master" <?php if($canv_user_cat_link == 'tbl_event_master'){ echo 'selected'; } ?>>tbl_event_master</option>
                                            </select> -->
                                            &nbsp;&nbsp;
                                            <!-- <input type="text" name="ur_ref_code" id="ur_ref_code" placeholder="Reference Code" style="width:200px;height: 24px;" value="<?php echo $ur_ref_code;?>"> -->
                                            <!-- Reference Code update by maple 05-11-19 -->
                                            <div style="margin-top: 2.5px;">
                                                Reference Code 
                                            ...
                                            <!--Add by ample 22-11-19 -->
                                            <button type="button" class="btn btn-xs" onclick="getSelfColumnData('<?=$canv_user_cat_link;?>','<?=$ur_ref_code;?>','<?=$cat_uniq_id['ur_cat_uid'];?>','ur_cat_uid');">Setting</button>
                                        </td>
                                    ...
                                    <tr>                                                                    
                                        ...
                                        <td  align="left" valign="top">
                                            ...
                                            <select name="set_goals_show" style="width:200px; height: 24px;">
                                                ...
                                                <option value="1" <?php if($set_goals_show == '1'){ ?> selected <?php } ?>>Individual</option>

                                                <option value="0" <?php if($set_goals_show == '0'){ ?> selected <?php } ?>>No</option>

                                                <option value="2" <?php if($set_goals_show == '2'){ ?> selected <?php } ?>>Common</option>

                                                <option value="3" <?php if($set_goals_show == '3'){ ?> selected <?php } ?>>Both</option>
                                    ...
                                    <tr>                                                                    
                                        ...
                                        <td  align="left" valign="top">
                                            ...
                                            <input type="radio" name="canv_wn_cat_show_fetch" value="1" <?php if($canv_wn_cat_show_fetch == 1){ echo 'checked'; } ?>>Show

                                             &nbsp;&nbsp;

                                            <input type="radio" name="canv_wn_cat_show_fetch" value="2" <?php if($canv_wn_cat_show_fetch == 2){ echo 'checked'; } ?>>Fetch

                                            &nbsp;&nbsp;&nbsp;Link 

                                             <!-- make daynamic by ample 05-11-19 -->
                                            <select name="canv_wn_cat_link" id="canv_wn_cat_link" class="tbl_link" onchange="get_column_names(this,'uw_ref_code','<?=$uw_ref_code;?>')">

                                                <?php echo $obj->getTableNameFrom_tbltabldropdown($tblID,$canv_wn_cat_link); ?> 
...
?>>tbldailyactivity</option>
                                                <option value="tbl_event_master" <?php if($canv_wn_cat_link == 'tbl_event_master'){ echo 'selected'; } ?>>tbl_event_master</option>

                                            </select> -->
                                            
                                            &nbsp;&nbsp;
                                            <!-- <input type="text" name="uw_ref_code" id="uw_ref_code" placeholder="Reference Code" style="width:200px;height: 24px;" value="<?php echo $uw_ref_code;?>"> -->
                                            <!-- Reference Code update by maple 05-11-19 -->
                                            <div style="margin-top: 2.5px;">
                                                Reference Code 
                                            ...
                                            <!--Add by ample 22-11-19 -->
                                            <button type="button" class="btn btn-xs" onclick="getSelfColumnData('<?=$canv_wn_cat_link;?>','<?=$uw_ref_code;?>','<?=$cat_uniq_id['uwn_uid'];?>','uwn_uid');">Setting</button>
                                        </td>
                                    ...
                                    <tr>                                                                    
                                        ...
                                        <td  align="left" valign="top">
                                            ...
                                            <select name="scale_show" style="width:200px; height: 24px;">
                                                ...
                                                <option value="1" <?php if($scale_show == '1'){ ?> selected <?php } ?>>Individual</option>

                                                <option value="0" <?php if($scale_show == '0'){ ?> selected <?php } ?>>No</option>

                                                <option value="2" <?php if($scale_show == '2'){ ?> selected <?php } ?>>Common</option>

                                                <option value="3" <?php if($scale_show == '3'){ ?> selected <?php } ?>>Both</option>
                                    ...
                                    <tr>                                                                    
                                        ...
                                        <td  align="left" valign="top">
                                            ...
                                            <select name="reminder_show" style="width:200px; height: 24px;">
                                                ...
                                                <option value="1" <?php if($reminder_show == '1'){ ?> selected <?php } ?>>Individual</option>

                                                <option value="0" <?php if($reminder_show == '0'){ ?> selected <?php } ?>>No</option>

                                                <option value="2" <?php if($reminder_show == '2'){ ?> selected <?php } ?>>Common</option>

                                                <option value="3" <?php if($reminder_show == '3'){ ?> selected <?php } ?>>Both</option>
                                    ...
                                    <tr>                                                                    
                                        ...
                                        <td  align="left" valign="top">
                                            ...
                                            <input type="radio" name="canv_au_cat_show_fetch" value="1" <?php if($canv_au_cat_show_fetch == 1){ echo 'checked'; } ?>>Show

                                             &nbsp;&nbsp;

                                            <input type="radio" name="canv_au_cat_show_fetch" value="2" <?php if($canv_au_cat_show_fetch == 2){ echo 'checked'; } ?>>Fetch

                                            &nbsp;&nbsp;&nbsp;Link 

                                            <!-- make daynamic by ample 05-11-19 -->
                                            <select name="canv_au_cat_link" id="canv_au_cat_link" class="tbl_link" onchange="get_column_names(this,'au_ref_code','<?=$au_ref_code;?>')">

                                                <?php echo $obj->getTableNameFrom_tbltabldropdown($tblID,$canv_au_cat_link); ?> 
...
?>>tbldailyactivity</option>
                                                <option value="tbl_event_master" <?php if($canv_au_cat_link == 'tbl_event_master'){ echo 'selected'; } ?>>tbl_event_master</option>
                                            </select> -->
                                            
                                            &nbsp;&nbsp;
                                           <!--  <input type="text" name="au_ref_code" id="au_ref_code" placeholder="Reference Code" style="width:200px;height: 24px;" placeholder="Reference Code" value="<?php echo $au_ref_code;?>"> -->
                                            <!-- Reference Code update by maple 05-11-19 -->
                                            <div style="margin-top: 2.5px;">
                                                Reference Code 
                                            ...
                                            <!--Add by ample 22-11-19 -->
                                            <button type="button" class="btn btn-xs" onclick="getSelfColumnData('<?=$canv_au_cat_link;?>','<?=$au_ref_code;?>','<?=$cat_uniq_id['au_cat_uid'];?>','au_cat_uid');">Setting</button>
                                        </td>
                                    ...
                                    <tr>                                                                    
                                        ...
                                        <td  align="left" valign="top">
                                            ...
                                            <select name="comments_show" style="width:200px; height: 24px;">
                                                ...
                                                <option value="1" <?php if($comments_show == '1'){ ?> selected <?php } ?>>Individual</option>

                                                <option value="0" <?php if($comments_show == '0'){ ?> selected <?php } ?>>No</option>

                                                <option value="2" <?php if($comments_show == '2'){ ?> selected <?php } ?>>Common</option>

                                                <option value="3" <?php if($comments_show == '3'){ ?> selected <?php } ?>>Both</option>
                                    ...
                                    <tr>                                                                    
                                        ...
                                        <td  align="left" valign="top">
                                            ...
                                            <select name="page_show" id="page_show" style="width:200px; height: 24px;">
                                                ...
                                                <option value="<?php echo $show_pop;?>"><?php echo $show_pop;?></option>
...
<script type="text/javascript">
    // code write by ample 20,21-11-19
...
//new add by ample
 function get_column_names_new(tbl="",show_on="",selected="",selected2="")
    {   
       get_column_names1(tbl,show_on,selected);
       get_column_names2(tbl,show_on,selected2);
    }
     function get_column_names1(tbl="",show_on="",selected="")
    {   
        //alert(tbl.value);
        var tbl_name=tbl.value;
        var dataString = 'action=getTableColumnsName&tbl_name='+tbl_name+'&selected='+selected;
     ...
     function get_column_names2(tbl="",show_on="",selected="")
    {   
        //alert(tbl.value);
        var tbl_name=tbl.value;
        var dataString = 'action=getTableColumnsName&tbl_name='+tbl_name+'&selected='+selected;
      ...
      $.ajax({
        ...
        success: function(result)
        {
            $('.'+show_on).html(result);      //add by ample 20-05-20 new condition special
        }
      });
    }
    $(document).ready(function()
