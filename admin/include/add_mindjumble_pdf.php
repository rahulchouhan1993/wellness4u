...
if(isset($_POST['btnSubmit']))
{
	...
	if($pdf_title == "")
	{
		...
		if(!$error)
			{  
				if($obj->Add_MindJumblePDF($pdf,$credit,$credit_url,$pdf_title,$day,$title_id,$short_narration))
					{
				...
				<tbody>
					<tr>
						<td class="mainbox-body">
							<form action="#" method="post" name="frmadd_mindjumble" id="frmadd_mindjumble" enctype="multipart/form-data" >
