...
if(isset($_POST['btnSubmit']))
{
	...
	if(!$error)
	{
		if($obj->UpdateContent($page_name,$page_title,$page_contents,$meta_title,$meta_keywords,$meta_description,$menu_title,$menu_link_enable,$page_id,$page_contents2))
		{
			$err_msg = "Page Updateds Successfully!";
			header('location: index.php?mode=vender_contents&msg='.urlencode($err_msg));
		}
		else
		{
			$error = true;
...
elseif(isset($_GET['page_id']))
{
	...
	list($page_name,$page_title,$page_contents,$meta_title,$meta_keywords,$meta_description,$menu_title,$menu_link_enable,$page_contents2) = $obj->getContentDetails($page_id);
}
else
{
	header('location: index.php?mode=vender_contents');
}	
?>
<!-- TinyMCE -->
