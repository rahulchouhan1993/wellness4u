							...
							if(!empty($data) ) 
							{
								...
								if($data[0] != '')
								{
									...
									if($obj->chkFoodConstituentExists($food_constituent))
									{
										...
										if($nid > 0)
										{
											if($obj->chkNSRFoodConstituentExists($nid))
											{
												$nsr_id = $obj->getNSRId($nid);
												if($nsr_id > 0)
												{
			...
			<td>
				...
				<tbody>
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Import Nutrient Standard Requirement </td>
