...
if(isset($_POST['btnSubmit']))
{
	...
	elseif( $obj->chkHeightExists($height_cms) )
	{
		$error = true;
			...
			<td>
				...
				<tbody>
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Add Height</td>
				...
				<tbody>
					<tr>
						<td class="mainbox-body">
							<form action="#" method="post" name="frmadd_height" id="frmadd_height" enctype="multipart/form-data" >
