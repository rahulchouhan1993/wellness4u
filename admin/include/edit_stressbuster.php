...
if(isset($_POST['btnSubmit']))
{
	...
	{  
		...
		if(!$error)
		{  
			if($obj->Update_StressBusterBanner($step,$status,$box_title,$banner_type,$banner,$box_desc,$credit_line,$credit_line_url,$day,$sound_clip_id,$banner_id))
				{
...
elseif(isset($_GET['uid']))
{
	$bannerid = $_GET['uid'];
	//echo $bannerid;
	list($step,$box_title,$banner_type,$box_desc,$banner,$status,$credit_line,$credit_line_url,$day,$sound_clip_id) = $obj->getSressBusterBannerDetails($bannerid);
			...
			<td>
				...
				<tbody>
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Edit Stress Buster </td>
				...
				<tbody>
					<tr>
						<td class="mainbox-body">
							...
							<input type="hidden" name="hdnbanner_id" value="<?php echo $bannerid;?>" />
							...
							<tbody>
								<tr>
									<td width="20%" align="right"><strong>Stress Buster Box Step</strong></td>
								...
								<tr>
									<td width="20%" align="right"><strong>Stress Buster Box Title</strong></td>
									<td width="5%" align="center"><strong>:</strong></td>
