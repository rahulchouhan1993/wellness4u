			...
			<td>
				...
				<tbody>
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Manage Anger Vent PDF</td>
					...
					<tr>
						<td class="mainbox-body">
							...
							<div id="pagination_contents" align="center"> 
								<p>
                                <form action="#" method="post" name="frm_AngerventPDF" id="frm_AngerventPDF" enctype="multipart/form-data" >
                                   <table border="0" width="100%" align="center" cellpadding="0" cellspacing="0">
                                	<tr align="left">
                                    	<td align="left" colspan="2">
                                        	<input type="button" name="btnSubmit" value="Back" onclick="window.location.href='index.php?mode=angervent';"/>
                                       		</td>
                                        <td align="left">&nbsp;</td>             
                                    </tr>
                                 </table>
								...
								<tbody>
									<tr>
										<td colspan="9" align="right" nowrap="nowrap">
                                         <?php if($angervent->chkValidActionPermission($admin_id,$add_action_id))
												{	 ?>
											<a href="index.php?mode=add_angervent_pdf"><img src="images/add.gif" width="10" height="8" border="0" />Add New Page</a>
										<?php } ?>
                                        </td>
									</tr>
									...
									<?php
									echo $angervent->GetAllAngerVentPDF();
									?>
								</tbody>
								</table>
								<p></p>
