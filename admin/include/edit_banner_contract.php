...
{
    $banner_cont_id = $_POST['hdnbanner_cont_id'];
    ...
    $banner_cont_status = trim($_POST['banner_cont_status']);
   ...
   if($banner_cont_amount == "")
    ...
    if(!$error)
    {
        ...
        if($obj->updateBannerContract($banner_client_id,$banner_broker_id,$banner_contract_no,$banner_order_no,$banner_contract_date,$banner_booked_date,$banner_cont_amount,$banner_cont_status,$banner_cont_id,$admin_id,$currency,$prct_cat_id,$ctt_id,$old_document_ref_no))
        {
            $msg = "Record Updated Successfully!";
            header('location: index.php?mode=banner_contracts&msg='.urlencode($msg));
        }
        else
        {
            $error = true;
...
elseif(isset($_GET['id']))
{
    ...
    list($banner_client_id,$banner_broker_id,$banner_contract_no,$banner_order_no,$banner_contract_date,$banner_booked_date,$banner_cont_amount,$banner_cont_status,$currency,$prct_cat_id,$ctt_id,$old_document_ref_no) = $obj->getBannerContractDetails($banner_cont_id);
    if($banner_client_id == '')
    {
			...
			<td>
				...
				<tbody>
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Edit Document</td>
							...
							<tbody>
                            	<tr>
									...
									<td width="65%" align="left">
                                                                            <select id="banner_cont_status" name="banner_cont_status">
                                                                                <option value="1" <?php if($banner_cont_status == '1'){ ?> selected <?php } ?>>Active</option>
                                                                                <option value="0" <?php if($banner_cont_status == '0'){ ?> selected <?php } ?>>Inactive</option>
                                                                            </select>
                                                                        </td>
								</tr>
                                <tr>
								...
								<tr>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            ...
                                            <input type="button" name="btnCancel" value="Cancel" onclick="window.location.href='index.php?mode=banner_contracts'">
                                        </td>
                                    </tr>
                                </tbody>
                                </table>
