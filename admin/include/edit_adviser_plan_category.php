...
if(isset($_POST['btnSubmit']))
{
	...
	elseif($obj->chkIfAdviserPlanCategoryAlreadyExists_Edit($apct_category_type,$apct_id))
	{
		$error = true;
...
{
	$apct_id = $_GET['id'];
	list($apct_category_type,$apct_status) = $obj->getAdviserPlanCategoryDetails($apct_id);
	if($apct_category_type == '')
	{
		header('location: index.php?mode=adviser_plan_categories');	
	}	
}	
else
{
