...
if(isset($_POST['btnSubmit']))
{
	...
	if(!$error)
	{
		if($obj->UpdateContent($image,$menu_link,$page_name,$page_title,$page_contents,$meta_title,$meta_keywords,$meta_description,$menu_title,$menu_link_enable,$page_id,$page_contents2,$admin_id))
		{
...
elseif(isset($_GET['page_id']))
{
	...
	list($page_icon,$menu_link,$page_name,$page_title,$page_contents,$meta_title,$meta_keywords,$meta_description,$menu_title,$menu_link_enable,$page_contents2) = $obj->getContentDetails($page_id);
}
else
{
