...
$obj = new Contents();
$allFilterOption = $obj->getFiltersFavCat();
$view_action_id = '313';
$add_action_id = '314';
                ...
                <tbody >
                    <tr>
                        <td class="mainbox-body">
                            ...
                            <form>
                                <input type="hidden" name="mode" value="manage_page_fav_cat_dropdowns">
                                <label>Page:</label>
                                <select name="page">
                            ...
                            <div id="pagination_contents" align="center"> 
                                ...
                                <tbody>
                                    ...
                                    <tr><td width="10%" height="30" align="left" valign="middle"><strong>Profile Category:</strong></td>
                                ...
                                <tbody>
                                    ...
                                    <tr class="manage-header">
                                        ...
                                        <td width="3%" class="manage-header" align="center">Status</td>
                                        <td width="5%" class="manage-header" align="center">Date</td>
                                        <td width="5%" class="manage-header" align="center">Added By Admin</td>
                                        <td width="5%" class="manage-header" align="center">Updated On</td>
                                         <td width="5%" class="manage-header" align="center">Updated By</td>
                                          
                                        <td width="2%" class="manage-header" align="center">Edit</td>
                                        <td width="2%" class="manage-header" align="center">Del</td>
                                        <td width="3%" class="manage-header" align="center">Ref Code</td>
                                    ...
                                    <?php
                                    echo $obj->getAllPageFavCatDropdowns($search,$status,$_GET);
                                    ?>
                                </tbody>
                                </table>
                                <p></p>
