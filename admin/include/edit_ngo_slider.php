...
if(isset($_POST['btnSubmit']))
{
	...
	if(!$error)
	{
		if($obj->updateSliderContent($slider_title,$slider_desc,$slider_image,$slider_type,$slider_link,$slider_id))
		{
			$msg = "Record Updated Successfully!";
			header('location: index.php?mode=ngo_sliders&msg='.urlencode($msg));
		}
		else
		{
			$error = true;
...
{
	$slider_id = $_GET['id'];
	list($slider_title,$slider_desc,$slider_image,$slider_type,$slider_link) = $obj->getSliderDetails($slider_id);
	if($slider_title == '')
	{
		header('location: index.php?mode=ngo_sliders');	
	}	
}	
else
{
