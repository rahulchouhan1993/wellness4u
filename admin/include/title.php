			...
			<td>
				...
				<tbody>
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Manage Mind Jumble Title</td>
									...
									<tr>
										<td colspan="7" align="right" nowrap="nowrap">
                                         <?php if($obj->chkValidActionPermission($admin_id,$add_action_id))
											{	 ?>
											<a href="index.php?mode=add_title"><img src="images/add.gif" width="10" height="8" border="0" />Add New Box</a>
										<?php } ?>
                                        </td>
									</tr>
