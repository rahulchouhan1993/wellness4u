...
if(isset($_POST['btnSubmit']))
{
	...
	if($obj->chkIfScrollingBarOrderAlreadyExists($sb_order,$page_id))
	{
		$error = true;
	...
	if(!$error)
	{
		...
		if(!$error)
		{
			...
			if($obj->addScrollingBar($page_id,$sb_listing_date_type,$sb_days_of_month,$sb_single_date,$sb_start_date,$sb_end_date,$sb_content,$sb_content_font_family,$sb_content_font_size,$sb_content_font_color,$sb_content_image,$sb_show_content_credit,$sb_content_credit_name,$sb_content_credit_link,$sb_order))
			{
