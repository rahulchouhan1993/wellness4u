...

{
	...
	$email_ar_id = trim($_POST['hdnemail_ar_id']);
	...
	$email_ar_status = trim($_POST['email_ar_status']);
...

	{
		...
		if($obj->updateEmailAutoresponder($email_ar_id,$email_action_id,$email_ar_subject,$email_ar_from_name,$email_ar_from_email,$email_ar_to_email,$email_ar_body,$email_ar_status,$SMS_ID))
...

{
	...
	list($email_action_id,$email_ar_subject,$email_ar_from_name,$email_ar_from_email,$email_ar_to_email,$email_ar_body,$email_ar_status,$SMS_ID) = $obj->getEmailAutoresponderDetails($email_ar_id);
...

	{
		...
		header('location: index.php?mode=email_autoresponders');
			...
			<td>
				...
				<tbody>
					...
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Edit Autoresponder</td>
				...
				<tbody>
					...
					<tr>
						...
						<td class="mainbox-body">
                            ...
                            <input type="hidden" name="hdnemail_ar_id" value="<?php echo $email_ar_id;?>" />
							...
							<tbody>
								...
								<tr>
                                 ...
                                 <tr>
									...
									<td align="left"><select name="email_ar_status" id="email_ar_status" style="width:400px;">

                                                                 <option value="1" <?php  if($email_ar_status == 1) {?> selected="selected" <?php } ?> >Active</option>

                                                                 <option value="0" <?php  if($email_ar_status == 0) {?> selected="selected" <?php } ?>>Inactive</option>
