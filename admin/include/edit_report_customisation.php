...
if(isset($_POST['report_setting']))
{
    ...
    {
        $res=$obj->update_report_custom_data($arr,$checkvalue,$page_cat_id,$u_col_name,'tbl_recordshow_dropdown','page_cat_id');
        if($res==true)
...

{
   ...
   // die('sssss');
    ...
    //add by ample
    $canv_sub_cat_ref_code = array();
    $canv_sub_cat_ref_code['canv_sub_cat1_ref_code']= $_POST['canv_sub_cat1_ref_code'];
...
// }
...

    {
        ...
        if($obj->updateRecordsCatDropdown($admin_comment,$arr_heading,$pag_cat_status,$admin_id,$ref_code,$page_name,$sub_cat1,$prof_cat1,$id,$time_show,$duration_show,$location_show,$like_dislike_show,$set_goals_show,$scale_show,$reminder_show,$heading,$order_show,$comments_show,$location_category,$user_response_category,$user_what_next_category,$alerts_updates_category,$cat_fetch_show_data,$canv_sub_cat_link,$canv_sub_cat_ref_code,$data_source,$report_name,$arr,$checkvalue,$is_action))
...

{
   ...
   // $pd_id = $_GET['id'];
     ...
     list($admin_comment,$arr_heading,$healcareandwellbeing,$page_name,$ref_code,$profcat1,$pag_cat_status,$heading,$time_show,$location_show,$like_dislike_show,$set_goals_show,$scale_show,$reminder_show,$order_show,$duration_show,$comments_show,$location_category,$user_response_category,$user_what_next_category,$alerts_updates_category,$canv_sub_cat1_link,$canv_sub_cat1_show_fetch,$page_type,$reference_name,$table_name,$report_name,$details_arr,$enduse,$wa_main_cat,$wa_sub_cat,$canv_sub_cat1_ref_code,$cat1_uid,$is_action) = $obj->getDataRecordsDropdownDetails($page_cat_id);
                             ...
                             <!-- ----------------------------- -->
                                    ...
                                    <tr>
                                        ...
                                        <td width="65%" align="left" valign="top">
                                            ...
                                            <select name="is_action" id="is_action" style="width:200px; height: 24px;">
                                                ...
                                                <option value="0" <?php if($is_action == '0'){ ?> selected <?php } ?> >Select</option>

                                                <option value="1" <?php if($is_action == '1'){ ?> selected <?php } ?> >Check key status</option>

                                                <option value="2" <?php if($is_action == '2'){ ?> selected <?php } ?> >Check User Plan</option>

                                                <option value="3" <?php if($is_action == '3'){ ?> selected <?php } ?> >Check Vendor Plan</option>
                                ...
                                <tr>
                                  ...
                                  <td align="left">
                                     ...
                                     <table align="left" border="0" width="100%" cellpadding="0" cellspacing="0"  id="getcolumsNew">
                                 ...
                                 <td width="15%" align="left"><?php echo $del_value['col_name'];?>
                                  ...
                                  <td width="10%" align="left" valign="top">
                                    ...
                                    <input class="chkbxapaid" type="checkbox" name="check_[]" id="check_<?php echo $index;?>" value="<?php echo $del_value['col_name'];?>" onclick="return selectcheckNew(<?php echo $index;?>,'<?php echo $del_value['col_name'];?>');" <?php echo $checked;?>></td>
                                 ...
                                 <?php echo $obj->getTableNameOptions_dropdown_new($index,$del_value['Id_table']);?>
                                   ...
                                   <!--  <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td width="65%" align="left" valign="top">
                                            ...
                                            <select name="canv_sub_cat1_link" id="canv_sub_cat1_link" class="tbl_link" onchange="get_column_names(this,'canv_sub_cat1_ref_code','<?=$canv_sub_cat1_ref_code?>')">
                                            ...
                                            <!--<input type="text" name="canv_sub_cat1_link" id="canv_sub_cat1_link" value="<?php //echo $canv_sub_cat1_link; ?>" >-->
                                              ...
                                              &nbsp;&nbsp;Reference Code 
                                                <select name="canv_sub_cat1_ref_code" id="canv_sub_cat1_ref_code" style="width: 155px;">
                                                <option value="">Select</option>
                                                </select>

                                                <!--Add by ample26-02-20 -->
                                            &nbsp;&nbsp; <button type="button" class="btn btn-xs" onclick="getSelfColumnData('<?=$canv_sub_cat1_link;?>','<?=$canv_sub_cat1_ref_code;?>','<?=$cat1_uid;?>','cat1_uid');">Setting</button>
...
function SelectableNew(get)

{   

    var table_name=$('#getcolumsNew #tables_names'+get).val();   
    ...
    var dataString = 'action=getTableColumnsNameKR&tablm_name='+table_name+'&get='+get;
      ...
      $.ajax({
...

        {
         ...
         $('#getcolumsNew #columns_dropdown'+get).html(result);

         $('#getcolumsNew #columns_dropdown_value'+get).html(result);
...
//update by ample 26-02-20
function Selectable(get)

{   

    var table_name=$('#getcolums #tables_names'+get).val();   
    ...
    var dataString = 'action=getTableColumnsNameKR&tablm_name='+table_name+'&get='+get;
      ...
      $.ajax({
...

        {
         ...
         $('#getcolums #columns_dropdown'+get).html(result);

         $('#getcolums #columns_dropdown_value'+get).html(result);
...
if($('#getcolums #check_'+num).is(":checked")) {

    $('#getcolums #checkvalue'+num).val(colums);
...

  {
     ...
     $('#getcolums #checkvalue'+num).val('');

  }
}

//copy by ample 26-02-20
  function selectcheckNew(num,colums)

{


if($('#getcolumsNew #check_'+num).is(":checked")) {

    $('#getcolumsNew #checkvalue'+num).val(colums);
...

  {
     ...
     $('#getcolumsNew #checkvalue'+num).val('');

  }

}

//add this by ample 26-02-20
