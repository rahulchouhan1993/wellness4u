			...
			<td>
				...
				<tbody>
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Manage Stressbuster User Area</td>
							...
							<div id="pagination_contents" align="center"> 
								...
								<tbody>
									<tr class="manage-header">
                                        ...
                                        <td class="manage-header" align="center" width="30%">User Area Title</td>
                                        <td class="manage-header" align="center" width="25%">User Area Description</td>
                                        <td class="manage-header" align="center" width="10%">Status</td>
                                        <td class="manage-header" align="center" width="5%" nowrap="nowrap" >Edit</td>
                               	</tr>
									<?php
									echo $obj->GetAllStressBusterUserArea();
									?>
								</tbody>
								</table>
								<p></p>
