...
if (isset($_POST['btnSubmit'])) 
{
    ...
    if (!$error) {
        ...
        if ($obj1->addScheduleData($admin_id,$data,$_GET)) {
            
            $msg = "Schedule Add Successfully!";
            ...
            <td>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Add Schedule</td>
                            ...
                            <form role="form" class="form-horizontal" id="add_banner_slider" name="add_banner_slider" method="post" enctype='multipart/form-data'> 
                                    ...
                                    <div style="border:1px solid #CCC;padding:5px;margin: 10px 0px;">
                                        ...
                                        <div class="form-group" >   
                                            ...
                                            <div class="col-sm-2">
                                                <select name="state_id" id="state_id" class="form-control" onchange="getCityOption()">
                                            ...
                                            <div class="col-sm-2">
                                                <select name="city_id" id="city_id" class="form-control" onchange="getAreaOption()">
