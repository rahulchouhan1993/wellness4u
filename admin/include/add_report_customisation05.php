...
foreach($getselected_data as $key=>$tblvalue)
{
  ...
  // 7:report order
    ...
    if(!$error)
    {
        ...
        if($obj->addRecordsDropdown($ref_code,$admin_comment,$fav_cat_type_id_0,$healcareandwellbeing,$page_type,$page_name,$heading,$table_dropdown_ref,$data_source,$report_name,$prof_cat1,$arr_selected_cat_id1,$cat_fetch_show_data,$canv_sub_cat_link,$order_show,$admin_id,$arr,$checkvalue,$show_value,$va_cat_id,$va_sub_cat_id))
        {
