			...
			<td>
				...
				<tbody>
					...
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Manage Contents </td>
                                ...
                                <table border="0" width="100%" align="center" cellpadding="0" cellspacing="0">
                                	...
                                	<tr align="left">
                                    	...
                                    	<td align="left">
                                        	...
                                        	<input type="button" name="btnSubmit" value="Manage Messages" onclick="window.location.href='index.php?mode=common_messages_user';"/>
								...
								<tbody>
									...
									<tr>
                                        ...
                                        { ?>
											...
											<a href="index.php?mode=add_content"><img src="images/add.gif" width="10" height="8" border="0" />Add New Page</a>
									...
									<tr class="manage-header">
										...
										<td class="manage-header" align="center" width="65%">Page Name</td>
                                                                                ...
                                                                                <td class="manage-header" align="center" width="10%">Menu Link</td>
