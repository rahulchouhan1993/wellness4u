			...
			<td>
				...
				<tbody>
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Manage Mind Jumble Narration</td>
						...
						<td class="mainbox-body">
							...
							<div id="pagination_contents" align="center"> 
                                 ...
                                 <table border="0" width="100%" align="center" cellpadding="0" cellspacing="0">
                                	<tr align="left">
                                    	<td align="left" colspan="2">
                                        	<input type="button" name="btnSubmit" value="Back" onclick="window.location.href='index.php?mode=title';"/>
                                       		</td>
                                        <td align="left">&nbsp;</td>             
                                    </tr>
                                 </table>
								...
								<tbody>
									<tr>
										<td colspan="7" align="right" nowrap="nowrap">
                                         <?php if($obj->chkValidActionPermission($admin_id,$add_action_id))
											{	 ?>
											<a href="index.php?mode=add_narration&id=<?php echo $id; ?>"><img src="images/add.gif" width="10" height="8" border="0" />Add New Box</a>
										<?php } ?>
                                        </td>
									</tr>
									<tr class="manage-header">
										<td class="manage-header" align="center" width="5%" nowrap="nowrap" >S.No.</td>
									    <td class="manage-header" align="center" width="35%">Title</td>
                                        <td class="manage-header" align="center" width="30%">Narration</td>
									...
									<?php
									echo $obj->GetNarration($search,$id);
									?>
								</tbody>
								</table>
								<p></p>
