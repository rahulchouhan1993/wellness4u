			...
			<td>
				...
				<tbody>
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Manage Anger Vent User Area</td>
						...
						<td class="mainbox-body">
							...
							<div id="pagination_contents" align="center"> 
								...
								<tbody>
									...
									<?php
									echo $obj->GetAllAngerVentUserArea();
									?>
								</tbody>
								</table>
								<p></p>
