...
$arr_inactive_menu_items = $obj->getAllInactiveMenuItemsAdviser();
$arr_active_menu_items = $obj->getAllActiveMenuItemsAdviser(0);
?>
<style type="text/css">
...
<script type="text/javascript">
	...
	function Serialize(selector)
	{
		...
		$.ajax({
			...
			method: 'post',
			type: 'POST',
			data: ({action : 'updateMenuOrdersAdviser' , result : result}),
