...
elseif(isset($_GET['id']))
{
	...
	if( ($nid == '') || ($nid == '0') )
	{
		header('location: index.php?mode=nutrientauplim');	
	}	
}	
else
{
	header('location: index.php?mode=nutrientuplim');
}
?>
			...
			<td>
				...
				<tbody>
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Edit Nutrient Upper Limit</td>
				...
				<tbody>
					<tr>
						<td class="mainbox-body">
							...
							<input type="hidden" name="hdnnul_id" id="hdnnul_id" value="<?php echo $nul_id;?>" />
