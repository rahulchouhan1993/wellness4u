...
list($arr_user_name,$arr_priority,$arr_library_id,$arr_category,$arr_note,$arr_file,$arr_title,$arr_type,$arr_status,$arr_date) = $obj->View_Library_details($user_id);
?>
			...
			<td>
				...
				<tbody>
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Manage Library</td>
                                ...
                                <table border="0" width="100%" cellpadding="1" cellspacing="1">
                                	<tr>
                                        ...
                                        <td width="25%" align="left">
                                        	<input type="submit" id="btnLibrary" name="btnLibrary" value="View Library" />
                                    	</td>
                                    </tr>
                                 </table>
                                </p>
                        ...
                        <?php if(count($arr_library_id)>0) { ?> 
                                  <table border="0" width="100%" cellpadding="7" cellspacing="1">
                                    ...
                                    <tr class="manage-header">
                                        ...
                                        <td width="20%" class="manage-header" align="center">Content</td>
