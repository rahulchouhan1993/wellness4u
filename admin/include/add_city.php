...
if(isset($_POST['btnSubmit']))
{
	...
	elseif( $obj->chkCityExists($city,$state_id) )
	{
		$error = true;
			...
			<td>
				...
				<tbody>
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Add City</td>
				...
				<tbody>
					<tr>
						<td class="mainbox-body">
							<form action="#" method="post" name="frmadd_city" id="frmadd_city" enctype="multipart/form-data" >
