...
if(isset($_POST['btnSubmit']))
{
	...
	if(!$error)
		{   
			if($obj->AddMindJumbleToolTip($page_id,$contents))
				{
    ...
    
	{
		...
		$contents = $obj->getMindJumbleToolTip();
							 ...
							 <tr>
								...
								<tr>
									...
									<td align="left"><input type="Submit" name="btnSubmit" value="Submit" />&nbsp;
                                    				<input type="button" name="btnSubmit" value="Back" onclick="window.location.href='index.php?mode=mindjumble';"/></td>
								</tr>
							</tbody>
							</table>
							</form>
