			...
			<td>
				...
				<tbody>
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Manage States</td>
									...
									<tr>
										<td colspan="4" align="right">
                                         <?php if($obj->chkValidActionPermission($admin_id,$add_action_id))
											{	 ?>
											<a href="index.php?mode=add_state"><img src="images/add.gif" width="10" height="8" border="0" />Add New Entry</a>
											<?php } ?>
                                        </td>
									</tr>
									<tr class="manage-header">
										<td width="10%" class="manage-header" align="center" >S.No.</td>
										<td width="70%" class="manage-header" align="center">State</td>
										<td width="10%" class="manage-header" align="center">Edit</td>
										<td width="10%" class="manage-header" align="center">Delete</td>
									</tr>
									<?php
									echo $obj->getAllStates($search);
									?>
								</tbody>
								</table>
								<p></p>
