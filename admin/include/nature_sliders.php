			...
			<td>
				...
				<tbody>
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Manage Nature Sliders</td>
								...
								<tbody>
									<tr>
										<td colspan="5" align="right">
											<a href="index.php?mode=add_nature_slider"><img src="images/add.gif" width="10" height="8" border="0" />Add New Entry</a>
										</td>
									</tr>
									...
									<?php
									echo $obj->getAllSliderContents(1);
									?>
								</tbody>
								</table>
								<p></p>
