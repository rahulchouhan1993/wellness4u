...
if(isset($_POST['btnSubmit']))
{
    ...
    if(!$error)
    {
        ...
        if($obj->addBodyPart($bp_name,$bp_side,$bp_sex,$bp_parent_id,$bp_image))
        {
            ...
            <td>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Add Body Part</td>
