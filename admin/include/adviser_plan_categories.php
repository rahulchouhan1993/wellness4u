			...
			<td>
				...
				<tbody>
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Manage Adviser Plan Categories</td>
						...
						<td class="mainbox-body">
							...
							<div id="pagination_contents" align="center"> 
								...
								<tbody>
									<tr>
										<td colspan="5" align="right">
                                          <?php if($obj->chkValidActionPermission($admin_id,$add_action_id))
											{	 ?>
											<a href="index.php?mode=add_adviser_plan_category"><img src="images/add.gif" width="10" height="8" border="0" />Add New Entry</a>
											<?php } ?>
                                        </td>
									</tr>
									...
									<?php
									echo $obj->getAllAdviserPlanCategories();
									?>
								</tbody>
								</table>
								<p></p>
