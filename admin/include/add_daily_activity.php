...

{
	...
	elseif( $obj->chkActivityExists($activity) )

	{

		$error = true;

		$err_msg = 'This activity is already added';
	...
	{	
		...
		if($obj->addDailyActivity($activity_code,$activity,$activity_cal_kg_min,$activity_cal_kg_hr,$activity_cal_59_kg,$activity_level_code,$activity_category,$recommendations,$guidelines,$precautions,$benefits,$status))
			...
			<td>
				...
				<tbody>
					...
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Add Daily Activity</td>
				...
				<tbody>
					...
					<tr>
						...
						<td class="mainbox-body">
							...
							<form action="#" method="post" name="frmadd_daily_activity" id="frmadd_daily_activity" enctype="multipart/form-data" >
							...
							<tbody>
								...
								<tr>
									...
									<td width="75%" align="left">
										...
										<input name="activity" id="activity" type="text" value="<?php echo $activity;?>" style="width:200px;"  />
...
<!--                                                                     <td width="10%" height="30" align="left" valign="middle"><strong>&nbsp;&nbsp;&nbsp;&nbsp;fav Category:</strong></td>
                                                                        ...
                                                                        <td width="15%" height="30" align="left" valign="middle">
                                                                            ...
                                                                            <select name="fav_cat_id" id="fav_cat_id" style="width:200px;">
                                                                                 ...
                                                                                 <?php  echo $obj1->getFavCategoryRamakant('35',$fav_cat_id)?>
									...
									<td align="left">	
																		<!-- code commemt by ample 27-11-19 -->
                                                                    ...
                                                                    <?php echo $obj1->getAllCategoryChkeckbox('35','','','','300','200'); ?>
