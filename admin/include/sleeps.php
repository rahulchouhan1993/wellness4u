			...
			<td>
				...
				<tbody>
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Manage Sleep Questions</td>
							...
							<div id="pagination_contents" align="center"> 
								...
								<tbody>
									<tr>
                                        ...
                                        { ?>
											<a href="index.php?mode=add_sleep"><img src="images/add.gif" width="10" height="8" border="0" />Add New Entry</a>
										<?php 
										} ?>
                                        </td>
									</tr>
