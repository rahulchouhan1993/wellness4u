...
if(isset($_POST['btnSubmit']))
{
	...
	{
		$error = true;
		$err_msg = "Please Enter Box Title.";
	}
	elseif($obj->chkEdit_TitleExists($title,$title_id))
	{
		$error = true;
		...
		if(!$error)
		{  
			if($obj->Update_Mindjumble_Title($status,$title,$title_id))
				{
...
elseif(isset($_GET['uid']))
{
	...
	list($title,$status) = $obj->getmindjumbletitle($title_id);
