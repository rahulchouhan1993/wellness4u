...
if(isset($_POST['btnSubmit']))
{
	...
	if($obj->chkIfScrollingWindowOrderAlreadyExists_Edit($sw_order,$page_id,$sw_id,$sw_show_in_contents))
	{
		//$error = true;
		...
		if(isset($_FILES['sw_header_image']['tmp_name']) && $_FILES['sw_header_image']['tmp_name'] != '')
		{
			...
			{	
				...
				if(!move_uploaded_file($_FILES['sw_header_image']['tmp_name'], $temp_file)) 
				{
					...
					$sw_header_image = $_POST['hdnsw_header_image'];
				}
			}
			else
			{
		...
		if(isset($_FILES['sw_footer_image']['tmp_name']) && $_FILES['sw_footer_image']['tmp_name'] != '')
		{
			...
			{	
				...
				if(!move_uploaded_file($_FILES['sw_footer_image']['tmp_name'], $temp_file)) 
				{
					...
					$sw_footer_image = $_POST['hdnsw_footer_image'];
				}
			}
			else
			{
...
{
	$sw_id = $_GET['id'];
	list($return,$page_id,$sw_header,$sw_header_image,$sw_show_header_credit,$sw_header_credit_link,$sw_footer,$sw_footer_image,$sw_show_footer_credit,$sw_footer_credit_link,$sw_status,$sw_header_font_family,$sw_header_font_size,$sw_footer_font_family,$sw_footer_font_size,$sw_order,$sw_header_font_color,$sw_footer_font_color,$sw_show_in_contents,$sw_header_bg_color,$sw_footer_bg_color,$sw_box_border_color,$sw_header_hide,$sw_footer_hide) = $obj->getScrollingWindowDetails($sw_id);
	if(!$return)
	{
		header('location: index.php?mode=scrolling_windows');	
	}	
				...
				<tbody>
					<tr>
						<td class="mainbox-body">
                            ...
                            <input type="hidden" name="hdnsw_header_image" id="hdnsw_header_image" value="<?php echo $sw_header_image;?>" />
							<input type="hidden" name="hdnsw_footer_image" id="hdnsw_footer_image" value="<?php echo $sw_footer_image;?>" />
							...
							<tbody>
								...
								<tr>
									<td colspan="3" align="center">&nbsp;</td>
                                                                ...
                                                                <tr>
									<td align="right" valign="top"><strong>Scrolling Windoe Header</strong></td>
									<td align="center" valign="top"><strong>:</strong></td>
                                ...
                                <tr>
									...
									<td align="center" valign="top"><strong>:</strong></td>
									<td align="left" valign="top"><?php if($sw_header_image != '') { ?><img border="0" width="50" src="<?php echo SITE_URL.'/uploads/'.$sw_header_image;?>" /><?php } ?></td>
								</tr>
                                <tr>
								...
								<tr>
									...
									<td align="center" valign="top"><strong>:</strong></td>
									<td align="left" valign="top"><?php if($sw_footer_image != '') { ?><img border="0" width="50" src="<?php echo SITE_URL.'/uploads/'.$sw_footer_image;?>" /><?php } ?></td>
								</tr>
                                                                <tr>
									<td align="right" valign="top"><strong></strong></td>
									<td align="center" valign="top"><strong>:</strong></td>
                                ...
                                <tr>
									...
									<td align="center" valign="top"><strong>:</strong></td>
									<td align="left" valign="top">
										<select id="sw_status" name="sw_status" style="width:200px;">
											<option value="0" <?php if($sw_status == 0) { ?> selected="selected" <?php } ?>>Inactive</option>
											<option value="1" <?php if($sw_status == 1) { ?> selected="selected" <?php } ?>>Active</option>
										</select>
									</td>
								</tr>
								<tr>
