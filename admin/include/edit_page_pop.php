...
//    die();
   ...
   if(isset($_POST['canv_sub_cat9_show_fetch']))
    ...
    if(!$error)
    {
        ...
        if($obj->updatePagePopup($admin_comment,$arr_heading,$pag_cat_status,$admin_id,$ref_code,$page_name,$sub_cat1,$sub_cat2,$sub_cat3,$sub_cat4,$sub_cat5,$sub_cat6,$sub_cat7,$sub_cat8,$sub_cat9,$sub_cat10,$prof_cat1,$prof_cat2,$prof_cat3,$prof_cat4,$prof_cat5,$prof_cat6,$prof_cat7,$prof_cat8,$prof_cat9,$prof_cat10,$id,$time_show,$duration_show,$location_show,$like_dislike_show,$set_goals_show,$scale_show,$reminder_show,$heading,$order_show,$comments_show,$location_category,$user_response_category,$user_what_next_category,$alerts_updates_category,$cat_fetch_show_data,$canv_sub_cat_link,$data_source,$page_show))
        {
...
{
    header('location: index.php?mode=page_pop');
    exit(0);
}
?>
			...
			<td>
				...
				<tbody>
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Edit Page Popup</td>
...
<!--                                            <select name="order_show" style="width:200px; height: 24px;">
    ...
    $( document ).ready(function()
    {
        ...
        if(parent_cat_id1!='')
        {
            var dataString = 'action=getdatasubcatoption_popup&parent_cat_id='+parent_cat_id1+'&id='+id+'&columns=sub_cat1';
	    $.ajax({
		type: "POST",
        ...
        if(parent_cat_id2!='')
        {
            var dataString = 'action=getdatasubcatoption_popup&parent_cat_id='+parent_cat_id2+'&id='+id+'&columns=sub_cat2';
	$.ajax({
		type: "POST",
		url: "include/remote.php",
		data: dataString,
        ...
        if(parent_cat_id3!='')
        {
            var dataString = 'action=getdatasubcatoption_popup&parent_cat_id='+parent_cat_id3+'&id='+id+'&columns=sub_cat3';
	$.ajax({
		type: "POST",
		url: "include/remote.php",
		data: dataString,
        ...
        if(parent_cat_id4!='')
        {
            var dataString = 'action=getdatasubcatoption_popup&parent_cat_id='+parent_cat_id4+'&id='+id+'&columns=sub_cat4';
	$.ajax({
		type: "POST",
		url: "include/remote.php",
		data: dataString,
        ...
        if(parent_cat_id5!='')
        {
            var dataString = 'action=getdatasubcatoption_popup&parent_cat_id='+parent_cat_id5+'&id='+id+'&columns=sub_cat5';
	$.ajax({
		type: "POST",
		url: "include/remote.php",
		data: dataString,
        ...
        if(parent_cat_id6!='')
        {
            var dataString = 'action=getdatasubcatoption_popup&parent_cat_id='+parent_cat_id6+'&id='+id+'&columns=sub_cat6';
	$.ajax({
		type: "POST",
		url: "include/remote.php",
		data: dataString,
        ...
        if(parent_cat_id7!='')
        {
            var dataString = 'action=getdatasubcatoption_popup&parent_cat_id='+parent_cat_id7+'&id='+id+'&columns=sub_cat7';
	$.ajax({
		type: "POST",
		url: "include/remote.php",
		data: dataString,
        ...
        if(parent_cat_id8!='')
        {
            var dataString = 'action=getdatasubcatoption_popup&parent_cat_id='+parent_cat_id8+'&id='+id+'&columns=sub_cat8';
	$.ajax({
		type: "POST",
		url: "include/remote.php",
		data: dataString,
        ...
        if(parent_cat_id9!='')
        {
            var dataString = 'action=getdatasubcatoption_popup&parent_cat_id='+parent_cat_id9+'&id='+id+'&columns=sub_cat9';
	$.ajax({
		type: "POST",
		url: "include/remote.php",
		data: dataString,
        ...
        if(parent_cat_id10!='')
        {
            var dataString = 'action=getdatasubcatoption_popup&parent_cat_id='+parent_cat_id10+'&id='+id+'&columns=sub_cat10';
	$.ajax({
		type: "POST",
		url: "include/remote.php",
		data: dataString,
