...
if(isset($_POST['btnSubmit']))
{
	...
	{
		$error = true;
		$err_msg .= "<br>Please Enter Mindjumble Box Title.";
	}
	...
	if(!$error)
		{   
        	...
        	//update by ample 18-11-19 & update 03-02-20
			if($obj->Add_MindJumble($page_id,$box_title,$banner_type,$banner,$box_desc,$credit_line,$credit_line_url,$sound_clip_id,$short_narration,$str_tags,$ref_code,$group_code,$take_key_title,$take_key_narration,$take_key_notes,$identity_type,$identity_id,$order,$is_featured))
				{
					$msg = "Record Added Successfully!";
					header('location: index.php?mode=mindjumble&msg='.urlencode($msg));
				}
			else
				{
					$error = true;
			...
			<td>
				...
				<tbody>
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Add Mind Jumble</td>
							...
							<tbody>
								...
								<tr>
                                    ...
                                    <td width="65%" align="left" valign="top">
                                        ...
                                        <input type="text" name="ref_code" id="ref_code" style="width:250px;" required="">
                                ...
                                <tr>
                                    ...
                                    <td width="65%" align="left" valign="top">
                                        ...
                                        <select name="group_code" id="group_code" style="width:250px;" required="">
                                                ...
                                                <?php echo $obj3->getdylgroupcodeoption('78',''); ?>
								...
								<tr>
									...
									<td width="75%" align="left"><input type="text"  id="box_title" name="box_title" value="<?php echo $box_title; ?>" style="width:250px;"/>&nbsp;&nbsp;&nbsp;<input type="checkbox" name="take_key_title" id="take_key_title"> keyword Selection</td>
								</tr>
                                <tr>
									<td colspan="3" align="center">&nbsp;</td>
								</tr>
								...
								<tr>
									...
									<td width="75%" align="left" id="narration">
                                                        ...
                                                        <textarea rows="5" cols="40" name="short_narration" id="short_narration"></textarea>
                                                        <input type="checkbox" name="take_key_narration" id="take_key_narration"> keyword Selection
                                     </td>
								</tr>
								...
								<tr>
									<td width="20%" align="right"><strong>Mind Jumble Box Banner Type</strong></td>
									<td width="5%" align="center"><strong>:</strong></td>
                                ...
                                <tr id="tr_rss_content" style="display:<?php echo $tr_rss_content;?>">
                                        ...
                                        <td align="left">
                                            <select name="banner" id="banner3" onchange="getDescriptionDataVivek();return false;" style="width:400px;">
                                                ...
                                                <?php echo $obj2->getRssFeedOptions($rss_feed_item_id); ?>
                                            </select>
                                   	</td>
                                </tr>
								<tr>
                                ...
                                <tr>
									...
									<td width="5%" align="center" valign="top"><strong>:</strong></td>
									<td width="75%" align="left"><textarea id="box_desc" rows="10" cols="50" name="box_desc" ><?php echo $box_desc; ?></textarea><input type="checkbox" name="take_key_notes" id="take_key_notes"> keyword Selection
									</td>
								</tr>
                                <tr>
									<td colspan="3" align="center">&nbsp;</td>
                                ...
                                <tr>
                                    ...
                                    <td width="5%" align="center"><strong>:</strong></td>
                                    <td width="75%" align="left">
                                    	<!-- <textarea id="tags" name="tags"  style="width:50%;"><?php echo $tags; ?> </textarea> -->
