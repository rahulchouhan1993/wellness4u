...
if(isset($_POST['btnSubmit']))
{
	...
	if(!$error)
		{   
			if($obj->Update_Angervent_user_area($id,$box_title,$box_desc))
				{
					$msg = "Record Updated Successfully!";
					header('location: index.php?mode=manage_anger_vent_user_area&msg='.urlencode($msg));
				}
			else
				{
					$error = true;
...
elseif(isset($_GET['uid']))
{
	...
	list($step,$box_title,$box_desc) = $obj->getAngerVentUserarea($userarea_id,'Angervent');
}
?>
                                   ...
                                   <table border="0" width="100%" align="center" cellpadding="0" cellspacing="0">
                                	<tr align="left">
                                    	<td align="left" colspan="2">
                                        	<input type="button" name="btnSubmit" value="Back" onclick="window.location.href='index.php?mode=manage_anger_vent_user_area';"/>
                                       		</td>
                                        <td align="left">&nbsp;</td>             
                                    </tr>
                                 </table>
