						...
						<td class="mainbox-body">
							...
							<div id="pagination_contents" align="center"> 
								...
								<tbody>
									<tr>
										<td colspan="6" align="right">
                                         <?php if($obj->chkValidActionPermission($admin_id,$add_action_id))
											{	 ?>
											<a href="index.php?mode=add_view_slider&pid=<?php echo $parents_slider_id ?>"><img src="images/add.gif" width="10" height="8" border="0" />Add New Entry</a>
										<?php } ?>
                                        </td>
									</tr>
									<tr class="manage-header">
										<td width="5%" class="manage-header" align="center"><strong>S.No</strong></td>
										<td width="40%" class="manage-header" align="center"><strong>Title</strong></td>
										<td width="25%" class="manage-header" align="center"><strong>Slider Description</strong></td>
                                        <td width="20%" class="manage-header" align="center"><strong>Slider Link</strong></td>
									...
									<?php
									echo $obj->getSliderContents($parents_slider_id);
									?>
								</tbody>
								</table>
								<p></p>
