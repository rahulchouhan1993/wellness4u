			...
			if($obj->Update_user_area($id,$box_title,$box_desc))
				{
					...
					header('location: index.php?mode=manage_stressbuster_user_area&msg='.urlencode($msg));
				}
			else
				{
					$error = true;
...
elseif(isset($_GET['uid']))
{
	...
	list($step,$box_title,$box_desc) = $obj->getUserarea($userarea_id,'Stressbuster');
}
?>
                                   ...
                                   <table border="0" width="100%" align="center" cellpadding="0" cellspacing="0">
                                	<tr align="left">
                                    	<td align="left" colspan="2">
                                        	<input type="button" name="btnSubmit" value="Back" onclick="window.location.href='index.php?mode=manage_stressbuster_user_area';"/>
                                       		</td>
                                        <td align="left">&nbsp;</td>             
                                    </tr>
                                 </table>
