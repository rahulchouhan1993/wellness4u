                                ...
                                <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td width="65%" align="left" valign="top">
                                        ...
                                        <!--  copy code from fav_ct_dropdown also update it by ample 04-11-19-->

                                         <input type="hidden" name="page_id" id="page_id" value="<?php echo $get_dta['page_id']; ?>">

                                           <?php echo $obj->getPagenamebyPage_menu_id('27',$get_dta['page_id'],$get_dta['page_type']); ?>
