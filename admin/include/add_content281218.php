...
if(isset($_POST['btnSubmit']))
{
	...
	if(!$error)
	{
		$adviser_panel = '0';
                $vender_panel = '0';
		if($obj->AddContent($image,$menu_link,$page_name,$page_title,$page_contents,$meta_title,$meta_keywords,$meta_description,$menu_title,$menu_link_enable,$adviser_panel,$page_contents2,$vender_panel,$admin_id))
		{
