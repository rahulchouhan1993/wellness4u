...
if(isset($_POST['btnSubmit'])) 
{
	...
	elseif($banner_type == 'Google Ads')
	{
        ...
        elseif($banner_type == 'Affilite Ads'|| $banner_type == 'Other Ads')
                        {
                          $banner = $_POST['banner_code'];
								...
								<tr>
									...
									<td width="75%" align="left"><select id="page_id" name="page_id">
                                                                 ...
                                                                 <?php //echo $obj->getPageOptions($page_id); 
                                                                        echo $obj->getPageOptionsFromDatadrop('16',$page_id);
                                                                 ?>
                                                                 </select></td>
								</tr>
								<tr>
										 ...
										 <?php
											...
											elseif($banner_type == 'Google Ads')
											{
												echo $banner;
                                                                                        ...
                                                                                        elseif($banner_type == 'Google Ads' || $banner_type == 'Google Ads')
											{
												echo $banner;
											}
										}
...
<!--								<tr id="trfile" style="display:<?php //echo $display_trfile;?>">
								...
								<tr id="trtext" style="display:<?php //echo $display_trtext;?>">
									...
									<td colspan="3" align="center">&nbsp;</td>
                                                                ...
                                                                <?php  if($banner_type == 'Affilite Ads' || $banner_type == 'Other Ads') { ?>
								<tr>
									<td width="20%" align="right"><strong>Banner Code</strong></td>
									<td width="5%" align="center"><strong>:</strong></td>
									<td width="75%" align="left">
                                                                      
                                                                        <textarea id="banner_code" name="banner_code" cols="60" rows="3"><?php  echo $banner; ?></textarea>
                                                                        </td>
								</tr>
                                                                <?php } ?>
								<tr>
