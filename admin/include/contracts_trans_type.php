            ...
            <td>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Manage Document Type</td>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <?php if($obj->chkValidActionPermission($admin_id,$add_action_id)) {	 ?>
                                            <a href="index.php?mode=add_contracts_trans_type"><img src="images/add.gif" width="10" height="8" border="0" />Add New Entry</a>
                                        <?php } ?>
                                        </td>
                                    </tr>
                                    <tr class="manage-header">
                                        <td width="10%" class="manage-header" align="center"><strong>S.No</strong></td>
                                        <td width="60%" class="manage-header" align="center"><strong>Document Type</strong></td>
                                    ...
                                    <?php
                                    echo $obj->getAllContractsTransactionType($search,$status);
                                    ?>
                                </tbody>
                                </table>
                                <p></p>
