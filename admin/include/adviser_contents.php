			...
			<td>
				...
				<tbody>
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Manage Adviser Panel Contents </td>
							...
							<div id="pagination_contents" align="center"> 
								...
								<tbody>
									<tr>
                                        ...
                                        { ?>
											<a href="index.php?mode=add_adviser_content"><img src="images/add.gif" width="10" height="8" border="0" />Add New Page</a>
                                        <?php 
                                        } ?>    
										</td>
									</tr>
									<tr class="manage-header">
										...
										<td class="manage-header" align="center" width="20%">Menu Link</td>
									...
									<?php
									echo $obj->GetAllPagesAdviser($search);
									?>
								</tbody>
								</table>
								<p></p>
