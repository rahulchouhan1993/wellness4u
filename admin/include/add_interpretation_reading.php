...
//        $row_totalRow = trim($_POST['cat_total_cnt']);  
	if(!$error)
	{
		...
		if($obj->addReading($healcareandwellbeing,$identity_type,$identity_id,$lab,$adviser,$referred_by,$referred_from,$prof_cat,$sub_cat,$patient_name,$reg_id,$gender,$age,$test_no,$test_date,$interpretation_criteria,$scale_form,$scale_to,$symptom_type,$symptom_name,$listing_order,$share_type))
		{
			...
			<td>
				...
				<tbody>
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Add Interpretation Reading</td>
...
<!--                                                        <input type="hidden" name="country_id" id="country_id"  />
							...
							<input type="hidden" name="place_id" id="place_id"  >
                                                        ...
                                                        <input type="hidden" name="user_age1" id="user_age1"  />
							<input type="hidden" name="user_age2" id="user_age2"  >
                                                        
							<input type="hidden" name="user_service" id="user_service"  />
							
                                                        
                                                         <input type="hidden" name="users_food_option" id="users_food_option"  />
                                                        <input type="hidden" name="users_height1" id="users_height1"  />
							<input type="hidden" name="users_height2" id="users_height2"  />
							<input type="hidden" name="users_weight1" id="users_weight1"  >
                                                        <input type="hidden" name="users_weight2" id="users_weight2" />
                                                        <input type="hidden" name="users_bmi1" id="users_bmi1"  >
                                                        <input type="hidden" name="users_bmi2" id="users_bmi2"  > -->
					   ...
					   <tr>
									<td colspan="9" align="center">&nbsp;</td>
                                        ...
                                        <td colspan="8" height="30" align="left" valign="middle">&nbsp;</td>
                                                  ...
                                                  <td width="10%" height="40" align="left" valign="middle" style="color:red"><strong>Interpretation Criteria Details:</strong></td>
                                                                <tr>
...
<!--									<td>&nbsp;</td>
									<td>&nbsp;</td> -->
									<td align="middle"><input type="Submit" name="btnSubmit" value="Submit" /></td>
								</tr>
							</form>
						</td>
					</tr>
