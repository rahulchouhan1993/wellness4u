			...
			<td>
				...
				<tbody>
					...
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Manage Reward Modules </td>
							...
							<div id="pagination_contents" align="center"> 
								...
								<tbody>
									...
									<tr>
                                                                            ...
                                                                            <td colspan="6" align="right" nowrap="nowrap">
                                                                                ...
                                                                                { ?>
                                                                                    ...
                                                                                    <a href="index.php?mode=add_reward_module"><img src="images/add.gif" width="10" height="8" border="0" />Add New Entry</a>
									...
									<tr class="manage-header">
										...
										<td class="manage-header" align="center" width="50%">Module Name</td>

                                                                                <td class="manage-header" align="center" width="10%">Status</td>

                                                                                <td class="manage-header" align="center" width="10%">Posted By</td>

                                                                                <td class="manage-header" align="center" width="20%">Date Time</td>
									...
									echo $obj->GetAllRewardsModuleList($search);
