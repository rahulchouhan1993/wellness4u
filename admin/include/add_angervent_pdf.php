...
if(!$angervent->chkValidActionPermission($admin_id,$add_action_id))
	{	
...
if(isset($_POST['btnSubmit']))
{
	...
	if($pdf_title == "")
	{
		...
		if(!$error)
			{  
				if($angervent->Add_AngerVentPDF($step,$pdf,$credit,$credit_url,$pdf_title,$day))
					{
				...
				<tbody>
					<tr>
						<td class="mainbox-body">
							<form action="#" method="post" name="frmadd_angerventpdf" id="frmadd_angerventpdf" enctype="multipart/form-data" >
