               ...
               <table border="0" width="100%" cellpadding="0" cellspacing="0">
                  <tbody>
                     <tr>
                        ...
                        <td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Manage Special Button Setting</td>
                        ...
                        <td class="mainbox-body">
                           ...
                           <div id="pagination_contents" align="center">
                              ...
                              <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                <tbody>
                                    <tr>
                                        <td colspan="8" height="30" align="left" valign="middle"><strong>Search Record By admin comment, Ref code</strong></td>
                                    </tr>
                                    <tr>
                              ...
                              <table border="1" width="100%" cellpadding="2" cellspacing="2">
                                 <tbody>
                                    <tr>
                                       <td colspan="10" align="left" nowrap="nowrap">
                                          <?php if($obj->chkValidActionPermission($admin_id,$add_action_id))
                                             {   ?>
                                          <a href="index.php?mode=add-common-button-setting"><img src="images/add.gif" width="10" height="8" border="0" />Add New</a>
                                          <?php } ?>
                                       </td>
                                    </tr>
                                    ...
                                    <?php
                                       echo $obj->geCommonButtonSettingListData($search,$status);
