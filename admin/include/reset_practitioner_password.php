...
if(isset($_POST['btnSubmit']))
{
	...
	if(!$error)
	{
		...
		if($obj->resetProUserPassword($user_id,$password))
		{
			$from_email = 'info@wellnessway4u.com';
			$from_name = 'info';
			
			$to_email = $obj->getEmailOfProUser($user_id);
			$name = $obj->getNameOfProUser($user_id);
...
{
	$user_id = $_GET['uid'];
	if(!$obj->chkValidProUser($user_id))
	{
			...
			<td>
				...
				<tbody>
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Reset Practitioner Password </td>
						...
						<td class="mainbox-body">
							...
							<tbody>
								<tr>
									...
									<td width="75%" align="left"><?php echo $obj->getEmailOfProUser($user_id);?></td>
								</tr>
								<tr>
