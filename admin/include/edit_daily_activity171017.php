...
if(isset($_POST['btnSubmit']))
{
	...
	if(!$error)
	{
		if($obj->updateDailyActivityFull($activity_code,$activity,$activity_cal_kg_min,$activity_cal_kg_hr,$activity_cal_59_kg,$activity_level_code,$activity_category,$recommendations,$guidelines,$precautions,$benefits,$activity_id))
		{
...
{
	$activity_id = $_GET['id'];
	list($activity_code,$activity,$activity_cal_kg_min,$activity_cal_kg_hr,$activity_cal_59_kg,$activity_level_code,$activity_category,$recommendations,$guidelines,$precautions,$benefits) = $obj->getActivityDetails($activity_id);
	if($activity == '')
	{
