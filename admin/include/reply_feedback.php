...
if(isset($_POST['btnSubmit']))
{
	...
	if($reply == "")
	{
		...
		if(!$error)
		{
			...
			$obj->Insert_admin_reply($parent_id,$page_id,$admin_id,$admin_name,$admin_email,$reply);
		}	
						...
						<td class="mainbox-body">
							...
							<tbody>
                                ...
                                <tr>
									...
									<td width="5%" align="center"><strong>:</strong></td>
									<td width="75%" align="left"><label id="email"><?php echo $email; ?></label>
                                     </td>
								</tr>
								<tr>
									<td colspan="3" align="center">&nbsp;</td>
                                ...
                                <tr>
									...
									<td width="5%" align="center"><strong>:</strong></td>
									<td width="75%" align="left"><label id="name"><?php echo $name; ?></label>
                                     </td>
								</tr>
								<tr>
									<td colspan="3" align="center">&nbsp;</td>
                                ...
                                <tr>
									<td width="20%" align="right"><strong>Feedback</strong></td>
									<td width="5%" align="center"><strong>:</strong></td>
                                ...
                                <tr>
									<td width="20%" align="right" valign="top"><strong>Reply</strong></td>
									<td width="5%" align="center" valign="top"><strong>:</strong></td>
									<td width="75%" align="left"><textarea cols="50" rows="5" type="text"  id="reply" name="reply"><?php echo $reply; ?></textarea>
                                     </td>
								</tr>
                                <tr>
									<td colspan="3" align="center">&nbsp;</td>
