			...
			<td>
				...
				<tbody>
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Manage Mindjumble User Area</td>
						...
						<td class="mainbox-body">
							...
							<div id="pagination_contents" align="center"> 
								...
								<tbody>
									...
									<?php
									echo $obj->GetAllMindjumbleUserArea();
									?>
								</tbody>
								</table>
								<p></p>
