...
{
    $contract_id = $_POST['hdncontract_id'];
    ...
    if(!$error)
    {
        if($obj->updateContractRecord($contract_person,$contract_person_type,$company_name,$contract_email,$contract_mobile,$address,$country_id,$state_id,$city_id,$place_id,$contract_status,$contract_id,$admin_id))
        {
...
{
    $contract_id = $_GET['id'];
    list($contract_person,$contract_person_type,$company_name,$contract_email,$contract_mobile,$address,$country_id,$state_id,$city_id,$place_id,$contract_status) = $obj->getContractDetails($contract_id);
    if($contract_person == '')
    {
        header('location: index.php?mode=clients_master');	
    }
}	
else
{
			...
			<td>
				...
				<tbody>
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Edit Client</td>
				...
				<tbody>
					<tr>
						<td class="mainbox-body">
							...
							<input type="hidden" name="hdncontract_id" id="hdncontract_id" value="<?php echo $contract_id;?>" />
                            	...
                            	<tr>
									...
									<td width="65%" align="left">
                                                                            <select id="contract_status" name="contract_status">
                                                                                <option value="1" <?php if($contract_status == '1'){ ?> selected <?php } ?>>Active</option>
                                                                                <option value="0" <?php if($contract_status == '0'){ ?> selected <?php } ?>>Inactive</option>
                                                                            </select>
                                                                        </td>
								</tr>
                                <tr>
