...
if(isset($_POST['btnSubmit']))
{
	...
	else
	{
		...
		if(!$error)
		{
			if($angervent->Update_AngerVentMusic($step,$music,$day,$credit,$credit_url,$status,$music_id))
				{
					$msg = "Record Edited Successfully!";
					header('location: index.php?mode=manage_anger_vent_bk_music&msg='.urlencode($msg));
				}
			else
				{
					$error = true;
	...
	elseif(isset($_GET['uid']))
	{
		...
		list($step,$music,$day,$credit,$credit_url,$status) = $angervent->getAngerVentMusicDetails($bk_music_id);
	...
	{
		header('location: index.php?mode=manage_anger_vent_bk_music');
	}	
						...
						<td class="mainbox-body">
							...
							<tbody>
								<tr>
									...
									<td width="75%" align="left"><strong><select name="step" id="step">
