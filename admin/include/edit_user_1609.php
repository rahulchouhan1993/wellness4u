...
if(isset($_POST['btnSubmit']))
{
	...
	if(!$error)
	{
		if($obj->updateUser($email,$name,$middle_name,$last_name,$dob,$height,$weight,$sex,$mobile,$status,$state_id,$city_id,$place_id,$food_veg_nonveg,$beef,$pork,$user_id))
		{
...
{
	$user_id = $_GET['uid'];
	list($return,$name,$middle_name,$last_name,$email,$dob,$height,$weight,$sex,$mobile,$state_id,$city_id,$place_id,$food_veg_nonveg,$beef,$pork,$status) = $obj->getUserDetails($user_id);
	if(!$return)
	{
