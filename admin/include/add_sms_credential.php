...
if (isset($_POST['btnSubmit'])) {
    ...
    if (!$error) {
        ...
        if ($obj->add_SMS_credential($admin_id,$data)) {
            ...
            <td>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Add SMS Credential</td>
                            ...
                            <form action="#" method="post"  enctype="multipart/form-data" >
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                        ...
                                        <td width="65%" align="left" valign="top">
                                            ...
                                            <input type="text" name="SMS_URL" id="SMS_URL" style="width:200px;height: 24px;">
                                     ...
                                     <tr>
                                        ...
                                        <tr>
                                            ...
                                            <input type="text" name="SMS_USERNAME" id="SMS_USERNAME" style="width:200px;height: 24px;">
                                ...
                                <tr>
                                    ...
                                    <td width="65%" align="left" valign="top">
                                       ...
                                       <input type="text" name="SMS_PASSWORD" id="SMS_PASSWORD" style="width:200px;height: 24px;">
                                ...
                                <tr>
                                    ...
                                    <td width="65%" align="left" valign="top">
                                       ...
                                       <input type="text" name="SMS_SENDERID" id="SMS_SENDERID" style="width:200px;height: 24px;">
