...
if(isset($_POST['save']))
{
	...
	$res=$obj->update_WSI_buttons($id,$data);
...
$data=$obj->get_button_data_WSI($id);



if(empty($data))
{
	$data=$obj->get_default_button_data_by_menuID($menu_id="68");
}
...
<!--notification_contents-->
	...
	<tbody>
		...
		<tr>
			<td>
				<br>
				<a href="index.php?mode=edit_wellness_solution_item&id=<?=$_GET['WSI_id']?>"><button class="btn btn-default">Back</button></a>
