...
{
    $reward_point_module_id = trim($_POST['reward_point_module_id']);
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td width="5%" align="center"><strong>:</strong></td>
                                        <td width="75%" align="left">
                                            <select id="reward_point_module_id" name="reward_point_module_id" style="width:400px;">
                                                <option value="">Select Module </option>
                                                <?php echo $obj->getRewardModuleOptions($reward_point_module_id); ?>
                                            </select>
...
<!-- 
                                    ...
                                    <tr>
                                        ...
                                        <td align="center"><strong>:</strong></td>
                                        <td align="left"><input name="reward_point_conversion_value" type="text" id="reward_point_conversion_value" value="<?php echo $reward_point_conversion_value; ?>" style="width:400px;" ></td>
                                    </tr>
                                    <tr>
                                        <td colspan="3" align="center">&nbsp;</td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center"><strong>:</strong></td>
                                        <td align="left"><input name="reward_point_min_cutoff" type="text" id="reward_point_min_cutoff" value="<?php echo $reward_point_min_cutoff; ?>" style="width:400px;" ></td>
                                    </tr>
                                    <tr>
                                        <td colspan="3" align="center">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td align="center"><strong>:</strong></td>
                                        <td align="left"><input name="reward_point_max_cutoff" type="text" id="reward_point_max_cutoff" value="<?php echo $reward_point_max_cutoff; ?>" style="width:400px;" ></td>
                                    </tr>
                                    <tr>
                                        <td colspan="3" align="center">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td align="center"><strong>:</strong></td>
                                        <td align="left">
                                            <input name="reward_point_date" id="reward_point_date" type="text" value="<?php echo $reward_point_date;?>" style="width:200px;"  />
                                            <script>$('#reward_point_date').datepick({ minDate: 0 , dateFormat : 'dd-mm-yy'}); </script>
                                        </td>
                                    </tr>
                                    <tr>
