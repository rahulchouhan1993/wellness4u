...
$tables=$obj2->getTableNameFrom_tbltabldropdown('5');
...

{
   ...
   // die();
	...
	$narration = $_POST['narration']; 
        ...
        //code added by ample 26-11-19 &update 23-01-20
        $level=array();
        ...
        //add by ample 22-05-20
        $box_data=array();
        $box_data['qr_box_type']=$_POST['qr_box_type'];
        if($box_data['qr_box_type']==1)
        {
            $box_data['qr_data_source']='';
        ...
        if($box_data['other_box_type']==1)
        {
            $box_data['other_box_type']='';
   ...
   if(isset($_POST['canv_sub_cat1_show_fetch']))

    {
        ...
        $cat_fetch_show_data['sub_cat1_show_fetch']= $_POST['canv_sub_cat1_show_fetch']; 
   ...
   if(isset($_POST['canv_sub_cat2_show_fetch']))
    ...
    //add & update  by ample 06-11-19
    $canv_sub_cat_link['sub_cat1_link']= $_POST['prof_cat1_link'];

    $canv_sub_cat_link['sub_cat2_link']= $_POST['prof_cat2_link'];

    $canv_sub_cat_link['sub_cat3_link']= $_POST['prof_cat3_link'];

    $canv_sub_cat_link['sub_cat4_link']= $_POST['prof_cat4_link'];
...

 {
       ...
       $fav_cat_id_data = implode(',',$fav_cat_id);
...

        {
            ...
            //update by ample 06-11-19 & update 23-01-20 & update 07-05-20 & 28-10-20
          if($obj2->AddDesignMyLife($text_box_show,$text_box_count,$user_upload_show,$box_count,$quick_response_show,$quick_tip_icon,$quick_tip_icon_type,$quick_response_heading,$response_heading,$show_to_user,$page_cat_id,$cat_fetch_show_data,$canv_sub_cat_link,$prof_cat2,$prof_cat3,$prof_cat4,$sub_cat2,$sub_cat3,$sub_cat4,$narration_show,$comment_order_show,$reminder_order_show,$scale_order_show,$set_goals_order_show,$like_dislike_order_show,$location_order_show,$duration_order_show,$time_order_show,$user_date_order_show,$ref_code,$admin_comment,$title_id,$narration,$user_date_show,$user_date_show_heading,$time_show,$time_heading,$duration_show,$duration_heading,$location_show,$location_heading,$location_category,$like_dislike_show,$like_dislike_heading,$user_response_category,$set_goals_show,$set_goals_heading,$user_what_next_category,$scale_show,$scale_heading,$reminder_show,$reminder_heading,$alerts_updates_category,$comments_show,$comments_heading,$order_show,$fav_cat_type_id,$fav_cat_id_data,$admin_id,$group_code,$prof_cat_heading,$prof_cat_ref_code,$cat_link_data,$cat_ref_code,$level,$page_show,$example_box,$box_data,$is_featured))
							...
							<tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="65%" align="left" valign="top">
                                                                        ...
                                                                        <select name="group_code" id="group_code" style="width:300px;" required="">
                                                                                ...
                                                                                <?php echo $obj2->getdylgroupcodeoption('78',''); ?>
                                ...
                                <tr>                                                                    
                                        ...
                                        <td  align="left" valign="top">
                                            ...
                                            <!--<input type="text" name="level_icon" id="level_icon" value="" style="width:200px;height: 24px;"> -->
                                ...
                                <tr>
									...
									<td colspan="3" align="center">&nbsp;</td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="65%" align="left" valign="top">
                                                                        ...
                                                                        <!-- update by ample 06-11-19-->
                                                                        <!-- &nbsp;&nbsp;&nbsp;Heading <input type="text" name="fav_cat_type_id_header" id="fav_cat_type_id_header" > -->
                                                                        &nbsp;&nbsp;&nbsp;Heading <input type="text" name="prof_cat1_heading" id="prof_cat1_heading" >
                                                                        <!-- added by ample 06-11-19-->
                                                                ...
                                                                <!-- added by ample 06-11-19 -->
                                                                 <tr>
                                                                    ...
                                                                    <div class="" style="margin-top: 2.5px;">
                                                                            Link
                                                                            <select name="prof_cat1_link" id="prof_cat1_link"  onchange="get_column_names(this,'prof_cat1_ref_code')" style="width: 177px;">
                                                                                <?php echo $tables; ?>
                                                                            </select>
                                                                             &nbsp;&nbsp; Reference Code 
                                    ...
                                    <tr>                                                                    
                                     ...
                                     <tr>                                                                    
                                        ...
                                        <td  align="left" valign="top">
                                            ...
                                            &nbsp;&nbsp;&nbsp;Box Count <input type="number" name="box_count" id="qr_box_count" >
                                            
                                            <br><br>
                                            <b>QR box type :</b>
                                            <select name="qr_box_type" id="qr_box_type" onchange="box_type_setting(this,'qr')" style="width:200px; height: 24px;">
                                                <option value="1">Input Box</option>
                                                <option value="2">Select Box</option>
                                                <option value="3">Example Box</option>
                                                <!-- <option value="4">Display Box</option> -->
                                            </select>
                                            
                                            <div id="data_source_box_qr" style="display: none;">
                                                <br><br>
                                                <b>QR data source :</b>
                                                <select name="qr_data_source[]" id="qr_data_source" style="width:200px; height: auto;" multiple>
                                            ...
                                            <div id="specifiq_text_box_qr" style="display: none;">
                                                ...
                                                <select name="qr_specifiq_text" id="qr_specifiq_text" style="width:200px; height: 24px;">
                                                    <option value="">Select</option>
                                                </select>
                                            </div>
                                            <br><br>
                                            <b>QR icon box type :</b>
                                            <select name="icon_box1" id="icon_box1" style="width:200px; height: 24px;" onchange="icon_box_type_setting(this,1)">
                                             ...
                                             <div id="icon_box_source1" style="display: none;">
                                                ...
                                                <select name="box_source1[]" id="box_source1" style="width:200px; height: auto;" multiple>
                                                    <option value="Location" selected>Location Category</option>
                                    ...
                                    <tr>                                                                    
                                        ...
                                        <td  align="left" valign="top">
                                            ...
                                            &nbsp;&nbsp;&nbsp;Heading <input type="text" name="response_heading" id="response_heading" > 
                                            &nbsp;&nbsp;&nbsp;Box Count <input type="number" name="text_box_count" id="other_box_count" >

                                            <br><br>
                                            <b>User box type :</b>
                                            <select name="other_box_type" id="other_box_type" onchange="box_type_setting(this,'ot')" style="width:200px; height: 24px;">
                                                <option value="1">Input Box</option>
                                                <option value="2">Select Box</option>
                                                <option value="3">Example Box</option>
                                                <!-- <option value="4">Display Box</option> -->
                                            ...
                                            <div id="data_source_box_ot" style="display: none;">
                                                ...
                                                <select name="other_data_source[]" id="other_data_source" style="width:200px; height: auto;" multiple>
                                                    <option value="ProfCat2" selected>ProfCat2</option>
                                                    <option value="ProfCat3">ProfCat3</option>
                                                    <option value="ProfCat4">ProfCat4</option>
                                                </select>
                                            ...
                                            <div id="specifiq_text_box_ot" style="display: none;">
                                                ...
                                                <select name="other_specifiq_text" id="other_specifiq_text" style="width:200px; height: 24px;">
                                                    <option value="">Select</option>
                                                </select>
                                            </div>
                                            <br><br>
                                            <b>User icon box type :</b>
                                            <select name="icon_box2" id="icon_box2" style="width:200px; height: 24px;" onchange="icon_box_type_setting(this,2)">
                                                <option value="0">No Icon</option>
                                                <option value="1">Drop-Down</option>
                                                <option value="2">Checkbox</option>
                                                <option value="3">Radio</option>
                                    ...
                                    <tr>                                                                    
                                        ...
                                        <td  align="left" valign="top">
                                            ...
                                            <input type="hidden" name="quick_tip_icon" id="quick_tip_icon" readonly />
                                            <input type="text" name="quick_tip_icon_type" id="quick_tip_icon_type" readonly/>
                                            <input type="text"  id="quick_tip_icon_name" disabled/>
                                            <input type="text"  id="quick_tip_icon_file" disabled />
                                            <button type="button" class="btn btn-danger btn-xs" onclick="ResetgalleryData('quick_tip_icon');">Reset</button>
                                    ...
                                    <tr>
                                        ...
                                        <td width="65%" align="left" valign="top">
                                            ...
                                            <!-- added by ample 06-11-19--->
                                            &nbsp;&nbsp;&nbsp;Heading <input type="text" name="prof_cat2_heading" id="prof_cat2_heading" >
                                     ...
                                     <!-- added by ample 06-11-19 -->
                                         <tr>
                                            ...
                                            <div class="" style="margin-top: 2.5px;">
                                                    Link
                                                    <select name="prof_cat2_link" id="prof_cat2_link"  onchange="get_column_names(this,'prof_cat2_ref_code')" style="width: 177px;">
                                                        <?php echo $tables; ?>
                                                    </select>
                                                     &nbsp;&nbsp; Reference Code 
                                    ...
                                    <tr>
                                        ...
                                        <td width="65%" align="left" valign="top">
                                            ...
                                            <!-- added by ample 06-11-19--->
                                            &nbsp;&nbsp;&nbsp;Heading <input type="text" name="prof_cat3_heading" id="prof_cat3_heading" >
                                     ...
                                     <!-- added by ample 06-11-19 -->
                                         <tr>
                                            ...
                                            <div class="" style="margin-top: 2.5px;">
                                                    Link
                                                    <select name="prof_cat3_link" id="prof_cat3_link"  onchange="get_column_names(this,'prof_cat3_ref_code')" style="width: 177px;">
                                                        <?php echo $tables; ?>
                                                    </select>
                                                     &nbsp;&nbsp; Reference Code 
                                    ...
                                    <tr>
                                        ...
                                        <td width="65%" align="left" valign="top">
                                            ...
                                            <!-- added by ample 06-11-19--->
                                            &nbsp;&nbsp;&nbsp;Heading <input type="text" name="prof_cat4_heading" id="prof_cat4_heading" >
                                     ...
                                     <!-- added by ample 06-11-19 -->
                                         <tr>
                                            ...
                                            <div class="" style="margin-top: 2.5px;">
                                                    Link
                                                    <select name="prof_cat4_link" id="prof_cat4_link"  onchange="get_column_names(this,'prof_cat4_ref_code')" style="width: 177px;">
                                                        <?php echo $tables; ?>
                                                    </select>
                                                     &nbsp;&nbsp; Reference Code 
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                          ...
                                          <input type="checkbox" value="1" name="is_featured" id="is_featured"> Featured Item
