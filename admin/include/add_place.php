...
if(isset($_POST['btnSubmit']))
{
	...
	elseif( $obj->chkPlaceExists($place,$city_id,$state_id) )
	{
		$error = true;
			...
			<td>
				...
				<tbody>
					<tr>
						...
						<td style="background-image: url(images/mainbox_title_bg.gif);" class="mainbox-title" width="100%">Add Place</td>
				...
				<tbody>
					<tr>
						<td class="mainbox-body">
							<form action="#" method="post" name="frmadd_place" id="frmadd_place" enctype="multipart/form-data" >
