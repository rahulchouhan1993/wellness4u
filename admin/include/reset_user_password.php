...
if(isset($_POST['btnSubmit']))
{
	...
	if(!$error)
	{
		...
		if($obj->resetUserPassword($user_id,$password))
		{
			$from_email = 'info@wellnessway4u.com';
			$from_name = 'info';
			
			$to_email = $obj->getEmailOfUser($user_id);
			$name = $obj->getNameOfUser($user_id);
						...
						<td class="mainbox-body">
							...
							<tbody>
								<tr>
									...
									<td width="75%" align="left"><?php echo $obj->getEmailOfUser($user_id);?></td>
								</tr>
								<tr>
