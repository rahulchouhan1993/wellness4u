...
{
    $reward_bonus_module_id = trim($_POST['reward_bonus_module_id']);
                            ...
                            <form action="#" method="post" name="frmadd_contents" id="frmadd_contents" enctype="multipart/form-data" >
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td width="5%" align="center"><strong>:</strong></td>
                                        <td width="75%" align="left">
                                            <select id="reward_bonus_module_id" name="reward_bonus_module_id" style="width:400px;">
                                  ...
                                  <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center"><strong>:</strong></td>
                                        <td align="left"><input name="reward_bonus_conversion_value" type="text" id="reward_bonus_conversion_value" value="<?php echo $reward_bonus_conversion_value; ?>" style="width:400px;" ></td>
                                    </tr>
                                    <tr>
                                        <td colspan="3" align="center">&nbsp;</td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center"><strong>:</strong></td>
                                        <td align="left"><input name="reward_bonus_min_cutoff" type="text" id="reward_bonus_min_cutoff" value="<?php echo $reward_bonus_min_cutoff; ?>" style="width:400px;" ></td>
                                    </tr>
                                    <tr>
                                        <td colspan="3" align="center">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td align="center"><strong>:</strong></td>
                                        <td align="left"><input name="reward_bonus_max_cutoff" type="text" id="reward_bonus_max_cutoff" value="<?php echo $reward_bonus_max_cutoff; ?>" style="width:400px;" ></td>
                                    </tr>
                                    <tr>
                                        <td colspan="3" align="center">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td align="center"><strong>:</strong></td>
                                        <td align="left">
                                            <input name="reward_bonus_date" id="reward_bonus_date" type="text" value="<?php echo $reward_bonus_date;?>" style="width:200px;"  />
                                            <script>$('#reward_bonus_date').datepick({ minDate: 0 , dateFormat : 'dd-mm-yy'}); </script>
                                        </td>
                                    </tr>
                                    <tr>
