...
//    die();
	...
	$credit_line_1 = strip_tags(trim($_POST['credit_line_1']));
        ...
        $canv_sub_cat2_link=$_POST['canv_sub_cat2_link'];
        ...
        $canv_sub_cat3_link=$_POST['canv_sub_cat3_link'];
        ...
        $canv_sub_cat4_link=$_POST['canv_sub_cat4_link'];
...
if(!empty($end_date))
 {
       ...
       $end_date = date("Y-m-d",strtotime($end_date));
                    ...
                    if(isset($_FILES['banner_1']['tmp_name']) && $_FILES['banner_1']['tmp_name'] != '')
			{
				...
				if(!$error)
				{
					...
					$banner_1 = time().'_'.$image;
					$target_path = $target_path .$banner_1;
                    ...
                    if(isset($_FILES['banner_2']['tmp_name']) && $_FILES['banner_2']['tmp_name'] != '')
			{
				...
				if(!$error)
				{
					...
					$target_path = SITE_PATH."/uploads/";
					$banner_2 = time().'_'.$image;
					$target_path = $target_path .$banner_2;
...
else
	{
                ...
                if(isset($_GET['id']))
                {
                  ...
                  $days_of_month = $design_data['days_of_month'];
                  $single_date = $design_data['single_date'];
                  $start_date = $design_data['start_date'];
                  $end_date = $design_data['end_date'];
                  $days_of_week = $design_data['days_of_week'];
                  $months = $design_data['months'];
                  ...
                  $data_dropdown =  $obj2->GETDATADROPDOWNMYDAYTODAYOPTION($design_data['data_category'],'127');
                                ...
                                $fetch_cat10 = array();
                                   ...
                                   $final_dropdown = $obj2->CreateDesignLifeDropdownEdit($show_cat,$final_array,$design_data['box_title']);
							...
							<tbody>
								...
								<tr>
                                                                    ...
                                                                    <td width="65%" align="left" valign="top">
                                                                        <input type="text" name="ref_code" id="ref_code" value="<?php echo $design_data['ref_code']; ?>" style="width:200px;height: 24px;" required="">
								...
								<tr>
									...
									<td width="75%" align="left">
										<select name="banner_type_1" id="banner_type_1" onchange="showVideoURL1();">
											<option value="Image" <?php if($design_data['image_type_1'] == 'Image'){ ?> selected <?php } ?>>Image</option>
                                                                                        <option value="Video" <?php if($design_data['image_type_1'] == 'Video'){ ?> selected <?php } ?>>Video</option>
										</select>
                                                                            &nbsp;&nbsp;&nbsp;&nbsp;Show&nbsp;&nbsp;
                                                                            <select name="image_1_show" style="width:100px; height: 24px;">
                                                                                <option value="">Select</option>
                                                                                <option value="1" <?php if($design_data['image_1_show'] == '1'){ ?> selected <?php } ?>>Yes</option>
                                                                                <option value="0" <?php if($design_data['image_1_show'] == '0'){ ?> selected <?php } ?>>NO</option>
                                                                            </select>
                                                                            &nbsp;&nbsp;&nbsp;&nbsp;Order&nbsp;&nbsp;
                                                                            <select name="image1_order_show" style="width:100px; height: 24px;">
                                                                                <option value="">Select</option>
                                                                                <option value="1" <?php if($design_data['image1_order_show'] == '1'){ ?> selected <?php } ?>>1</option>
                                                                                <option value="2" <?php if($design_data['image1_order_show'] == '2'){ ?> selected <?php } ?>>2</option>
                                                                                <option value="3" <?php if($design_data['image1_order_show'] == '3'){ ?> selected <?php } ?>>3</option>
                                                                                <option value="4" <?php if($design_data['image1_order_show'] == '4'){ ?> selected <?php } ?>>4</option>
                                                                                <option value="5" <?php if($design_data['image1_order_show'] == '5'){ ?> selected <?php } ?>>5</option>
                                                                                <option value="6" <?php if($design_data['image1_order_show'] == '6'){ ?> selected <?php } ?>>6</option>
                                                                                <option value="7" <?php if($design_data['image1_order_show'] == '7'){ ?> selected <?php } ?>>7</option>
                                                                                <option value="8" <?php if($design_data['image1_order_show'] == '8'){ ?> selected <?php } ?>>8</option>
                                                                                <option value="9" <?php if($design_data['image1_order_show'] == '9'){ ?> selected <?php } ?>>9</option>
                                                                                <option value="10" <?php if($design_data['image1_order_show'] == '10'){ ?> selected <?php } ?>>10</option>
                                                                                <option value="11" <?php if($design_data['image1_order_show'] == '11'){ ?> selected <?php } ?>>11</option>
                                                                            </select>
									</td>
								</tr>
								<tr>
								...
								<tr id="banner_1_show">
									...
									<td width="5%" align="center" valign="top"><strong>:</strong></td>
									<td width="75%" align="left">
                                                                           <?php if(!empty($design_data['image_1']) && $design_data['image_type_1'] == 'Image') { ?>
                                                                            <img src="../uploads/<?php echo $design_data['image_1']; ?>" style="width:75px; height: 75px;">
                                                                            <br>
                                                                            <?php } ?>
                                                                            
                                                                            <input type="file" name="banner_1" id="banner_1" />
                                                                            <br>
                                                                        </td>
								</tr>
                                                                <tr id="video_1_show" style="<?php if(empty($design_data['video_link_1'])) { echo "display:none;"; } ?>">
									<td width="20%" align="right" valign="top"><strong>youtube Link</strong></td>
									<td width="5%" align="center" valign="top"><strong>:</strong></td>
                                                                        <td width="75%" align="left">
                                                                            <input type="text" name="video_1" id="video_1" value="<?php echo $design_data['video_link_1']; ?>"/>
                                                                        </td>
								</tr>
                                                                <tr>
									<td colspan="3" align="center">&nbsp;</td>
								...
								<tr>
									...
									<td width="5%" align="center"><strong>:</strong></td>
									<td width="75%" align="left"><input type="text"  id="credit_line_1" name="credit_line_1" value="<?php echo $design_data['image_credit_1']; ?>"/></td>
								</tr>
								<tr>
									<td colspan="3" align="center">&nbsp;</td>
								</tr>
									...
									<td width="5%" align="center"><strong>:</strong></td>
									<td width="75%" align="left"><input type="text"  id="credit_line_url_1" name="credit_line_url_1" value="<?php echo $design_data['image_credit_url_1']; ?>"/></td>
								</tr>
								<tr>
									<td colspan="3" align="center">&nbsp;</td>
								</tr>
									...
									<td width="75%" align="left"><select name="sound_clip_id_1" id="sound_clip_id_1" onchange="Playsound(sound_clip_id)">
                                    					...
                                    					<?php echo $obj->getSoundClipOptions($design_data['sound_clip_1']); ?>
                                                                    </select>
								...
								<tr>
									...
									<td width="75%" align="left">
										<select name="banner_type_2" id="banner_type_2" onchange="showVideoURL2();">
											<option value="Image" <?php if($design_data['image_type_2'] == 'Image'){ ?> selected <?php } ?>>Image</option>
                                                                                        
                                                                                        <option value="Video" <?php if($design_data['image_type_2'] == 'Video'){ ?> selected <?php } ?>>Video</option>
										</select>
                                                                            &nbsp;&nbsp;&nbsp;&nbsp;Show&nbsp;&nbsp;
                                                                            <select name="image_2_show" style="width:100px; height: 24px;">
                                                                                <option value="">Select</option>
                                                                                <option value="1" <?php if($design_data['image_2_show'] == '1'){ ?> selected <?php } ?>>Yes</option>
                                                                                <option value="0" <?php if($design_data['image_2_show'] == '0'){ ?> selected <?php } ?>>NO</option>
                                                                            </select>
                                                                            &nbsp;&nbsp;&nbsp;&nbsp;Order&nbsp;&nbsp;
                                                                            <select name="image2_order_show" style="width:100px; height: 24px;">
                                                                                <option value="">Select</option>
                                                                                <option value="1" <?php if($design_data['image2_order_show'] == '1'){ ?> selected <?php } ?>>1</option>
                                                                                <option value="2" <?php if($design_data['image2_order_show'] == '2'){ ?> selected <?php } ?>>2</option>
                                                                                <option value="3" <?php if($design_data['image2_order_show'] == '3'){ ?> selected <?php } ?>>3</option>
                                                                                <option value="4" <?php if($design_data['image2_order_show'] == '4'){ ?> selected <?php } ?>>4</option>
                                                                                <option value="5" <?php if($design_data['image2_order_show'] == '5'){ ?> selected <?php } ?>>5</option>
                                                                                <option value="6" <?php if($design_data['image2_order_show'] == '6'){ ?> selected <?php } ?>>6</option>
                                                                                <option value="7" <?php if($design_data['image2_order_show'] == '7'){ ?> selected <?php } ?>>7</option>
                                                                                <option value="8" <?php if($design_data['image2_order_show'] == '8'){ ?> selected <?php } ?>>8</option>
                                                                                <option value="9" <?php if($design_data['image2_order_show'] == '9'){ ?> selected <?php } ?>>9</option>
                                                                                <option value="10" <?php if($design_data['image2_order_show'] == '10'){ ?> selected <?php } ?>>10</option>
                                                                                <option value="11" <?php if($design_data['image2_order_show'] == '11'){ ?> selected <?php } ?>>11</option>
                                                                            </select>
									</td>
								</tr>
								<tr>
								...
								<tr id="banner_2_show">
									...
									<td width="5%" align="center" valign="top"><strong>:</strong></td>
									<td width="75%" align="left">
                                                                            <?php if(!empty($design_data['image_2']) && $design_data['image_type_2'] == 'Image') { ?>
                                                                            <img src="../uploads/<?php echo $design_data['image_2']; ?>" style="width:75px; height: 75px;">
                                                                            <br>
                                                                            <?php } ?>
                                                                            <input type="file" name="banner_2" id="banner_2" />
                                                                            <br>
                                                                        </td>
								</tr>
                                                                <tr id="video_2_show" style="<?php if(empty($design_data['video_link_2'])) { echo "display:none;"; } ?>">
									<td width="20%" align="right" valign="top"><strong>youtube Link</strong></td>
									<td width="5%" align="center" valign="top"><strong>:</strong></td>
                                                                        <td width="75%" align="left">
                                                                            <input type="text" name="video_2" id="video_2" value="<?php echo $design_data['video_link_2']; ?>"/>
                                                                        </td>
								</tr>
								...
								<tr>
									...
									<td width="5%" align="center"><strong>:</strong></td>
									<td width="75%" align="left"><input type="text"  id="credit_line_2" name="credit_line_2" value="<?php echo $design_data['image_credit_2']; ?>"/></td>
								</tr>
								<tr>
									<td colspan="3" align="center">&nbsp;</td>
								</tr>
									...
									<td width="5%" align="center"><strong>:</strong></td>
									<td width="75%" align="left"><input type="text"  id="credit_line_url_2" name="credit_line_url_2" value="<?php echo $design_data['image_credit_url_2']; ?>"/></td>
								</tr>
								<tr>
									<td colspan="3" align="center">&nbsp;</td>
								</tr>
								...
								<tr>
									...
									<td width="75%" align="left"><select name="sound_clip_id_2" id="sound_clip_id_2" onchange="Playsound(sound_clip_id)">
                                                                    <option value="">Select Music File </option>
                                    					<?php echo $obj->getSoundClipOptions($design_data['sound_clip_2']); ?>
                                                                    </select>
                                                                    <div id="playmusic"></div></td>
								</tr>
								<tr>
                                    ...
                                    <tr>                                                                    
                                        ...
                                        <td  align="left" valign="top">
                                            <select name="user_date_show" style="width:200px; height: 24px;">
                                                <option value="">Select</option>
                                                <option value="1" <?php if($design_data['user_date_show'] == '1'){ ?> selected <?php } ?>>Yes</option>
                                     ...
                                     <tr>                                                                    
                                        ...
                                        <td  align="left" valign="top">
                                            <select name="time_show" style="width:200px; height: 24px;">
                                                 <option value="">Select</option>
                                                 <option value="1" <?php if($design_data['time_show'] == '1'){ ?> selected <?php } ?>>Yes</option>
                                    ...
                                    <tr>                                                                    
                                        ...
                                        <td  align="left" valign="top">
                                            <select name="duration_show" style="width:200px; height: 24px;">
                                                <option value="">Select</option>
                                                <option value="1" <?php if($design_data['duration_show'] == '1'){ ?> selected <?php } ?>>Yes</option>
                                    ...
                                    <tr>                                                                    
                                        ...
                                        <td  align="left" valign="top">
                                            <select name="location_show" style="width:200px; height: 24px;">
                                                <option value="">Select</option>
                                                <option value="1" <?php if($design_data['location_show'] == '1'){ ?> selected <?php } ?>>Yes</option>
                                    ...
                                    <tr>                                                                    
                                        ...
                                        <td  align="left" valign="top">
                                            <select name="like_dislike_show" style="width:200px; height: 24px;">
                                                <option value="">Select</option>
                                                <option value="1" <?php if($design_data['User_view'] == '1'){ ?> selected <?php } ?>>Yes</option>
                                    ...
                                    <tr>                                                                    
                                        ...
                                        <td  align="left" valign="top">
                                            <select name="set_goals_show" style="width:200px; height: 24px;">
                                                <option value="">Select</option>
                                                <option value="1" <?php if($design_data['User_Interaction'] == '1'){ ?> selected <?php } ?>>Yes</option>
                                    ...
                                    <tr>                                                                    
                                        ...
                                        <td  align="left" valign="top">
                                            <select name="scale_show" style="width:200px; height: 24px;">
                                                <option value="">Select</option>
                                                <option value="1" <?php if($design_data['scale_show'] == '1'){ ?> selected <?php } ?>>Yes</option>
                                    ...
                                    <tr>                                                                    
                                        ...
                                        <td  align="left" valign="top">
                                            <select name="reminder_show" style="width:200px; height: 24px;">
                                                <option value="">Select</option>
                                                <option value="1" <?php if($design_data['alert_show'] == '1'){ ?> selected <?php } ?>>Yes</option>
                                    ...
                                    <tr>                                                                    
                                        ...
                                        <td  align="left" valign="top">
                                            <select name="comments_show" style="width:200px; height: 24px;">
                                                <option value="">Select</option>
                                                <option value="1" <?php if($design_data['comment_show'] == '1'){ ?> selected <?php } ?>>Yes</option>
                                    ...
                                    <tr>                                                                    
                                        ...
                                        <td  align="left" valign="top">
                                            <select name="quick_response_show" style="width:200px; height: 24px;">
                                                <option value="">Select</option>
                                                <option value="1" <?php if($quick_response_show == 1) { echo 'selected'; } ?>>Yes</option>
                                                <option value="0" <?php if($quick_response_show == 0) { echo 'selected'; } ?>>NO</option>
                                            </select>
                                    ...
                                    <tr>                                                                    
                                        ...
                                        <td  align="left" valign="top">
                                            ...
                                            &nbsp;&nbsp;&nbsp;Box Count <input type="text" name="box_count" id="box_count" value="<?php echo $box_count; ?>">
                                    ...
                                    <tr>                                                                    
                                        ...
                                        <td  align="left" valign="top">
                                            <select name="text_box_show" id="text_box_show" style="width:200px; height: 24px;">
                                                <option value="">Select</option>
                                                <option value="1" <?php if($text_box_show == 1) { echo 'selected'; } ?>>Yes</option>
                                                <option value="0" <?php if($text_box_show == 0) { echo 'selected'; } ?>>NO</option>
                                            </select>
                                            &nbsp;&nbsp;&nbsp;Box Count <input type="text" name="text_box_count" id="text_box_count" value="<?php echo $text_box_count; ?>">
                                    ...
                                    <tr>                                                                    
                                        ...
                                        <td  align="left" valign="top">
                                            <input type="text" name="response_heading" id="response_heading"  value="<?php echo $response_heading; ?>">                                           
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="8" align="center">&nbsp;</td>
