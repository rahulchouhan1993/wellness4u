                            ...
                            { 
                                foreach($referral_data as $record) 
                                {
                                    ...
                                    if($record['request_status'] == '1')
                                    {
                                        ...
                                        $action = '<input type="button" name="btnAccept" id="btnAccept" value="Authorise/Modify Access" onclick="showAcceptInvitationPopup(\''.$record['ar_id'].'\',\''.$uid.'\')" >';
                                    ...
                                    <table width="760" border="0" align="center" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td width="75%" align="left" valign="middle"><strong>Adviser Name: <?php echo $record['name'];?></strong>&nbsp;<input type="button" name="btnViewAdviser" id="btnViewAdviser" value="View Adviser Profile" onclick="viewAdviserPopup('<?php echo $uid;?>')" >&nbsp;<input type="button" name="btnViewAdviserReportLog" id="btnViewAdviserReportLog" value="View Access Log" onclick="javascript:window.open('my_adviser_authorise_log.php?id=<?php echo $uid;?>', '_blank');" ></td>
