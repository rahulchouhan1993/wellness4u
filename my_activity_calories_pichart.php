...
$ref = base64_encode('my_activity_calories_pichart.php');
...
if(chkUserPlanFeaturePermission($user_id,'13'))
{
	$my_activity_calories_pi_chart = 1;
}
else
{
...
<meta name="viewport" content="width=device-width, initial-scale=1">
 ...
 <link href="csswell/bootstrap/css/bootstrap.min.css" rel="stylesheet"> 
   ...
   <script type="text/javascript" src="js/jquery.min.js"></script>
    ...
    <link rel="stylesheet" type="text/css" href="scc/examples.min.css" />
								...
								<td align="center" valign="top" bgcolor="#FFFFFF">
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0" id="my_tbl">
										...
										<tr>
											...
											if($my_activity_calories_pi_chart == 1) 
											...
											{ ?>	
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													...
													<tr>
														...
														<td width="10%" height="45" align="left" valign="middle" class="Header_brown">Start Date:</td>
...
<td width="10%">
														...
														<td width="10%" height="45" align="left" valign="middle" class="Header_brown">End Date:</td>
														...
														<td width="25%" align="left" valign="middle">
													  	...
													  	<td width="20%" height="45" align="left" valign="middle"><input type="submit" name="btnSubmit" id="btnSubmit" value="View Report" /></td>
												...
												<table width="100%" border="1" cellpadding="1" cellspacing="1" bgcolor="#999999" class="report_header" >

                                                    <tr>

                                                        <td height="50" width="5%" align="left" valign="middle" bgcolor="#E1E1E1" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal; color:#0000FF;">SNo</td>

                                                        <td height="50" width="20%" align="left" valign="middle" bgcolor="#E1E1E1" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal; color:#0000FF;">Date/day</td>

                                                   

                                                        <td height="50" width="75%" align="left" valign="middle" bgcolor="#FFFFFF" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal; color:#0000FF;">&nbsp;</td>
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td height="50" align="center" valign="middle" bgcolor="#FFFFFF" style="FONT-SIZE: 11px; FONT-STYLE: normal; FONT-FAMILY: Tahoma, Verdana, Arial; font-weight: normal; color:#000000;">
                                                      ...
                                                      <div id="chart1<?php print $l; ?>" style="height:300px; width:700px; font-size:12px;"></div></td>
                                                    ...
                                                    { 
                                                      ...
                                                      legend: { show:true, location: 'e' }
                                                        ...
                                                        <div id="total" style="height:300px; width:700px; font-size:12px;"></div>
