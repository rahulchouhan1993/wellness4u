...

{
    ...
    if ($obj->chkIfValidCityId($topcityid))
...

{
    ...
    if ($obj->chkIfValidAreaId($topareaid))
...
$toplocationstr = $obj->getTopLocationStr($topcityid, $topareaid);
...
?>
        ...
        <nav>
            <div class="container">
                <div class="col-md-2 col-xs-4">
                    <a href="index.php" class="logo"> <img src="images/cwri_logo.png" class="img-responsive" alt="logo.png"> </a>
                </div>
                <div class="col-md-10 col-xs-8" class="img-responsive">
                    <!-- <?php
                    ...
                    ?> <a href="<?php echo $url1; ?>" class="img-responsive" target="_blank"><img src="<?php echo SITE_URL . "/uploads/" . $arr_banner[$i]; ?>"  border="0" /></a>
                                                            <?php
...

                                {
                                    ...
                                    <li>
                                        <a href="<?php echo $menu_link1; ?>">
                                            <?php echo $val['menu_details']['menu_title']; ?>
                                        </a>
                                        <?php
...

                                        {
                                            ...
                                            <li>
                                                <a href="<?php echo $menu_link2; ?>">
                                                    <?php echo $val2['menu_details']['menu_title']; ?>
                                                </a>
                                                <?php
                                            ...
                                            <li style="border-left: 1px solid #ffffff;border-right: 1px solid #ffffff;">
                                                <a href="<?php echo $menu_link3; ?>">
                                                    <?php echo $val3['menu_details']['menu_title']; ?>
                                                </a>
                                            </li>
                                            <?php
    ...
    <div class="container" style="background-color:white;">
        <?php //include_once('sticker_slider.php');
 ?>
            <div class="row">
                <div class="col-md-12">
                    <?php echo $obj->getScrollingBarCode_KR($page_id) ?>
                </div>
            </div>
    </div>
    <?php
