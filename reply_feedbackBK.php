					...
					<td width="620" align="center" valign="top">
                        ...
                        <form action="#" name="frmviewfeedback" id="frmviewfeedback" method="post"> 
                           ...
                           <input type="hidden" name="hdn_p_id" id="hdn_p_id" value="<?php echo $p_id; ?>" />
                           	 ...
                           	 <table width="580" border="0" align="left" cellpadding="3" cellspacing="3">

                        	 	 <tr>

                                	<td  align="left" valign="top"><strong>Subject :</strong></td>

									<td align="left"><?php echo $feedback_page_name; ?></td>
                                 ...
                                 <tr>
                                    ...
                                    <td><textarea type="text" name="reply" id="reply" cols="50" rows="5" ><?php echo $reply; ?></textarea></td>
                                 ...
                                 <tr>
                                   ...
                                   <td  align="left" valign="top">&nbsp;</td>
                                    ...
                                    <td  align="left" valign="top"><input type="button" value="btnSubmit" id="btnSubmit" onclick="SubmitReply()" /></td>
