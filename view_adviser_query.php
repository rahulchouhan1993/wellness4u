...
if(!$obj->chk_valid_user_query_id($id,$user_id))
{
...
{
	$obj->setUserQueryRead($id,$user_id,'1');
}

$query_data = $obj->getAdviserQueryDetails($id);
//echo '<pre>';
//print_r($query_data);
//echo '</pre>';
$all_queries_data =	$obj->getAllAdviserQueriesByID($id);
//echo '<pre>';
	...
	<tr>
		<td align="center" valign="top">
			...
			<table width="980" border="0" cellspacing="0" cellpadding="0">
                    ...
                    if($obj->isLoggedIn())
                    { 
                        echo $obj->getWelcomeUserBoxCode($_SESSION['name'],$_SESSION['user_id'],'1');
                    }
                    ?>
                    </td>
                </tr>
						...
						<table width="760" border="0" align="center" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
								<td align="left" valign="top">
									...
									<?php echo $obj->getPageContents($main_page_id);?>
								</td>
							</tr>
                            <tr>
                            	<td align="left"><strong>Subject: <?php echo $obj->getReportTypeName($query_data[0]['page_id']); ?></strong></td>
                            </tr>
                            <tr>
                            	<td align="left"><strong>Adviser Name: <?php echo $obj->getProUserFullNameById($query_data[0]['pro_user_id']); ?></strong></td>
                            </tr>
						</table><br/>
                        <form action="#" name="frmviewfeedback" id="frmviewfeedback" method="post"> 
                           <input type="hidden" name="hdn_id" id="hdn_id" value="<?php echo $id; ?>" />
							...
							{ 
								...
								{
									$from = 'You';
									$to = $obj->getProUserFullNameById($record['pro_user_id']);
								}
								else
								{
									$from = $obj->getProUserFullNameById($record['pro_user_id']);
									$to = 'You';
								}
