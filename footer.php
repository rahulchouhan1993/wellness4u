		...
		<div class="row">
			...
			<div class="col-md-3 col-xs-12 footer_menu ">
				...
				<ul>
					...
					<li><a href="<?php echo SITE_URL.'/privacy_policy.php';?>">Privacy Policy</a></li>
                                       ...
                                       <!--<li><a href="<?php echo SITE_URL.'/shpg_delivery.php';?>">Shipping & Delivery Policy</a></li>-->

                                        <li><a href="<?php echo SITE_URL.'/refund_cancl.php';?>">Cancellation & Refund Policy</a></li>
			...
			<div class="col-md-3 col-xs-12 footer_menu ">
				...
				<ul>
					...
					<li><a href="<?php echo SITE_URL.'/wa_register.php';?>">Wellness Associates Registration/Login</a></li>



					<!--<li><a href="<?php //echo BA_URL.'/login.php';?>">Wellness Associates Login</a></li>-->
					
				<h4>WellnessWay4u Ecosystem</h4>
				...
				<ul>
					...
					<li><a href="<?php echo SITE_URL.'/resources.php';?>">Fundamentals, validation, and uniqueness of the ecosystem</a></li>
			...
			<div class="col-md-3 col-xs-12 footer_menu ">
				...
				<ul>
					...
					<li><i class="fa fa-phone" aria-hidden="true"></i> &nbsp;8655018341</li>
				...
				<div class="row">
					...
					<div class="col-md-12">
						...
						<ul class="social">    	
							...
							<li><a href="https://www.facebook.com/WellnessWay4U/" target="_blank" alt="Facebook"><i class="fa fa-facebook iconshow" >&nbsp;</i></a></li>



							<li><a href="https://twitter.com/WellnessWay4U" target="_blank" alt="Twitter"><i class="fa fa-twitter iconshow">&nbsp;</i></a></li>  



							<li><a href="https://instagram.com/WellnessWay4U" target="_blank" alt="Instagram"><i class="fa fa-instagram iconshow">&nbsp;</i></a></li>

                                                        

                                                        <li><a href="https://wellnessway4u.com/blog/" target="_blank" alt="blog"><i class="fa-solid fa-blog iconshow">&nbsp;</i></a></li>   
...
<!-- <div class="feedback" onclick="FeedBackForm()"><img src="images/feedback_button.png" width="35" height="127" /></div> -->
	...
	<div class="feedback feedback1" >
		<button class="btn btn-default btn-feedback" title="Help us Improve" onclick="FeedBackForm(<?=$page_id;?>)"> <i class="fa fa-question-circle" aria-hidden="true"></i> Help us Improve</button>
	</div>
	<!-- add 1 more button by ample 28-09-20 -->
	<?php 
	  if(isset($_SESSION['user_id']) && !empty($_SESSION['user_id']))
	  {
	  	?>
	  	<div class="feedback feedback2" >
			<button class="btn btn-default btn-feedback" title=" Today Task" onclick="today_task()" style="margin-top: 7.5px;"> <i class="fa fa-tasks" aria-hidden="true"></i> Today Task</button>
		</div>
	  	<?php
	  }
	?>
		<!-- comment by ample 13-04-20-->
         <!-- <div class="QTPopup">    
...
/* function doAcceptAdviserInvitation(ar_id,vid)
{
	...
	if (Choice == true)
	{
		...
		$.ajax({
		    url: "remote2.php",
		    type:'get',
		    data: {action:'doacceptadviserinvitation',ar_id:ar_id, vid:vid },
		    dataType: 'json',
...
function showDeclineAdviserInvitation(ar_id,vid)
{
	var Choice = confirm("Do you wish to modify?");
	if (Choice == true)
	{
		...
		$.ajax({
		    url: "remote2.php",
		    type:'get',
		    data: {action:'showdeactivateadviserinvitationpopup',ar_id:ar_id, vid:vid },
		    dataType: 'json',
		    success: function(response) {
		      //Do Something
		      window.location.reload(true);
...

{
    ...
    var dataString ='action=feedback_form&page_id='+page_id;
  ...
  $( function() {
    ...
    $( "#invite_start_date" ).datepicker({ dateFormat: 'dd/mm/yy' });  // line added by ample 23-10-19
...
<!-- <script>
  ...
  if(isset($_SESSION['user_id']) && !empty($_SESSION['user_id']))
  {
  	if($_SESSION['today_task_popup']!==1)
	  {
	    ?>
	    <script type="text/javascript">
...
<!-- add by ample 28-09-20 --> 
  <script type="text/javascript">
   ...
   function today_task()
  {
      var dataString ='action=today_event_task';
