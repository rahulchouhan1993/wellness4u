...
<table width="100%" border="0" cellspacing="4" cellpadding="2">
											...
											<tr>
												<td width="40%" height="50" align="left" valign="bottom">Name:</td>
											...
											<tr>
												<td height="50" align="left" valign="bottom">DOB:</td>
 ...
 <!--default footer end here-->
       <!--scripts and plugins -->
        ...
        <script src="csswell/js/custom.js" type="text/javascript"></script>
         <!--sky form plugin js-->
         <script src="csswell/sky-form/js/jquery.form.min.js" type="text/javascript"></script>
         <script src="csswell/sky-form/js/jquery.validate.min.js" type="text/javascript"></script>
         <script src="csswell/js/sky-forms-custom.js" type="text/javascript"></script>
             <!--gmap js-->
