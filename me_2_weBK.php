...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var slider_count = document.getElementById('hndslidercount').value;
						...
						<table width="580" border="0" align="center" cellpadding="0" cellspacing="0">
							<tr>
								<td align="left" valign="top">
                                    <form action="#" id="frmme2we" name="frmme2we" method="post">
                                        <input type="hidden" name="hndslidercount" id="hndslidercount" value="<?php echo $slider_count; ?>"  />
