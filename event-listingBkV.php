...
$tdata['upcoming_current'] = $upcoming_current;
                    ...
                    <div class="col-md-12" id="explore" style="background-repeat:repeat; padding:5px;">
                        ...
                        <form role="form" class="form-horizontal" id="event_listing" name="event_listing" enctype="multipart/form-data" method="post"> 
                            ...
                            <div class="col-md-2">
                                ...
                                <select name="event_country" id="event_country" class="form-control" onchange="GetEventState();" required="">
...
<!--                            <div class="col-md-3">
                               ...
                               <select name="upcoming_current" id="upcoming_current" class="form-control" required="" onchange="ShowHideDate();">
                                   ...
                                   <option value="1" <?php //if($upcoming_current == 1) { echo 'selected'; } ?>>current</option>
                            ...
                            <div class="col-md-2">
                               ...
                               <input type="text" value="<?php echo $from_day_month_year; ?>" name="from_day_month_year" id="from_day_month_year" placeholder="Select Date" class="form-control" autocomplete="off" required="">
                            </div> 
                            <div class="col-md-2" id="datehideshow">
                               <span style="font-size:15px; font-weight: bold;" class="Header_brown">To Date</span>
                               <input type="text" value="<?php echo $to_day_month_year; ?>" name="to_day_month_year" id="to_day_month_year" placeholder="Select Date" class="form-control" autocomplete="off" >
                            </div> 
                             <div class="col-md-3">
                        ...
                        <div class="col-md-12">
                        <span style="font-size:15px; font-weight: bold;" class="Header_brown">Search by Tags..</span><br>
                         <?php if(count($tags_arr)>0) { 
                             for($i=0;$i<count($tags_arr);$i++)
                             {
                             ?> 
                                <a href="event-search.php?event_country=<?php echo $_POST['event_country']; ?>&event_state=<?php echo $_POST['event_state']; ?>&event_city=<?php echo $_POST['event_city']; ?>&event_area=<?php echo $_POST['event_area']; ?>&from_day_month_year=<?php echo $_POST['from_day_month_year']; ?>&to_day_month_year=<?php echo $_POST['to_day_month_year']; ?>&event_type=<?php echo $_POST['event_type']; ?>&tags=<?php echo $tags_arr[$i]; ?>&action=search_event" target="_blank" class="breadcrumb_link" style="font-size:14px;"><?php echo $tags_arr[$i];  ?></a>&nbsp;&nbsp;&nbsp;&nbsp;
                            <?php 
                             }
                            }
                         ?>
                       ...
                       ?>
                        ...
                        <div class="col-sm-3">
                            <div class="col-item">
                                ...
                                <div class="photo">
                                    <img src="https://www.wellnessway4u.com/wa/uploads/<?php echo $event_display_data[$j]['event_image']; ?>" style="width:266px; height: 177px;" class="img-responsive" alt="" />
                                </div>
                                <div class="info">
                       ...
                       ?>
                        <div class="col-sm-3">
                            <div class="col-item">
                                ...
                                <div class="photo">
                                    <img src="https://www.wellnessway4u.com/wa/uploads/<?php echo $event_display_data[$m]['event_image']; ?>" style="width:266px; height: 177px;" class="img-responsive" alt="a" />
                                </div>
                                <div class="info">
                                    <div class="separator clear-left">
                                        <p style="text-align: left; font-size: 12px;">
